...
- safe: [MoinMoin](MoinMoin) remembers all old page versions.
...
- Menu item **[FindPage](FindPage)**

  - Includes indexes of all pages sorted by page names and words in the page name.
  - Advanced search functions.

![(!)](/wiki/modernized/img/idea.png "(!)") The title search can also be used to quickly navigate to pages that you only roughly know the title of.
...
For this reason you can easily follow these changes on the page **[RecentChanges](RecentChanges)**.
...
![(!)](/wiki/modernized/img/idea.png "(!)") If you are logged in to the wiki, you can set a temporal *bookmark* using this page. In that case, the wiki will remember which changes you have already seen and will only display the new ones after that.
:::
...
- set a temporal bookmark on [RecentChanges](RecentChanges).
...
![/!\\](/wiki/modernized/img/alert.png "/!\") Then click on **Create Profile**. ![/!\\](/wiki/modernized/img/alert.png "/!\")

The account will be created and you can log in to the wiki using your user name and password.

![(!)](/wiki/modernized/img/idea.png "(!)") You are logged in if you see the user name in the navigation area.
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") You can\'t mess anything up, because the previous version of the page is always saved and can be restored if needed.
...
When you\'re done, you should enter an appropriate comment (which will then appear on [RecentChanges](RecentChanges) and in the history of the page) and click **save**.
...
![(!)](/wiki/modernized/img/idea.png "(!)") You should *not* go back to the editor page with the \"back\" button of the browser after editing, because this can lead to strange editing conflicts. Just use [MoinMoin](MoinMoin)\'s *edit* button again.
...
- ![(!)](/wiki/modernized/img/idea.png "(!)") Linux and other UNIX OSes / X11: A left doubleclick *selects* and *copies* a word, and a click on the middle mouse key is *insert*.
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") The [MoinMoin](MoinMoin) wiki markup will be explained in more detail on the following pages.
...
You just start writing. ![:)](/wiki/modernized/img/smile.png ":)")
...
![(!)](/wiki/modernized/img/idea.png "(!)") If a headline isn\'t displayed correctly, it is usually because:
...
![(!)](/wiki/modernized/img/idea.png "(!)") MoinMoin can count on its own!

![(!)](/wiki/modernized/img/idea.png "(!)") The number of leading spaces defines the hierarchical level of the list.
...
![(!)](/wiki/modernized/img/idea.png "(!)") More at [HelpOnEditing](HelpOnEditing).
::::
...
[ToDo](./ToDo.html) is [CamelCase](CamelCase), so it links to a homonymous page, which isn\'t very exciting. ![:)](/wiki/modernized/img/smile.png ":)")

![(!)](/wiki/modernized/img/idea.png "(!)") But you can click on the page name on the page [ToDo](./ToDo.html) and lo and behold, you find every page that also includes a [ToDo](./ToDo.html).
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") As you can see, `[[...]]`{.backtick} sets a link to the target, `{}`{.backtick} embeds the target, which is especially useful for pictures.
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") As long as the files aren\'t uploaded:
...
::: {}
  ...
  **Markup**   **Display**                                                                    **Markup**   **Display**                                                                   **Markup**   **Display**                                                                     **Markup**   **Display**
  `X-(`        ![X-(](/wiki/modernized/img/angry.png "X-(")           `:D`         ![:D](/wiki/modernized/img/biggrin.png ":D")          `<:(`        ![\<:(](/wiki/modernized/img/frown.png "<:(")           `:o`         ![:o](/wiki/modernized/img/redface.png ":o")
  `:(`         ![:(](/wiki/modernized/img/sad.png ":(")               `:)`         ![:)](/wiki/modernized/img/smile.png ":)")            `B)`         ![B)](/wiki/modernized/img/smile2.png "B)")             `:))`        ![:))](/wiki/modernized/img/smile3.png ":))")
  `;)`         ![;)](/wiki/modernized/img/smile4.png ";)")            `/!\`        ![/!\\](/wiki/modernized/img/alert.png "/!\")         `<!>`        ![\<!\>](/wiki/modernized/img/attention.png "<!>")      `(!)`        ![(!)](/wiki/modernized/img/idea.png "(!)")
  `:-?`        ![:-?](/wiki/modernized/img/tongue.png ":-?")          `:\`         ![:\\](/wiki/modernized/img/ohwell.png ":\")          `>:>`        ![\>:\>](/wiki/modernized/img/devil.png ">:>")          `|)`         ![\|)](/wiki/modernized/img/tired.png "|)")
  `:-(`        ![:-(](/wiki/modernized/img/sad.png ":-(")             `:-)`        ![:-)](/wiki/modernized/img/smile.png ":-)")          `B-)`        ![B-)](/wiki/modernized/img/smile2.png "B-)")           `:-))`       ![:-))](/wiki/modernized/img/smile3.png ":-))")
  `;-)`        ![;-)](/wiki/modernized/img/smile4.png ";-)")          `|-)`        ![\|-)](/wiki/modernized/img/tired.png "|-)")         `(./)`       ![(./)](/wiki/modernized/img/checkmark.png "(./)")      `{OK}`       ![{OK}](/wiki/modernized/img/thumbs-up.png "{OK}")
  `{X}`        ![{X}](/wiki/modernized/img/icon-error.png "{X}")      `{i}`        ![{i}](/wiki/modernized/img/icon-info.png "{i}")      `{1}`        ![{1}](/wiki/modernized/img/prio1.png "{1}")            `{2}`        ![{2}](/wiki/modernized/img/prio2.png "{2}")
  `{3}`        ![{3}](/wiki/modernized/img/prio3.png "{3}")           `{*}`        ![{\*}](/wiki/modernized/img/star_on.png "{*}")       `{o}`        ![{o}](/wiki/modernized/img/star_off.png "{o}")                       
  ------------ --------------------------------------------------------------------------- -- ------------ -------------------------------------------------------------------------- -- ------------ ---------------------------------------------------------------------------- -- ------------ ----------------------------------------------------------------------------
:::
::::
...
![(!)](/wiki/modernized/img/idea.png "(!)") *The following four chapters are about advanced details. If you don\'t care about this, you can just [skip](./WikiCourse(2f)30(20)The(20)graphical(20)editor.html) them.*
...
- prepare to edit using:
  ...
  - ![(!)](/wiki/modernized/img/idea.png "(!)") the list of similar page names shown to ensure that there isn\'t any slightly different named page on the same topic.

- start editing, fill the page with content, and save it.

![(!)](/wiki/modernized/img/idea.png "(!)") This method makes sure that new pages are always accessible from links on already existing pages.
:::
...
- only if a topic has many subtopics (which aren\'t main topics), subpages are used.
  ...
  ![(!)](/wiki/modernized/img/idea.png "(!)") Sub pages are named as `MainPage/SubPage`{.backtick}
...
Of course, you should avoid that to prevent complete chaos. ![B-)](/wiki/modernized/img/smile2.png "B-)")
