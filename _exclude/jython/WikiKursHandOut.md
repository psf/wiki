...
![(!)](/wiki/modernized/img/idea.png "(!)") Die Titelsuche kann auch als schnelle Sprungfunktion verwendet werden, wenn man den Seitennamen nur so ungefähr weiß.
...
![(!)](/wiki/modernized/img/idea.png "(!)") Wenn man im Wiki angemeldet ist, kann man auf dieser Seite auch ein zeitliches *Lesezeichen* setzen. Damit merkt sich das Wiki für jeden Benutzer, bis wann er die Änderungen bereits gelesen hat und zeigt ihm danach nur noch die Neuigkeiten danach an.
:::
...
- ![/!\\](/wiki/modernized/img/alert.png "/!\") Auf **Benutzer anlegen** klicken! ![/!\\](/wiki/modernized/img/alert.png "/!\")

Damit wird das Benutzerkonto angelegt und man kann sich danach dann mit Name/Passwort beim Wiki anmelden.

![(!)](/wiki/modernized/img/idea.png "(!)") Dass man angemeldet ist, sieht man dadurch, dass der Benutzername im Navigationsbereich angezeigt wird.
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") Man kann nichts kaputt machen, denn die vorherige Version des Text wird immer gesichert und kann ggf. auch wieder hergestellt werden.
...
![(!)](/wiki/modernized/img/idea.png "(!)") Man sollte nach dem Speichern *nicht* mit dem \"Zurück\"-Knopf des Browsers wieder auf die Editorseite zurückblättern (dies kann zu merkwürdigen Edit-Konflikten führen), sondern den von [MoinMoin](MoinMoin) angeboten *Editieren*-Link erneut anklicken.
...
- ![(!)](/wiki/modernized/img/idea.png "(!)") Linux / X11: Ein Doppelklick links *selektiert* und *kopiert* ein Wort, ein Klick auf die mittlere Maustaste ist *einfügen*.
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") Das [MoinMoin](MoinMoin)-Wiki Markup wird auf den folgenden Seiten noch genauer erklärt.
:::
...
Man schreibt einfach drauf los. ![:)](/wiki/modernized/img/smile.png ":)")
...
![(!)](/wiki/modernized/img/idea.png "(!)") Wenn eine Überschrift nicht richtig dargestellt wird, liegt es i.d.R. an einem dieser Punkte:
...
![(!)](/wiki/modernized/img/idea.png "(!)") MoinMoin kann selbst zählen!

![(!)](/wiki/modernized/img/idea.png "(!)") Die Anzahl der führenden Leerzeichen bestimmt die Hierachiestufe der Liste.
...
![(!)](/wiki/modernized/img/idea.png "(!)") Weitere auf [HilfeZumFormatieren](HilfeZumFormatieren).
::::
...
![](http://moinmoin.wikiwikiweb.de/wiki/common/moinmoin.png "http://moinmoin.wikiwikiweb.de/wiki/common/moinmoin.png")

![(!)](/wiki/modernized/img/idea.png "(!)") Wie man sieht, setzt `[[...]]`{.backtick} einen Link zum Zielobjekt, `{}`{.backtick} bettet das Zielobjekt ein (z.B. Bilder).
:::
...
[![\[ATTACH\]](/wiki/modernized/img/attach.png "[ATTACH]")]( "Upload new attachment "foto.jpg"")

![(!)](/wiki/modernized/img/idea.png "(!)") Solange die Dateien noch nicht hochgeladen wurden, erscheint die Aufforderung hierzu:
...
::: {}
  ---------------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  `{1} {2} {3}`{.backtick}                 ![{1}](/wiki/modernized/img/prio1.png "{1}") ![{2}](/wiki/modernized/img/prio2.png "{2}") ![{3}](/wiki/modernized/img/prio3.png "{3}")
  `/!\ (!) (./) {X} {i} {OK}`{.backtick}   ![/!\\](/wiki/modernized/img/alert.png "/!\") ![(!)](/wiki/modernized/img/idea.png "(!)") ![(./)](/wiki/modernized/img/checkmark.png "(./)") ![{X}](/wiki/modernized/img/icon-error.png "{X}") ![{i}](/wiki/modernized/img/icon-info.png "{i}") ![{OK}](/wiki/modernized/img/thumbs-up.png "{OK}")
  `{*} {o}`{.backtick}                     ![{\*}](/wiki/modernized/img/star_on.png "{*}") ![{o}](/wiki/modernized/img/star_off.png "{o}")
  `:) B-) :( X-(`{.backtick}               ![:)](/wiki/modernized/img/smile.png ":)") ![B-)](/wiki/modernized/img/smile2.png "B-)") ![:(](/wiki/modernized/img/sad.png ":(") ![X-(](/wiki/modernized/img/angry.png "X-(")
  ---------------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
:::
...
![(!)](/wiki/modernized/img/idea.png "(!)") *Die folgenden vier Kapitel behandeln fortgeschrittene Details. Wenn Sie das nicht interessiert, können Sie sie auch einfach [überspringen](./WikiKurs(2f)30(20)Der(20)grafische(20)Editor.html).*
...
Etwas Text mit einer Fußnote.^[1](#WikiKurs.2F21_Makros.fnref-f7f23ae3742ff0bcc06a6662a0fbc751d011569e)^
::::
...
Welcher Editor angeboten bzw. persönlich bevorzugt wird, kann man in den [BenutzerEinstellungen](./WikiKurs(2f)30(20)Der(20)grafische(20)Editor.html?action=userprefs) einstellen. Man kann im Editor auch jeweils in den anderen Editor umschalten (Text-Modus vs. GUI-Modus).
...
- nun erscheint der Hinweis, dass diese Seite nicht existiert und ob und wie man sie anlegen möchte:
  ...
  - ![(!)](/wiki/modernized/img/idea.png "(!)") rechts wird übrigens eine Liste mit ähnlichen Seitennamen angezeigt. Hier sollte man schauen, ob es nicht bereits eine leicht anders benannte Seite zum gleichen Thema gibt

- dann wird der Editor aufgerufen und man kann die Seite mit Inhalten füllen und zuguterletzt speichern

![(!)](/wiki/modernized/img/idea.png "(!)") Diese Methode hat den Vorteil, dass neue Seiten immer von bereits existierenden Seiten per Link erreichbar sind.
:::
...
- nur wenn ein Thema viele Unterthemen hat (die aber keine Hauptthemen darstellen), werden dazu Unterseiten benutzt.
  ...
  ![(!)](/wiki/modernized/img/idea.png "(!)") Unterseiten legt man einfach als `HauptSeite/UnterSeite`{.backtick} an.
...
Natürlich sollte man vermeiden, dass es ein komplettes Chaos gibt. ![B-)](/wiki/modernized/img/smile2.png "B-)")
