...
::: {}
+:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+:---------------------------------------------------------------------------------:+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:+
| ![(./)](/wiki/europython/img/checkmark.png "(./)") ![/!\\](/wiki/europython/img/alert.png "/!\") ![\<!\>](/wiki/europython/img/attention.png "<!>") | If you have just installed or upgraded your wiki you are not in the wrong place.\ | ![\<!\>](/wiki/europython/img/attention.png "<!>") ![/!\\](/wiki/europython/img/alert.png "/!\") ![(./)](/wiki/europython/img/checkmark.png "(./)") |
...
![/!\\](/wiki/europython/img/alert.png "/!\") If you go the *multiple languages* way, people reaching your wiki will be directed to the front page corresponding to their browser language setting. If you did not prepare that page (see front page name for different languages in [wiki comment](http://master.moinmo.in/HelpOnComments "MoinMaster") below), they will see the default page for their language and have the impression the wiki is empty or badly maintained.
