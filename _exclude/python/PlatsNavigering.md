...
- [SökSida](./S(c3b6)kSida.html) - går till en sida där man kan söka efter sidor

- [ÖnskadeSidor](./(c396)nskadeSidor.html) - en lista på sidor som inte är skrivna ännu

- [FöräldrarlösaSidor](./F(c3b6)r(c3a4)ldrarl(c3b6)saSidor.html) - en lista på sidor som inte är refererade till

- [SlumpvisSida](SlumpvisSida) - ger en lista på ett antal slumpvist utvalda sidor

- [SidStorlek](SidStorlek) - ger en lista på sidor sorterade efter storlek
