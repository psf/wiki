...
\* making a change to a member\'s address/e-mail/etc.

\* getting a count of AMs. Better: getting a count of AMs over time (is

- membership increasing or not?)

\* send a monthly (or weekly?) set of e-mails to AMs whose membership

- is expiring or has expired, reminding them to renew.

\* send an informational e-mail to all of the AMs in good standing.
