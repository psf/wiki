...
# Methods of specifying Jython settings {#Methods_of_specifying_Jython_settings}
...
- Registry: property files `registry`{.backtick} in Jython root and `.jython`{.backtick} in `user.home`{.backtick}; if both are present, the latter replaces the former completely. If either is present, the Java system properties are replaced entirely. (This is likely a bug in `PySystemState.addRegistryFile`{.backtick}.) See [Finding the Registry File](http://www.jython.org/Project/userguide.html#finding-the-registry-file){.http} for more information.
...
- The options whose destinations are static variables in the `Options`{.backtick} class are well-documented [there](https://jython.svn.sourceforge.net/svnroot/jython/branches/asm/src/org/python/core/Options.java){.https}.

- The [default registry file](https://jython.svn.sourceforge.net/svnroot/jython/branches/asm/registry){.https} is severely bitrotted and needs redoing.

- The [Jython user guide](http://www.jython.org/Project/userguide.html#the-jython-registry){.http} refers to a subset of these properties.

::: {}
  --------------------------------------------------------------------------------------- ---------------------------------------------------------------------------- -----------------------------------------------------------------------------------
  Source                                                                                  Destination                                                                  Default
  install.root                                                                                                                                                         
  python.cachedir                                                                         [PySystemState](./PySystemState.html){.nonexistent}.cachedir = File(\...)    \"cachedir\"
  python.cachedir.skip                                                                    [PySystemState](./PySystemState.html){.nonexistent}.cachedir = null          true if standalone, else false
  python.collections                                                                      [PyInstance](./PyInstance.html){.nonexistent}.initializeIterators            \"\"
  python.console                                                                          jython.main                                                                  \"org.python.util.[InteractiveConsole](./InteractiveConsole.html){.nonexistent}\"
  python.console.encoding                                                                 [CompilerFlags](./CompilerFlags.html){.nonexistent}.encoding                 
  ...
  python.executable                                                                       [PySystemState](./PySystemState.html){.nonexistent}.\[default\]Executable    set by launcher script, else null
  python.home                                                                             [PySystemState](./PySystemState.html){.nonexistent}.\[exec\_\]prefix         set by launcher script, else \".\"
  python.modules.builtin                                                                  [PySystemState](./PySystemState.html){.nonexistent}.builtin_module_names     \"\"; appended to Setup.builtinModules
  ...
  python.options.internalTablesImpl                                                       [InternalTables](./InternalTables.html){.nonexistent}.createInternalTables   null
  ...
  python.path ![{X}](/wiki/modernized/img/icon-error.png "{X}"){height="16" width="16"}   end of path after JYTHON_JAR/Lib                                             \"\"
...
![{X}](/wiki/modernized/img/icon-error.png "{X}"){height="16" width="16"} gone in Jython 2.5 or later
::::
