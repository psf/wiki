...
zxJDBC and JyJDBC are different implementations of Python [DB API 2.0](http://www.python.org/dev/peps/pep-0249/){.http .reference .external}. The following paragraphs describe zxJDBC, but using the latter is preferred.
