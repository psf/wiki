...
Tests that raise support.[TestWarning](./TestWarning.html){.nonexistent} are for bugs that have been identified but not yet fixed. It\'s probably worth asking if the problem it\'s hiding is worth fixing or if the test should just be tossed.
