...
Jython 2.7.1 is distributed via an executable jar file installer. After [downloading](DownloadInstructions) it, either double click the jython_installer-2.7.1.jar or run java with the -jar option
