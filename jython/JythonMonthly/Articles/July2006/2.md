# JythonMonthly/Articles/July2006/2
...
There is a preview available: [snapshot build](http://homepage.sunrise.ch/mysunrise/ohumbel/2837/jython_snapshot.jar){.http}, and an overview of the [test results](http://homepage.sunrise.ch/mysunrise/ohumbel/){.http}

A sample install and run session, after downloading `jython_snapshot.jar`{.backtick}:
