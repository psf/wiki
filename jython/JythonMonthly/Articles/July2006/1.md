...
{{{public class [FooTest](./FooTest.html){.nonexistent} {
...
In the same way that you add a signature line for a method, you can add one for your [init]{.u} method.
