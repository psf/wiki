...
The original Sun example is available at: [http://java.sun.com/docs/books/tutorial/uiswing/misc/dnd.html#complex](http://java.sun.com/docs/books/tutorial/uiswing/misc/dnd.html#complex){.http}
