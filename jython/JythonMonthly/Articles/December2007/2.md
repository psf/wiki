...
*[http://jj-blogger.blogspot.com](http://jj-blogger.blogspot.com){.http}*
...
First of all, we need to set up our environment. The easiest way to get started with JavaFX and Jython is to begin with the command line. You need to ensure that the javafxrt.jar and swing-layout.jar Java archives are included in your classpath before running this small demo. You can obtain these jars from the [OpenJFX project pages](https://openjfx.dev.java.net/){.https}.
...
## Coding the Application {#Coding_the_Application}
...
*[JythonFx](./JythonFx.html){.nonexistent}.fx*
