...
# \*New\* Jython Basics - Decorators {#A.2ANew.2A_Jython_Basics_-_Decorators}
...
## What Is A Decorator? {#What_Is_A_Decorator.3F}
...
[Timing a Function (Python)](http://www.daniweb.com/code/snippet368.html){.http}

[Python Decorators Don\'t Have to be (that) Scary](http://www.siafoo.net/article/68){.http}

[The decorator module](http://www.phyast.pitt.edu/~micheles/python/documentation.html){.http}
:::
