...
# Parsing and Writing RSS Using Jython and Project ROME {#Parsing_and_Writing_RSS_Using_Jython_and_Project_ROME}
...
## Setting Up The CLASSPATH {#Setting_Up_The_CLASSPATH}
...
*[FeedWriter](./FeedWriter.html){.nonexistent}.py*
...
After you have created the XML, you\'ll obviously need to place it on a web server somewhere so that others can use your feed. The [FeedWriter](./FeedWriter.html){.nonexistent}.py module would probably be one module amongst many in an application for creating and managing RSS Feeds, but you get the idea.
...
[Project ROME Tutorials](http://wiki.java.net/bin/view/Javawsxml/Rome05Tutorials){.http}
:::
