...
A Better Python for the JVM - Tobias Ivarsson [http://us.pycon.org/2009/conference/schedule/event/32/](http://us.pycon.org/2009/conference/schedule/event/32/){.http}
...
[Read Article](http://jimmyg.org/blog/2009/ironpython-jython-scala.html){.http}

## Blogs {#Blogs}

Blogs noted in **bold** are only presented in newsletter, not on podcast.

[Jython 2.5rc3 is Out](http://fwierzbicki.blogspot.com/2009/05/jython-250-release-candidate-3-is-out.html){.http} - Frank Wierzbicki

[How To Compile Jython-dev Under Gentoo](http://ianyue.blogspot.com/2009/05/how-to-compile-jython-dev-under-gentoo.html){.http} - Ian Yue

[JbConsole 0.2.0](http://www.firebirdnews.org/?p=2763){.http} - [FireBird](./FireBird.html){.nonexistent} News

- [Getting to Know Firebird in Two Minutes](http://www.firebirdnews.org/docs/fb2min.html){.http}

[Configuration of Websphere](http://buildmeister.blogspot.com/2009/04/configuration-of-websphere.html){.http} - Buildmeister

[Jython Script to Create Domain and Set DB Connection using WLST](http://skytechcafe.wordpress.com/2009/04/29/jython-script-to-create-domain-and-set-database-connection-using-wlst/){.http} - Vikas Dahiya

[Rapid Application Development with JFace and Jython I](http://blog-of-darius.blogspot.com/2009/05/rapid-application-development-with.html){.http} - Darius

[Rapid Applicaton Development with JFace and Jython II](http://blog-of-darius.blogspot.com/2009/05/rapid-application-development-with_16.html){.http} - Darius

[Java, JRuby, or Jython for Scientific Computing - A Test Case](http://www.mblondel.org/journal/2009/05/19/java-jruby-or-jython-for-scientific-computing-a-test-case-with-hidden-markov-models/){.http} - Mathieu

[sMash Snakelike](https://www.projectzero.org/forum/viewtopic.php?f=3&t=1697){.https}

[The Performance of Python and Jython and IronPython](http://www.smallshire.org.uk/sufficientlysmall/2009/05/17/the-performance-of-python-jython-and-ironpython/){.http} - smallshire.org

[IronPython 2.0 and Jython 2.5 Performance Compared to Python 2.5](http://www.smallshire.org.uk/sufficientlysmall/2009/05/22/ironpython-2-0-and-jython-2-5-performance-compared-to-python-2-5/){.http} - smallshire.org

[Distributing Jython Apps in a Single JAR File](http://www.enigmacurry.com/2009/05/20/distributing-jython-apps-in-a-single-jar-file/){.http} - Ryan [McGuire](./McGuire.html){.nonexistent}

[Java Dynamically Loading Scripting](http://illegalargumentexception.blogspot.com/2009/05/java-dynamically-loading-scripting.html){.http} - Illegal Argument Exception

[Jython/Scala Stack Revisited](http://tinesware.blogspot.com/2009/05/jythonscala-stack-revisited.html){.http} - Steve Gilham

**[Jython Connect via JDBC](http://lujiacn.blogspot.com/2009/05/jython-connect-oracle-via-jdbczt.html){.http}**

**[Flash Lite/Python Study Tip](https://www.projectzero.org/forum/viewtopic.php?f=3&t=1697){.https}**

## Observations {#Observations}

**[CherryPy](./CherryPy.html){.nonexistent} on Jython Soon?**

See for yourself: [http://www.cherrypy.org/ticket/921](http://www.cherrypy.org/ticket/921){.http}
