# JythonMonthly/Newsletters/November2006
...
## Extending Jython Drag N Drop Example {#Extending_Jython_Drag_N_Drop_Example}
...
[Read Complete Article](http://wiki.python.org/jython/JythonMonthly/Articles/November2006/1){.http}

## Jython and SOAP Example {#Jython_and_SOAP_Example}
...
[Read Complete Article](http://wiki.python.org/jython/JythonMonthly/Articles/November2006/2){.http}

# Special Last Minute Off The Lists! {#Special_Last_Minute_Off_The_Lists.21}

## Sun Extends a Helping Hand for Jython {#Sun_Extends_a_Helping_Hand_for_Jython}
...
Then there\'s also the recent release of [IronPython](./IronPython.html){.nonexistent} by Microsoft via Jim Hugunin, the original creator of Jython. [IronPython](./IronPython.html){.nonexistent} has proven that Python can run even faster on a VM, so the logical next step would be to bring Jython up to speed as well. We certainly don\'t want the JVM\'s Python story to be lacking.
...
What would be the next major steps for Jython if we wanted to start moving it back toward Python compatibility and [IronPython](./IronPython.html){.nonexistent} performance levels?
...
*If interested in responding, please post to [jython-dev@lists.sourceforge.net](mailto:jython-dev@lists.sourceforge.net){.mailto}*
...
[JyConsole 1.3 Released](http://freshmeat.net/projects/jyconsole/?branch_id=62133&release_id=238776){.http}

[PyDev 1.2.5 Released](http://pydev.sourceforge.net/){.http}
...
[Marathon 1.0](http://www.infoq.com/news/jalian-marathon-1-0){.http}

[Tivoli Application Dependancy Software](http://www.gulfsoft.com/modules.php?op=modload&name=News&file=article&sid=323&mode=thread&order=0&thold=0){.http}

# Jython Blogs {#Jython_Blogs}

[Multicore processors or how to choose a programming language for the next 5 years](http://achimr.spaces.live.com/Blog/cns!7F4D1D66B60229E6!123.entry){.http}

[Using Python Interpreter](http://ivarsv.blogspot.com/2006/10/python.html){.http}

[Using Jython to Call Java](http://sujitpal.blogspot.com/2006/10/using-jython-to-call-java.html){.http}

# Discussions {#Discussions}

[Jython and toString()](http://coding.derkeiler.com/Archive/Python/comp.lang.python/2006-10/msg03204.html){.http}
