# JythonMonthly/Newsletters/November2007
...
[Read Entire Article](http://wiki.python.org/jython/JythonMonthly/Articles/November2007/NC){.http}

# Jython Blogs {#Jython_Blogs}

[Frank Wierzbicki on Jython 2.2.1](http://fwierzbicki.blogspot.com/2007/10/jython-221-released.html){.http}

[Qt Jambi and Jython](http://labs.trolltech.com/blogs/2007/11/06/qt-jambi-and-jython/){.http}

[Annotated Scala, Groovy, JRuby, Rhino, Jython \...](http://blogs.sun.com/sandoz/entry/annotated_scala_groovy_jruby_rhino){.http}
...
# Online Discussions {#Online_Discussions}

[HTML Parser for Jython](http://www.thescripts.com/forum/thread724546.html){.http}

# IDE {#IDE}

[Pydev 1.3.10 Released](http://pydev.sf.net/){.http}
...
# Projects Utilizing Jython {#Projects_Utilizing_Jython}

[Guess - Graph Exploration System](http://graphexploration.cond.org/){.http}
