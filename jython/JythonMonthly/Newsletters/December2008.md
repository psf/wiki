# JythonMonthly/Newsletters/December2008
...
\- Jim Baker and Leo Soto Presentation of Django on Jython at [DjangoCon](./DjangoCon.html){.nonexistent} 2008

\- [PyDev](./PyDev.html){.nonexistent} and Netbeans 6.5 Provide Two Great IDEs for Jython Development
...
As always, I\'d love to hear your feedback and suggestions. Please email me at [jythonpodcast@gmail.com](mailto:jythonpodcast@gmail.com){.mailto} and let me know if you\'ve got any commentary to add.
...
[Read More](http://wiki.glassfish.java.net/attach/V3FunctionalSpecs/Scripting-one-pager.html){.http}
...
[Get It Now](http://www.python.org/download/releases/3.0/){.http}
...
[Read Article](http://broadcast.oreilly.com/2008/12/java-in-the-cloud.html){.http}

## Blogs {#Blogs}

[Python Support in Netbeans](http://blogs.sun.com/tor/entry/netbeans_screenshot_of_the_week6){.http} - Tor Norbye

[Setting Up Django with Sqlite](http://compiler-error.blogspot.com/2008/12/setting-up-django-on-jython-with-sqlite.html){.http} - Matthew Harrison

[Jython + TileCache/FeatureServer](http://crschmidt.net/blog/340/jython-tilecachefeatureserver-it-just-works/){.http} - Christopher Schmidt

[Jython and GeoTools](http://crschmidt.net/blog/344/using-jython-geotools/){.http} - Christopher Schmidt

[Jython Servlets Part 1](http://justinworrall.com/blog/?p=87){.http} - Justin Worall

[Jython Servlets Part 2](http://justinworrall.com/blog/?p=109){.http} - Justin Worall

[Sudden Interest in Java](http://bretthoerner.com/blog/2008/nov/23/sudden-interest-java-platform/){.http} - Brett Hoerner
...
[Click Here to take survey](http://www.surveymonkey.com/s.aspx?sm=OBT3PW6zaAHxagGxQdbITg_3d_3d){.http}
