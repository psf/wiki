...
## Web Application Development Using web.py and Jython {#Web_Application_Development_Using_web.py_and_Jython}
...
[Read entire article](http://wiki.python.org/jython/JythonMonthly/Articles/January2007/1){.http}

## Proof of Concept: Using Jython with the JOGL API {#Proof_of_Concept:_Using_Jython_with_the_JOGL_API}
...
[Read entire article](http://wiki.python.org/jython/JythonMonthly/Articles/January2007/2){.http}
...
[http://www.javalobby.org/java/forums/t44534.html](http://www.javalobby.org/java/forums/t44534.html){.http}
...
For example I have a folder \"/package\" which contains \'myscript.py\' and \'[init]{.u}.py\'.
...
[Python Cookbook: Reload Classes Dynamically](http://aspn.activestate.com:80/ASPN/Cookbook/Python/Recipe/499295){.http}

[Python Cookbook: The KeyedDict object keeps a list of approved key values](http://aspn.activestate.com:80/ASPN/Cookbook/Python/Recipe/499296){.http}

[Python Cookbook: Calculate hamming distance between two strings](http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/499304){.http}

# Noteworthy Book Releases {#Noteworthy_Book_Releases}

[Python Phrasebook](http://www.techbookreport.com/tbr0278.html){.http}

# Jython Blogs {#Jython_Blogs}

[Great Jython blogs from Paul Drummond](http://gushieblog.blogspot.com:80/){.http}

[CherryPy + Jython + modjy + JBoss = true](http://henkenotes.blogspot.com/2006/12/cherrypy-jython-modjy-jboss-true.html){.http}
