...
The podcast is will be available on June 4th: [http://www.jythonpodcast.com](http://www.jythonpodcast.com){.http}.
...
[Read More](http://cryzed.de/2010/5/18/vynk-jython-desktop-automation-library){.http}
...
[New Features in 1.2](http://docs.djangoproject.com/en/dev/releases/1.2/){.http}

Read More at the [Django Project site](http://www.djangoproject.com/download/){.http}.
...
[The Combination of Java and Jython](http://www.codeweblog.com/the-combination-of-java-and-jython/){.http} - [CodeWeblog](./CodeWeblog.html){.nonexistent}
...
[WLST Development with Pydev in Eclipse](http://javamonamour.blogspot.com/2010/05/wlst-development-with-pydev-in-eclipse.html){.http} - Java Mon Amour
...
[The Future Can Be Written in RPython Now](http://pyevolve.sourceforge.net/wordpress/?p=1189){.http} - Christian Perone

Following the recent article arguing why [PyPy](./PyPy.html){.nonexistent} is the future of Python, I must say, [PyPy](./PyPy.html){.nonexistent} is not the future of Python, is the present. When I have tested it last time ([PyPy](./PyPy.html){.nonexistent}-c 1.1.0) with Pyevolve into the optimization of a simple Sphere function, it was at least 2x slower than Unladen Swallow Q2, but in that time, [PyPy](./PyPy.html){.nonexistent} was not able to JIT. Now, with this new release of [PyPy](./PyPy.html){.nonexistent} and the JIT'ing support, the scenario has changed.

**[FOP and Jython](http://matveichev.blogspot.com/2010/05/fop-jython.html){.http} - Hopscotch**

[Opinion: Can you Change Your Default Programming Language?](http://www.computerworld.com.au/article/347706/opinion_can_change_your_default_programming_language_/){.http} - Pascal Hakim
...
[Using Jython With The vCloud API](http://blog.chmouel.com/2010/05/17/using-jython-with-the-vcloud-api/){.http} - Chmouel Blog
...
[Invoking Python Script From Java](http://www.programmersheaven.com/mb/python/415726/415726/invoking-python-script-from-java/){.http} - [ProgrammersHeaven](./ProgrammersHeaven.html){.nonexistent}.com
...
[How Do I Start Using Jython?](http://answers.yahoo.com/question/index?qid=20100523113756AAq9EgK){.http}
...
[Netbeans 6.8, 6.9 RC1](http://www.netbeans.org){.http}
