# JythonMonthly/Newsletters/December2007

::::: {#content dir="ltr" lang="en"}
::: {}
  --------------------------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ***Jython Monthly***                                                                ![](http://www.jython.org/css/jython.png "http://www.jython.org/css/jython.png"){.external_image}
  **December 2007 \-- Issue #13**    ![](http://lh5.google.com/juneau001/R259iI_6Z_I/AAAAAAAABBE/QYoKXeM6Flc/s144/wreath_3.gif "http://lh5.google.com/juneau001/R259iI_6Z_I/AAAAAAAABBE/QYoKXeM6Flc/s144/wreath_3.gif"){.external_image}
  --------------------------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
:::
...
## Scripting for the Java Platform {#Scripting_for_the_Java_Platform}

*By: Gregor Roth*

[Read Article](http://www.javaworld.com/javaworld/jw-11-2007/jw-11-jsr223.html){.http}

## Newbie Corner {#Newbie_Corner}
...
[Read Entire Article](http://wiki.python.org/jython/JythonMonthly/Articles/December2007/NC){.http}

## Using JavaFX in Jython Applications {#Using_JavaFX_in_Jython_Applications}
...
[Read Entire Article](http://wiki.python.org/jython/JythonMonthly/Articles/December2007/2){.http}

## Python Mini Learning Guide {#Python_Mini_Learning_Guide}

[Read the Guide](http://tssblog.blogs.techtarget.com/2007/11/15/python-mini-learning-guide/){.http}
...
[Jython on Mac OSX Tip: Using JDK 6 with Jython](http://wiki.python.org/jython/JythonMonthly/Articles/December2007/1){.http}

[Find more great tips at the Python Cookbook!](http://aspn.activestate.com/ASPN/Cookbook/Python){.http}
