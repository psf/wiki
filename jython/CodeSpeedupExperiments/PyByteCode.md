...
# Planned and implemented speedups for PyByteCode interpreter {#Planned_and_implemented_speedups_for_PyByteCode_interpreter}
...
At this time there are two classes that extend the base abstract `PyCode` class, `PyTableCode` and `PyBytecode`, along with some helper classes (`PyBaseCode`). You will also want to look at `PyFrame`, for frame support; and `ThreadState`. (Speaking of `ThreadState`, I believe there was a discussion [here](http://blog.crazybob.org/2006/07/hard-core-java-threadlocal.html){.http} of how to implement dynamic scoping in Java, this is best done with `java.lang.ThreadLocal`. But don\'t follow what we\'ve done with `ThreadState`, because it mixes too many ideas together that we will fix, see [this bug](http://bugs.jython.org/issue1327){.http}.)
...
The switch-case `PyBytecode` was converted to enum in a new file `PyBytecodeEnum`^[1](#fnref-8a9f15891d8340b808ad32b4689c550d15484e2c){#fndef-8a9f15891d8340b808ad32b4689c550d15484e2c-0}^.
...
![with_enum_vs_without_5_30.png](attachments/CodeSpeedupExperiments(2f)PyByteCode/with_enum_vs_without_5_30.png "with_enum_vs_without_5_30.png"){.attachment}
...
::: footnotes
1.  []{#fnref-8a9f15891d8340b808ad32b4689c550d15484e2c}[http://bitbucket.org/shashank/jython-experiments/](http://bitbucket.org/shashank/jython-experiments/){.http} ([1](#fndef-8a9f15891d8340b808ad32b4689c550d15484e2c-0))
:::
::::
