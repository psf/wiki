...
# Creating an Eclipse Project for Jython Development {#Creating_an_Eclipse_Project_for_Jython_Development}
...
1.  [Creating an Eclipse Project for Jython Development](#Creating_an_Eclipse_Project_for_Jython_Development)
    1.  [Setting up to Develop](#Setting_up_to_Develop)
        1.  [Tools Assumed](#Tools_Assumed)
        2.  [Clone the Jython Repository](#Clone_the_Jython_Repository)
        3.  [Create an Eclipse project](#Create_an_Eclipse_project)
        4.  [Build it once outside the IDE](#Build_it_once_outside_the_IDE)
        5.  [Fix-up the class path in the IDE](#Fix-up_the_class_path_in_the_IDE)
        6.  [Controlling compilation in the IDE](#Controlling_compilation_in_the_IDE)
        7.  [A first run](#A_first_run)
    2.  [Things that go wrong](#Things_that_go_wrong)
        1.  [No project created](#No_project_created)
        2.  [JYTHON_HOME Defined](#JYTHON_HOME_Defined)
        3.  [IDE Console problems](#IDE_Console_problems)
        4.  [Missing packages and objects](#Missing_packages_and_objects)
        5.  [Missing parser classes](#Missing_parser_classes)
        6.  [Bootstrap types](#Bootstrap_types)
        7.  [End-of-line Encoding](#End-of-line_Encoding)
        8.  [Character Encoding](#Character_Encoding)
        9.  [\"version.properties\" not found](#A.22version.properties.22_not_found)
        10. [The access\$ problem](#The_access.24_problem)
    3.  [Key files](#Key_files)
2.  [Instructions Posted Nov 2009](#Instructions_Posted_Nov_2009)
:::

## Setting up to Develop {#Setting_up_to_Develop}

### Tools Assumed {#Tools_Assumed}
...
### Clone the Jython Repository {#Clone_the_Jython_Repository}
...
### Create an Eclipse project {#Create_an_Eclipse_project}
...
### Build it once outside the IDE {#Build_it_once_outside_the_IDE}
...
### Fix-up the class path in the IDE {#Fix-up_the_class_path_in_the_IDE}
...
### Controlling compilation in the IDE {#Controlling_compilation_in_the_IDE}
...
## Things that go wrong {#Things_that_go_wrong}
...
### No project created {#No_project_created}
...
### JYTHON_HOME Defined {#JYTHON_HOME_Defined}
...
### IDE Console problems {#IDE_Console_problems}
...
### Missing packages and objects {#Missing_packages_and_objects}

The list of JAR files used in the build and at runtime has been tidied up recently (December 2011) but as you work you may find that the Java editor, or your run configuration, complains it cannot resolve the names of classes. It is not obvious where in the massive class path the class ought to be. There are sites to help such as [http://www.jarfinder.com](http://www.jarfinder.com){.http} can help you guess which of the JAR files has dropped out of your path.

### Missing parser classes {#Missing_parser_classes}
...
### Bootstrap types {#Bootstrap_types}
...
### End-of-line Encoding {#End-of-line_Encoding}
...
### \"version.properties\" not found {#A.22version.properties.22_not_found}
...
### The access\$ problem {#The_access.24_problem}
...
# Instructions Posted Nov 2009 {#Instructions_Posted_Nov_2009}
