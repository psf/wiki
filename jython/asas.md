...
- [Jython 2.5.2 and 2.2.x](#jython-2-5-2-and-2-2-x){#id1 .reference .internal}
...
:::::: {#jython-2-5-2-and-2-2-x .section}
### [Jython 2.5.2 and 2.2.x](#id1){.toc-backref}

::: {#basic-install .section}
#### [Basic Install](#id2){.toc-backref}

Jython 2.5.2 and 2.2.1 are distributed as executable jar file installers. After [downloading](DownloadInstructions){.reference .external} it, either double click the jython_installer-2.5.2.jar or run java with the -jar option
