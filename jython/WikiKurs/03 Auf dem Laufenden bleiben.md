...
![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} Wenn man im Wiki angemeldet ist, kann man auf dieser Seite auch ein zeitliches *Lesezeichen* setzen. Damit merkt sich das Wiki für jeden Benutzer, bis wann er die Änderungen bereits gelesen hat und zeigt ihm danach nur noch die Neuigkeiten danach an.
:::
