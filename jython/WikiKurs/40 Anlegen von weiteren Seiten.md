...
# Weitere Seiten anlegen {#Weitere_Seiten_anlegen}
...
- nun erscheint der Hinweis, dass diese Seite nicht existiert und ob und wie man sie anlegen möchte:
  ...
  - ![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} rechts wird übrigens eine Liste mit ähnlichen Seitennamen angezeigt. Hier sollte man schauen, ob es nicht bereits eine leicht anders benannte Seite zum gleichen Thema gibt

- dann wird der Editor aufgerufen und man kann die Seite mit Inhalten füllen und zuguterletzt speichern

![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} Diese Methode hat den Vorteil, dass neue Seiten immer von bereits existierenden Seiten per Link erreichbar sind.
:::
