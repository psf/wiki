...
- ![/!\\](/wiki/modernized/img/alert.png "/!\"){height="16" width="16"} Auf **Benutzer anlegen** klicken! ![/!\\](/wiki/modernized/img/alert.png "/!\"){height="16" width="16"}

Damit wird das Benutzerkonto angelegt und man kann sich danach dann mit Name/Passwort beim Wiki anmelden.

![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} Dass man angemeldet ist, sieht man dadurch, dass der Benutzername im Navigationsbereich angezeigt wird.
:::
