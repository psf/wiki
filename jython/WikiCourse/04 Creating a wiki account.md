...
# Creating a wiki account {#Creating_a_wiki_account}
...
![/!\\](/wiki/modernized/img/alert.png "/!\"){height="16" width="16"} Then click on **Create Profile**. ![/!\\](/wiki/modernized/img/alert.png "/!\"){height="16" width="16"}

The account will be created and you can log in to the wiki using your user name and password.

![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} You are logged in if you see the user name in the navigation area.
:::
