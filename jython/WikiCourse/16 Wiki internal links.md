...
[ToDo](./ToDo.html){.nonexistent} is [CamelCase](CamelCase), so it links to a homonymous page, which isn\'t very exciting. ![:)](/wiki/modernized/img/smile.png ":)"){height="16" width="16"}

![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} But you can click on the page name on the page [ToDo](./ToDo.html){.nonexistent} and lo and behold, you find every page that also includes a [ToDo](./ToDo.html){.nonexistent}.
:::
