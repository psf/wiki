...
![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} As you can see, `[[...]]`{.backtick} sets a link to the target, `{{...}}`{.backtick} embeds the target, which is especially useful for pictures.
:::
