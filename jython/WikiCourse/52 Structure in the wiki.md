...
# Structure in the wiki {#Structure_in_the_wiki}
...
- only if a topic has many subtopics (which aren\'t main topics), subpages are used.
  ...
  ![(!)](/wiki/modernized/img/idea.png "(!)"){height="16" width="16"} Sub pages are named as `MainPage/SubPage`{.backtick}
...
Of course, you should avoid that to prevent complete chaos. ![B-)](/wiki/modernized/img/smile2.png "B-)"){height="16" width="16"}
