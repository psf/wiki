...
After founding and managing a pioneering Zope company in Brasil (Hiperlógica 1999-2003), I decided to focus on training and education. I am now a senior instructor at [Simples Consultoria](http://simplesconsultoria.com.br/). I am the author of a popular Portuguese-language short tutorial which teaches basic programming with Python, [Aprenda a Programar](http://www.pythonbrasil.com.br/moin.cgi/AprendaProgramar) (Learn to program). Also, I led the team who translated [How to Think Like a Computer Scientist: Learning with Python](http://www.ibiblio.org/obp/thinkCSpy/) to Portuguese ([translation](http://pensarpython.incubadora.fapesp.br/)).

Recently I created the [Turing Club](http://turing-club.org) to promote computer programming as a hobby, and between March-May of 2007 we held our first public workshop at SESC Pinheiros, a major culture and arts center in São Paulo.
