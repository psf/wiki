...
This project is discussed on [the python-grants list](http://starship.python.net/cgi-bin/mailman/listinfo/python-grants).

See also [PythonEducationalDistribution](http://www.seapig.org/PythonEducationalDistribution "SeaPig") by the Seattle Python Interest Group. They are creating a Windows CD. Also, the Python [EduSig](EduSig) list has discussed using [Morphix](http://www.morphix.org/modules/news/) to create a bootable custom CD. I would encourage you to get in touch with both these groups.
