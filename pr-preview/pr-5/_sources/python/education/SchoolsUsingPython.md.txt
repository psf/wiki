...
- Yorktown and Washington-Lee High Schools and the Arlington Career Center in Arlington Virginia ([Jeff Elkner](http://www.elkner.net/))

- [Gimnasio Fidel Cano](http://www.gfc.edu.co/colegio/proyectos/spt/), Bogotá, Colombia ([Igor Támara](http://igor.tamarapatino.org/))

- Model Experimental Senior High School of University of Macedonia - Thessaloniki, Greece\
  ([http://http://peiramatiko.uom.gr/](http://http://peiramatiko.uom.gr/)), ICT instructor at [python2304@gmail.com](mailto:python2304@gmail.com)
...
- University of Toronto
  ...
  - [CSC207H](http://www.cdf.toronto.edu/~csc207h/winter) is a third-semester course that teaches several weeks of Python.

  - A few 2nd- and 3rd-year theory courses have students implement some algorithms in Python.

- University of Waterloo
  - One of the more prestigious engineering/comp-sci schools in Canada is using it officially in [CS488 (Intro to 3D graphics)](http://www.student.cs.uwaterloo.ca/~cs488/), and I\'m told there\'s lots of use among faculty, staff and students. I don\'t think they actually teach much Python, they\'re focused on teaching OpenGL/graphics programming, but they do wind up using it as the framework into which the students slot their code.

- Wilfrid Laurier University
  - Python is taught in the Introduction to Programming ([CP104](http://www.wlu.ca/physcomp/cp104/)) and Data Structures ([CP114](http://www.wlu.ca/physcomp/cp114/)) courses.

- Cégep du Vieux-Montréal
  - Used for Advanced Web Development course (420-B63-VM)

  - Note: Cégeps are collegiate level schools giving a 2 year pre-university program or a 3 year professionnal program such as [Computing Technology](http://www.cvm.qc.ca/informatique/pages/main.html)
...
- Université Laval
  - The EECE department is giving an [Introductory course on programming using Python (GLO-1900)](https://capsuleweb.ulaval.ca/pls/etprod7/bwckctlg.p_disp_course_detail?cat_term_in=201009&subj_code_in=GLO&crse_numb_in=1900) to all first year students in the programs of Computer Engineering and Electrical Engineering (and possibly to Software Engineering students in 2011).
...
- Université Bordeaux 1
  ...
  - [http://dept-info.labri.fr/initinfo/index.html](http://dept-info.labri.fr/initinfo/index.html)
- Université Paris Sud (Paris XI) - IUT d\'Orsay
  ...
  - [http://www.iut-orsay.fr/dptmphy/Pedagogie/](http://www.iut-orsay.fr/dptmphy/Pedagogie/)
- Université Paris 13 - IUT Villetaneuse
  - Python is used as a first language for the Telecom & Networks DUT

  - [http://www-gtr.iutv.univ-paris13.fr/Cours](http://www-gtr.iutv.univ-paris13.fr/Cours)
- Institut Pasteur - Cours d\'Informatique en Biologie
  - Python is used a the main language for teaching programming.

  - Course description: [http://www.pasteur.fr/formation/infobio/](http://www.pasteur.fr/formation/infobio/)

  - Online Python course: [http://www.pasteur.fr/formation/infobio/python/](http://www.pasteur.fr/formation/infobio/python/)
...
- University of Calicut
  ...
  - Course Syllabus (Two modules): [http://www.universityofcalicut.info/syl/B.Sc_Maths_Syll.pdf](http://www.universityofcalicut.info/syl/B.Sc_Maths_Syll.pdf)
...
- IES Pirámide (Huesca).
  ...
  - Maths and Game Programming. Materials: [http://sites.google.com/site/laislalibre/](http://sites.google.com/site/laislalibre/)
...
- University of Oxford
  ...
  - [http://www-teaching.physics.ox.ac.uk/computing/Programming/Python/Oxford/html/handbook_Python.html](http://www-teaching.physics.ox.ac.uk/computing/Programming/Python/Oxford/html/handbook_Python.html)

- University of Wolverhampton

- Coventry University [http://www.coventry.ac.uk](http://www.coventry.ac.uk/)

- University of Southampton, MSc in Web Science \"Computational Thinking\" module for non-computer scientists. [http://www.ecs.soton.ac.uk/admissions/pg/msc/syllabus.php?unit=COMP6046](http://www.ecs.soton.ac.uk/admissions/pg/msc/syllabus.php?unit=COMP6046)
...
- University of California, Irvine
  ...
  - [http://wingide.com/pipermail/marketing-python/2003-March/004157.html](http://wingide.com/pipermail/marketing-python/2003-March/004157.html)
...
- [How to Think Like a Computer Scientist: Learning with Python](http://www.greenteapress.com/thinkpython/) by Allen Downey, Jeff Elkner and Chris Meyers

- [Fundamentals of Python: From First Programs Through Data Structures](http://home.wlu.edu/~lambertk/python/) by Kenneth Lambert

- [Python: Programming in Context and Problem Solving with Algorithms and Data Structures Using Python](http://www.pythonworks.org/home) by Brad Miller and David Ranum

- [Introduction to Computing Using Python: An Application Development Focus](http://www.wiley.com/WileyCDA/WileyTitle/productCd-EHEP002019.html) by Ljubomir Perkovic
