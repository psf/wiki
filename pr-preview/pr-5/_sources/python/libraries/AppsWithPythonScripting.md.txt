...
- Python is a [Free Software](../people/FreeSoftware) ([Open Source](../people/OpenSource)) solution and can be embedded and distributed without charge, so there are no royalty payments or licensing hassles
...
- On the Windows platform, Python has an excellent interface to COM (also known as ActiveX) and can be used to interface to almost any COM program (such as the MS-Office suite). Again, Python scripting can be added to enhance a project without change to the existing COM components. (See [Win32All](../platforms/Win32All))

- [PyObjC](http://pyobjc.sourceforge.net) can be used to add scripting to any Cocoa app on Mac OS X

- Many Mac OS applications provide Apple event-based scripting interfaces, allowing them to be controlled from languages such as [AppleScript](http://www.apple.com/applescript/), [JavaScript OSA](http://www.latenightsw.com/freeware/JavaScriptOSA/), Perl (via [Mac::Glue](http://search.cpan.org/~cnandor/Mac-Glue/)), Python (via [appscript](http://freespace.virgin.net/hamish.sanderson/appscript.html)), Tcl and [UserTalk](./UserTalk.html). (See [MacPython](../platforms/MacPython))
...
::: {}
  ...
  **Name**                                                                                                       **Platform**               **Notes**
  ...
  [ClearSilver](../people/ClearSilver)                                                                              multi-platform             Web application framework
  ...
  [Mahogany](http://mahogany.sourceforge.net/)                                                            Linux, Mac OS X, Windows   [OpenSource](../people/OpenSource) cross-platform mail and news client.
  ...
  [NSIS2](http://nsis.sourceforge.net/)                                                                   Windows                    There is an [NSIS Python Plugin](http://homepage.hispeed.ch/py430/python/) for this [OpenSource](../people/OpenSource) installer for Windows. \-- Note: *makensis*, the installer compiler, now compiles and runs on POSIX systems too.
  ...
  [Resolver One](http://www.resolversystems.com/products/resolver-one.php)                                .NET/CLR                   Programmable spreadsheet built around [IronPython](../implementations/IronPython).
...
::: {}
  ...
  [Blender](http://www.blender.org/)                                                                                                                                             multi-platform         [OpenSource](../people/OpenSource) software for 3D modeling, animation, rendering, post-production, interactive creation and playback. [Blender Python API reference](http://www.blender.org/documentation/245PythonDoc/API_intro-module.html) and [tutorials](http://www.blender.org/tutorials-help/python/).
  [Crystal Space](http://crystal.sourceforge.net/)                                                                                                                               multi-platform         [OpenSource](../people/OpenSource) 3D SDK
...
- [Pyrex](../implementations/Pyrex) \-- now superceded by [Cython](http://www.cython.org/)
