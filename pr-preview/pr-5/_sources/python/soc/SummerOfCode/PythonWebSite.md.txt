...
- Automate postings to the [Python Job Board](http://python.org/community/jobs/).
...
- Create a source code analysis tool similar to that used to produce reports in [Maven](http://maven.apache.org/). Perhaps integrate it with [Trac](http://projects.edgewall.com/trac).
