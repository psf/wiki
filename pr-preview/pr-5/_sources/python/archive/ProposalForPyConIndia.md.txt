...
[PyCon](../conferences/pycon/PyCon) is a global community event. We intend to have an Indian edition of the same, in association with [BangPypers](../community/BangPypers). The idea is to have all pythonistas from around the country come together and have a good fun pythonic time. The general outline is something as follows:
...
- Contact David Goodger of PSF to express the idea for an Indian edition of the conference, and for using the [PyCon](../conferences/pycon/PyCon) title. (Ramakrishna Reddy)

- Write formal proposal (Noufal Ibrahim) [PyConIndiaProposalDraft](../conferences/pycon/PyConIndiaProposalDraft)
...
- How to do Publicity
  ...
  - Contact the mainstream media which do write about tech-focussed events. \[svaksha\]

- Create one website with event details and co-ordinating proposals. May be use the same code used by [PyCon](../conferences/pycon/PyCon) ?

## Community Discussion 

### Decisions to be made 

Please add your name to what you have to say, and try not to edit the opinions of others, you may reorder them though, I guess. \-- [RoshanMathews](../people/RoshanMathews)
...
- [PyCon](../conferences/pycon/PyCon) India should be a conference, not an unconference.
...
- I\'m not so sure about September anymore. [ConventionHowto](../people/ConventionHowto) indicates a much longer planning period. We need to discuss this.
...
- Having the conference be a \"[PyCon](../conferences/pycon/PyCon)\" is serious stuff, which can\'t be a damp squib like one of the local meets.
...
- Instead of swag like stickers/T-shirts/mugs, why not give Python books ? Alternatively if that is too expensive, the freely available documentation (with respective author perms) could be printed and bound for those interested at a nominal cost.
  - This is a **great** idea! I\'ll second it. We can get publishers to offer deep discounts in return for having stalls at the conference. Assuming an average book will cost around Rs.400, if the publishers offer a discount of 100, and the conference uses it\'s t-shirt money to knock off another 100 bucks per book, then we\'ve managed a 50% discount which is really cool. \-- [RoshanMathews](../people/RoshanMathews)

  - And instead of stickers we can have print-outs of those folding reference cards as handouts. \-- [RoshanMathews](../people/RoshanMathews)

  - If this idea seems cool, I can elide the rant \"To Tee or Not To\" from above. \-- [RoshanMathews](../people/RoshanMathews)
...
- In general in India, for some silly reason, it has become conventional to have free entrance to such conferences and also to pay for speakers accomodation and travel. I do not see this happening in other countries. I suggest we professionalise the conference - people pay their way, with maybe a discount for students.
  - Hello Python is supposed to be absolutely free, so official Pycon has to be free of cost(especially in India). We should find some other way to raise fund, say by sponsorship or donation \-- anirudh
