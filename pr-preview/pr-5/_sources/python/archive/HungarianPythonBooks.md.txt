...
**Python tudásépítés lépésről lépésre az alapoktól az első asztali alkalmazásig, 2. kiadás**

Egy e-könyv azoknak, akik komolyan gondolják a Python programozás önálló tanulását. Egy kezdő és haladó tanfolyam tartalmának megfelelő ismeretanyag egyetlen könyvben. Oktatók, hallgató, mérnökök, szoftverfejlesztők, karrierváltók vagy hobbi programozók mellett ajánlott azoknak is, akik tanfolyamon szerzett ismereteiket kívánják kiegészíteni. Különösen ajánlott azok számára, akik szeretnének ugyan egy Python tanfolyamon részt venni, de valamilyen okból (költség, kisgyerek, mozgáskorlátozottság, távolság, kötött idő stb.) nem áll módjukban. A könyv ezen segít, mert tartalma egyéni időbeosztással és ütemben dolgozható fel.
...
**Python a gépben, 2. kiadás**

Programozási tankönyv teljesen kezdőknek, ajánlott a középiskola első osztályától. A Python 3-as verzióját veszi alapul.
...
**Szoftverfejlesztés okosan Pythonnal - Agilis csapatok közös nyelve**

Egy rövid könyv a Python programozási nyelv 3.8-as változatáról. Széles célközönség számára íródott: programozással most ismerkedőktől a középhaladó szintig. A könyv didaktikusan 6 fő koncepcióra építi fel a nyelv ismertetését.
...
**Hogyan gondolkozz úgy, mint egy informatikus: tanulás Python3 segítségével**

A kezdő lépésektől a középhaladó szintig közel 370 oldalon. Ingyen letölthető.

- Peter Wentworth, Jeffrey Elkner, Allen B. Downey és Chris Meyers könyvének magyar nyelvű fordítása.
...
**Az informatikai érettségi programozási feladatainak megoldásai Python 3 nyelven**

Néhány kidolgozott feladat és az elemi programozási tételek PDF formátumú mini könyvként. Ingyen letölthetőek.
...
**Python-oktató (Python 3.6.0), a hivatalos \"Python tutorial\" magyar fordítása**

- Magyar fordítás: Horváth Árpád
- Online olvasható
...
- Magyar fordítás: Horváth Árpád, Nyírő Balázs
- Még nem a Python 3-as verzióját tárgyalja.
...
- A Python 2-es verzióját tárgyalja.
...
A fordítással egy középiskolai tanításra alkalmas kiváló könyv vált magyar nyelven hozzáférhetővé. A könyv anyaga, amit a szerző a liége-i Institut St Jean Berchmans - Ste Marie középiskolában állított össze, jelenleg a belga középiskolai számítástechnikai oktatás részét képezi.
