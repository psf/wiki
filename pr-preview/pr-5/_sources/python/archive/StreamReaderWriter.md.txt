...
The Python2.5\'s `codecs.StreamReaderWriter` combines [StreamReader](../people/StreamReader) and [StreamWriter](../people/StreamWriter). The wrapper will read narrow `str` strings from the underlying stream and decode them to `unicode` strings. On writing `unicode` data to the wrapper, it will encode them to narrow `str` strings.
...
See also: [StreamReader](../people/StreamReader), [StreamWriter](../people/StreamWriter), [StreamRecoder](../people/StreamRecoder).
