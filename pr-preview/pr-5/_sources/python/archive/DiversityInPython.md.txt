...
- [Diversity \-- Promoting diversity in the Python community mailing list](http://mail.python.org/mailman/listinfo/diversity)

  - [Diversity archives](http://mail.python.org/mailman/private/diversity/) (Only open to subscribers. It\'s not hard to subscribe though!)
...
- If you are yourself in an underrepresented group, please consider blogging to the [Open Mike](http://python-open-mike.posterous.com) in order to increase the visibility of diversity within Python
...
- Organize a weekend workshop like the \"Boston Python Workshop for women and their friends\" in your city. Feel free to use the documents Jessica McKellar created for the Boston Python Workshop. General: [http://meetup.bostonpython.com/events/22818421/](http://meetup.bostonpython.com/events/22818421/). The schedule and links to all documents: [http://openhatch.org/wiki/Boston_Python_Workshop_3](http://openhatch.org/wiki/Boston_Python_Workshop_3). Links to all dependencies to be set up on Friday: [http://openhatch.org/wiki/Boston_Python_Workshop_3/Friday](http://openhatch.org/wiki/Boston_Python_Workshop_3/Friday). You can read her \"lessons learned\" here: [https://openhatch.org/blog/2011/lessons-learned-from-the-boston-python-workshop-an-outreach-event-for-women/](https://openhatch.org/blog/2011/lessons-learned-from-the-boston-python-workshop-an-outreach-event-for-women/)
...
- Help create foreign-language versions of the Python documentation [example - French](http://sourceforge.net/%20http%3A//frpython.sourceforge.net "SourceForge")
...
- Join [diversity@](http://mail.python.org/mailman/listinfo/diversity) and work with others on whatever needs doing at the time
...
[Dos and Don\'ts of encouraging women in Linux](http://tldp.org/HOWTO/Encourage-Women-Linux-HOWTO/x168.html) \-- the immediately practical part of a larger article. Some of these suggestions can also be translated to other issues.

[How to encourage women in FLOSS](http://geekfeminism.wikia.com/wiki/Open_Source_Software#How_to_encourage_women_in_FLOSS) - also the practical part of a larger article.

Consider the [recording and photography policies](http://geekfeminism.org/2009/10/11/conference-recordings-and-harassment/) at the conference you\'re running.

Invite someone who has something to say but no blog of their own to post on the [Python Open Mike](http://python-open-mike.posterous.com/) blog.
...
[Abilene paradox](http://en.wikipedia.org/wiki/Abilene_paradox) - breakdown in group communication where groups take an action that the all of the group\'s members oppose.

[Bystander Effect](http://en.wikipedia.org/wiki/Bystander_effect) - social psychological phenomenon where individuals in a group do not offer help to people in trouble.

[cis-gender](http://juliaserano.livejournal.com/14700.html) - person for whom the sex they were assigned at birth corresponds with their identity. Used as the opposite of \"transgender\"

[Offense](http://infotrope.net/blog/2009/08/05/action-and-reaction-on-avoiding-offense/) - recommendation against using the word *offense* which focuses on reactions instead of actions.

[Polite](http://marc.info/?l=debian-devel&m=122988725702000&w=2) - on the trickiness of defining it.

[Privilege](http://blog.shrub.com/archives/tekanji/2006-03-08_146) - What it means and how it\'s used on the Diversity list.

[Spoons](http://www.butyoudontlooksick.com/articles/written-by-christine/the-spoon-theory-written-by-christine-miserandino/) - Used by people who are sick or disabled to describe the limited and fluctuating capability to get anything done
...
**[Languages](http://wiki.python.org/moin/Languages)**
...
[Anti-racist FAQ](http://community.livejournal.com/debunkingwhite/339225.html)

[Racism_101 Community on LiveJournal](http://community.livejournal.com/racism_101/profile)

[Unpacking the Invisible Knapsack](http://www.antiracistalliance.com/Unpacking.html) (An article examining the author\'s own sense of privilege.)

[Anti-racism and anti-oppression links](http://maysie.web.net/node/24)

[Anti-racism and activism links](http://infoshop.org/page/Anti-Oppression)

[RaceFail 09](http://wiki.feministsf.net/index.php?title=RaceFail_09) - An example of how the Science Fiction community\'s addressing one kind of diversity doesn\'t automatically translate to other kinds.
...
[Feminism 101 - The Essentials](http://www.feminism101.com/)

[The Terrible Bargain We Have Regretfully Struck](http://shakespearessister.blogspot.com/2009/08/terrible-bargain-we-have-regretfully.html) - A blog post about the absolute pervasiveness of sexism and the effects it has on trust.

[Sex and Gender terminology](http://preview.tinyurl.com/6ljr3l) [(tinyurl preview link due to the wiki blocking the real URL)]
...
[On Trust and Diversity](http://annaraven.blogspot.com/2009/08/on-being-normal.html) - a blog post about the invisibility of neuro-diversity and its effects.
...
[RailsBridge](http://railsbridge.org/) - guidelines, more than \"a statement\" (top left on the page linked).

[Ohio LinuxFest \'09 Diversity in Open Source workshop](http://www.ohiolinux.org/dios) is/was on 9/27/2009.

[Diversity/Careers in Engineering and IT](http://www.diversitycareers.com/mc_index.htm)

[Women in IT](http://naramore.net/blog/gender-in-it-oss-php-and-how-it-affects-us-all-1) - emphasis on PHP, which seems to show better gender balance than Python (as of the Summer of 2009).

[JAOO 2009 diversity effort](http://jaoo.dk/aarhus-2009/women/)

[How to Encourage Women in Linux](http://tldp.org/HOWTO/Encourage-Women-Linux-HOWTO/)

[Standing out in the crowd](http://infotrope.net/blog/2009/07/25/standing-out-in-the-crowd-my-oscon-keynote/) - Kirrily Robert\'s OSCON talk, the repurcussions from which inspired Aahz to create the Diversity mailing list (see above.)

[Addresses lack of gender/race diversity in Science Fiction](http://www.tor.com/index.php?option=com_content&view=blog&id=50514) - was suggested as having applicable insight/inspiration to the Python Community re: thinking outside the box.

[On the HARD work of reaching out (Science Fiction editorships)](http://preview.tinyurl.com/l5cqgd) - also suggested as being insightful/inspirational. [(link is tinyurl preview link because the real URL contains a word banned on this wiki)]

[Gr8 Designs for Gr8 Girls](https://www.gr8-designs.ca/) - A computer science activity day for Grade 8 Girls. [(NOTE: Browser security certificate has expired. ![:(](/wiki/europython/img/sad.png ":(") )]
...
[Universal Design](http://en.wikipedia.org/wiki/Universal_design) and how it can improve design for everyone. Parallels to how diversity can benefit everyone too?

[Derailing for Dummies](http://www.derailingfordummies.com/) on the various ways discussions can be derailed, how to spot them, convenient names for talking about them. (Note: \"\... for Dummies\" is a popular series of books (at least in the US) and uses \"Dummies\" in a some-what self-deprecating way. I\'ve personally often found that the \"for Dummies\" books are very good introductions. \--[DougPhilips](./DougPhilips.html))

[Google\'s Diversity Delegates Programme](http://lca2009.linux.org.au/media/news/66) - Some of what Google is doing.

[TeX Users Group\'s Bursary Fund description](https://www.tug.org/bursary/) - does not specifically address diversity, just those who might need assistance, but there is probably a correlation.

[Gender interactions - a continuum where one end leads to rape](http://fugitivus.wordpress.com/2009/06/26/another-post-about-rape-3/) - **(STRIDENT CONTENT - NOT SAFE FOR WORK)** - This is not just a Western issue, cultures around the world are overwhelmingly patriarchal. How we interact in more civilized ways is not irrelevant, but starts the slope ending in this kind of abhorrent behavior. Why the \"little stuff\" matters. (Link from Steve Holden\'s message). Aahz then linked to [this article](http://groups.google.com/group/alt.polyamory/msg/a248e4369d1a2307) a bit more directly applicable to the topic/Diversty list.

[Article](http://preview.tinyurl.com/2qh5v6) explaining the \"Why work on X when Y is so much more important\" distraction/derailing. Here because this came up in the context of a post suggesting \"Open Source is no worse than Closed Source\" regarding gender diversity. Those looking to tackle the broader issue of Women and Technology might find [The Anita Borg Institute](http://anitaborg.org/) a helpful resource. [(tinyurl preview link since \"oh one dot wordpress dot com\" links are forbidden here, and this is a link to a Feminism 101 URL on wordpress.)]

[Unlocking the Clubhouse](http://www.cs.cmu.edu/afs/cs/project/gendergap/www/index.html) - Published Research from Carnegie Mellon University on closing the Gender Gap in Higher Education. Has been recommended many times on the Diversity list.

[Thinking in Python](http://thinkpython.com) - resource for teaching Python to non-programmers. Free online version. It is used in several teaching situations, generic good resource.

[Edu-Sig: Python in Education](http://www.python.org/community/sigs/current/edu-sig/)
...
[FOSS Mentor Projects (at Teaching Open Source)](http://teachingopensource.org/index.php/FOSS_Mentor_Projects)

[A Tale of \"O\": On Being Different in an Organization](http://www.amazon.com/Tale-Being-Different-Organization/dp/0061320641) - Recommended as being descriptive of being the only woman in a room of men.
