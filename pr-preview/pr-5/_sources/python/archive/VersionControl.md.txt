...
- [Hg-Git](http://hg-git.github.com/) - access Git repositories from Mercurial

- [pysync](http://code.google.com/p/pysync/) - abstraction layer, looks inactive, but a lot of commits

- [pyvcs (Alex Gaynor and co.)](https://github.com/alex/pyvcs) - pure python abstraction layer of multiple VCS, very lightweight
