...
[RedHat](../../people/RedHat) 4.3 (32-bit) -\> 5.5 (64-bit) / Python 2.3.4 -\> 2.4.3 / Sybase Module for Python (static) 0.39 -\> 0.39

After this upgrade, a Python script used to query sybase tables and extract data and load back to [RedHat](../../people/RedHat) server is taking 6x as long.
