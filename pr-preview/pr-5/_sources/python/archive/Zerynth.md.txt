...
- The [Zerynth Studio](http://www.zerynth.com/zerynth-studio/) is a dedicated development environment. From the Zerynth Studio users can develop their scripts saving them locally and syncing with the cloud. Through the Zerynth Studio it is possible to manage all the boards by customizing them and installing the right virtual machines.
...
Zerynth free version can be downloaded from the [Zerynt Studio download page](http://www.zerynth.com/zerynth-studio)

Zerynth sources are available on the [Zerynth Github Page](https://github.com/zerynth/)

The Zerynth App Android version is available on [Google Play](https://play.google.com/store/apps/details?id=thingsoninternet.biz.Zerynthapp&hl=en), iOS version is under development.
