...
- lightning talks
  - \"The [PyHole](./PyHole.html) library. Python generic REST API client with no pre-configuration based on dynamic object oriented call/getattr interface.\" by Krzysztof Dorosz
...
- Django
  ...
  - Acceptance testing ala [http://fitnesse.org/](http://fitnesse.org/) \-- making sure what you deliver is what your client wants (+)
  ...
  - [GeoDjango](./GeoDjango.html)
- Tools, IDE\'s
  - EMACS / VI - show increase of coding productivity using keyboard instead of mouse

  - [PyCharm](./PyCharm.html) - advanced usage
- Design Patterns
- Non Python
  - jQuery / Dojo / CSS
    - same form inputs rendering on different browsers
      - problem? - [http://www.456bereastreet.com/archive/200409/styling_form_controls/](http://www.456bereastreet.com/archive/200409/styling_form_controls/)

      - existing tools: [http://www.ajaxblender.com/jniceit.html](http://www.ajaxblender.com/jniceit.html) or [http://www.emblematiq.com/lab/niceforms/](http://www.emblematiq.com/lab/niceforms/) - poor
