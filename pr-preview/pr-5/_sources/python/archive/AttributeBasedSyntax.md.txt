...
Attribute-based syntax typically uses XML-like attributes to either annotate parts of a Web page (see [StructureAnnotation](../language/StructureAnnotation)) or to introduce program code into the document (see [PythonInWebPage](PythonInWebPage)).

See [StructureAnnotation](../language/StructureAnnotation) for an example.
