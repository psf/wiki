...
- **[CameronLaird](../people/CameronLaird)** occasionally teaches classes on advanced Python topics\--Python for process control, Python with LDAP, and so on.
...
- **[Antonio Cuni](http://antocuni.eu/)** offers training and courses about Python and [PyPy](../implementations/PyPy) in Italy and Europe.
...
- **[Michael Foord](http://www.voidspace.org.uk/)** is available for Python and [IronPython](../implementations/IronPython) training in the UK, Europe and the USA.
...
- **[Mark Summerfield](http://www.qtrac.eu)**, author of [Programming in Python 3](http://www.qtrac.eu/py3book.html) and [Rapid GUI Programming with Python and Qt](http://www.qtrac.eu/pyqtbook.html), provides Python and [PyQt](../gui/PyQt) training, research, and consultancy in English, primarily in the UK.

- **[Christopher Arndt](http://chrisarndt.de/about.html)** is an independent software developer and Linux consultant based in [Cologne, Germany](http://wiki.python.de/pyCologne). He provides general Python, [TurboGears](../web/TurboGears) and Linux training in English or German language all over Europe on request. For further information write an email to chris at chrisarndt dot de.
...
Public training courses presented by these trainers are listed on the [PythonEvents](../conferences/regional/PythonEvents) page.

Before creation of this page, [CameronLaird](../people/CameronLaird) maintained [a private one](http://phaseit.net/claird/comp.lang.python/python_training.html) on the same subject.
