...
- [RFIDIOt](http://rfidiot.org/) - an open source python library for exploring RFID devices (see also [\"RFID enabled e-passport skimming proof of concept code released (RFIDIOt)\"](http://www.securityfocus.com/archive/1/449926/30/0/threaded) and [\"Code highlights e-passport eavesdropping risk\"](http://www.theregister.co.uk/2006/10/31/rfid_e-passport_attack/))

- [t616hack](http://www.python.org/pypi/t616hack) - a distribution providing access to the contacts, phonebook and messages on the Sony Ericsson T610/T616 and compatible mobile telephones

- [jaraco.nxt](http://pypi.python.org/pypi/jaraco.nxt) - a package implementing low-level API communication with the LEGO Mindstorms NXT robot kit.
