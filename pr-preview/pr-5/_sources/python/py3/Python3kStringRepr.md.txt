...
- The algorithm to build repr() strings should be changed to:
  ...
  - Backslash-escape quote characters (apostrophe, 0x27) and add quote character at the beginning and the end.
