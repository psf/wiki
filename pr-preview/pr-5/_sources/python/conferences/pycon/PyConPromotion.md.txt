...
- [PyCon](PyCon) 2006: Register now for this conference featuring tutorials, sprints, and over 50 talks. (February 24-26, 2006, Dallas Texas)
  ...
  [PyCon](PyCon) 2006: Learn about Python in education, science, and web development. (February 24-26, 2006, Dallas Texas)

58-word blurb:

    PyCon 2006: February 24-26, 2006, in Dallas Texas.  

    Register now for this community conference for users and developers of
    the Python programming language.  The conference will feature half-day
    tutorials on a variety of topics, four days of development sprints,
    and over 50 talks on topics ranging from Python libraries to success
    stories and applications.

    http://us.pycon.org for more information.
