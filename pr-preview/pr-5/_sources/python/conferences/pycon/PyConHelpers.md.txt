...
Please think about how you can assist the conference, using the points below as a focus, and make up your mind not to simply be a passive consumer at [PyCon](PyCon). The more people who *get involved* the more fun (and the more rewarding) the conference will be. Consult the list of [PyConTasks](PyConTasks) and see what you can do.
...
- You could locate low-cost accommodation in the area and publicize it with transportation options. [PyConTransportationOptions](PyConTransportationOptions) [PyConMaps](PyConMaps)
...
- You could put a task force together to organize the \*next\* [PyCon](PyCon)
