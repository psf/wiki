...
- [IronPython](../../../implementations/IronPython) (Python implemented in .NET)
...
- Questions from people who attended the following talks:
  ...
  - [IronPython](../../../implementations/IronPython): The Road Ahead, by Jim Hugunin

  - End-user computing without tears using Resolver, an [IronPython](../../../implementations/IronPython) spreadsheet, by Giles Thomas

  - Python in your Browser with [IronPython](../../../implementations/IronPython) & Silverlight, by Michael Foord

- Discussion about future directions of Python+.NET

- Discussion of [IronPython](../../../implementations/IronPython) related projects like Ironclad (C Extensions from [IronPython](../../../implementations/IronPython)) and Coils (Static wrappers for [IronPython](../../../implementations/IronPython) classes)
