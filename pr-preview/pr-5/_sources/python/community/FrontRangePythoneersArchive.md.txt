...
For Front Range Pythoneers\' current events, please see our [main page](./FrontRangePythoneers(2f).html).
...
- Turbogears2 Sprint. More [information](http://docs.turbogears.org/SprintOrganization).
...
- [Turbogears2Sprint](./Turbogears2Sprint.html). More [information](http://docs.turbogears.org/SprintOrganization).
...
Meet at Bivio to participate in the worldwide Django sprint: [http://code.djangoproject.com/wiki/Sprint1Dec2007](http://code.djangoproject.com/wiki/Sprint1Dec2007)
...
We\'re hosting a Front Range faction in the Django worldwide sprint this Friday and Saturday, September 14 and 15. If you would like to pitch in, please add yourself to the [sprint wiki](http://code.djangoproject.com/wiki/Sprint14Sep).
...
The event is not only for GIS industry types. We welcome anybody who\'s innovating on any aspect of geography and location: environment, transportation, geocoding, geocaching, you name it. Python is widely used in both open source and proprietary GIS software, and will certainly be a major theme at the [GeoSummit](./GeoSummit.html).
...
- [IPython1 Beta](http://ipython.scipy.org/moin/Developer_Zone/Sprint). This would be an excellent opportunity to learn about decorators, Twisted, and other advanced Python concepts while helping getting this shell to beta status.
...
- Matt Boersma presented \"Write Less Code with XRC for wxPython\": an easier way to do GUI layout using wxPython\'s XML-based resource system. [Slides , demo code, and useful base classes](http://us.pycon.org/common/talkdata/PyCon2007/079/xrc4wxpy.tgz).

- Sean Reifschneider presented \"Python and vim: Two great tastes that go great together\". The vim editor includes extensive abilities for customization and scripting. In addition to its own simple macro language, vim also supports calling Python code. This Python code has access back into vim for manipulating the edit buffer as well as running normal vim commands. Examples demonstrated in this talk will include automatically detecting indentation style (tabs/N spaces), automatic update of DNS \"serial\" numbers when editing DNS zone files, mail alias tab-expansion, and a time tracking application using a \"domain specific vim\" as the user interface. [Slides](http://www.tummy.com/Community/Presentations/)

## PyCon: February 23-25, 2007 

- [PyCon 2007](http://us.pycon.org/TX2007/HomePage) Dallas/Addison TX. List of attendees from the Front Range:

- Matt Boersma. Presented [Write Less Code with XRC for wxPython](http://us.pycon.org/common/talkdata/PyCon2007/079/xrc4wxpy.tgz)

- Eric Dobbs. Sprinted on Jython.

- Brian Granger. Presented [Interactive Parallel and Distributed Computing with IPython](http://us.pycon.org/common/talkdata/PyCon2007/061/ipython1_pycon_2007.pdf) and [IPython: getting the most out of working interactively in Python](http://us.pycon.org/common/talkdata/PyCon2007/058/ipython_pycon_2007.pdf)

- Evelyn Mitchell

- Sean Reifschneider. Presented [Python and vim: Two great tastes that go great together](http://www.tummy.com/Community/Presentations/). And he [ran the network](http://www.tummy.com/journals/entries/jafo_20070315_154951)!

- Jim Baker. Presented [Iterators in Action](http://us.pycon.org/common/talkdata/PyCon2007/028/IteratorsInActionWithNotes.pdf). Sprinted on Jython.

- [SteveRogers](./SteveRogers.html)
...
- Location: [Churchill Navigation](http://www.churchillnavigation.com).
...
- Steve Rogers showed up for his first meeting with us. He credits seeing the [Pythoneering blog](http://zyasoft.com/pythoneering/), now that it\'s included in the [Daily Python-URL](http://www.pythonware.com/daily/index.htm). It\'s good to have the visibility. With Steve had just read some of the reports from [Supercomputing 2006](http://sc06.supercomputing.org/), so we talked a lot about parallel computing paradigms in Python, among other things.
