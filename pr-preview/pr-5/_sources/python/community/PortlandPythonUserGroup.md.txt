...
The Portland Oregon Python User Group has presentations the second Tuesday of the month, and a project hack night on the fourth Tuesday of the month.
...
- Twitter: [http://twitter.com/pdxpython](http://twitter.com/pdxpython)
...
- Lightning talks!
  - [RunSnakeRun](./RunSnakeRun.html) - Joel Bernstein
...
- [PyParsing](./PyParsing.html) examples by Brett Carter
...
- Kirby: Open Source and Health Care / [BarCamp](./BarCamp.html) Alpha

- Jeff: Simplicity

- Chris: Django [NewForms](./NewForms.html)
