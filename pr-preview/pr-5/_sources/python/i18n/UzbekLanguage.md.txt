...
``` 
   ...
   3 # python 3.0/3.1
   4 
   5 alaykumenglish = ['Good morning', 'Good afternoon', 'Good evening']
   6 alaykumo_zbek = ['Hayirli tong', 'Hayirli kun', 'Hayirli kech']
   7 
   8 mening_ismim = 'Dilshod'
   9 
  10 for alaykum in zip(alaykumenglish, alaykumo_zbek):
  11     for alaykumx in alaykum:
  12         print(alaykumx + ' ' + mening_ismim)
```
:::
::::
