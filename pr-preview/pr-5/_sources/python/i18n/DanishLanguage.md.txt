...
**dansk** [1SEP09 Ideally, all the language pages should be like the Polish or Turkish pages - all native language, only the necessary English. ]
...
[http://www.linuxbog.dk/python/python/index.html](http://www.linuxbog.dk/python/python/index.html) (text for learning Python)
...
- [ComputerWorld.dk](http://www.computerworld.dk/blog/studblog/1931?a=blog_rss&i=0) - Announcement for Harry Pierson speaking engagement in code

- [forum](http://www.eksperten.dk/spm/881397) - urllib and non-ascii characters

- [fixing-unknown-locale-in-python-26](http://www.nowhere.dk/articles/fixing-unknown-locale-in-python-26) - Article in English, but geared to Danish programmers
