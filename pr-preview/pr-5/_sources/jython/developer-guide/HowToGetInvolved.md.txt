...
- jython-users: Discussion of and questions about using Jython [archive](http://www.nabble.com/jython-users-f4123.html) [join](http://lists.sourceforge.net/mailman/listinfo/jython-users)

- jython-dev: Discussion of developing and enhancing Jython itself [archive](http://www.nabble.com/jython-dev-f4122.html) [join](http://lists.sourceforge.net/mailman/listinfo/jython-dev)
...
We have bugs - if you can help out, that\'s fantastic. You can see the list of open items on the [issue tracker](http://bugs.jython.org/).

To get started with the code, see the [JythonDeveloperGuide](JythonDeveloperGuide).
