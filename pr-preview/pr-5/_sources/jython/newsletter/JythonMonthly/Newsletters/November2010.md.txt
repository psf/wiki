# Jython Monthly / Newsletters / November 2010
...
::: {}
  ...
  **October/November 2010 \-- Issue #46**   
  ----------------------------------------- ---------------------------------------------------------------------------------------------------
:::
...
For more information, please see the [online documentation](http://packages.python.org/jython-swingutils/).

## Blogs 

[Regular Expression Unicode Blocks in IronPython and Jython](http://pyright.blogspot.com/2010/10/regular-expression-unicode-blocks-in.html) - Carl Trachte

One last thing that\'s available in jython and [IronPython](./IronPython.html), but not in CPython regular expressions is Unicode Blocks. Blocks are similar to Unicode Scripts, but do not correspond one to one with them. Blocks, as the name implies, represent continuous sequences of Unicode code points. This page, recommended to me by artisonian on twitter, has a good synopsis.

[Read More](http://pyright.blogspot.com/2010/10/regular-expression-unicode-blocks-in.html)

## Articles 

**No articles for October/November 2010**

## Discussions 

[Adding Jython Modules to the Classpath](http://www-01.ibm.com/support/docview.wss?uid=swg21268538)

## Videos 

[jHepWork Channel - Using Java and Jython for Data Analysis](http://www.youtube.com/user/jhepwork)
...
[Fiji Scripting Tutorial](http://www.ini.uzh.ch/~acardona/fiji-tutorial/)

## IDE 

[Field Project](http://openendedgroup.com/field)

[PyDev 1.6.3](http://pydev.sourceforge.net/)
