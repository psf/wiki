# Jython Monthly / Newsletters / December 2008
...
\- Jim Baker and Leo Soto Presentation of Django on Jython at [DjangoCon](./DjangoCon.html) 2008

\- [PyDev](./PyDev.html) and Netbeans 6.5 Provide Two Great IDEs for Jython Development
...
As always, I\'d love to hear your feedback and suggestions. Please email me at [jythonpodcast@gmail.com](mailto:jythonpodcast@gmail.com) and let me know if you\'ve got any commentary to add.
...
[Read More](http://wiki.glassfish.java.net/attach/V3FunctionalSpecs/Scripting-one-pager.html)
...
[Get It Now](http://www.python.org/download/releases/3.0/)
...
[Read Article](http://broadcast.oreilly.com/2008/12/java-in-the-cloud.html)

## Blogs 

[Python Support in Netbeans](http://blogs.sun.com/tor/entry/netbeans_screenshot_of_the_week6) - Tor Norbye

[Setting Up Django with Sqlite](http://compiler-error.blogspot.com/2008/12/setting-up-django-on-jython-with-sqlite.html) - Matthew Harrison

[Jython + TileCache/FeatureServer](http://crschmidt.net/blog/340/jython-tilecachefeatureserver-it-just-works/) - Christopher Schmidt

[Jython and GeoTools](http://crschmidt.net/blog/344/using-jython-geotools/) - Christopher Schmidt

[Jython Servlets Part 1](http://justinworrall.com/blog/?p=87) - Justin Worall

[Jython Servlets Part 2](http://justinworrall.com/blog/?p=109) - Justin Worall

[Sudden Interest in Java](http://bretthoerner.com/blog/2008/nov/23/sudden-interest-java-platform/) - Brett Hoerner
...
[Click Here to take survey](http://www.surveymonkey.com/s.aspx?sm=OBT3PW6zaAHxagGxQdbITg_3d_3d)
