...
1.  To help connect Pythonistas in Cuba with the PSF in terms of providing resources and support to User Groups and Events, such as Pycons or [PyDays](./PyDays.html) in Cuba, including but not limited to:
...
The working group takes the form of a mailman listserv within Python.org. It has a public archive. One joins by approval of the moderator. [https://mail.python.org/mailman/listinfo/python-cuba](https://mail.python.org/mailman/listinfo/python-cuba)
