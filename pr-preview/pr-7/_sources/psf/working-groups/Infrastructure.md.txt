...
Membership in the Infra-WG is open to all members of the PSF, however several special classes of member are recognized: Chair, Advisory, Staff, and Tenant Members as described below. Any PSF member may apply for membership in the Infra-WG by first emailing [mailto:infrastructure@python.org](mailto:infrastructure@python.org) and introducing yourself, and asking to join. After approval, you can join the [Infra-WG mailing list](http://mail.python.org/mailman/listinfo/infrastructure). The PSF IT Manager is a permanent member of this workgroup.

All participants agree to abide by the Python Community Code of Conduct: [https://www.python.org/psf/codeofconduct/](https://www.python.org/psf/codeofconduct/)
