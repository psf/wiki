...
Education and learning are core pillars of the PSF\'s mission. As a working group, we seek to guide the strategy to fulfill the [PSF\'s mission](https://www.python.org/psf/mission/) to publicize, promote the adoption of, and facilitate the ongoing development of Python-related technology and educational resources.
...
- [PSF Education WG Charter](Python Edu Charter)

### Mailing List: 

To actively participate in these projects, please join the [PythonEdu-WG](https://mail.python.org/mailman/listinfo/pythonedu-wg) mailing list.
...
The [Education SIG](https://www.python.org/community/sigs/current/edu-sig/) has a long history serving the Python community as an informal mailing list for discussions on education. The [Education SIG mailing list](https://mail.python.org/mailman/listinfo/edu-sig) description and its archives give an overview of the broad range of topics discussed in the Education SIG.

The [Outreach & Education committee](https://mail.python.org/mailman/listinfo/outreach-and-education)\'s mission is to increase the number of Python users, especially in under-represented demographics.
