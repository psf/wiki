# Jython Monthly / Newsletters / October 2009
...
The Jump project is a new build tool for distributing Jython applications as JAR files. Jump is currently at version 0.9.5 and is under active development. For more information and to get started using Jump, please visit the site at [http://gitorious.org/jump](http://gitorious.org/jump)
...
Visit Site: [http://bitbucket.org/agronholm/jython-swingutils/](http://bitbucket.org/agronholm/jython-swingutils/)

**Django-Jython 1.0 To Be Released**

The 1.0 version of Django-Jython will be released soon. It will include support for a few different database backends including PostgreSQL, MySQL, Oracle, and [SqlServer](./SqlServer.html). Stay tuned for the release that should occur sometime in November 2009.

Visit Site: [http://code.google.com/p/django-jython/](http://code.google.com/p/django-jython/)
...
[Read Entire Article](http://www.ibm.com/developerworks/web/library/wa-jython)

## Blogs 

Blogs noted in **bold** are only presented in newsletter, not on podcast.

[Setuptools with Jython](http://veryhappythings.github.com/2009/10/01/using-setuptools-with-jython-25.html) - Very Happy Blog

[Slides and Demos from Jython Talk](http://blog.leosoto.com/2009/10/slides-and-demos-from-jython-talk-at.html) - Leo Soto

[Grinder Load Testing Tool](http://acceptancetest.blogspot.com/2009/10/ginder-load-testing-tool.html) - Srikanth Reddy

[See How Spring Python Works with Jython](http://blog.springpython.webfactional.com/2009/10/15/see-how-spring-python-works-with-jython/) - Spring Python Blog

[Call JRuby and Jython from Maven](http://matschaffer.com/2009/10/call-jruby-jython-from-maven/) - Mat Schaffer

**[Introduction to the Web Services Framework for Jython](http://bonlebon.blogspot.com/2009/10/introduction-to-web-services-framework.html) - Bon Lebon**

**[Android Beyond Java P2](http://www.androidjunkies.com/index.php/2009/10/15/android-beyond-java-part-two) - Android Junkies**

**[Pyevolve Benchmark on Different Python Flavors](http://pyevolve.sourceforge.net/wordpress/?p=862) - Christian Perone**

**[Data Types](http://softwaredesignblog.blogspot.com/2009/10/data-types.html) - Tom Smith**

**[Open Source Data Analysis Framework jHepwork](http://www.greepit.com/2009/10/open-source-data-analysis-framework-jhepwork/) - [Rob@greepit.com](mailto:Rob@greepit.com)**

**[Remove special character using Jython script](http://odiexperts.com/?p=619) - Kshitiz Devendra**

***Pycon India 2009 Posts***

**[Pycon 2009 India First Impressions](http://programming-tidbits.blogspot.com/2009/10/pycon-india-2009-my-impressions.html) - Shailesh Kumar**

**[Pycon India 2009 Report](http://jaganadhg.freeflux.net/blog/archive/2009/09/29/pycon-india-2009-a-report.html) - Jaggu\'s World**

**[Pycon India 2009: A Review](http://uswaretech.com/blog/2009/10/pycon-india-2009/) - The Usware Blog**
