...
Maybe let the presenters manage their bios as a wiki page that is gathered into the Program Guide? Either dead simple text only with paragraph breaks, or [ReStructured](./ReStructured.html) Text? Maybe do the same for sponsor info?
