...
- The criteria are
  1.  Clarity of the proposal (summary field)
  2.  Clarity of the talk details (Outline)
  3.  Bio of authors (reputation, contributions etc.)
  4.  Novelty of the topic (1 for a dead topic, 5 for a novel one).
  5.  Competing talks in the same category (0 if no competing talk, \# of competing talks if there are any)
  6.  Overall rating
