...
Anyone can post to the [PyCon twitter](http://twitter.com/pycon) channel.

During the conference, the organizers will post tasks and volunteering opportunities to the [pyconvolunteers](http://twitter.com/pyconvolunteers/) channel.

## Jaiku 

[Jaiku](http://www.jaiku.com) is a micro-blogging site like Twitter, but with some extra features. Unfortunately, as of this writing (2008-02-23) they are not open to accepting new accounts while they deal with their acquisition by Google. Pre-existing members, though, do have a limited number of invitations they can give out.

On Jaiku there is a [#PyCon](http://jaiku.com/channel/PyCon) channel as well as a general [#python](http://jaiku.com/channel/python) channel.

## Pownce 

From the site: \"[Pownce](http://www.pownce.com) is a way to send stuff to your friends. What kind of stuff? You can send just about anything: music, photos, messages, links, events, and more.\" It\'s written in Python using Django and offers functionality similar to Twitter/Jaiku.

## CrowdVine 

There is now [a CrowdVine community for PyCon 2008](http://pycon2008.crowdvine.com/). Once you sign up for the community, you can send comments to other members and write weblog posts that everyone can see.
