...
Project URL: [https://pycon.coderanger.net/](https://pycon.coderanger.net/)

Sprint Leader: Doug Napoleone

Mailing List: [http://mail.python.org/mailman/listinfo/pycon-tech](http://mail.python.org/mailman/listinfo/pycon-tech)

Contribution instructions: [https://pycon.coderanger.net/](https://pycon.coderanger.net/)

Repository: [https://svn.python.org/conference/django/trunk/](https://svn.python.org/conference/django/trunk/)

ohloh page: [http://www.ohloh.net/projects/4806?p=PyCon-Tech](http://www.ohloh.net/projects/4806?p=PyCon-Tech)

**Sprinters**

- David Goodger ([goodger@python.org](mailto:goodger@python.org))
- Lionel Hummel ([ptdm9q502@sneakemail.com](mailto:ptdm9q502@sneakemail.com))
- Daniel Mizyrycki ([mzdaniel@gmail.com](mailto:mzdaniel@gmail.com))
