...
You can also [read some Python success stories](http://www.python.org/about/success/), and look through the papers from the various [Python conferences](http://www.python.org/workshops/) to find other organizations that are using Python. There is also a [user-created video](http://www.youtube.com/watch?v=RqhUz2vh6lA) that provides a presentation of a selection of the various uses of Python.
...
Many components of the Google spider and search engine are written in Python (mentioned on [Slashdot](http://slashdot.org/articles/99/02/19/0833230.shtml)).
...
[ElasticHosts Cloud Servers](http://www.elastichosts.com/)
...
Mojam\'s [Musi-Cal](http://www.musi-cal.com/) web site provides easy access to the most up-to-date worldwide live music information: concerts, festivals, gigs and other musical events. Much of the back-end (database and email interfaces) is written in Python.
...
[Shopzilla](http://about.shopzilla.com/)
...
[Movieplayer.it](http://www.movieplayer.it/)
...
[Battlefield 2](http://www.eagames.com/official/battlefield/battlefield2/us/home.jsp)

Battlefield 2 uses python to implement core elements of the gameplay such as score keeping and team balancing. Check out the [BF2 Tech Wiki](http://bf2.fun-o-matic.org/) for sample BF2 Python scripts and information about API.
...
[Star Trek Bridge Commander](http://www.bridgecommander.com/)

The game \"Star Trek Bridge Commander\" by [Totally Games](http://www.totallygames.com/) uses Python both as the mission scripting language and also for a ton of other features.

[The Temple of Elemental Evil](http://www.atari.com/toee/) and [Vampire: The Masquerade: Bloodlines](http://www.vampirebloodlines.com/)
...
There is a short [interview with Steve Moret](http://www.pygame.org/interview/stevemoret.shtml) from Troika Games about using Python in ToEE (and looking forwards to Bloodlines).

[Civilization 4](http://www.2kgames.com/civ4/home.htm)
...
[QuArK](http://quark.sourceforge.net/) (Quake Army Knife)
...
There\'s [a paper from the 2002 Game Developer Conference](http://www.cygnus-software.com/papers/gamescriptinginpython.html) that provides more information about Python and game development.
...
[HKS, Inc. (ABAQUS/CAE)](http://www.hks.com/)
...
[RoboFog](http://www.letterror.com/code/robofog/)

[RoboFog](./RoboFog.html) is a scriptable font editor for the Macintosh. It is basically good old Fontographer with an embedded Python interpreter. Developed by Petr van Blokland, Just van Rossum and Erik van Blokland.

[Caligari Corporation](http://www.caligari.com/)
...
[Jasc Software, Paint Shop Pro](http://www.jasc.com/)

Starting with Version 8, Paint Shop Pro uses Python as its scripting language.

## Financial 

[Altis Investment Management](http://www.altis.ch/)
...
[ABN AMRO Bank, Treasury Systems](http://www.abnamro.com/)
...
[Bellco Credit Union](http://www.bellco.org/)

The online banking system for Bellco Credit Union and [Bethpage Federal Credit Union](https://www.bethpagefcu.com/) is written in Python. The product is known as SAFE (Secure Access Financial Enterprise)\[TM\], a product suite developed by [Sapereon](http://www.sapereon.com/).

[Journyx Timesheet and Resource Management Software](http://journyx.com/)

Journyx products (Timesheet and [ProjectXecute](./ProjectXecute.html)) are all written in Python and so it has been since 1996. The products enable tracking time for billing, payroll, and project management as well as allocating peoples\' future time to different tasks.
...
The [Radar Remote Sensing Group](http://rrsg.ee.uct.ac.za/) at the University of Cape Town.
...
Applied Maths is using Python in their bioinformatics software suite [BioNumerics](http://www.applied-maths.com/bionumerics/bionumerics.htm) to automate series of actions that are executed repeatedly, to create custom reports, to import and export non-standard formats, to perform custom calculations, etc.

[Biosoft](http://www.biosoft.com/)

Biosoft is using an embedded Python interpreter in their [ModKine](http://www.biosoft.com/w/modkine.htm) product. [ModKine](./ModKine.html) is a pharmacokinetic analysis program for Windows 9x/NT that allows users to enter their own transformation and curve-fitting functions in Python.

[The National Research Council of Canada](http://www.nrc.ca/)
...
[Los Alamos National Laboratory (LANL) Theoretical Physics Division](http://bifrost.lanl.gov/MD/MD.html)

Scientists in the Theoretical Physics Division at Los Alamos National Laboratory are using Python to control large-scale physics codes on massively parallel supercomputers, high-end servers, and clusters. Python plays a central role in controlling these simulations, performing data analysis, and visualization. To support these efforts, Python has been ported to run over MPI. The [SWIG interface generation tool](http://www.swig.org/) has also been developed to support the integration of legacy applications with Python and to build modules for physics applications.

[AlphaGene, Inc.](http://www.alphagene.com/)

[AlphaGene](./AlphaGene.html) is a leader in gene and protein discovery and gene expression technologies. [AlphaGene](./AlphaGene.html) uses Python as the core of its bioinformatics/tracking system \-- binding together a variety of data input sources, an Oracle database, large-scale genetic analysis, specialized supercomputers and an html-based system interface. Python has proven to be an excellent language for efficiently integrating these and other heterogeneous tasks.

[LLNL](http://www.llnl.gov/)

A group at the Lawrence Livermore National Laboratories is basing a new numerical engineering environment on Python, replacing a home-grown scripting language of ten-year standing. [Paul Dubois](http://www.pfdubois.com/) is a central figure in that effort.
...
[Swedish Meteorological and Hydrological Institute (SMHI)](http://www.smhi.se/)

SMHI is the home of the Swedish civilian weather, hydrological and oceanographic services. Its Python-based remote sensing software for automatic product generation, using NOAA and Meteosat data, provides information to bench forecasters, objective analysis schemes, and commercial interests such as the media. This system receives raw data from several weather satellites, and produces images for many purposes, including the satellite images used for the presentation of the daily weather on Swedish [TV 4](http://www.tv4.se/).
...
ESRI is a leader in the field of Geographic Information Systems (software that relates data to location). As of version 9.0 of ESRI\'s [ArcView](./ArcView.html) software suite, ESRI uses Python as a scripting language and distributes the Python runtime. ESRI has released the Python interface library to its products as an open source package called [AVPython](http://avpython.sourceforge.net/).

[Nmag Computational Micromagnetics](http://nmag.soton.ac.uk/)

The [nmag](http://nmag.soton.ac.uk/) project uses a Python user interface to control micromagnetic simulations.
...
Ciranova is an [Electronics Design Automation (EDA)](http://en.wikipedia.org/wiki/Electronic_design_automation) company that provides automated [integrated circuit (IC)](http://en.wikipedia.org/wiki/Integrated_circuit) layout tools. The Ciranova [RuleWise](./RuleWise.html) API provides a high-level programming interface designed specifically for building deep-submicron cell generators. It is accessed as a Python extension package.
...
A Python runtime is available for the EFI (fancy BIOS, sorta) environment being developed by Intel for SGI\'s IA64 Itanium and future IA32 systems. You can find mention of this at [http://developer.intel.com/technology/efi/efi.htm](http://developer.intel.com/technology/efi/efi.htm) .

[MCI Worldcom](http://www.mciworldcom.com/)
...
Nokia is using Python to provide high level programming environment for their [S60 (Symbian)](http://sourceforge.net/projects/pys60) and [Maemo (Linux)](http://pymaemo.sourceforge.net/cgi-bin/moin.cgi/) platforms

## Education 

[University of California, Irvine](http://www.reg.uci.edu/)
...
[Delft University of Technology, Faculty of Aerospace Engineering, Delft, Netherlands](http://www.lr.tudelft.nl/en)

The largest Aerospace Engineering faculty of Europe uses Python, with plugins Numpy, Scipy, Matplotlib and pygame in a course \"Programming & Scientific Computing in Aerospace\". This is a course for first year undergraduate students. Throughout the complete curriculum Python gradually replaces Matlab as the default programming language and scientific computing tool. Other faculties in Delft, such as Civil Engineering are also moving in the same direction and using Python more and more. And, like in most universities, Python is used by many [PhDs](./PhDs.html) throughout the university.

[Smeal College of Business, The Pennsylvania State University](http://www.smeal.psu.edu/)

The Smeal College of Business was an early adopter of the Python-based web framework [Zope](http://www.zope.org/) at Penn State using the open-source Content Management System (CMS) [Plone](http://www.plone.org/) to house their 8,000 plus object marketing site and numerous microsites. They are currently exploring different ways to harness the power of python to assist in business modeling and research.
...
[Raven Bear Systems Corporation](http://www.raven-bear.com/)

Raven Bear has developed a Python based version of its enterprise analytics platform. Integrated into the analytics platform are data mining and OLAP functionalities. Users can access and interact with data over a [Zope](http://www.zope.org/) platform.

[Thawte Consulting](http://www.thawte.com/)

Thawte Consulting, which has issued digital certificates to 23% of the world\'s secure web servers (according to [the Netcraft survey](http://news.netcraft.com/)), uses Python extensively for intranet and extranet services. Python generates web pages based on database content, and takes care of the cryptography and digital certificate management involved in certification. \"Python makes us extremely productive, and makes maintaining a large and rapidly evolving codebase relatively simple.\"

[Advanced Management Solutions Inc.](http://www.amsrealtime.com/)
...
[Arakn\<E9\>](http://www.arakne.com/)

[MetaDynamic](http://www.arakne.com/home/products.html) is a seamless integration of Python on client and server sides within the Metaphase product data management system (an object-oriented distributed system), that provides a new RAD environment as a substitute to the traditional customization environment in C. Arakn\<E9\> uses Python internally on its other developments.

[RealNetworks](http://www.real.com/)

[RealNetworks](./RealNetworks.html) has developed a Python binding for their [RealMedia](./RealMedia.html) client. They use this extensively in load testing and feature testing of both their server and client on all of their supported platforms. Additionally, their build system and bug tracking system have significant Python components.

[dSPACE](http://www.dspaceinc.com/)

dSPACE uses Python as the scripting language for its integrated real-time simulation experiment environment [ControlDesk](http://www.dspaceinc.com/en/Products/Experisw.htm). While COM-based tool automation libs are provided on the one hand, access libs for real-time simulation hardware, RS232 and several automotive ECU (electronic control units) communication channels have been developed on the other. Many customers from various car manufacturers worldwide started Python programming with this program.

[Escom](http://www.escom.net.pl/)
...
The [site](http://www.cia.gov/) of the USA Central Intelligence Agency (CIA) is powered by Python/Zope/Plone.
