...
- for Windows, use [MovablePython](../people/MovablePython);

- for this purpose, [Pyrex](../implementations/Pyrex) can be regarded as a language variant to Python itself;
...
- [PyInstaller](../people/PyInstaller) (supports Windows, Linux and soon Mac)
...
[FredrikLundh](../people/FredrikLundh) [discussed](http://effbot.org/zone/python-compile.htm) some of these in 2003.
