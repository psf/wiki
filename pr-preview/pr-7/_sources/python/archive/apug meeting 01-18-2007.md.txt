...
[Amara](http://uche.ogbuji.net/tech/4suite/amara/) - an open-source collection of Python tools for XML processing

[SOAPpy](http://pywebsvcs.sourceforge.net/) - SOAP and WSDL toolkit

[Reportlab](http://www.reportlab.org/) - PDF Creation

[PyPfPro](http://sourceforge.net/projects/pypfpro/) - a Python wrapper for the [PayflowPro](./PayflowPro.html) SDK
...
[the B-List](http://www.b-list.org/) - Nice site/blog about Django and other web technologies
