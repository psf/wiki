# Charlottesville Python User Group
...
- Meetup in Richmond sponsored by [Capital TechSearch](http://capitaltechsearch.com/). [http://pythonmeetup.eventbrite.com/](http://pythonmeetup.eventbrite.com/)
...
- Topic: Demo a module/package (or a few) which you have been using lately: [http://xkcd.com/353/](http://xkcd.com/353/).
...
- discussed unit testing in Python:
  ...
  - [nose](http://somethingaboutorange.com/mrl/projects/nose) (easy_install nose)
...
- started the PyCHO project, discussed [http://pypi.python.org/pypi](http://pypi.python.org/pypi)
