...
- [Actual Technologies](http://www.actualtech.com/) (specialized on Mac OS X)

- [CData Software](http://www.cdata.com/) ODBC Drivers for more than 60 data sources.

- [Devart](https://www.devart.com/odbc/) (Windows, Linux, Mac OS X)
...
- [Simba Cassandra ODBC driver with SQL connector](http://www.simba.com/connectors/apache-cassandra-odbc)
...
- [Simba Couchbase ODBC driver with SQL connector](http://www.simba.com/connectors/couchbase-odbc-jdbc-drivers)
...
- [Devart Interbase ODBC Driver](https://www.devart.com/odbc/interbase/download.html)\
  Works on Windows, Linux, Mac OS X 32/64 bits.\
  Supports all the [InterBase](./InterBase.html) server and client versions.
...
- [IBM ODBC Driver for Linux on iSeries / AS/400 DB2 servers](http://www-03.ibm.com/systems/power/software/i/access/linux/guide.html)

- [DataDirect ODBC Driver for IBM DB2](http://www.datadirect.com/)

- [OpenLink ODBC Driver for IBM DB2](http://www.openlinksw.com/)
...
- Netezza ODBC driver
  ...
  Since IBM acquired Netezza, the ODBC drivers are only available to customers with active support contracts. If you have one, you can download the driver as part of the software bundles from [IBM FixCentral](http://www-933.ibm.com/support/fixcentral/options) (search for \"Netezza\").
...
- [MariaDB ODBC Driver](https://mariadb.com/kb/en/mariadb/about-mariadb-connector-odbc/)

- [Devart MariaDB ODBC Driver](https://www.devart.com/odbc/mysql/download.html)\
  Works on Windows, Linux, Mac OS X 32/64 bits.\
...
- [Actual Technologies Mac OS X ODBC Driver for SQL Server](http://www.actualtech.com/)

- [DataDirect ODBC Driver for SQL Server](http://www.datadirect.com/)

- [Devart SQL Server ODBC Driver](https://www.devart.com/odbc/sqlserver/)\
  Works on Windows, Linux, Mac OS X 32/64 bits.\
...
- [EasySoft ODBC Driver for SQL Server](http://www.easysoft.com/)

- [FreeTDS Unix ODBC Driver for SQL Server](http://www.freetds.org/)\
...
- [OpenLink ODBC Driver for SQL Server](http://www.openlinksw.com/)

- [Simba SQL Server ODBC drivers](http://www.simba.com/connectors/sql-server-odbc-driver) Supports Linux, Mac and Windows. Available in client and server (two-tier) versions.
...
- [Simba MongoDB ODBC driver with SQL connector](http://www.simba.com/connectors/mongodb-odbc)
...
- [Actual Technologies Mac OS X ODBC Driver for MySQL](http://www.actualtech.com/)

- [CData ODBC Driver for MySQL](http://www.cdata.com/drivers/mysql/odbc)

- [DataDirect ODBC Driver for MySQL](http://www.datadirect.com/)
...
- [OpenLink ODBC Driver for MySQL](http://www.openlinksw.com/)
...
- [Actual Technologies Mac OS X ODBC Driver for Oracle](http://www.actualtech.com/)

- [DataDirect ODBC Driver for Oracle](http://www.datadirect.com/)
...
- [EasySoft ODBC Driver for Oracle](http://www.easysoft.com/)

- [OpenLink ODBC Driver for Oracle](http://www.openlinksw.com/)
...
- [Actual Technologies Mac OS X ODBC Driver for PostgreSQL](http://www.actualtech.com/)

- [DataDirect ODBC Driver for PostgreSQL](http://www.datadirect.com/)

- [Devart PostgreSQL ODBC Driver](https://www.devart.com/odbc/postgresql/download.html)\
  Works on Windows, Linux, Mac OS X 32/64 bits.\
  Supports PostgreSQL server versions since 7.1 up to 9.4.

- [EasySoft ODBC Driver for PostgreSQL](http://www.easysoft.com/)

- [OpenLink ODBC Driver for PostgreSQL](http://www.openlinksw.com/)
...
- [DataDirect ODBC Driver for Teradata](http://www.datadirect.com/)
