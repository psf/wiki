...
2.  [PyPy](../../implementations/PyPy) - The python on python project. There are some fascinating topics in the [google video](http://www.youtube.com/watch?v=GnPmErtqPXk%5D) on this topic (+1)

3.  [PyGame](../../multimedia/PyGame) - The SDL wrapper for Python used to make games \[[NoufalIbrahim](NoufalIbrahim)\]
...
11. Python GUI frameworks for native desktop and web based applications ([WxPython](../../gui/WxPython), Tk \[also TTk\], GTK \[On Windows and Linux\], [PyJamasDesktop](./PyJamasDesktop.html), Titanium, [WebKit](../../people/WebKit) Desktop etc) (+3)
