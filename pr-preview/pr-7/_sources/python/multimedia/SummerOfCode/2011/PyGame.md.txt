...
[PyGame](PyGame) developers can be found on \#[PyGame](PyGame) on irc.freenode.net or \[[http://pygame.org/wiki/info\|mailing](http://pygame.org/wiki/info%7Cmailing) lists\].
