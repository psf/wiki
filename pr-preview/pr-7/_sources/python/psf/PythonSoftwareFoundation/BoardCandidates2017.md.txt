# Python Software Foundation / Board Candidates 2017
...
- Interviewed about the PSF in several capacities, for example: ZimboPy April 2017 Interview, Podcast Interviews (e.g. Python.\_\_init\_\_)
...
2.  implementing specific process for deployment to reach sponsors and close commitments that will contribute monies to our Foundation
...
3.  specific calendar for action
...
I\'m Kay -- some of you might have seen me present a poster at this year\'s PyCon, which was my very first PyCon and a really exciting experience for me. I\'m based in Central Europe (Vienna, Austria) and currently work as a Python/Django/JavaScript developer at a social science research institute after having completed my BSc in Computer Science in autumn last year. My original background is in journalism/writing/social sciences and I\'m particularly interested in areas where tech overlaps with art, culture and media. Works of mine have been published in The Recompiler and Model View Culture, both magazines covering tech and diversity topics. I felt encouraged to apply for the PSF board after chatting with Naomi (Ceder) at PyCon.
