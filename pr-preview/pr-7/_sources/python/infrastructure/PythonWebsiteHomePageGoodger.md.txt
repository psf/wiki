...
- \"FOUNDATION\" (was \"PSF\")
  ...
  - change to \"Python Software Foundation\", even if it wraps (AMK changed \"PSF\" to \"FOUNDATION\", which is better, but still not clear IMO; could be confused with \"foundation classes\" etc.)
