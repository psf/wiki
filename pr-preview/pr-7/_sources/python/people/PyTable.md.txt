...
- An SQL abstraction mechanism: unlike [PyDO](../archive/PyDO) no attempt is made to define a common SQL sub-set, i.e. it\'s not like ADO from Microsoft
