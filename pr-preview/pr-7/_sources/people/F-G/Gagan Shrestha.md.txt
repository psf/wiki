...
1\. Save both \"[GuessTheWord](./GuessTheWord.html).py\" and \"questions.txt\" files in the same location. 2. Edit \"questions.txt\" file to include your guess word followed by the cue in the very next line. Some samples are already in their. 3. In the command prompt, run \'python [GuessTheWord](./GuessTheWord.html).py\"

[GuessTheWord.py](attachments/GaganShrestha/GuessTheWord.py)

[questions.txt](attachments/GaganShrestha/questions.txt)
