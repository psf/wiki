...
Sprint participants, meet the other sprint participants. ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
...
\- [http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/I18nFormatLocaleSupport](http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/I18nFormatLocaleSupport){.http}

\- [http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/ZPTInternationalizationSupport](http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/ZPTInternationalizationSupport){.http}

\- [http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/UnicodeForText](http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/UnicodeForText){.http}

\- [http://www.python.org/dev/doc/devel/lib/module-gettext.html](http://www.python.org/dev/doc/devel/lib/module-gettext.html){.http}
...
- I18n facilities. We\'ll probably build on an existing \"job board\" application. Write a tutorial around the sample application.

\- Implement facilities to support internationalization of strings in Zope

- schema and zope configuration markup language.
