...
Guido\'s keynote online at [http://www.python.org/doc/essays/ppt/](http://www.python.org/doc/essays/ppt/){.http} (scroll to the end).
...
Paul Graham gave a keynote on the \"hundred-year language\" (his vision of the programming language people will be using a hundred years from now). The text is here: [http://www.paulgraham.com/hundred.html](http://www.paulgraham.com/hundred.html){.http} . The talk is reviewed by Ziggy in his blog: [http://use.perl.org/\~ziggy/journal/11248](http://use.perl.org/~ziggy/journal/11248){.http} See also how Paul Prescod made Paul Graham famous: [http://www.prescod.net/python/IsPythonLisp.html](http://www.prescod.net/python/IsPythonLisp.html){.http}
...
# Speakers shows the emerging conference {#Speakers_shows_the_emerging_conference}

Talk to the speakers via the ***[/Speakers](./PyConDC2003(2f)Speakers.html)*** page, where each presentation is listed

# Want to get involved? Confused by chaotic wiki web pages? {#Want_to_get_involved.3F__Confused_by_chaotic_wiki_web_pages.3F}
...
### PyCon Schedule and Floorplan {#PyCon_Schedule_and_Floorplan}
...
- I\'ve provided a wiki-based version of the preliminary schedule, with hyperlinks to the presentation descriptions. See [/Schedule](./PyConDC2003(2f)Schedule.html). \--Jeff Kunce
  ...
  I\'ve posted a (somewhat) annotated floorplan at [http://perspex.com/pycon/floorplan/pycon-space-plan.html](http://perspex.com/pycon/floorplan/pycon-space-plan.html){.http} \--[TrippLilley](./TrippLilley.html){.nonexistent}

## Topics for PyCon DC 2003 - Build Your Own Conference!!!! {#Topics_for_PyCon_DC_2003_-_Build_Your_Own_Conference.21.21.21.21}

[PyCon DC 2003](http://www.python.org/pycon/){.http} is not going to be an elitist conference. It needs your help to ensure that there is something for everybody! Matt Croydon\'s notes in [/ForCheap](./PyConDC2003(2f)ForCheap.html) might help.
...
### Birds of a Feather Sessions {#Birds_of_a_Feather_Sessions}
...
I am very interested in this \-- [jim.vickroy@noaa.gov](mailto:jim.vickroy@noaa.gov){.mailto}

See the [PyCon2004LightningTalks](./PyCon2004LightningTalks.html){.nonexistent} page for notes, presentations. \-- [fawcett@uwindsor.ca](mailto:fawcett@uwindsor.ca){.mailto}
...
- *Modules* \-- Pick a module (standard or third party) and talk it up. Go through some basic usage and perhaps some advanced tricks. This could be lots of fun and extremely informative.
  ...
  - *[reStructuredText](http://docutils.sf.net/rst.html){.http}* \-- Lightning tutorial on the markup and basic usage of the tools included with [Docutils](http://docutils.sf.net/){.http} for generating HTML pages from reST files. \-- brett
...
- [PyConGopherCentral](./PyConGopherCentral.html){.nonexistent} - we\'ll post updates for gophers here

- [PyConToDo](./PyConToDo.html){.nonexistent} - we\'re keeping track of what\'s left to do here

### Work Opportunities {#Work_Opportunities}
...
### Interested in Jython/J2EE track {#Interested_in_Jython.2FJ2EE_track}
...
*That\'s great. It\'s a long time since I studied Beans, so clearly the Jythoneers will have to put this together. Maybe you and Matt Payne \[[Payne@MattPayne.org](mailto:Payne@MattPayne.org){.mailto}\] could create a [PyConJython](PyConJython) page where the track details could be thrashed out and suitable authors could be press-ganged into submission? \-- steve*

### OpenSpace Track {#OpenSpace_Track}
...
Agile Universe in Chicago ran an [OpenSpace](OpenSpace) track and it was exciting and well attended [http://www.xpuniverse.com/openSpace](http://www.xpuniverse.com/openSpace){.http}. It is a straight forward way to get greater participation by all attendees. It is somewhat like BOF sessions but more dynamic and collaborative, with people negotiating slot times and combining/dividing talks. It has been called the XP of conference organization. One surprising result was that there were more testers in attendance than anyone expected, they essentially set up their own testing track in [OpenSpace](OpenSpace).

I have facilitated many training events and would be happy to facilitate such a track if people were interested. [BobPayne](./BobPayne.html){.nonexistent} \[[bobpayne@webdc.com](mailto:bobpayne@webdc.com){.mailto}\]

### Background {#Background}

The first annual Python community conference was [PyCon DC 2003](http://www.pycon.org/pastevents/dc2003){.http}, held at George Washington University\'s Cafritz Conference Center in Washington DC, from 26-28 March 2003. The major theme of the conference was ***Popularizing Python*** and it was a great success! A two-day \"sprint\" event was held before the conference with several teams working on different projects including the Python core, Twisted, Zope 3, and others.
:::
