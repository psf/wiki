...
# Preparation Stage {#Preparation_Stage}
...
This proposal is still being designed. Please send comments to [ml@cs.toronto.edu](mailto:ml@cs.toronto.edu){.mailto}, or add below

------------------------------------------------------------------------

*Hope I\'m not taking too much of a liberty by putting this proposal here. \--[ChrisAkre](./ChrisAkre.html){.nonexistent}*
