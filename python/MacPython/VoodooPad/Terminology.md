...
- **application.getURL(\...)** \-- Open a [FileMaker](./FileMaker.html){.nonexistent} Pro database using a URL specification\

  - *Text* \-- The URL specification for the [FileMaker](./FileMaker.html){.nonexistent} Pro database in the form \"FMP5://\[host\]/filename\"\
    Result: *None*
...
- **application.begin_transaction()** \-- Begin a transaction\
  ...
  **application.do_script(\...)** \-- Execute a script\
  ...
  - *Text* \-- The name or specifier of the [FileMaker](./FileMaker.html){.nonexistent} script to be executed\
...
- **application** \-- The application
  ...
  **window** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro document window
  ...
  **document** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro document
  ...
  **database** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro database
  ...
  **[FileMaker](./FileMaker.html){.nonexistent}\_script** \-- A [FileMaker](./FileMaker.html){.nonexistent} script

  - Properties:
    - **best_type** (r/o) *Type* \-- The best descriptor type\
      **class\_** (r/o) *Type* \-- The class\
      **default_type** (r/o) *Type* \-- The default descriptor type\
      **name** (r/o) *[IntlText](./IntlText.html){.nonexistent}* \-- The name of the [FileMaker](./FileMaker.html){.nonexistent} Script\
      **ID** (r/o) *[LongFloat](./LongFloat.html){.nonexistent}* \-- The unique ID of the [FileMaker](./FileMaker.html){.nonexistent} Script\

  **layout** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro layout
  ...
  - Properties:
    - **best_type** (r/o) *Type* \-- The best descriptor type\
      ...
      **kind** (r/o) *k.table \| k.view* \-- The kind of layout (View = [FileMaker](./FileMaker.html){.nonexistent} Pro layout, table = all fields i.e. layout 0)\
  ...
  **field** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro field
  ...
  **record** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro record
...
## FileMaker Suite {#FileMaker_Suite}
...
- **reference.go_to()** \-- Go to an object\
  ...
  **reference.find()** \-- Perform a [FileMaker](./FileMaker.html){.nonexistent} Pro Find given current requests\

  - Result: *None*

  **application.get_remote_URL()** \-- Opens a hosted [FileMaker](./FileMaker.html){.nonexistent} Pro database\

  - Result: *Text* \-- The URL specification for the opened database in the form \"FMP5://\[host\]/filename\"

### Classes {#Classes-1}

- **request** \-- A [FileMaker](./FileMaker.html){.nonexistent} Pro find request
