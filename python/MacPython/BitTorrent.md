...
***[BitTorrent](./BitTorrent.html){.nonexistent}*** is a peer-to-peer (P2P) file distribution tool written by Bram Cohen.
...
Official site: [http://bitconjurer.org/BitTorrent/](http://bitconjurer.org/BitTorrent/){.http}

More information (en español) available here: [AyudaBitTorrent](http://www.ayudabittorrent.com){.http}
:::
