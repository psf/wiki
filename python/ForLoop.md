...
## When do I use for loops {#When_do_I_use_for_loops}
...
## How do they work? {#How_do_they_work.3F}
...
- [Python.org docs](https://docs.python.org/3/tutorial/controlflow.html#for-statements){.https}

- [Python for loop and while loop](https://python.land/introduction-to-python/python-for-loop){.https} tutorial with interactive code examples
:::
