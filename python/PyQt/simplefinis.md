...
## \"Simple Finished\" {#A.22Simple_Finished.22}
...
- Download and expand the tar ball **\"simple0.1.00.tar.gz\"** from [http://akabaila.pcug.org.au/data_sample/](http://akabaila.pcug.org.au/data_sample/){.http} It has the required resource files.
...
### \"Simple\" Finished {#A.22Simple.22_Finished}
...
#### Image of \"Simple\" {#Image_of_.22Simple.22}

![editor0.1.00.png](attachments/PyQt(2f)simplefinis/editor0.1.00.png "editor0.1.00.png"){.attachment align="middle"}

#### Program Listing of \"Simple\" {#Program_Listing_of_.22Simple.22}

:::: {.highlight .python}
::: {.codearea dir="ltr" lang="en"}
``` {#CA-0374e944f6a124c467878c1c0eecd65c282b4529 dir="ltr" lang="en"}
