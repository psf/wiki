...
# Modifying a standard Qt image plugin {#Modifying_a_standard_Qt_image_plugin}
...
3.  Apply the [set of patches](attachments/PyQt(2f)Modifying_a_standard_Qt_image_plugin/tiff_ccitt.patches "set of patches"){.attachment} to the files in that directory, typically by entering the directory at the command line and typing
