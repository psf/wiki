...
# Where you can get the PythonCd on the internet {#Where_you_can_get_the_PythonCd_on_the_internet}

- [ftp://ftp.uni-erlangen.de/pub/Linux/LOCAL/PythonCD/](ftp://ftp.uni-erlangen.de/pub/Linux/LOCAL/PythonCD/){.ftp} (Germany, primary site)

- [ftp://ftp.uni-stuttgart.de/pub/mirror/ftp.uni-erlangen.de/pub/Linux/PythonCD/](ftp://ftp.uni-stuttgart.de/pub/mirror/ftp.uni-erlangen.de/pub/Linux/PythonCD/){.ftp} (Germany)
...
# Checking integrity of the ISO image {#Checking_integrity_of_the_ISO_image}
...
![/!\\](/wiki/europython/img/alert.png "/!\"){height="16" width="16"} Do not master a fresh data CD containing the ISO file as a regular data file, this is wrong and won\'t boot nor work as intended in any other way.

# Booting from the CD {#Booting_from_the_CD}

![/!\\](/wiki/europython/img/alert.png "/!\"){height="16" width="16"} You maybe have to enter your PC\'s BIOS and change **Boot sequence** to **CDROM,C,A** (or something similar) to make your PC boot from a bootable CD before trying to boot from hard disk.
