...
# 1. Packaging Sprint 2/3 April 2011 {#Packaging_Sprint_2.2F3_April_2011}
...
- ![(./)](/wiki/europython/img/checkmark.png "(./)"){height="16" width="16"} remove all distutils2 occurrences and replace them with packaging.

- ![(./)](/wiki/europython/img/checkmark.png "(./)"){height="16" width="16"} fix some spelling and grammar errors

- ![\<!\>](/wiki/europython/img/attention.png "<!>"){height="16" width="16"} make docs conform to the python documentation style guide (%50)

- ![\<!\>](/wiki/europython/img/attention.png "<!>"){height="16" width="16"} clean up Sphinx syntax and reStructuredText usage (%50)

- ![(./)](/wiki/europython/img/checkmark.png "(./)"){height="16" width="16"} fix Sphinx errors and warnings

- ![(./)](/wiki/europython/img/checkmark.png "(./)"){height="16" width="16"} start to re-work the doc that lives outside the packaging folder, that refers to installing/building stuff

- ![(./)](/wiki/europython/img/checkmark.png "(./)"){height="16" width="16"} reorganize the doc into sections:
...
### 1.4.1. Hg repository {#Hg_repository}

hg clone [https://bitbucket.org/tarek/cpython](https://bitbucket.org/tarek/cpython){.https} Most work will take place under the cpython/Doc/packaging/ directory.

### 1.4.2. Markup and doc generation {#Markup_and_doc_generation}

Docs are written using reStructuredText markup and auto-generated using Sphinx.

- [Sphinx](http://sphinx.pocoo.org/){.http}

- [reStructuredText](http://docutils.sourceforge.net/rst.html){.http}
...
## 1.7. Sprint Report Day 1 {#Sprint_Report_Day_1}
...
### 1.7.1. Major Changes {#Major_Changes}
...
## 1.8. Sprint Report Day 2 {#Sprint_Report_Day_2}
...
### 1.8.1. Major Changes {#Major_Changes-1}
