...
It is not (and will never be) a full featured IDE, but simply a \"designer\": the generated code does nothing apart from displaying the created widgets. If you are looking for a complete IDE, maybe [BoaConstructor](BoaConstructor) or [PythonCard](./PythonCard.html){.nonexistent} is the right tool.

Project website: [http://wxglade.sourceforge.net/](http://wxglade.sourceforge.net/){.http}
:::
