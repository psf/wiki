...
Pyjamas\' underlying widget set is very similar in concept to that of [KiWi](http://www.async.com.br/projects/kiwi){.http}, with the difference being that it targets the Web rather than Desktop. If you want your Pyjamas application to run on the desktop, you can - unmodified! - using [PyjamasDesktop](PyjamasDesktop).
...
Pyjamas was originally a port of [Google Web Toolkit](http://code.google.com/gwt){.http}, to python.

Information on Pyjamas is available here:

- [http://pyjs.org](http://pyjs.org){.http}

- [https://github.com/pyjs/pyjs](https://github.com/pyjs/pyjs){.https}

- [http://groups.google.com/group/pyjamas-dev](http://groups.google.com/group/pyjamas-dev){.http}
