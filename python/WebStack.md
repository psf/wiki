...
:   [https://pypi.python.org/pypi/WebStack](https://pypi.python.org/pypi/WebStack){.https} (Google group: [webstack-discuss](http://groups.google.com/group/webstack-discuss){.http})
...
WebStack leaves the issue of resource presentation to higher-level frameworks and applications (such as [XSLTools](http://www.python.org/pypi/XSLTools){.http}).
