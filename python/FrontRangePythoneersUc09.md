...
# FRUncon 09: Front Range Pythoneers Unconference 2009 {#FRUncon_09:_Front_Range_Pythoneers_Unconference_2009}
...
Day 2 [CodeJam](./CodeJam.html){.nonexistent} Sun Oct 11
...
(Registered: [http://tagal.us/tag/fruncon09](http://tagal.us/tag/fruncon09){.http} )
...
- Uche Ogbuji lives in Superior, CO and works for zepheira.com. Fuller bio: [http://wiki.python.org/moin/UcheOgbuji](http://wiki.python.org/moin/UcheOgbuji){.http} . I\'ll be back from 2 weeks in Europe Oct 8th and am not sure to what extent I can help, but I will try to do what I can. Can\'t make it till about 12:30 :/

- Jim Baker, core committer on Jython and leader of the Front Range Pythoneers, [jbaker@zyasoft.com](mailto:jbaker@zyasoft.com){.mailto}.
...
- \* Slides here: [http://gonzaga.akara.info/\~uogbuji/etc/2009/akara-frpycon09.pdf](http://gonzaga.akara.info/~uogbuji/etc/2009/akara-frpycon09.pdf){.http} (Note: includes promised simplification in last code slide)
...
- Flappserver \-- the Foolscap Application Server: a convenient, secure \"remote button\" [http://foolscap.lothar.com/docs/flappserver.html](http://foolscap.lothar.com/docs/flappserver.html){.http}
...
If you are wishing to attend the unconfrence. We do ask that if you would please RSVP on the Meetup site @ [http://www.meetup.com/frpythoneers/calendar/11167624/](http://www.meetup.com/frpythoneers/calendar/11167624/){.http}
...
#### Relational Database Applications NOW! with TurboGears {#Relational_Database_Applications_NOW.21_with_TurboGears}

This tutorial is intended to be an un-tutorial. The idea is simple. Bring me a public database, (or 4) and share with the class as we explore the new admin-level RESTful features that [TurboGears2](./TurboGears2.html){.nonexistent} employs.
...
- Modify the TG code to replace the default TG [AdminConfig](./AdminConfig.html){.nonexistent} with A customizable one. (10 mins)

- See where the class would like to customize their admin, following necessary parts of:
  - [http://turbogears.org/2.0/docs/main/Extensions/Admin/index.html](http://turbogears.org/2.0/docs/main/Extensions/Admin/index.html){.http}

  - [http://www.sprox.org/tutorials/table.html](http://www.sprox.org/tutorials/table.html){.http}

  - [http://www.sprox.org/tutorials/form.html](http://www.sprox.org/tutorials/form.html){.http}
...
If we need extra filler at the end (not likely), or, if people want to meet after the afternoon session, I will have a mini-tutorial for [BootAlchemy](./BootAlchemy.html){.nonexistent}. [BootAlchemy](./BootAlchemy.html){.nonexistent} allows people to load Yaml files directly into a relational database.
