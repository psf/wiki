...
- [MvMac](./MvMac.html)(1) - A metadata and fork aware mv tool, but doesn\'t work across volumes/filesystems yet

- [CpMac](./CpMac.html)(1) - A metadata and fork aware cp tool

- [DeRez](./DeRez.html)(1) - decompiles a resource fork into a textual description
