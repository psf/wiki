...
[/PyObjC](./MacPython(2f)PyObjC(2f)PyObjC.html) 1.1 was released 2004-05-30.

The latest version of [/PyObjC](./MacPython(2f)PyObjC(2f)PyObjC.html) can always be retrieved from the subversion repository at [http://svn.red-bean.com/pyobjc](http://svn.red-bean.com/pyobjc)

## links

[http://pyobjc.sourceforge.net/](http://pyobjc.sourceforge.net/)

Some [notes](./LtrWiki(3a)StartCocoa.html) on starting [\"Cocoa\"](http://developer.apple.com/cocoa) programming with [/PyObjC](./MacPython(2f)PyObjC(2f)PyObjC.html) from a (Mac)Python programmer\'s perspective.
