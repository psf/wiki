...
NodeBox is a Mac OS X application that lets you create 2D visuals (static, animated or interactive) using Python and export them as a PDF or [QuickTime](./QuickTime.html){.nonexistent} movie.

[nodebox.net](http://nodebox.net/){.http}
