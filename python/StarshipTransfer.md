...
# Starship Python has Moved! {#Starship_Python_has_Moved.21}
...
If you\'re a Starship admin, feel free to update this page. Otherwise, please email [webmaster@python.net](mailto:webmaster@python.net){.mailto} if you want to add stuff to our to-do list.

## Tasks for old Starship {#Tasks_for_old_Starship}
...
## Tasks for new Starship {#Tasks_for_new_Starship}
...
- give the machine a proper hostname
  ...
  \
  (will have to be in python2.net domain for now; once DNS service is transferred to a new provider, we can give it a python.net name \-- anything but starship.python.net, of course!) Proposed proper hostname: drydock.python2.net ![;)](/wiki/europython/img/smile4.png ";)"){height="16" width="16"}\
...
- web services
  ...
  - install, configure, and test Zope (**not** critical path)\
    (Zope 2.7 preferable; (really?) note that Debian testing has Zope 2.6.1 and a working plone on top ![;)](/wiki/europython/img/smile4.png ";)"){height="16" width="16"} )\
...
- compare /etc/{passwd,group,shadow} and friends on both ships, evaluate migration strategy of credential data (**critical path**)\
  ...
  \[done: gward ![;)](/wiki/europython/img/smile4.png ";)"){height="16" width="16"} \]

## Tasks for python.net DNS {#Tasks_for_python.net_DNS}
...
## Detailed transfer plan {#Detailed_transfer_plan}
