...
The first dojo will held in the [ABC Treehouse in Amsterdam](http://www.treehouse.abc.nl/index.php?page=location){.http}, on the 21th of April at 19:30, until about 22:00.
...
[presentation.pdf](attachments/Dojo(2d)NL(2f)dojo210410/presentation.pdf){.attachment}
...
[marijn_guyon_tdd_dojo.py](attachments/Dojo(2d)NL(2f)dojo210410/marijn_guyon_tdd_dojo.py){.attachment}

[konrad_todd_tdd_dojo.py](attachments/Dojo(2d)NL(2f)dojo210410/konrad_todd_tdd_dojo.py){.attachment}

[todd_gijs_reversi.py](attachments/Dojo(2d)NL(2f)dojo210410/todd_gijs_reversi.py){.attachment}

[todd_gijs_test.py](attachments/Dojo(2d)NL(2f)dojo210410/todd_gijs_test.py){.attachment}
...
- [Guyon Morée](http://www.gumuz.nl){.http}
...
- [André van der Vlies](mailto:andre@vandervlies.xs4all.nl){.mailto}
:::
