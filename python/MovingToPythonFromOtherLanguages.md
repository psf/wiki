...
- [Eric S. Raymond \'Why Python?\'](https://www.linuxjournal.com/article/3882){.https}
...
## Where is Python\'s CPAN? {#Where_is_Python.27s_CPAN.3F}

See the [Python Package Index (PYPI)](http://www.python.org/pypi){.http}, Python\'s centralised database of software. Any developer of Python software packaged using distutils (the built-in packaging system) may easily submit their package information to the index.

Before PYPI, Pythonistas contributed code to [The Vaults of Parnassus](http://www.vex.net/parnassus){.http}. Unfortunately, the Vaults are not standardized or automated to the degree that the CPAN is, and the site now appears to be inactive. All hail its many useful years of service.

## Python PEP 8: Style Guide for Python Code {#Python_PEP_8:_Style_Guide_for_Python_Code}

[Style Guide for Python Code](http://www.python.org/peps/pep-0008.html){.http}
...
## Tips for \"Thinking in Python\" {#Tips_for_.22Thinking_in_Python.22}

(The phrase *Thinking in Python* was borrowed from [a book Bruce Eckel was writing](http://www.mindview.net/Books/Python/ThinkingInPython.html){.http} of the same name. The book was not meant for beginners to Python, however. It is the Python equivalent of Bruce Eckel\'s popular *Thinking in C++* and *Thinking in Java*)

- *Thinking in Python* is completely different from *Thinking in C++/Java*. It\'s adapted from Eckel\'s draft for *Thinking in Patterns*, a bit like the [DesignPatternsBook](http://c2.com/cgi/wiki?DesignPatternsBook "Wiki"){.interwiki} by the [GangOfFour](http://c2.com/cgi/wiki?GangOfFour "Wiki"){.interwiki}.
...
- Hidden under the docs for \'Other Types\' are the descriptions of all the file methods. There are no iostreams per se, but the class method [str]{.u} can get some of the effect for your own classes, and there are surely other angles I haven\'t thought of.
...
- For reference the [Module Index](https://docs.python.org/3/py-modindex.html){.https} of the Python docs are generally sufficient.

## Python Culture {#Python_Culture}

- [Python Culture (Tim Peters channeling Guido)](http://www.python.org/dev/culture/){.http}
