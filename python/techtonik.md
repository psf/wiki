...
- prematurely closed: [https://github.com/pypa/pip/issues/2409](https://github.com/pypa/pip/issues/2409){.https}

### Python wishlist {#Python_wishlist}
...
- `-*- coding -*-`{.backtick} header [is not used as default encoding](http://bugs.python.org/issue17439){.http} when transforming string literals in the source file
...
- real-time activity feed for [http://bugs.python.org/](http://bugs.python.org/){.http}
...
- monthly mailing list FAQ (status) posts on busy mailing lists [.](https://mail.python.org/pipermail/distutils-sig/2010-March/015907.html){.https}
...
- reduce formalism on [who can participate](http://mail.python.org/pipermail/python-dev/2012-December/123231.html){.http}

- accept edits as patches ([create online editor](https://code.google.com/p/pydotorg/source/browse/?repo=doceditor){.https})
...
### Component wishlist {#Component_wishlist}

Public domain or MIT preferred.

- [wikify](https://bitbucket.org/techtonik/wikify){.https} - micro-framework for text wikification (easy to extend and debug) ([1](http://issues.roundup-tracker.org/msg4572){.http}, [2](http://psf.upfronthosting.co.za/roundup/meta/msg2666){.http})
...
### Ideas open for the taking {#Ideas_open_for_the_taking}
...
- Logo for [web.py](http://webpy.org/){.http}

GSoC/Help needed for tools that support Python development:

- complete module-2-source tree map at [https://bitbucket.org/techtonik/python-stdlib](https://bitbucket.org/techtonik/python-stdlib){.https}
...
### steAm and SMArt (dealing with complexity) {#steAm_and_SMArt_.28dealing_with_complexity.29}

Canvas2D ideas:

- redo \*key status script\* for PySDL2, pyprocessing and (maybe) pyglet

- [http://devinvenable.blogspot.com/2009/12/creating-digital-synth-sounds-using.html](http://devinvenable.blogspot.com/2009/12/creating-digital-synth-sounds-using.html){.http}

- [http://devinvenable.blogspot.com/2010/07/opengl-intellivision-man.html](http://devinvenable.blogspot.com/2010/07/opengl-intellivision-man.html){.http}

Dynamic data visualization examples:

- [http://www.fudgie.org/](http://www.fudgie.org/){.http}

- [https://code.google.com/p/logstalgia/](https://code.google.com/p/logstalgia/){.https}

### Human Language Translation Table {#Human_Language_Translation_Table}
