...
::: {#about-the-idea .section}
### About the idea

[Original blog post](http://catherinedevlin.blogspot.com/2009/06/python-for-secretaries.html){.http .reference .external} on the idea
...
- [ResolverOne](http://www.resolversystems.com/){.http .reference .external}
- [Blaze](http://ironpython-urls.blogspot.com/2009/09/blaze-automated-desktop-experience.html){.http .reference .external}
:::

::: {#common-automation-tasks .section}
...
::: {#useful-packages .section}
### Useful Packages

[http://timgolden.me.uk/python/active_directory.html](http://timgolden.me.uk/python/active_directory.html){.http .reference .external}

[http://github.com/mikemaccana/python-docx](http://github.com/mikemaccana/python-docx){.http .reference .external}
:::

::: {#sources-of-teaching-material .section}
### Sources of teaching material

[Working with Excel Files in Python](http://www.europython.eu/talks/talk_abstracts/index.html#talk91){.http .reference .external}

[Python and Microsoft Office](http://www.blog.pythonlibrary.org/2010/07/16/python-and-microsoft-office-using-pywin32/){.http .reference .external}

[http://www.blog.pythonlibrary.org/2010/02/14/python-windows-and-printers/](http://www.blog.pythonlibrary.org/2010/02/14/python-windows-and-printers/){.http .reference .external}

[http://www.python-excel.org/](http://www.python-excel.org/){.http .reference .external}
:::
:::::::::
