...
- For up to date user focused documentation, refer to the Python Packaging User Guide: [https://packaging.python.org](https://packaging.python.org){.https}

- For more details on the Python Packaging Authority, its goals, and current activities: [https://www.pypa.io](https://www.pypa.io){.https}
...
## Historical distutils2 focused content {#Historical_distutils2_focused_content}
...
### Past distutils2 work {#Past_distutils2_work}
...
### Learning Distutils {#Learning_Distutils}

#### Documentation {#Documentation}

- [distutils --- Building and installing Python modules](http://docs.python.org/library/distutils.html){.http}

  - [Distributing Python Modules](http://docs.python.org/distutils/){.http} - information for developers

  - [Installing Python Modules](http://docs.python.org/install/){.http} - information for users and system administrators

- [distutils SIG](http://www.python.org/sigs/distutils-sig/){.http}

- [PyPI\'s XML-RPC interface](http://wiki.python.org/moin/PyPiXmlRpc){.http} for querying the packages database
