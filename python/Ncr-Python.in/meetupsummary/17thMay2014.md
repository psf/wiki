# Ncr-Python.in/meetupsummary/17thMay2014

::: {#content dir="ltr" lang="en"}
We started of with:

- Interaction with a team lead by **Dr Victor Udoewa** from Google\'s [http://www.webacademy.com/splash/](http://www.webacademy.com/splash/){.http} project who would be \" using the insights in order to create a curriculum on digital literacy\"
...
- In his talk he showed us a video how digital literacy can be helpful very inspiring link [http://www.youtube.com/watch?v=OE63BYWdqC4](http://www.youtube.com/watch?v=OE63BYWdqC4){.http}
...
- [http://en.wikipedia.org/wiki/Currying](http://en.wikipedia.org/wiki/Currying){.http}

- [http://pydanny.com/python-partials-are-fun.html](http://pydanny.com/python-partials-are-fun.html){.http}

*Tail Recursion*

- [http://en.wikipedia.org/wiki/Tail_call](http://en.wikipedia.org/wiki/Tail_call){.http}

- [http://oldfashionedsoftware.com/2008/09/27/tail-recursion-basics-in-scala/](http://oldfashionedsoftware.com/2008/09/27/tail-recursion-basics-in-scala/){.http}
...
- [http://docs.python.org/2/library/functools.html](http://docs.python.org/2/library/functools.html){.http}

Guys so if you want to be informed about stuff like this go register @ [https://mail.python.org/mailman/listinfo/ncr-python.in](https://mail.python.org/mailman/listinfo/ncr-python.in){.https}

Next was Aniket Maithani who is doing a project using Pi board named HASS:

- *Home Automation & Security System \[HASS\] is a full fledged home automation system which will be economically viable for the user to adapt. The cross platform type of the application will enable user to get alerts on the go irrespective of the type of phone/system a user uses. The application would be released under GPL License. \--Taken from the documentation found* @ [http://aniketmaithani.github.io/HASS/](http://aniketmaithani.github.io/HASS/){.http}

He is open to suggestion and discussioin about the project improvement and other ideas related to it. So don\'t hesitate and find him on [https://github.com/aniketmaithani](https://github.com/aniketmaithani){.https} also a member of the mailing list.
