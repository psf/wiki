...
wxPython is a blending of the [WxWidgets](WxWidgets) (formerly [WxWindows](WxWindows)) class library for C++ and Python. wxPython can be found at (surprise!) [http://www.wxpython.org/](http://www.wxpython.org/) and it has its own wiki there: [http://wiki.wxpython.org/](http://wiki.wxpython.org/). wxPython Guide is a thorough tutorial on wxPython toolkit. It can be found on [zetcode.com](http://www.zetcode.com/wxpython)
