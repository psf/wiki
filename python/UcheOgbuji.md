...
## Uche Ogbuji {#Uche_Ogbuji}

Email: `<uche AT SPAMFREE ogbuji DOT net>`
...
- [http://bitbucket.org/uche/scatter-share/](http://bitbucket.org/uche/scatter-share/){.http}

- [http://bitbucket.org/uche/amara/](http://bitbucket.org/uche/amara/){.http}

- [http://bitbucket.org/uche/akara/](http://bitbucket.org/uche/akara/){.http}

### A bit corporate. Needs editing for soul {#A_bit_corporate._Needs_editing_for_soul}

I\'m a founding partner at [Zepheira](http://Zepheira.com){.http} which provides solutions to effectively integrate, navigate and manage information across boundaries of person, group and enterprise. In effect Zepheira provides architecture, software prototypes and mentoring to combine Semantic Technology and RESTful Web services.
...
I studied studied Electronic Engineering at [The University of Nigeria at Nsukka](http://en.wikipedia.org/wiki/University_of_Nigeria){.http}, and earned my B.Sc. in Computer Engineering at the [Milwaukee School of Engineering](http://en.wikipedia.org/wiki/Milwaukee_School_of_Engineering){.http}.
