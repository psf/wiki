...
::: {}
  ...
  Homepage   [http://livingcode.org/](http://livingcode.org/)
  Weblog     [http://livingcode.org/](http://livingcode.org/)
  ---------- ---------------------------------------------------------
:::
...
- Game framework in [PyGame](PyGame) to make it easier and faster to develop games, including:
  ...
  - [BoggleTrainer](./BoggleTrainer.html), a port of Boggle which \"solves\" puzzle, makes spelling suggestions, and looks up definitions of words, gives hints, etc. to help with kids\' spelling and vocabulary

  - [GoMoku](./GoMoku.html), playable now, needs some tweaks

  - Kutia, a Logo-like turtle-graphics tool to explain programming

  - Quipu, a hex-based path game

- PyObjC clone of [Oblique Strategies](http://www.curvedspace.org/software/oblique.html) so I can add my other quotes and also to learn [PyObjC](./PyObjC.html)
