...
Email: `<TerriOda AT gmail DOT com>`
...
There is a list of projects here: [http://wiki.python.org/moin/SummerOfCode](http://wiki.python.org/moin/SummerOfCode)
...
If you are not sure who to contact for any reason, you should be asking on the soc general mailing list. You can subscribe to this here: [http://mail.python.org/mailman/listinfo/gsoc-general/](http://mail.python.org/mailman/listinfo/gsoc-general/)

You can also make use of our irc channel #python-gsoc on [Freenode](http://freenode.net/). Do be aware that mentors can be busy/asleep, so you may have to be patient! You can always send an email to the mailing list if you don\'t have time to stay on IRC.
