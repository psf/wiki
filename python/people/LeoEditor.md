...
- [Fully scriptable](http://webpages.charter.net/edreamleo/scripting.html) using Python. Leo\'s core is 100% pure Python

- Plays well with others:
  - there\'s an [ipython bridge](http://webpages.charter.net/edreamleo/IPythonBridge.html),

  - an [emacs leo](http://webpages.charter.net/edreamleo/emacs.html) \'server\',

  - you can use [vim key bindings](http://webpages.charter.net/edreamleo/vimBindings.html),

  - and [embed leo](http://webpages.charter.net/edreamleo/leoBridge.html) in another program.
