...
- [PlayerPiano](http://playerpiano.googlecode.com/): tool for giving better presentations using an interactive shell

- [Twiggy](http://python-twiggy.googlecode.com/): a more Pythonic logger

- [Factory](http://pypi.python.org/pypi/Factory/): object-oriented approach to partial function application (currying)

- [More Python Software](http://i.wearpants.org/software)
...
[My Python Resume](http://i.wearpants.org)

## Education 

### Continuing 

[David Beazley](http://www.dabeaz.com)\'s small, intense classes explore advanced programming techniques and the inner workings of Python.
