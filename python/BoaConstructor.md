...
The project released through [SourceForge](https://boa-constructor.sourceforge.net){.https}, but that has been inactive since 2007. A successor project on [GitHub](https://github.com/ianBBB/boa-constructor){.https} aims to update to Python 3 and newer wxPython.
