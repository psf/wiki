...
# Welcome to Pydotorg Central {#Welcome_to_Pydotorg_Central}
...
To build and run the site, see [build/README](https://svn.python.org/www/trunk/beta.python.org/build/README){.https} in the checked-out beta.python.org tree.

You can monitor the build status on the [status page](http://www.python.org/status/){.http}.

For extra information, see [PythonWebsiteDetails](PythonWebsiteDetails)

## How Can I Help? {#How_Can_I_Help.3F}
...
Chat/help on IRC at [#pydotorg](irc://freenode.net/pydotorg){.irc} on freenode.net
