...
The [Columbus Public Library](http://www.columbuslibrary.org/){.http} has been selected as the venue for [PyOhio](PyOhio) 2008.
...
# Venue Considerations {#Venue_Considerations}
...
- Ohio Supercomputing Center
  - They did, after all, put this on: [http://www.osc.edu/press/releases/2007/python.shtml](http://www.osc.edu/press/releases/2007/python.shtml){.http}
...
- Library
  - The Columbus Public Library has a very generous policy on letting groups meet: [http://evanced.columbuslibrary.org/evanced/lib/roomrequest.asp](http://evanced.columbuslibrary.org/evanced/lib/roomrequest.asp){.http}
...
- [OCLC](http://www.oclc.org/conferencecenter/default.htm){.http}
