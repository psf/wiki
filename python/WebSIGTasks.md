...
Bill Janssen has suggested reviving the Web SIG: [http://mail.python.org/pipermail/meta-sig/2003-September/001277.html](http://mail.python.org/pipermail/meta-sig/2003-September/001277.html){.http}

Possible deliverables:

# SSL server support {#SSL_server_support}
...
[http://pyopenssl.sourceforge.net/](http://pyopenssl.sourceforge.net/){.http} and [http://www.post1.com/home/ngps/m2/](http://www.post1.com/home/ngps/m2/){.http} are more complete wrappers.

# HTTP client updates {#HTTP_client_updates}
...
# HTTP server improvements {#HTTP_server_improvements}
...
# cgi module improvements {#cgi_module_improvements}
...
# Add request/response objects to standard library {#Add_request.2Fresponse_objects_to_standard_library}

This has been brought up on the [pyweb mailing list](http://www.amk.ca/pipermail/pyweb/){.http}.
