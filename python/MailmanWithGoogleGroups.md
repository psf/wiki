...
[Mailman](http://en.wikipedia.org/wiki/GNU_Mailman){.http} is a piece of software by Barry Warsaw that runs all \@python.org mailing lists. It is a good product, but there is a major flaw with it - in the era of web technologies, it doesn\'t have the web interface that conforms to the modern standard of usability.
