...
# PySoy Ideas for GSoC 2011 {#PySoy_Ideas_for_GSoC_2011}
...
## Texture Manipulation {#Texture_Manipulation}
...
## Volume and Surface {#Volume_and_Surface}
...
## Gyro Controller Input {#Gyro_Controller_Input}

Write one or more new controller classes that take input from various gyro controllers, from [WiiMotes](./WiiMotes.html){.nonexistent} to Android phones. Most of these devices require working with bluetooth.
