...
## My week-by-week work plan: {#My_week-by-week_work_plan:}
...
# Start of Program (May 24) {#Start_of_Program_.28May_24.29}
...
# Midterm Evaluation (July 12) {#Midterm_Evaluation_.28July_12.29}
...
# Final Evaluation (Aug 16) {#Final_Evaluation_.28Aug_16.29}
...
b.  Blog: [http://higery.wordpress.com/](http://higery.wordpress.com/){.http}
