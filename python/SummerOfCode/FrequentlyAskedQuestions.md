...
1.  [Where do I start?](#Where_do_I_start.3F)
2.  [How do I choose a project or a sub-org?](#How_do_I_choose_a_project_or_a_sub-org.3F)
3.  [What does \"don\'t ask to ask\" mean?](#What_does_.22don.27t_ask_to_ask.22_mean.3F)
4.  [What should I do if no one answers my question?](#What_should_I_do_if_no_one_answers_my_question.3F)
5.  [How should I address my emails (or Why shouldn\'t I start my emails with \"Dear Sir\")?](#How_should_I_address_my_emails_.28or_Why_shouldn.27t_I_start_my_emails_with_.22Dear_Sir.22.29.3F)
6.  [Why does Meflin always say no?](#Why_does_Meflin_always_say_no.3F)
7.  [What do I need to know to participate in Summer of Code with Python?](#What_do_I_need_to_know_to_participate_in_Summer_of_Code_with_Python.3F)
8.  [How many slots does python get? How many does project \$x get?](#How_many_slots_does_python_get.3F__How_many_does_project_.24x_get.3F)
9.  [What does it take to be a mentor?](#What_does_it_take_to_be_a_mentor.3F)
:::

# Where do I start? {#Where_do_I_start.3F}

1.  **Choose an organization to work with.** Python has a lot of sub-orgs (In recent years, around 20-25 is normal), so this can be hard. You *do* need to choose a sub-org if you\'re working with Python; projects without a sub-org are usually rejected at selection time. See \"[How do I choose a project or a sub-org?](https://wiki.python.org/moin/SummerOfCode/FrequentlyAskedQuestions#How_do_I_choose_a_project_or_a_sub-org.3F){.https}\" if you need help.
...
4.  **Find some beginner-friendly bugs and try to fix them.** Many projects have these tagged as \"easy\" \"bite-size\" or \"beginner-friendly\"
    ...
    - Some projects have beginner-friendly \"bite-sized\" bugs listed in the [OpenHatch](./OpenHatch.html){.nonexistent} search engine, found here: [http://openhatch.org/search/](http://openhatch.org/search/){.http}
...
# How do I choose a project or a sub-org? {#How_do_I_choose_a_project_or_a_sub-org.3F}
...
# What does \"don\'t ask to ask\" mean? {#What_does_.22don.27t_ask_to_ask.22_mean.3F}
...
# What should I do if no one answers my question? {#What_should_I_do_if_no_one_answers_my_question.3F}
...
# How should I address my emails (or Why shouldn\'t I start my emails with \"Dear Sir\")? {#How_should_I_address_my_emails_.28or_Why_shouldn.27t_I_start_my_emails_with_.22Dear_Sir.22.29.3F}
...
# Why does Meflin always say no? {#Why_does_Meflin_always_say_no.3F}
...
# What do I need to know to participate in Summer of Code with Python? {#What_do_I_need_to_know_to_participate_in_Summer_of_Code_with_Python.3F}
...
- **You might like to take a bit of time to read [the python style guide, PEP8](https://www.python.org/dev/peps/pep-0008/){.https}.** Not every project uses these rules, but they can give you a rough idea of what is considered \"readable code\" by most pythonistas. (And for fun, you might want to read the poetry of [PEP20 \"The Zen of Python\"](https://www.python.org/dev/peps/pep-0020/){.https})

# How many slots does python get? How many does project \$x get? {#How_many_slots_does_python_get.3F__How_many_does_project_.24x_get.3F}
...
# What does it take to be a mentor? {#What_does_it_take_to_be_a_mentor.3F}
