...
**Contact: Tarek Ziadé \<[tarek@ziade.org](mailto:tarek@ziade.org){.mailto}\> or Alexis Métaireau \<[alexis@notmyidea.org](mailto:alexis@notmyidea.org){.mailto}\>**

PyPI has recently gained a [PubSubHubBub](./PubSubHubBub.html){.nonexistent} interface we can use to trigger events when a new package is uploaded.
...
- create a [PubSubHubBub](./PubSubHubBub.html){.nonexistent} daemon
