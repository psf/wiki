...
# 2014 Google Summer of Code Proposal Template {#A2014_Google_Summer_of_Code_Proposal_Template}
...
- Sub-organization with whom you hope to work(\*):
  ...
  (e.g. SunPy, Mercurial, etc. See [SummerOfCode/2014](./SummerOfCode(2f)2014.html) for the list of valid sub-organizations)
...
Mentors are often available on IRC, as well as the respective sub-organizations mailing lists. The mailing list for each sub-org is listed here: [SummerOfCode/2014](./SummerOfCode(2f)2014.html). As a reciprocal courtesy students are expected to also be regularly available on IRC and/or available via e-mail and reasonably responsive to questions and requests for improvements. Students are encouraged to help other students with proposals and help answer questions in IRC or the mailing lists.

If for any reason you have not been able to find a mentor who can help you with your proposal, or you have a question that you think will be relevant to more than just your sub-organization, you can direct your questions to the [soc2014-general@python.org](mailto:soc2014-general@python.org){.mailto} mailing list. You should sign up here before you post: [http://mail.python.org/mailman/listinfo/soc2014-general/](http://mail.python.org/mailman/listinfo/soc2014-general/){.http}
:::
