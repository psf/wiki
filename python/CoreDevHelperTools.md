...
# 1. Core Development Helper Tools {#Core_Development_Helper_Tools}
...
- mercurial-simpleshare - A tool for simple sharing of mercurial branches (while [\"hg serve\" or hgwebdir.cgi](http://www.selenic.com/mercurial/wiki/index.cgi/HgWebDirStepByStep#head-746ca383e3a62df34279ec2fca888113497da022){.http} fill this slot, it could be made easier, see below).
...
### 1.1.2. Roundup VCS integration {#Roundup_VCS_integration}
