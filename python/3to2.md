...
The following goals were targeted at the US [PyCon](http://us.pycon.org){.http} 2009 sprint of Python Core:
...
During the Google Summer of Code 2009, [Joe Amenta](JoeAmenta) wrote a more-or-less complete lib3to2. It is hosted on [bitbucket](http://bitbucket.org/amentajo/lib3to2){.http} and has a [PyPI page](http://pypi.python.org/pypi/3to2){.http}.
:::
