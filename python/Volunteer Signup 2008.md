...
- Swag bag stuffers
- Session Chairs: sign up for this role [on the main schedule app page](http://us.pycon.org/2008/conference/schedule/){.http .reference .external}.
- Electrical cord tapers / untapers
- Last minute helper mob

::: {#registration-desk-volunteers .section}
### Registration Desk Volunteers
...
- Sheila (shekay pobox com): Thursday PM. Available after the first two tutorial sessions. Fri/Sat AM. IM google talk: shekay irc: skay
...
- Michael Carter ([CarterMichael@gmail.com](mailto:CarterMichael@gmail.com){.mailto .reference .external}): Fri AM / whatever other time thereafter that I\'m needed
- Kumar McMillan ([kumar.mcmillan@gmail.com](mailto:kumar.mcmillan@gmail.com){.mailto .reference .external}): Thurs PM, after 1st tutorial session
- Rob Kirkpatrick ([robertk@bcgsc.ca](mailto:robertk@bcgsc.ca){.mailto .reference .external}) : Wednesday eve and beyond! (arrive at the hotel \~5:00pm)
...
- Patrick O\'Brien ([pobrien@orbtech.com](mailto:pobrien@orbtech.com){.mailto .reference .external}): Friday AM (arriving Thursday evening around 8:30)
:::

::: {#swag-bag-stuffers .section}
### Swag bag stuffers
...
- Kumar McMillan ([kumar.mcmillan@gmail.com](mailto:kumar.mcmillan@gmail.com){.mailto .reference .external}): Thursday afternoon
- Rob Kirkpatrick (see above)
- Alex Gaynor([alex.gaynor@gmail.com](mailto:alex.gaynor@gmail.com){.mailto .reference .external}): Thursday early afternoon to evening(I\'m coming for the ChiPy meeting)
- Mike Driscoll ([kyosohma@gmail.com](mailto:kyosohma@gmail.com){.mailto .reference .external}): Wednesday evening (Getting in sometime in the afternoon)
...
::: {#electrical-cord-tapers-untapers .section}
### Electrical cord tapers / untapers
...
- Sheila (see above)
- Anna Horne ([anna@happypants.org](mailto:anna@happypants.org){.mailto .reference .external}): Wednesday evening (getting in around 8:30 pm)
- Richard House (richard.house i-logue.com), Wed evening, (getting in around 18:00)
- Ed Sweeney (ed onextent com), Wed evening after 5pm, Thu after 4, Fri - Sun anytime.
:::

::: {#last-minute-helper-mob .section}
### Last minute helper mob

We\'ll probably need people here and there to help out, if we can call you or sms message you, that would be great. Sign up by following the [http://twitter.com/pyconvolunteers](http://twitter.com/pyconvolunteers){.http .reference .external} twitter channel. Calls for mob-like volunteer opportunities will go out as the need arises.

------------------------------------------------------------------------

[CategoryPyCon2008](CategoryPyCon2008){.reference .external} CategoryPyCon
:::
:::::::
