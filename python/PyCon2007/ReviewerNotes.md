...
(This page has been moved to [http://us.pycon.org/TX2007/ReviewerNotes;](http://us.pycon.org/TX2007/ReviewerNotes;){.http} the contents of this page might be outdated.)
...
Reviewers have logins on [http://us.pycon.org/apps07/proposals/](http://us.pycon.org/apps07/proposals/){.http}, just like proposal authors, and can view the list of submitted proposals. Reviewers can record comments and votes on proposals.

Proposals will be assessed using the [Identify the Champion](http://www.iam.unibe.ch/~oscar/Champion/champion.html){.http} process. Basically, reviewers vote using a +/- 1, +/- 0 scale. To be accepted, a paper must have at least one +1 vote; each person who votes +1 on a paper is a paper\'s champion.
...
Reviewers should join [the pycon-pc mailing list](http://mail.python.org/mailman/listinfo/pycon-pc/){.http}, which is for program committee discussions.
