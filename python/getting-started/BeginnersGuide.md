...
- If you have never programmed before, see [BeginnersGuide/NonProgrammers](./BeginnersGuide(2f)NonProgrammers.html) for a list of suitable tutorials.

- If you have previous programming experience, consult [BeginnersGuide/Programmers](./BeginnersGuide(2f)Programmers.html), which lists more advanced tutorials.
...
Consult [BeginnersGuide/Examples](./BeginnersGuide(2f)Examples.html) for small programs and little snippets of code that can help you learn.
