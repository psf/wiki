...
This [link](http://groups.google.com/group/comp.lang.python/browse_frm/thread/3df7b51071dbfad){.http} points to an informal comparison of distributed computing technologies, including [CORBA](CorbaPython), [XML-RPC, SOAP](WebServices), \... in *comp.lang.python*.
...
- [http://www.mindhog.net/\~mmuller/projects/dopy/](http://www.mindhog.net/~mmuller/projects/dopy/){.http}
...
- [http://fnorb.sourceforge.net/](http://fnorb.sourceforge.net/){.http}
...
- [http://www.zeroc.com/index.html](http://www.zeroc.com/index.html){.http}

  - ICE (Internet Communications Engine) is a GPL\'d CORBA-like middleware. It\'s

    simple, fast, and powerful, and in [serious production use](http://www.zeroc.com/customers.html){.http}.

  - Languages: Python, C++, Java, PHP, C#, and Visual Basic.

  - Platforms: [http://www.zeroc.com/platforms.html](http://www.zeroc.com/platforms.html){.http}

### omniORB {#omniORB}

- [http://omniorb.sourceforge.net/](http://omniorb.sourceforge.net/){.http}
...
- [http://www.dscpl.com.au/wiki/OSE](http://www.dscpl.com.au/wiki/OSE){.http}
...
- [http://irmen.home.xs4all.nl/pyro/](http://irmen.home.xs4all.nl/pyro/){.http}
...
- [http://sourceforge.net/projects/orbit-python](http://sourceforge.net/projects/orbit-python){.http}
...
- [https://github.com/ray-project/ray](https://github.com/ray-project/ray){.https}
...
- [http://rpyc.sourceforge.net/](http://rpyc.sourceforge.net/){.http}
...
- [http://www.pyscoop.org/](http://www.pyscoop.org/){.http}
...
- [http://www.python.org/other/spread/](http://www.python.org/other/spread/){.http}
...
- [http://msobczak.com/prog/yami/](http://msobczak.com/prog/yami/){.http}
