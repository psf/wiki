...
# Fixing the Changes {#Fixing_the_Changes}
...
# Preventing Future Attacks {#Preventing_Future_Attacks}
...
See [AntiSpamGlobalSolution](http://moinmo.in/AntiSpamGlobalSolution "MoinMoin"){.interwiki} for more details.
:::
