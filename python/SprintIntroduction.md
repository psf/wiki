...
# An Introduction to Sprinting {#An_Introduction_to_Sprinting}
...
Steve Holden has a good [article](http://www.onlamp.com/pub/a/python/2006/10/19/running-a-sprint.html){.http} in [O\'Reilly\'s OnLamp Python Python DevCenter](http://www.onlamp.com/python/){.http} on how to run a sprint. [This installment](http://www.unixreview.com/documents/s=10116/ur0701j/){.http} of a monthly column gives more background.

## Why sprint? {#Why_sprint.3F}

Sprints are intended to benefit a projects by getting people working in the same room and making decisions quickly. They\'re also a good opportunity to spend 4 or 8 hours concentrating on a task, and to encourage more people to take part in development. They will also be a good place to see [ExtremeProgramming](ExtremeProgramming) or other [AgileMethods](./AgileMethods.html){.nonexistent} in action, and to work closely with experienced project developers.
...
## What equipment and supplies do sprints need? {#What_equipment_and_supplies_do_sprints_need.3F}
