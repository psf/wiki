...
## Organizing Member Meetings {#Organizing_Member_Meetings}

To be filled in.

## Organizing Board Meetings {#Organizing_Board_Meetings}

The Chairman is responsible for setting up and running the board meetings. The Secretary is usually responsible for taking minutes. For a schedule of upcoming meetings, see [PythonSoftwareFoundationBoard](PythonSoftwareFoundationBoard).
...
- A typical agenda has these parts:
  ...
  - Progress reports / other Add the URLs to appropriate resources (like draft minutes) directly to the agenda.
...
## Form for Meeting Minutes {#Form_for_Meeting_Minutes}
...
## Billing Sponsors {#Billing_Sponsors}

To be filled in.

## Adding New Members {#Adding_New_Members}

To be filled in.

## Trademark and License Queries {#Trademark_and_License_Queries}
