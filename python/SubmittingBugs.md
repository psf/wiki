...
**NOTE**: For updated instructions please refer to the [devguide](http://docs.python.org/devguide/tracker.html){.http}.

# Reporting Bugs in Python {#Reporting_Bugs_in_Python}
...
Bug reports should be submitted via the Python Bug Tracker [http://bugs.python.org/](http://bugs.python.org/){.http}. The bug tracker offers a Web form which allows pertinent information to be entered and submitted to the developers.

## Filing a Report {#Filing_a_Report}
...
- Small code examples that don\'t depend on external code are a great way to help confirming and fixing the bug you report (providing them as [unittests](http://www.python.org/dev/workflow/#unit-test-needed){.http} is ideal, but not required).
...
See [Issue Workflow](http://www.python.org/dev/workflow/){.http} and [general Roundup guidelines](http://www.python.org/dev/intro/#general-roundup-guidelines){.http} for detailed descriptions of how bugs get fixed.
...
Contributions in the form of tests, docs and patches are very welcome. The [Developer Documentation](http://www.python.org/dev/){.http} is your main guide to the procedures and [tools of the trade](http://www.python.org/dev/tools){.http}. The [PythonBugDay](PythonBugDay) volunteer docs offers an overview focused at newcomer developers.

#### see also: {#see_also:}

*How to Report Bugs Effectively* [http://www-mice.cs.ucl.ac.uk/multimedia/software/documentation/ReportingBugs.html](http://www-mice.cs.ucl.ac.uk/multimedia/software/documentation/ReportingBugs.html){.http}
...
*Bug Writing Guidelines* [http://www.mozilla.org/quality/bug-writing-guidelines.html](http://www.mozilla.org/quality/bug-writing-guidelines.html){.http}
