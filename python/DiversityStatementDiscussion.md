...
## Current PSF Statement Suggestion: {#Current_PSF_Statement_Suggestion:}
...
## Other Statement Suggestions {#Other_Statement_Suggestions}
...
### Original Diversity List Suggestion {#Original_Diversity_List_Suggestion}
...
The Python community welcomes people no matter what languages they are fluent in. (Although core Python development is done only in English.) The Python community encourages the creation of user groups in all locales, and many of them are listed at [http://wiki.python.org/moin/LocalUserGroups](http://wiki.python.org/moin/LocalUserGroups){.http} Many of these user groups also have mailing lists in the locally preferred language.

If you want to help create a more diverse Python community, we encourage you to join the diversity mailing list at

- [http://mail.python.org/mailman/listinfo/diversity](http://mail.python.org/mailman/listinfo/diversity){.http}
...
### All Positive - Aahz {#All_Positive_-_Aahz}
...
### What is Diversity Anyway {#What_is_Diversity_Anyway}
