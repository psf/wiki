...
- Registration
  - We need an idea of fees: whether previous years\' fees were about right, whether [RuPy](./RuPy.html){.nonexistent} changed anyone\'s perceptions, whether any demographic is excluded. See [EuroPython/2007/FeeStructureAttendees](./EuroPython(2f)2007(2f)FeeStructureAttendees.html) for a comparison between fees in previous years.
