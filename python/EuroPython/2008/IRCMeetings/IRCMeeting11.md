...
Please look at the minutes from the last meeting for more background information: [../IRCMeeting10](./EuroPython(2f)2008(2f)IRCMeetings(2f)IRCMeeting10.html)
...
- Registration/Budget
  ...
  - The PayPal details should be confirmed, as published here: [http://www.europython.org/community/Payment_Information](http://www.europython.org/community/Payment_Information){.http}

  - Mentioning the recording policy ([http://www.europython.org/community/Audio_and_Video](http://www.europython.org/community/Audio_and_Video){.http}) on the registration form. Should registrants have a box to tick? **Correspondence with John suggested that it might be too confusing to do this, although issues with lightning talk recordings would arguably be reduced by such a measure.**

  - T-shirts - any proposals or plans? See [this page](http://www.europython.org/community/T_Shirts){.http}! **Still waiting for ideas!**
- Keynotes
