...
How to Give a Python Talk [http://us.pycon.org/2009/conference/schedule/event/6/](http://us.pycon.org/2009/conference/schedule/event/6/){.http}

## Dates and Venue {#Dates_and_Venue}
...
## Sample topics (not exclusive) {#Sample_topics_.28not_exclusive.29}
...
- [http://us.pycon.org/2009/conference/proposals/#pycon-topics](http://us.pycon.org/2009/conference/proposals/#pycon-topics){.http}
...
Register on the [\[http://in.pycon.org/2009](./Pycon(20)India(20)website(5d).html){.nonexistent} and then use the link provided to submit your talk.
