...
*the **L**eonine **E**ditor with **O**utlines - [http://leoeditor.com/](http://leoeditor.com/){.http}*
...
- Can organize your data in as many ways as you like within a single outline

- A programmer\'s editor that fully integrates outline structure with programming

- [Fully scriptable](http://webpages.charter.net/edreamleo/scripting.html){.http} using Python. Leo\'s core is 100% pure Python

- Plays well with others:
  - there\'s an [ipython bridge](http://webpages.charter.net/edreamleo/IPythonBridge.html){.http},

  - an [emacs leo](http://webpages.charter.net/edreamleo/emacs.html){.http} \'server\',

  - you can use [vim key bindings](http://webpages.charter.net/edreamleo/vimBindings.html){.http},

  - and [embed leo](http://webpages.charter.net/edreamleo/leoBridge.html){.http} in another program.
...
- Has an active community of helpful users and developers
:::
