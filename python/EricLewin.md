...
### Me, myself and my concerns :-) {#Me.2C_myself_and_my_concerns_:-.29}
...
### How did I professionally come to Python ? {#How_did_I_professionally_come_to_Python_.3F}
...
### Working configurations {#Working_configurations}
...
- While travelling or working at home, a [MacBook](./MacBook.html){.nonexistent} Pro (10.4.11) with [MacPython](MacPython) 2.4 : I had hard time to find and install it ; it seems to miss the module manager ; therefore, I don\'t know where to install the modules ![:-(](/wiki/europython/img/sad.png ":-("){height="16" width="16"} Not a satisfying install\...
...
### My present difficulties and concerns (july 2008) : {#My_present_difficulties_and_concerns_.28july_2008.29_:}
...
- \- either use this \[[EricLewin/DiscussionPage](./EricLewin(2f)DiscussionPage.html)\], - or email me (but please, no blabla, no chat ; professional email\...) here : \< Eric *\_DOT\_* Lewin+python *\_AT\_* uJF-Grenoble *\_DOT\_* fr \>
