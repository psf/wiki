# PyCon2008/SprintSignups/Bazaar
...
Project URL: [http://bazaar-vcs.org/](http://bazaar-vcs.org/){.http .reference .external}

Sprint Leader: John Arbash Meinel

Downloads and source code repository: [http://bazaar-vcs.org/Download](http://bazaar-vcs.org/Download){.http .reference .external}

Documentation: [http://bazaar-vcs.org/Documentation](http://bazaar-vcs.org/Documentation){.http .reference .external}

Mailing list instructions: [http://bazaar-vcs.org/BzrSupport](http://bazaar-vcs.org/BzrSupport){.http .reference .external}

Developer guide: [http://doc.bazaar-vcs.org/bzr.dev/en/developer-guide/HACKING.html](http://doc.bazaar-vcs.org/bzr.dev/en/developer-guide/HACKING.html){.http .reference .external}.
