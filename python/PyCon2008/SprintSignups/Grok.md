...
Signing up is a rather unofficial process. Just click [here](http://wiki.python.org/moin/PyCon2008/SprintSignups/Grok?action=edit){.http .reference .external} to edit the wiki page and add your name and email address to the list of sprinters.
...
Project URL: [http://grok.zope.org/](http://grok.zope.org/){.http .reference .external}

Sprint Leader: Brandon Rhodes

Mailing list: [grok-dev@zope.org](mailto:grok-dev@zope.org){.mailto .reference .external}
:::
