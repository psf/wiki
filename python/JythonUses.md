...
## Install Java; program in Python {#Install_Java.3B_program_in_Python}
...
## Program in Java; assemble with Python {#Program_in_Java.3B_assemble_with_Python}
...
## Program in Python; extend in Java {#Program_in_Python.3B_extend_in_Java}
...
## Embed Jython in Java Applications {#Embed_Jython_in_Java_Applications}
...
## Prototype in Jython; develop in Java. {#Prototype_in_Jython.3B_develop_in_Java.}
