...
# Google Tips for Python {#Google_Tips_for_Python}

People frequently have trouble finding stuff on the Python websites. Sometimes they are just too lazy to search. Other times they don\'t shine a light in the proper corner. [Google](http://www.google.com/){.http} pokes in every corner, but you sometimes need a little help coaxing information out of it. This page gives a few idioms useful for searching Google effectively for content on the Python websites.

## Searching a Single Site {#Searching_a_Single_Site}
...
### Searching Mailing Lists {#Searching_Mailing_Lists}
...
### Searching the Library Reference Manual {#Searching_the_Library_Reference_Manual}
...
### Searching the Language Reference Manual {#Searching_the_Language_Reference_Manual}
...
### Searching the PEPs {#Searching_the_PEPs}
...
## Searching for a Phrase {#Searching_for_a_Phrase}
