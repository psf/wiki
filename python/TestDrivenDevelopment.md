...
- Coding tests means you have to call your non-existing code with all the parameters thus forcing you to think how your library should work, thus it fixes the [Signature](./Signature.html){.nonexistent} of your code
...
- [http://www.agiledata.org/essays/tdd.html](http://www.agiledata.org/essays/tdd.html){.http}
