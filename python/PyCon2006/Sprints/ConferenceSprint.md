...
Some ideas for the paper-submission portion are at \<[http://www.amk.ca/w/ConferenceSWIdeas\>](http://www.amk.ca/w/ConferenceSWIdeas%3E){.http}.
...
[http://cern.ch/indico](http://cern.ch/indico){.http} \-- CERN\'s open source conference software written in Python
