...
# Vote for the talk you want to see! {#Vote_for_the_talk_you_want_to_see.21}
...
# Unit Testing in Python {#Unit_Testing_in_Python}

This talk is based on one I gave for the the [Triangle Python/Zope User Group](http://dev.zope.org/Members/tbryan/TriZPUG/FrontPage){.http} in November 2002. I extended the content for the [PyCon](PyCon). The original talk covered the following topics:
...
# Feedback from visitors to this page {#Feedback_from_visitors_to_this_page}
