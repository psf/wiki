...
In general, Directors help to fulfill [the mission of the PSF](http://www.python.org/psf/mission){.http .reference .external}; we take responsibility for moving Python and the PSF forward.

Check out the PSF\'s video titled Life as a Python Software Foundation Director: [https://www.youtube.com/watch?v=ZLKj6FaQA4M](https://www.youtube.com/watch?v=ZLKj6FaQA4M){.https .reference .external} .

Please see [the minutes of the monthly Board of Directors meetings](http://www.python.org/psf/records/board/minutes){.http .reference .external} for specific actions, decisions, and reports given.

::: {#what-are-the-responsibilities-of-board-members .section}
...
- Fiduciary duties (care, loyalty, obedience) ([https://boardsource.org/fundamental-topics-of-nonprofit-board-service/roles-responsibilities/](https://boardsource.org/fundamental-topics-of-nonprofit-board-service/roles-responsibilities/){.https .reference .external})
:::

::: {#how-do-directors-and-officers-conduct-business .section}
...
::: {#what-is-the-flow-of-meetings .section}
### What is the flow of meetings?

> 1.  Introduction and Roll call
> 2.  The PSF uses a [consent agenda](https://www.councilofnonprofits.org/sites/default/files/documents/a3e8abbfab7a4d088d56ba3e563c6c061.pdf){.https .reference .external} for actions that a consensus is made on prior to the board meeting.
...
::: {#additional-items-to-know .section}
### Additional items to know

> 1.  The position of Director is unpaid, purely volunteer.
> 2.  [Staff positions](https://www.python.org/psf/records/staff/){.https .reference .external} receive a salary.
...
> 6.  The formal responsibilities of Directors and Officers are listed in [the bylaws, articles V and VI](http://www.python.org/psf/bylaws){.http .reference .external}.
:::
:::::::
