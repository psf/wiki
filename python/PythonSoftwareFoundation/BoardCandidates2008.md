...
- [David Goodger](#david-goodger){#id1 .reference .internal}
- [Brett Cannon](#brett-cannon){#id2 .reference .internal}
- [Raymond Hettinger](#raymond-hettinger){#id3 .reference .internal}
- [Steve Holden](#steve-holden){#id4 .reference .internal}
- [Stephan Deibel](#stephan-deibel){#id5 .reference .internal}
- [Tim Peters](#tim-peters){#id6 .reference .internal}
- [Martin v. Löwis](#martin-v-lowis){#id7 .reference .internal}
- [James Tauber](#james-tauber){#id8 .reference .internal}
:::
...
- [2007 Board Candidates](./PythonSoftwareFoundation(2f)BoardCandidates2007.html){.reference .external}
:::

::: {#david-goodger .section}
### [David Goodger](#id1){.toc-backref}
...
[Home page](http://drbrett.ca/){.http .reference .external}.
:::

::: {#raymond-hettinger .section}
### [Raymond Hettinger](#id3){.toc-backref}
...
- CEO of [Holden Web LLC](http://www.holdenweb.com){.http .reference .external}

[Loosely Python-related blog](http://holdenweb.blogspot.com/){.http .reference .external} \| [Vaguely Open Source blog](http://onyourdesktop.blogspot.com/){.http .reference .external} \| [Yorkshireman in America](http://yorksamerica.blogspot.com/){.http .reference .external}
:::

::: {#stephan-deibel .section}
### [Stephan Deibel](#id5){.toc-backref}

I\'m the current chairman of the board of the PSF (since 2004) and will be running again as a director. I\'m also co-founder of Wingware, maker a commercial IDE for Python, and have been involved with various advocacy related efforts such as the somewhat dated [pythonology.org website](http://pythonology.org){.http .reference .external} and the [Python Success Stories collection](http://pythonology.org/success){.http .reference .external} (which are [also on python.org](http://python.org/about/success){.http .reference .external}). I\'ve been using Python since 1998.

In my past work for the PSF, I\'ve concentrated on trademarks and licensing. I worked with legal counsel on the [trademark policy](http://www.python.org/psf/trademarks/){.http .reference .external}, drafted parts of the [license FAQ](http://wiki.python.org/moin/PythonSoftwareFoundationLicenseFaq){.http .reference .external}, and respond to questions on trademarks and licensing that are emailed to the board mailing list.

I\'ve also supported funding of the website redesign (where I also participated as a volunteer), paying nominal salaries for the critical work done by the Treasurer (Kurt Kaiser) and Secretary (David Goodger), funding Jeff Rush in the [Python Advocacy Coordinator](http://wiki.python.org/moin/PythonAdvocacyCoordinator){.http .reference .external} position, and donating to Python conferences around the world.

Recently, I wrote up an article on the PSF that was just published in volume 2 issue 4 of [The Python Papers](http://pythonpapers.org/){.http .reference .external}.
...
### [Martin v. Löwis](#id7){.toc-backref}
...
[Home page](http://jtauber.com/){.http .reference .external}.
:::
:::::::::::::
