...
Instead, additional focus was placed on the PSF\'s Working Group and project management processes, and in particular the delegation of funding authority from the Board level to designated Working Groups. See [this page](https://www.python.org/psf/committees/){.https} for the list of currently active Working Groups.
:::
