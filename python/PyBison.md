...
# PyBison - Scott Hassan - 1997 {#PyBison_-_Scott_Hassan_-_1997}
...
- [for linux-i686](http://ppm.activestate.com/PPMPackages/PyPPM/2.2/packages/PyBison-0.1.0.0.linux-i686.2.2.tar.gz){.http}

- [win32](http://ppm.activestate.com/PPMPackages/PyPPM/2.2/packages/PyBison-0.1.0.0.win32.2.2.zip){.http}

# PyBison - David McNab - 2004 {#PyBison_-_David_McNab_-_2004}

A *completely different* PyBison can be found at (version 0.1.8 as of 2006-06-22):

- [http://www.freenet.org.nz/python/pybison/](http://www.freenet.org.nz/python/pybison/){.http}

This PyBison was designed and written by David McNab and has an OO model inspired by PLY ([http://www.dabeaz.com/ply/](http://www.dabeaz.com/ply/){.http}). This PyBison has existed since April 2004. But this link is also dead.
...
[http://freenet.mcnabhosting.com/python/pybison/](http://freenet.mcnabhosting.com/python/pybison/){.http}
:::
