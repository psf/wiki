...
- the particular GUI framework involved\--wxPython, [TkInter](TkInter), probably has specific mechanisms for managing concurrency in an event-based way. The toolkit behind Tkinter, in fact, already has a Wiki page on [the subject above](http://wiki.tcl.tk/1526){.http}, many of whose hints can be adapted to other frameworks;
