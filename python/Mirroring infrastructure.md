...
# Mirroring infrastructure in PyPI {#Mirroring_infrastructure_in_PyPI}
...
## Mirror listing and registering {#Mirror_listing_and_registering}

A new text page will be added at [http://pypi.python.org/mirrors](http://pypi.python.org/mirrors){.http} that can be browsed like the simple index. This page gives a list of the mirrors through a list of links.
...
## Special pages a mirror needs to provide {#Special_pages_a_mirror_needs_to_provide}
...
The date is provided in GMT time, using the iso 8601 format ([http://en.wikipedia.org/wiki/ISO_8601](http://en.wikipedia.org/wiki/ISO_8601){.http})
...
### Local statistics {#Local_statistics}
...
This page is a csv-like page, with a header at the first line. It needs to obey PEP 305 [http://www.python.org/dev/peps/pep-0305/#id19](http://www.python.org/dev/peps/pep-0305/#id19){.http}. Basically, it should be readable by Python csv module.
...
### Mirrors listing page {#Mirrors_listing_page}

Like /stats, each mirror should get and provide the /mirrors page.

Conventionaly, this page should be reachable at: \"/mirrors\".

## How a mirror should synchronize with PyPI {#How_a_mirror_should_synchronize_with_PyPI}
...
### The mirroring protocol {#The_mirroring_protocol}

XXX changelog, pje link + to be defined

### User-agent request header {#User-agent_request_header}
...
## How a client can use PyPI and its mirrors {#How_a_client_can_use_PyPI_and_its_mirrors}

XXX

## Fail-over mechanism {#Fail-over_mechanism}
...
## Extra package indexes {#Extra_package_indexes}
...
- [PloneSoftwareCenter](./PloneSoftwareCenter.html){.nonexistent}

- [EggBasket](./EggBasket.html){.nonexistent}

## Merging several indexes {#Merging_several_indexes}
...
## Other PyPI enhancements {#Other_PyPI_enhancements}

XXX

### Contact form for Package maintainers {#Contact_form_for_Package_maintainers}
