...
### Welcome to Pybots, the Python Community Buildbots {#Welcome_to_Pybots.2C_the_Python_Community_Buildbots}

For the impatient: to view the buildmaster\'s status page, please select one of the following:

- [All](http://www.python.org/dev/buildbot/community/all/){.http} builders

- Only builders for the [trunk](http://www.python.org/dev/buildbot/community/trunk/){.http}

- Only builders for the Python [2.5](http://www.python.org/dev/buildbot/community/2.5/){.http} branch
...
The idea originated from [Glyph](http://glyf.livejournal.com/){.http}, of [Twisted](http://twistedmatrix.com/trac/){.http} fame. He sent out a message to the python-dev mailing list (thanks to John J. Lee for bringing this message to my attention), in which he said:
...
If you are interested in participating in this project, please read these [Instructions on setting up a Pybots buildslave](http://agiletesting.blogspot.com/2006/08/setting-up-pybots-buildslave.html){.http}, take a look at the [PyBotsFaq](PyBotsFaq), then send a message to the [Pybots mailing list](http://lists2.idyll.org/listinfo/pybots){.http} and I will send you a slavename and a password.
:::
