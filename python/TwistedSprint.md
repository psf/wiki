...
## Potential mini-sprints {#Potential_mini-sprints}
...
- **[LivePage](./LivePage.html){.nonexistent}:** bi-directional, realtime calling between Python in the backend and [JavaScript](./JavaScript.html){.nonexistent} in the front-end; enhance API available to Python to manipulate the browser, and add SSL support.
