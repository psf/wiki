...
Here are SciTE features useful while editing Python files: syntax highlighting, code folding, auto-indent, brace matching, codepage/unicode support, multiple documents, context help, code execution, output pane, external tools support, [RegExp](./RegExp.html){.nonexistent} find/replace, text export (HTML, RTF, PDF, LaTeX, XML).

SciTE currently supports about 50 computer languages.

Get it from [http://www.scintilla.org/SciTE.html](http://www.scintilla.org/SciTE.html){.http}

I\'m also using it, not only for Python ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"} It highlights JSP pages verry good too (best IMHO). Does anybody know a way to use SciTE for Python debugging?
...
This is not exactly a debugger, but is still useful. Read the comment at the bottom : [http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/52215](http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/52215){.http}
:::
