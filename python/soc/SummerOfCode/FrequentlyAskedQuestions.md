...
4.  **Find some beginner-friendly bugs and try to fix them.** Many projects have these tagged as \"easy\" \"bite-size\" or \"beginner-friendly\"
    ...
    - Some projects have beginner-friendly \"bite-sized\" bugs listed in the [OpenHatch](./OpenHatch.html) search engine, found here: [http://openhatch.org/search/](http://openhatch.org/search/)
...
- **You might like to take a bit of time to read [the python style guide, PEP8](https://www.python.org/dev/peps/pep-0008/).** Not every project uses these rules, but they can give you a rough idea of what is considered \"readable code\" by most pythonistas. (And for fun, you might want to read the poetry of [PEP20 \"The Zen of Python\"](https://www.python.org/dev/peps/pep-0020/))
