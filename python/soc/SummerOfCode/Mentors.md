...
- Buddha Buck ([PySoy](http://www.pysoy.org))

- Carl Friedrich Bolz ([PyPy](http://codespeak.net/pypy))

- Titus Brown and Grig Gheorghiu (automatic patch verification system for Python core and PyPI packages, based on a buildbot farm running on VMware machines, with ideas from [Pybots](http://pybots.org) and [Cheesecake](http://pycheesecake.org))

- Jean-Paul Calderone, Glyph Lefkowitz, James Knight, and Christopher Armstrong ([Twisted](http://twistedmatrix.com/trac/wiki/SummerOfCode))

- Jennifer Campbell ([PyGraphics](./PyGraphics.html))

- Brett Cannon (Python core and standard library)

- Ondrej Certik ([sympy](http://code.google.com/p/sympy/)), project [ideas](http://code.google.com/p/sympy/wiki/SummerOfCode)

- Fabian Seoane ([sympy](http://code.google.com/p/sympy/)), project [ideas](http://code.google.com/p/sympy/wiki/SummerOfCode)
...
- David Goodger ([Docutils](http://docutils.sf.net))

- Will Guaraldi ([PyBlosxom](http://pyblosxom.sf.net) - [project ideas](http://pyblosxom.sourceforge.net/blog/static/soc2007.html))

- Peter Hansen ([DrProject](http://www.drproject.org))

- Alan Isaac ([SciPy](http://scipy.org), optimization, esp. as co-mentor)

- Max Ischenko (testing tools development, TurboGears/Pylons and web-related projects)

- Jim Jewett (client-side web projects, particularly plucker [http://www.plkr.org/](http://www.plkr.org/)) or backup mentor.
...
- Zach Miller ([pySoy](http://pySoy.org/))
...
- Arc Riley ([PySoy](http://www.pysoy.org))
...
- Blake Winton ([DrProject](http://www.drproject.org/), [PyBlosxom](http://pyblosxom.sourceforge.net/))

- Johannes Woolard ([Crunchy](http://code.google.com/p/crunchy)) [project ideas](http://code.google.com/p/crunchy/wiki/SummerOfCodeIdeas)

- Maciej Fijalkowski ([py-lib](http://codespeak.net/py/), [PyPy](http://codespeak.net/pypy))

- Toby Donaldson ([Crunchy](http://code.google.com/p/crunchy))

- Richard Tew ([Stackless Python](http://www.stackless.com))

- Satya Kiran (Python core,Python standard library)

- Paul Gries ([PyGraphics](http://code.google.com/p/pygraphics))

- Rene Dudfield ([PyGame](http://www.pygame.org), [PyOpenGL](http://pyopengl.sf.net))

- Marcus von Appen ([PyGame](http://www.pygame.org))

- Phil Hassey ([PyGame](http://www.pygame.org), [TinyPy](./TinyPy.html))
