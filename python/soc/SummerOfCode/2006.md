...
The main target of the project is to produce a framework which takes advantage of [PyPy](PyPy)\'s [JavaScript](./JavaScript.html) backend and to make it easy to write an AJAX based framework written entirely in Python.
