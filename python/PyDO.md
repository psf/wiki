...
[http://skunkweb.sourceforge.net/PyDO/](http://skunkweb.sourceforge.net/PyDO/){.http}

## Is this tool similar to JavaDataObjects? {#Is_this_tool_similar_to_JavaDataObjects.3F}
