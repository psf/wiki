...
**suomi** [1SEP09 Ideally, all the language pages should be like the Polish or Turkish pages - all native language, only the necessary English. ]
...
[PDF - tutorial](http://solmu.math.helsinki.fi/2004/1/python.pdf) - Antti Rasila, gnuplot example

[PDF - linear algebra, matrices](http://solmu.math.helsinki.fi/2005/2/python3.pdf) - Antti Rasila

[Python 3 book and course - commercial](http://www.docendo.fi/?p=showproduct&product=951-0-35273-X)

[Plans for Pycon Finland 2010](http://fi.pycon.org/)

[Wikipedia](http://fi.wikipedia.org/wiki/Python)
