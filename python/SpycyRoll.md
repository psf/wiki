...
Web site: [http://spycyroll.sourceforge.net/](http://spycyroll.sourceforge.net/){.http}
...
- Does this go *far beyond* aggregating? For example, does it not just aggregate the feeds, but produce HTML as if you were using this [PythonModule](./PythonModule.html){.nonexistent} as your very own personal news aggregator?
