...
This document (originally derived from [PaulBoddie](PaulBoddie)\'s [Python Frameworks and J2EE Standards](http://www.boddie.org.uk/python/web_modules_enterprise.html){.http} document) provides an analysis of Python Web modules and frameworks, along with a comparison of these frameworks to Java 2 Enterprise Edition (J2EE) standard technologies. Whilst many different Python Web modules and frameworks exist (see the [WebProgramming](WebProgramming) topic guide for details), this document only attempts to review those frameworks which provide environments comparable to the more complete J2EE implementations.
...
### Comparable Technologies {#Comparable_Technologies}
...
::: {}
  ...
  **Framework**                 **Equivalent**                                                                                                        **Notes**
  mod_python                    [Request handlers](http://www.modpython.org/live/current/doc-html/pyapi-handler.html){.http}                          
  Webware                       [WebKit Servlets](http://webware.sourceforge.net/Webware-0.8.1/WebKit/Docs/Source/Summaries/Servlet.py.html){.http}   Higher-level classes are also available
  ...
  Zope                          Products and [PythonMethods/PythonScripts](./PythonMethods(2f)PythonScripts.html){.nonexistent}                       
  Snakelets                     [Snakelets](http://snakelets.sourceforge.net/){.http} use snakelets as \"servlets\"                                   
  ----------------------------- --------------------------------------------------------------------------------------------------------------------- -----------------------------------------------------------------------------------------
:::

## JavaServer Pages {#JavaServer_Pages}

[JavaServer](./JavaServer.html){.nonexistent} Pages (JSP) is a program-code-inside-HTML template technology, similar to Active Server Pages and other \*SP technologies, but with Java as the programming language of choice.
...
### Comparable Technologies {#Comparable_Technologies-1}
...
| **Framework**                               | **Equivalent**                                                                                     | **Notes**                                                                                  |
+---------------+-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
| JSP           | mod_python                  | [Python Server Pages](http://www.modpython.org/live/current/doc-html/pyapi-psp.html){.http}        |                                                                                            |
|               +-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
|               | Webware                     | [Python Server Pages](http://webware.sourceforge.net/Webware-0.8.1/PSP/Docs/index.html){.http}     |                                                                                            |
|               +-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
|               | [SkunkWeb](SkunkWeb) | [STML](http://skunkweb.sourceforge.net/stmlrefer/){.http}                                          |                                                                                            |
|               +-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
...
|               +-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
|               | [SkunkWeb](SkunkWeb) | [:component:](http://skunkweb.sourceforge.net/stmlrefer/node25.html){.http}                        |                                                                                            |
|               +-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
...
|               +-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
|               | Spyce                       | [Spyce taglibs](http://spyce.sourceforge.net/doc-tag_new.html){.http}                              |                                                                                            |
+---------------+-----------------------------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
...
### Comparable Technologies {#Comparable_Technologies-2}
...
### Container Managed Persistence {#Container_Managed_Persistence}
...
### Bean Managed Persistence {#Bean_Managed_Persistence}
...
### Comparable Technologies {#Comparable_Technologies-3}
...
### Comparable Technologies {#Comparable_Technologies-4}
