...
- Evaluate the PEPs for optimizing global and attribute lookups
  - [PEP 266](http://www.python.org/dev/peps/pep-0266/){.http}, [PEP 267](http://www.python.org/dev/peps/pep-0267/){.http}, and [PEP 280](http://www.python.org/dev/peps/pep-0280/){.http} [JackDiederich](./JackDiederich.html){.nonexistent} suggests that these changes would be too radical to be incorporated during the sprint.
