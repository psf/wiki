...
## The Winnipeg Python Users Group {#The_Winnipeg_Python_Users_Group}

Welcome! We are about 60 [Python](http://www.python.org){.http} users in and around Winnipeg, Manitoba.
...
We encourage you to [join](http://mail.python.org/mailman/listinfo/winnipeg){.http} our **mailing list**. The traffic is low and it provides a point for connection to Winnipeg Python users for events, job offers, etc. There are [archives](http://mail.python.org/pipermail/winnipeg/){.http}.

### Meeting Times and Location {#Meeting_Times_and_Location}
...
For meetings at Epic, the address is 167 Sherbrook, parking on the street or in the lot at the back, website [http://Epic.ca](http://Epic.ca){.http}.
...
::: {}
  ...
  7:30 p.m., Mar 23, 2011   Epic       Bo-Keep   Mark Jenkins            see [http://parit.ca/parit_news/presentation-on-bo-keep](http://parit.ca/parit_news/presentation-on-bo-keep){.http}
  ------------------------- ---------- --------- ----------------------- ---------------------------------------------------------------------------------------------------------------------
:::
...
::: {}
  ...
  Dec 13, 2005    Organizing                                                           Stuart Williams                     [Rough minutes](http://mail.python.org/pipermail/winnipeg/2005-December/000020.html){.http}   
  Jan 17, 2006    Teaching Programming with Python                                     Stuart Williams                                                                                                                   
  Feb 22, 2006    Recent Code and List Comprehensions                                  Mark Jenkins                                                                                                                      
  Mar 22, 2006    Database Access                                                      Sydney Weidman                      [Python Database Access](http://wiki.uwinnipeg.ca/index.php/Python_Database_Access){.http}    
  Apr 26, 2006    Code review of text based game                                       Mike Pfaiffer                                                                                                                     
  May 24, 2006    Object Oriented Python                                               Syd Weidman                         [Presentation](http://wiki.uwinnipeg.ca/index.php/ObjectOrientedPython){.http}                
  Jun 28, 2006    Wrapping C Libraries                                                 Mark Jenkins                                                                                                                      
  Jul 26, 2006    LdapFS.py sprint                                                     Scott Balneaves                                                                                                                   
  Aug 23, 2006    Starlanes2 sprint                                                    Syd Weidman                         [Starlanes2Sprint](Starlanes2Sprint)                                                   
  Sept 27, 2006   Iterators and Generators                                             Jason Hildebrand                    [IteratorsAndGenerators](./IteratorsAndGenerators.html){.nonexistent}                         
  Oct 25, 2006    Beer                                                                 Various                                                                                                                           
  Nov 22, 2006    Python IDEs                                                          Various                             [PythonDevEnvironments](PythonDevEnvironments)                                         
  ...
  Jun 27, 2007    Batteries Included: A tour of the Python Library                     See presenter list                  [PresenterSignUp](PresenterSignUp)                                                     
  ...
  May 28, 2008    buildout                                                             Syd Weidman                         [WinnipugBuildoutPresentation](WinnipugBuildoutPresentation)                           
  Oct 22, 2008    PyUNO for [OpenOffice](./OpenOffice.html){.nonexistent} Automation   Syd Weidman                         [UNO](http://wiki.uwinnipeg.ca/index.php/PyUno){.http}                                        
...
- Web framework like [Django](http://www.djangoproject.com/){.http} or [TurboGears](http://www.turbogears.org){.http}

- GUI framework like [Kiwi](http://www.async.com.br/projects/kiwi/){.http}
...
[CategoryUsergroups](CategoryUsergroups) [CategoryPythonWebsite](CategoryPythonWebsite)
:::::
