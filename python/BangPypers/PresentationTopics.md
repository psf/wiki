...
These are topics which people are interested in having presented (or which people can present) at the [BangPypers](BangPypers) meetings ie. It\'s a mix of expertise and desire.
...
2.  [PyPy](PyPy) - The python on python project. There are some fascinating topics in the [google video](http://www.youtube.com/watch?v=GnPmErtqPXk%5D){.http} on this topic (+1)

3.  [PyGame](PyGame) - The SDL wrapper for Python used to make games \[[NoufalIbrahim](NoufalIbrahim)\]
...
10. Environment setup hacks - Nice tricks used in development environments to make python development more fun (IDEs, scripts etc.) \[[AmitSaha](AmitSaha)\] +1

11. Python GUI frameworks for native desktop and web based applications ([WxPython](WxPython), Tk \[also TTk\], GTK \[On Windows and Linux\], [PyJamasDesktop](./PyJamasDesktop.html){.nonexistent}, Titanium, [WebKit](WebKit) Desktop etc) (+3)
