...
## Foreign delegates (100000) {#Foreign_delegates_.28100000.29}

- I have spoken to two people in at [PyCon](PyCon) Atlanta 2010 who are open to travelling if we can cover air fare/accommodation. I approximate a 70k two way air ticket and around 15k for a 2 day stay/commute at a decent hotel. This comes to approximately 2L
...
- **[NoufalIbrahim](NoufalIbrahim)** : +1 for just one delegate. +1 for PSF funding if possible. I\'m neutral about the person as long as it\'s someone notable.

## Professional wifi (35000) {#Professional_wifi_.2835000.29}

I\'m pulling this number out of thin air. Around 35k for 2 days of professional recording?

Wifi (20000)

- We can contact someone like [AirTel](./AirTel.html){.nonexistent} or others to sponsor wifi. I\'m not sure about costs here. If we have to do it manually, I think we can cover it in around 20k (wild guesstimate).

\* Barter sponsorship

At pycon, there was one hall with folks selling wares, swag, books, etc\... during the conference. I am not sure how this would tie-in with the venue or if it is permitted at all. If yes, we can try asking [AirTel](./AirTel.html){.nonexistent} to provide wifi in exchange for a booth selling pre-paid cards or talktime?

## Food (100000) {#Food_.28100000.29}
...
- Keep 3-tiers slab rates. One: for students (200-250INR per head). Two: for speakers and project contributors (500 per head) and Third, for delegates sponsored by corporates (3 people for INR1000? plus a sponsorship package which can cost extra (TBD)).
  ...
  - **[NoufalIbrahim](NoufalIbrahim)** : +1. Two tiers is more than enough. There would also have to be a few free tickets with every sponsorship package but that\'s best discussed on the Sponsorship pages.

## Miscellaneous (10000) {#Miscellaneous_.2810000.29}
...
## \'\'\'Total\'\'\' : 165000 INR (1.65 Lakhs) {#A.27.27.27Total.27.27.27_:_165000_INR_.281.65_Lakhs.29}
