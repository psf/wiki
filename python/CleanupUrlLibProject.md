...
- Hi, I\'m interested in this project and would therefore like to receive further information on what you expect it to be. The first thing that came to my mind was rewriting the url modules in order to get parallelity (using select or poll). This would futhermore include a bit of redesign with the main focus on the http protocol. \-- [HelmutGrohne](http://linuxwiki.org/HelmutGrohne "LinuxWiki"){.interwiki}
