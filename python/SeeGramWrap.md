...
Thanks to John Mitchell and Monty Zukowski for \"cgram.tgz\". Every parser generator need to have a good C grammar. Also thanks to Terrence Parr for [ANTLR](http://www.antlr.org/){.http}.
...
The best-known approach is [SWIG](./SWIG.html){.nonexistent}. For complex wrappings, SWIG requires the writing of *typemaps*, an unintuitive process where pieces of C code you write are spliced into the wrapper code generated by SWIG.
...
I use some C grammars associated with ANTLR. The grammar package is called **cgram**. See [http://www.antlr.org/resources.html](http://www.antlr.org/resources.html){.http}.
