...
- Implement the [SCSU](http://www.unicode.org/reports/tr6/){.http} codec.
...
- [MakeXmlrpclibAsynchronous](./MakeXmlrpclibAsynchronous.html){.nonexistent}

- Document the bgen tool included in the Python source distribution. Jack Jansen has a version of bgen extended for C++; see [Jack\'s home page](http://homepages.cwi.nl/~jack/){.http} for a paper about it. Perhaps it could be incorporated.
...
- Write an RPC mechanism, or prepare an existing RPC mechanism, for the standard library (note: [http://rpyc.wikispaces.com](http://rpyc.wikispaces.com){.http}).
...
- Suggest a \"Personal Standard Library\". See [http://programming.oreilly.com/2013/10/dead-batteries-included.html](http://programming.oreilly.com/2013/10/dead-batteries-included.html){.http} for example.
:::
