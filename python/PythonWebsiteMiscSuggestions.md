...
Here we develop some ideas for enhancements or changes to the beta.python.org site. As ideas get clearer we may add them to the tickets.
...
2\. Any chance of moving the \"Using Python for\...\" box farther up the page? I think that will be a high-traffic link\[s\], and not just cause I mentioned it a year or two ago ![;-)](/wiki/europython/img/smile4.png ";-)"){height="16" width="16"} . - ToddG

3\. No specific suggestion, just a pointer for some ideas: [http://www.webdesignfromscratch.com/current-style.cfm](http://www.webdesignfromscratch.com/current-style.cfm){.http} - Shalabh
