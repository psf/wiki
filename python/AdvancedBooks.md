...
- Web Security: Automates SQLi/XSS testing with requests and [BeautifulSoup](./BeautifulSoup.html){.nonexistent}, and dynamic content analysis with Selenium.
...
[Publisher\'s Page](https://www.amazon.com/Mastering-Cybersecurity-using-Python-1/dp/B0F7RFR8JN/ref=tmm_kin_swatch_0?_encoding=UTF8&qid=&sr=){.https}

------------------------------------------------------------------------

[Mastering PostgreSQL using Python Vol 1: A Comprehensive Guide](https://www.amazon.com/Mastering-PostgreSQL-Python-Comprehensive-Guide/dp/B0C9S1498Z){.https}

Abhishek Singh

ISBN: 979-8850565985 318 pages (July 1, 2023)
...
[Publisher\'s Page](https://www.amazon.com/Mastering-PostgreSQL-Python-Comprehensive-Guide-ebook/dp/B0C9TPZM6N/ref=tmm_kin_swatch_0?_encoding=UTF8&qid=&sr=){.https}

------------------------------------------------------------------------

[Python Coding -- One Year Later: A Treasure Trove of Practical and Simple Examples](https://www.amazon.com/dp/B08RJ2W1TY){.https}

Cathy Young

ISBN: 9798707217357 M & C Publishing 356 Pages (December 2020)

Book Overview:

Learn the simple basics of debugging a Python script so your code runs as expected. Chapter 3 presents \"Python Basics\" because a big part of debugging is knowing the correct syntax for a particular object and task. Dozens of diagrams explain concepts such as indexing, slicing, scope, or recursive functions. The syntax relevant to each type of object is also shown. To add to a \"list,\" you could use \'append,\' \'join\' or \'extend\' methods. While adding a new key:value pair to a dictionary is straightforward, adding to an existing dictionary requires you to know the \"type\" of object in the key:value pair to determine which methods to use to add, update, or delete objects.

Copy and paste over 50 real-world self-contained examples into your IDE and run the code snippets. Between the detailed Table of Contents and extensive Index, you can quickly find answers. The Index includes common phrases for those times when you don\'t know the technical term. For example, to find a string in Python, you could use the \"in\" comparison operator. Whether you look for \"find\" or \"search,\" the Index refers you to the \"in\" comparison operator. The examples are varied so you can work with different types of data, such as: XML, HTML, matplotlib (plots/charts/graphs), OS (files/directories), \*.txt, \*.csv, user input, or dates.

[Publisher\'s Page](https://www.amazon.com/dp/B08RD15PDC?binding=kindle_edition&ref=dbs_dp_rwt_sb_pc_tukn){.https}

------------------------------------------------------------------------

[Publishing Python Packages](https://www.manning.com/books/publishing-python-packages){.https}

Dane Hillard

ISBN 13: 9781617299919 Manning Publications 275 Pages (March 2022)
...
[Publisher\'s Page](https://www.manning.com/books/publishing-python-packages){.https}

------------------------------------------------------------------------

[Intuitive Python: Productive Development for Projects that Last](https://pragprog.com/titles/dmpython/intuitive-python/){.https}

David Muller

ISBN 13: 9781680508239 The Pragmatic Bookshelf 130 Pages (June 2021)
...
[Publisher\'s Page](https://pragprog.com/titles/dmpython/intuitive-python/){.https}

------------------------------------------------------------------------

[Practices of the Python Pro](https://www.manning.com/books/practices-of-the-python-pro){.https}

Dane Hillard

ISBN 13: 9781617296086 Manning Publications 248 Pages (14 Jan 2020)
...
[Publisher\'s page](https://www.manning.com/books/practices-of-the-python-pro){.https}

------------------------------------------------------------------------

[Network Science with Python and NetworkX Quick Start Guide](https://www.packtpub.com/big-data-and-business-intelligence/network-science-python-and-networkx-quick-start-guide){.https}

Edward Platt

ISBN 13: 9781789955316 Packt 190 Pages (25 Apr 2019)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/network-science-python-and-networkx-quick-start-guide){.https}

------------------------------------------------------------------------

[Data Science Projects with Python](https://www.packtpub.com/big-data-and-business-intelligence/data-science-projects-python){.https}

Steve Klosterman

ISBN 13: 9781838551025 Packt 374 Pages (29 Apr 2019)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/data-science-projects-python){.https}

------------------------------------------------------------------------

[Applied Supervised Learning with Python](https://www.packtpub.com/big-data-and-business-intelligence/applied-supervised-learning-python){.https}

Benjamin Johnston and Ishita Mathur

ISBN 13: 9781789954920 Packt 404 Pages (26 Apr 2019)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/applied-supervised-learning-python#tab-label-additional){.https}

------------------------------------------------------------------------

[Hands-On Unsupervised Learning with Python](https://prod.packtpub.com/big-data-and-business-intelligence/hands-unsupervised-learning-python){.https}

Giuseppe Bonaccorso

ISBN 13: 9781789348279 Packt 386 Pages (28 Feb 2019)
...
[Publisher\'s page](https://prod.packtpub.com/big-data-and-business-intelligence/hands-unsupervised-learning-python){.https}

------------------------------------------------------------------------

[Mastering Python for Finance - Second Edition](https://prod.packtpub.com/big-data-and-business-intelligence/mastering-python-finance-second-edition){.https}

James Ma Weiming

ISBN 13: 9781789346466 Packt 426 Pages(29 Apr 2019)
...
[Publisher\'s page](https://prod.packtpub.com/big-data-and-business-intelligence/mastering-python-finance-second-edition){.https}

------------------------------------------------------------------------

[Python Parallel Programming Cookbook - Second Edition](https://www.packtpub.com/programming/python-parallel-programming-cookbook){.https}

Giancarlo Zaccone

ISBN 13: 9781789533736 Packt 370 Pages (6 Sep 2019)

Book:

Implement effective programming techniques in Python to build scalable software that saves time and memory

This updated edition features cutting-edge techniques for building effective concurrent applications in Python 3.7. The book introduces parallel programming architectures and covers the fundamental recipes for thread-based and process-based parallelism. You\'ll learn about mutex, semaphores, locks, queues exploiting the threading, and multiprocessing modules, all of which are basic tools to build parallel applications. Recipes on MPI programming will help you to synchronize processes using the fundamental message passing techniques with mpi4py. Furthermore, you\'ll get to grips with asynchronous programming and how to use the power of the GPU with PyCUDA and PyOpenCL frameworks. Finally, you\'ll explore how to design distributed computing systems with Celery and architect Python apps on the cloud using [PythonAnywhere](./PythonAnywhere.html){.nonexistent}, Docker, and serverless applications.
...
[Hands-On Neuroevolution with Python](https://www.packtpub.com/data/hands-on-neuroevolution-with-python?utm_source=wiki.python.org&utm_medium=referral&utm_campaign=OutreachB14532dollar5){.https}
...
[Publisher\'s page](https://www.packtpub.com/data/hands-on-neuroevolution-with-python?utm_source=wiki.python.org&utm_medium=referral&utm_campaign=OutreachB14532dollar5){.https}

------------------------------------------------------------------------

[Mastering pandas - Second Edition](https://www.packtpub.com/data/mastering-pandas-second-edition?/utm_source=python.org&utm_medium=referral&utm_OutreachB11257dollar5){.https}

Ashish Kumar

ISBN 13: 9781789343236 Packt Course Length: 20 hours 13 minutes (25 Oct 2019)
...
With this book, you will learn how to perform efficient data analysis using pandas on complex data, and become an expert data analyst or data scientist in the process.

[Publisher\'s page](https://www.packtpub.com/data/mastering-pandas-second-edition?/utm_source=python.org&utm_medium=referral&utm_OutreachB11257dollar5){.https}

------------------------------------------------------------------------

[Python API Development Fundamentals](https://www.packtpub.com/web-development/python-api-development-fundamentals?utm_source=wiki.python.org&utm_medium=wiki&utm_campaign=OutreachB15308fivedollar){.https}

Jack Huang, Ray Chung, Et al

ISBN 13 :9781838983994 Packt 372 Pages (22 Nov 2019)
...
[Publisher\'s page](https://www.packtpub.com/web-development/python-api-development-fundamentals?utm_source=wiki.python.org&utm_medium=wiki&utm_campaign=OutreachB15308fivedollar){.https}

------------------------------------------------------------------------

[Full-Stack React, Python, and GraphQL \[Video](https://www.packtpub.com/web-development/full-stack-react-python-and-graphql-video?utm_source=Python.org&utm_medium=wikiforum&utm_campaign=OutreachV15708){.https}\]

Reed Barger

ISBN 13: 9781839215698 Packt Course Length: 6 hours 35 minutes (24 Oct 2019)

Video Overview:

Develop impressive, rich full-stack apps with the latest and greatest features of Python, React, and GraphQL

This course is for developers keen to build complete, full-stack applications with cutting-edge React user interfaces, powered by a robust Python backend and using GraphQL on the server and client. This course was designed for developers keen to get ahead of the curve in the latest web technologies, and focuses on how to use GraphQL from front to back, the most current techniques and tools in React (including React Hooks, Apollo Boost, and Material UI), and how to combine it all with Python, Django, and Graphene for an amazing stack.
...
This app will be a social music-sharing app called [ReactTracks](./ReactTracks.html){.nonexistent} where users can upload and share any music they like, interact with various tracks by liking them and adding them to their profile, searching for tracks, adding information about their music, and editing/deleting their tracks.

[Publisher\'s page](https://www.packtpub.com/web-development/full-stack-react-python-and-graphql-video?utm_source=Python.org&utm_medium=wikiforum&utm_campaign=OutreachV15708){.https}

------------------------------------------------------------------------

[Learn Python and Ethical Hacking from Scratch \[Video](https://www.packtpub.com/security/learn-python-and-ethical-hacking-from-scratch-video?utm_source=Python.org&utm_medium=wikiforum&utm_campaign=Outreach%20V15319){.https}\]

Zaid Sabih

ISBN 13:9781839214561 Packt course Length: 23 hours 29 minutes (11 Oct 2019)

Video Overview:

Start from scratch and learn both topics simultaneously by writing 20+ hacking programs
...
All the code files are placed at [https://github.com/PacktPublishing/Learn-Python-and-Ethical-Hacking-From-Scratch](https://github.com/PacktPublishing/Learn-Python-and-Ethical-Hacking-From-Scratch){.https}

[Publisher\'s page](https://www.packtpub.com/security/learn-python-and-ethical-hacking-from-scratch-video?utm_source=Python.org&utm_medium=wikiforum&utm_campaign=Outreach%20V15319){.https}

------------------------------------------------------------------------

[Reinforcement Learning Algorithms with Python](https://www.packtpub.com/data/hands-on-reinforcement-learning-algorithms-with-python?utm_source=Python.org&utm_medium=wikiforum&utm_campaign=OutreachB10405){.https}

Andrea Lonza

ISBN 13:9781789131116 Packt 366 Pages (18 Oct 2019)

Book Overview:

Develop self-learning algorithms and agents using [TensorFlow](./TensorFlow.html){.nonexistent} and other Python tools, frameworks, and libraries

Reinforcement Learning (RL) is a popular and promising branch of AI that involves making smarter models and agents that can automatically determine ideal behaviour based on changing requirements. This book will help you master RL algorithms and understand their implementation as you build self-learning agents.
...
[Publisher\'s page](https://www.packtpub.com/data/hands-on-reinforcement-learning-algorithms-with-python?utm_source=Python.org&utm_medium=wikiforum&utm_campaign=OutreachB10405){.https}

------------------------------------------------------------------------

[Python A-Z - Learn Python Programming By Building 5 Projects \[Video](https://www.packtpub.com/programming/python-a-z-learn-python-programming-by-building-5-projects-video){.https}\]

Shubham Sarda

ISBN 13: 9781839212956 Packt Course Length: 12 hours 21 minutes 11 Oct 2019 (MONTH YEAR)
...
All the codes and supporting files for this course are available at -[https://github.com/PacktPublishing/Python-A-Z\-\--Learn-Python-Programming-By-Building-5-Projects](https://github.com/PacktPublishing/Python-A-Z---Learn-Python-Programming-By-Building-5-Projects){.https}

[Publisher\'s page](https://www.packtpub.com/programming/python-a-z-learn-python-programming-by-building-5-projects-video){.https}

------------------------------------------------------------------------

[Python Parallel Programming Cookbook - Second Edition](https://www.packtpub.com/programming/python-parallel-programming-cookbook?/utm_source=python.org&utm_medium=referral&utm_Outreach){.https}

Giancarlo Zaccone

ISBN 13: 9781789533736 Packt 370 pages Pages: 11 hours 6 minutes (6 Sep 2019)
...
[Publisher\'s page](https://www.packtpub.com/programming/python-parallel-programming-cookbook?/utm_source=python.org&utm_medium=referral&utm_OutreachTITLE%20URL){.https}

------------------------------------------------------------------------

[Python GUI Programming Cookbook - Third Edition](https://www.packtpub.com/programming/python-gui-programming-cookbook-third-edition?/utm_source=python.org&utm_medium=referral&utm_Outreach){.https}

Burkhard Meier

ISBN 13: 9781838827540 Packt 486 Pages (11 Oct 2019)
...
[Publisher\'s page](https://www.packtpub.com/programming/python-gui-programming-cookbook-third-edition?/utm_source=python.org&utm_medium=referral&utm_Outreach){.https}

------------------------------------------------------------------------

[Python GUI Programming - A Complete Reference Guide](https://www.packtpub.com/?utm_source=wiki.python&utm_medium=referral&utm_DataUnlocked){.https}

Alan D. Moore and B.M. Harwani

ISBN 13: 9781838988470 Packt 746 Pages (24 Jun 2019)
...
[Publisher\'s page](https://www.packtpub.com/programming/python-gui-programming-a-complete-reference-guide){.https}

------------------------------------------------------------------------

[Python Clean Coding](https://www.packtpub.com/programming/python-clean-coding-video){.https}

Peter Fisher

ISBN 13: 9781788831079 Course Length: 2 hours 8 minutes (3 Jul 2019)
...
With this course we will apply what we've learned in the previous videos to rewriting and reorganizing real-world Python programs into clean and beautiful code that can be more easily understood, debugged, and extended.

[Publisher\'s page](https://www.packtpub.com/programming/python-clean-coding-video){.https}

------------------------------------------------------------------------

[Python GUI Programming - A Complete Reference Guide](https://www.packtpub.com/programming/python-gui-programming-a-complete-reference-guide){.https}

Alan D. Moore and B.M. Harwani

ISBN 13: 9781838988470 Packt 746 Pages Course Length: 22 hours 22 minutes (24 Jun 2019)
...
[Hands-On Qt for Python Developers](https://www.packtpub.com/application-development/hands-qt-python-developers?utm_source=python-forum.io&utm_medium=referral&utm_campaign=Outreach){.https}

Volodymyr Kirichinets

ISBN 13: 9781789612790 Packt 770 Pages (29 May 2019)

Book Overview:

Boost UI development with ready-made widgets, controls, charts, and data visualization and create stunning 2D and 3D graphics with [PyQt](PyQt) and [PySide2](./PySide2.html){.nonexistent}.
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-qt-python-developers?utm_source=python-forum.io&utm_medium=referral&utm_campaign=Outreach){.https}

------------------------------------------------------------------------

[Deep Learning and Neural Networks using Python - Keras: The Complete Beginners Guide](https://www.packtpub.com/application-development/deep-learning-and-neural-networks-using-python-keras-complete-beginners-guid){.https}

Abilash Nelson

ISBN 13: 9781838986476 Packt Course Length: 11 hours 7 minutes (28 May 2019)

Video Overview:

Deep learning and data science using a Python and Keras library - The complete guide from a beginner to professional

The world has been obsessed with the terms \"machine learning\" and \"deep learning\" recently. We use these technologies every day, with or without our knowledge. Ranging from Google suggestions to translations, ads, movie recommendations, friend suggestions, sales and customer experiences. There are tons of other applications too so there's no wonder that deep learning and machine learning specialists, along with data science practitioners, are the most sought-after talent in the current technology world. But the problem is that, when you think about learning these technologies, there is a common misconception that it's a prerequisite to study lots of maths, statistics, and complex algorithms. It's almost like someone making you believe that you must learn the working of an internal combustion engine before you learn how to drive a car

This course is organized and an overview of the list of topics included. Overall, this is a basic to an advanced crash course in deep learning neural networks and convolutional neural networks using Keras and Python.

[Publisher\'s page](https://www.packtpub.com/application-development/deep-learning-and-neural-networks-using-python-keras-complete-beginners-guid){.https}

------------------------------------------------------------------------

[Using MySQL Databases With Python](https://www.packtpub.com/application-development/using-mysql-databases-python-video){.https}

John Elder

ISBN 13: 9781838984670 Packt Course Length: 2 hours 2 minutes (28 May 2019)

Video Overview:

Learn the [MySql](./MySql.html){.nonexistent} Database with Python the fast and easy way!

These days, everything uses a database, and MySQL is one of the most popular databases out there. FREE and Open Source, Mysql is a great database for just about all of your needs. Likewise, Python is one of the most popular and powerful programming languages today. Pairing the two together is a powerful combination!

With this course, you\'ll learn the basics of using MySQL with Python. You\'ll learn how to create databases and tables, add data, sort data, create reports, pull specific data, and more.

[Publisher\'s page](https://www.packtpub.com/application-development/using-mysql-databases-python-video){.https}

------------------------------------------------------------------------

[Hands-On Qt for Python Developers](https://www.packtpub.com/application-development/hands-qt-python-developers){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-qt-python-developers){.https}

------------------------------------------------------------------------

[Hands-On GPU Computing with Python](https://www.packtpub.com/big-data-and-business-intelligence/hands-gpu-computing-python){.https}

Avimanyu Bandyopadhyay

ISBN 13: 9781789341072 Packt 452 Pages (13 May 2019)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-gpu-computing-python){.https}

------------------------------------------------------------------------

------------------------------------------------------------------------

[Mastering GUI Programming with Python](https://www.packtpub.com/application-development/mastering-gui-programming-python){.https}

Alan D. Moore

ISBN : 9781789612905 Packt Pages : 542 pages (23 May 2019)
...
You will get started with an introduction to [PyQt5](./PyQt5.html){.nonexistent}, before going on to develop stunning GUIs with modern features. You will then learn how to build forms using QWidgets and learn about important aspects of GUI development such as layouts, size policies, and event-driven programming. Moving ahead, you'll discover [PyQt5](./PyQt5.html){.nonexistent}'s most powerful features through chapters on audio-visual programming with [QtMultimedia](./QtMultimedia.html){.nonexistent}, database-driven software with QtSQL, and web browsing with [QtWebEngine](./QtWebEngine.html){.nonexistent}. Next, in-depth coverage of multithreading and asynchronous programming will help you run tasks asynchronously and build high-concurrency processes with ease. In later chapters, you'll gain insights into QOpenGLWidget, along with mastering techniques for creating 2D graphics with QPainter. You'll also explore [PyQt](PyQt) on a Raspberry Pi and interface it with remote systems using [QtNetwork](./QtNetwork.html){.nonexistent}. Finally, you will learn how to distribute your applications using setuptools and [PyInstaller](PyInstaller).

By the end of this book, you will have the skills you need to develop robust GUI applications using [PyQt](PyQt).

[Publisher\'s page](https://www.packtpub.com/application-development/mastering-gui-programming-python){.https}

------------------------------------------------------------------------

[MicroPython Cookbook](https://www.packtpub.com/application-development/micropython-cookbook){.https}

Marwan Alsabbagh

ISBN :9781838649951 Packt Pages : 452 (20 May 2019)

Book Overview: **Build practical solutions to control LEDs, make music and read sensor data using popular microcontrollers such as Adafruit Circuit Playground, ESP8266, and the BBC Micro Bit**

The [MicroPython](./MicroPython.html){.nonexistent} book covers recipes that will help you experiment with the programming environment and hardware programmed in [MicroPython](./MicroPython.html){.nonexistent}. You\'ll find tips and techniques for building a variety of objects and prototypes that can sense and respond to touch, sound, position, heat, and light. This book will take you through the uses of [MicroPython](./MicroPython.html){.nonexistent} with a variety of popular input devices and sensors. You\'ll learn techniques to handle time delays and sensor readings, and apply advanced coding techniques to create complex projects. As you advance, you\'ll deal with Internet of Things (IoT) devices and integration with other online web services. Furthermore, you\'ll also use [MicroPython](./MicroPython.html){.nonexistent} to make music with bananas and create portable multiplayer video games that incorporate sound and light animations into the gameplay.

By the end of the book, you\'ll have mastered the tips and tricks to troubleshoot your development problems and push your [MicroPython](./MicroPython.html){.nonexistent} project to the next level!

[Publisher\'s page](https://www.packtpub.com/application-development/micropython-cookbook){.https}

------------------------------------------------------------------------

[Real World Projects in Python 3.x](https://www.packtpub.com/application-development/real-world-projects-python-3x-video){.https}

- Matthew Macarty

ISBN 13: 9781789953374 Packt Course Length: 2 hours 23 minutes (29 Apr 2019)

Video Overview:

Step by Step practical guide for building real-world projects using Python 3

This course covers the essential concepts in Python 3 showing how to implement them in various applications. You'll learn about Python 3.x new features and develop the skills required for building robust, easily scalable, and maintainable code in Python.Throughout this course, you will be building multiple applications ranging from simpler ones to more complex ones. Learning by doing has its advantages as you will immediately see the concepts explained in action. You will learn how to build scalable, resilient, and effective applications as real-world projects in Python 3.x that suit your software requirements and also furthers your understanding of the Python programming language. By the end of the course, you will build upon your basic programming skills taking your programming skills to another level and conveniently build projects with Python 3.x as per your need.

[Publisher\'s page](https://www.packtpub.com/application-development/real-world-projects-python-3x-video){.https}

------------------------------------------------------------------------

[Applied Deep Learning with PyTorch](https://www.packtpub.com/big-data-and-business-intelligence/applied-deep-learning-pytorch){.https}

Hyatt Saleh

ISBN 13: 9781789804591 Packt 254 Pages (26 Apr 2019)
...
With this book, you'll be able to apply the skills and confidence you\'ve gathered along your learning process to use [PyTorch](./PyTorch.html){.nonexistent} for building deep learning solutions that can solve your business data problems.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/applied-deep-learning-pytorch){.https}

------------------------------------------------------------------------

[Python Data Mining Quick Start Guide](https://www.packtpub.com/big-data-and-business-intelligence/python-data-mining-quick-start-guide){.https}

Nathan Greeneltch

ISBN 13: 9781789800265 Packt 188 Pages (24 Apr 2019)
...
With this book, you will be able to build an efficient data mining pipeline using Python without any hassle.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-data-mining-quick-start-guide){.https}

\-\-- [Troubleshooting Python Deep Learning \[Video](https://prod.packtpub.com/in/big-data-and-business-intelligence/troubleshooting-python-deep-learning-video){.https}\]

Jakub Konczyk

ISBN 13: 9781788998192 Packt Course Length: 3 hours 2 minutes ( 29 April 2019)

Video Overview:

After carefully analyzing the most popular errors or problems that arise while working on Deep Learning models, we have identified the most usable models used for classification in this course and provided practical yet unique solutions to each problem that are easy to understand and implement. You can either follow the entire course or directly jump into the section that covers a specific problem you're facing. Some of the common yet important issues we cover include errors while building and training Deep Learning with neural networks, especially without a specific framework.

By the end of the course, you will be well-versed to tackle and troubleshoot any errors with your Deep learning models.

[Publisher\'s page](https://prod.packtpub.com/in/big-data-and-business-intelligence/troubleshooting-python-deep-learning-video){.https}

------------------------------------------------------------------------

[Hands-On Deep Learning Architectures with Python](https://www.packtpub.com/big-data-and-business-intelligence/hands-deep-learning-architectures-python){.https}

Yuxi (Hayden) Liu, Saransh Mehta

ISBN 13: 9781788998086 Packt 316 Pages (April 2019)
...
With this book you will be able to construct deep models using popular frameworks and datasets with the required design patterns for each architecture. You will be ready to explore the potential of deep architectures in today\'s world.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-deep-learning-architectures-python){.https}

------------------------------------------------------------------------

[OpenCV Computer Vision Examples with Python: A Complete Guide for Dummies \[Video](https://www.packtpub.com/application-development/opencv-computer-vision-examples-python-complete-guide-dummies-video){.https}\]

Abhilash Nelson

ISBN 13: 9781838820817 Packt Course Length: 08 hours 50 minutes (March 2019)
...
[Publisher\'s page](https://www.packtpub.com/application-development/opencv-computer-vision-examples-python-complete-guide-dummies-video){.https}

------------------------------------------------------------------------

[Artificial Intelligence in 3 Hours \[Video](https://www.packtpub.com/application-development/artificial-intelligence-3-hours-video){.https}\]

Luka Anicin

ISBN 13: 9781838646196 Packt Course Length: 03 hours 05 minutes (March 2019)

Video Overview:

Get up and running with AI in less than 3 hours
...
A comprehensive course that takes you through AI in 3 hours. It is packed with step by step instructions and working examples.

[Publisher\'s page](https://www.packtpub.com/application-development/artificial-intelligence-3-hours-video){.https}

------------------------------------------------------------------------

[Hands-On Artificial Intelligence with Keras and Python \[Video](https://www.packtpub.com/application-development/hands-artificial-intelligence-keras-and-python-video){.https}\]

Sandipan Das

ISBN 13: 9781838557829 Packt Course Length: 2 hours 31 minutes (March 2019)
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-artificial-intelligence-keras-and-python-video){.https}

------------------------------------------------------------------------

[Hands-On Python 3.x GUI Programming \[Video](https://www.packtpub.com/application-development/hands-python-3x-gui-programming-video){.https}\]

Burkhard Meier

ISBN 13: 9781789957242 Course Length: 2 hours 56 minutes (March 2019)

Video Overview:

Create complete fluid, interactive and powerful applications with Tkinter & [PyQt5](./PyQt5.html){.nonexistent}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-python-3x-gui-programming-video){.https}

------------------------------------------------------------------------

[Full-Stack Web Development with Flask \[Video](https://www.packtpub.com/web-development/full-stack-web-development-flask-video){.https}\]

Christian Hur

ISBN 13: 9781789957464 Course Length: 5 hours 10 minutes (March 2019)

Video Overview:

Learn to create and deploy simple yet powerful websites using the Flask Framework

In this course, we will cover everything you need to know to build a dynamic web application using the Python and Flask frameworks for seamless full-stack web development. You\'ll dive into the Flask environment and get to know its directory structure, template, and routing systems. Then you\'ll learn to connect to databases such as Flask-SQLAlchemy and Flask-[MongoEngine](./MongoEngine.html){.nonexistent} to help store and track data.

The course will develop your experience in Flask and when you\'ve completed it you will be able to build your own complex web applications.

[Publisher\'s page](https://www.packtpub.com/web-development/full-stack-web-development-flask-video){.https}

------------------------------------------------------------------------

[PyTorch Deep Learning in 7 Days \[Video](https://www.packtpub.com/big-data-and-business-intelligence/pytorch-deep-learning-7-days-video){.https}\]

Will Ballard

ISBN 13: 9781789135367 Packt Course Length: 2 hours 9 minutes (March 2019)

Video Overview:

Seven short lessons and a daily exercise, carefully chosen to get you started with [PyTorch](./PyTorch.html){.nonexistent} Deep Learning faster than other courses

[PyTorch](./PyTorch.html){.nonexistent} is Facebook's latest Python-based framework for Deep Learning. It has the ability to create dynamic Neural Networks on CPUs and GPUs, both with significantly less code compared to other competing frameworks. [PyTorch](./PyTorch.html){.nonexistent} has a unique interface that makes it as easy to learn as [NumPy](NumPy).

This 7-day course is for those who are in a hurry to get started with [PyTorch](./PyTorch.html){.nonexistent}. You will be introduced to the most commonly used Deep Learning models, techniques, and algorithms through [PyTorch](./PyTorch.html){.nonexistent} code. This course is an attempt to break the myth that Deep Learning is complicated and show you that with the right choice of tools combined with a simple and intuitive explanation of core concepts, Deep Learning is as accessible as any other application development technologies out there. It's a journey from diving deep into the fundamentals to getting acquainted with the advanced concepts such as Transfer Learning, Natural Language Processing and implementation of Generative Adversarial Networks.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/pytorch-deep-learning-7-days-video){.https}

------------------------------------------------------------------------

[Hands-On Big Data Analytics with PySpark](https://www.packtpub.com/big-data-and-business-intelligence/hands-big-data-analytics-pyspark){.https}

Rudy Lai, Bartłomiej Potaczek

ISBN 13: 9781838644130 Packt 182 Pages (March 2019)

Book Overview:

Use [PySpark](./PySpark.html){.nonexistent} to easily crush messy data at-scale and discover proven techniques to create testable, immutable, and easily parallelizable Spark jobs
...
You will learn how to source data from all popular data hosting platforms, including HDFS, Hive, JSON, and S3, and deal with large datasets with [PySpark](./PySpark.html){.nonexistent} to gain practical big data experience. This book will help you work on prototypes on local machines and subsequently go on to handle messy data in production and at scale. This book covers installing and setting up [PySpark](./PySpark.html){.nonexistent}, RDD operations, big data cleaning and wrangling, and aggregating and summarizing data into useful reports. You will also learn how to implement some practical and proven techniques to improve certain aspects of programming and administration in Apache Spark.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-big-data-analytics-pyspark){.https}

------------------------------------------------------------------------

[Learning Python Networking - Second Edition](https://www.packtpub.com/networking-and-servers/learning-python-networking-second-edition){.https}

José Manuel Ortega, Dr. M. O. Faruque Sarker, Sam Washington

ISBN 13: 9781789958096 Packt 490 Pages (March 2019)
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/learning-python-networking-second-edition){.https}

------------------------------------------------------------------------

[Data Science for Marketing Analytics](https://www.packtpub.com/big-data-and-business-intelligence/data-science-marketing-analytics){.https}

Tommy Blanchard, Debasish Behera, Pranshu Bhatnagar

ISBN 13: 9781789959413 Packt 420 Pages (March 2019)
...
The book is designed for developers and marketing analysts looking to use new, more sophisticated tools in their marketing analytics efforts. It\'ll help if you have prior experience of coding in Python and knowledge of high school level mathematics. Some experience with databases, Excel, statistics, or Tableau is useful but not necessary.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/data-science-marketing-analytics){.https}

------------------------------------------------------------------------

[Python Machine Learning Cookbook - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-cookbook-second-edition-0){.https}

Giuseppe Ciaburro, Prateek Joshi

ISBN 13: 9781789808452 Packt 642 Pages (March 2019)

Book Overview:

Discover powerful ways to effectively solve real-world machine learning problems using key libraries including scikit-learn, [TensorFlow](./TensorFlow.html){.nonexistent}, and [PyTorch](./PyTorch.html){.nonexistent}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-cookbook-second-edition-0){.https}

------------------------------------------------------------------------

[Hands-On Natural Language Processing with Pytorch {Video}](https://www.packtpub.com/application-development/hands-natural-language-processing-pytorch-video){.https}

Jibin Mathew

ISBN 13: 9781789133974 Packt Course Length: 2 hours 24 minutes (January 2019)

Video Overview:

Use modern NLP tools & techniques with Deep Learning & [PyTorch](./PyTorch.html){.nonexistent} to build intelligent language applications

The main goal of this course is to train you to perform complex NLP tasks (and build intelligent language applications) using Deep Learning with [PyTorch](./PyTorch.html){.nonexistent}.

You will build two complete real-world NLP applications throughout the course. The first application is a Sentiment Analyzer that analyzes data to determine whether a review is positive or negative towards a particular movie. You will then create an advanced Neural Translation Machine that is a speech translation engine, using Sequence to Sequence models with the speed and flexibility of [PyTorch](./PyTorch.html){.nonexistent} to translate given text into different languages.

[Publisher\'s page](https://www.packtpub.com/application-development/hands-natural-language-processing-pytorch-video){.https}

------------------------------------------------------------------------

[Artificial Intelligence and Machine Learning Fundamentals](https://www.packtpub.com/big-data-and-business-intelligence/artificial-intelligence-and-machine-learning-fundamentals){.https}

Zsolt Nagy

ISBN 13: 9781789801651 Packt 330 Pages (December 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/artificial-intelligence-and-machine-learning-fundamentals){.https}

------------------------------------------------------------------------

[Data Analysis with Python](https://www.packtpub.com/big-data-and-business-intelligence/data-analysis-python){.https}

David Taieb

ISBN 13: 9781789950069 Packt 490 Pages (December 2018)
...
Explore the power of this approach to data analysis by then working with it across key industry case studies. Four fascinating and full projects connect you to the most critical data analysis challenges you're likely to meet in today. The first of these is an image recognition application with [TensorFlow](./TensorFlow.html){.nonexistent} -- embracing the importance today of AI in your data analysis. The second industry project analyses social media trends, exploring big data issues and AI approaches to natural language processing.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/data-analysis-python){.https}

------------------------------------------------------------------------

[Computer Vision Projects with OpenCV and Python 3](https://www.packtpub.com/big-data-and-business-intelligence/computer-vision-projects-opencv-and-python-3){.https}

Matthew Rever

ISBN 13: 9781789954555 Packt 182 Pages (December 2018)
...
With the help of this book, you will learn how to set up Anaconda and Python for the major OSes with cutting-edge third-party libraries for Computer Vision. You\'ll learn state-of-the-art techniques for classifying images, finding and identifying human postures, and detecting faces within videos. You will use powerful machine learning tools such as OpenCV, Dlib, and [TensorFlow](./TensorFlow.html){.nonexistent} to build exciting projects such as classifying handwritten digits, detecting facial features,and much more. The book also covers some advanced projects, such as reading text from license plates from real-world images using Google's Tesseract software, and tracking human body poses using [DeeperCut](./DeeperCut.html){.nonexistent} within [TensorFlow](./TensorFlow.html){.nonexistent}.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/computer-vision-projects-opencv-and-python-3){.https}

------------------------------------------------------------------------

[Introduction to Bayesian Analysis in Python (Video)](https://www.packtpub.com/networking-and-servers/introduction-bayesian-analysis-python-video){.https}

Sunil Gupta

ISBN 13: 9781788997010 Packt Course Length: 1 hour 10 minutes (December 2018)
...
All the codes of the course are uploaded on the Github repository: [https://github.com/PacktPublishing/-Introduction-to-Bayesian-Analysis-in-Python](https://github.com/PacktPublishing/-Introduction-to-Bayesian-Analysis-in-Python){.https}

[Publisher\'s page](https://www.packtpub.com/networking-and-servers/introduction-bayesian-analysis-python-video){.https}

------------------------------------------------------------------------

[Deep Learning for Python Developers {Video}](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-python-developers-video){.https}

Will Ballard

ISBN 13: 9781788993883 Packt Course Length: 2 hours 11 minutes (December 2018)

Video Overview:

Use your Python skills to build powerful Deep Learning applications

This course is for Python developers who haven\'t worked with machine learning or data science, and want to build intelligent systems right away---without taking a math degree! You will learn about recurrent neural networks, Backprop, SGD, and more. You will work on code examples that are used in a developer\'s life on a daily basis; you\'ll not only master the theory, you\'ll also see how to applied it in the industry as a whole. You will practice all these ideas in [MxNet](./MxNet.html){.nonexistent}, [TensorFlow](./TensorFlow.html){.nonexistent}, Keras, and Gluon. Last but not the least, build Convolutional Neural Networks and apply them to image data.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-python-developers-video){.https}

------------------------------------------------------------------------

[Hands-On Enterprise Application Development with Python](https://www.packtpub.com/application-development/hands-enterprise-application-development-python){.https}

Saurabh Badhwar

ISBN 13: 9781789532364 Packt 374 pages (December 2018)
...
[Amazon Page](https://www.amazon.com/dp/1789532361){.https}

------------------------------------------------------------------------

[Bayesian Analysis with Python - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/bayesian-analysis-python-second-edition){.https}

Osvaldo Martin

ISBN 13: 9781789341652 Packt 356 Pages (December 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/bayesian-analysis-python-second-edition){.https}

------------------------------------------------------------------------

[Hands-On Predictive Analytics with Python](https://www.packtpub.com/big-data-and-business-intelligence/hands-predictive-analytics-python){.https}

Alvaro Fuentes

ISBN 13: 9781789138719 Packt 330 Pages (December 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-predictive-analytics-python){.https}

------------------------------------------------------------------------

[Learning Python Artificial Intelligence by Example (Video)](https://www.packtpub.com/big-data-and-business-intelligence/learning-python-artificial-intelligence-example-video){.https}

Mark Strefford

ISBN 13: 9781788839532 Packt Course Length: 1 hour 58 minutes (November 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/learning-python-artificial-intelligence-example-video){.https}

------------------------------------------------------------------------

[Consuming Python APIs with React (Video)](https://www.packtpub.com/application-development/consuming-python-apis-react-video){.https}

Wayne Merry

ISBN 13: 9781788396073 Packt Course Length: 2 hours 21 minutes (November 2018 )
...
[Publisher\'s page](https://www.packtpub.com/application-development/consuming-python-apis-react-video){.https}

------------------------------------------------------------------------

[Bioinformatics with Python Cookbook - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/bioinformatics-python-cookbook-second-edition){.https}

Tiago Antao

ISBN 13: 9781789344691 Packt 360 Pages (November 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/bioinformatics-python-cookbook-second-edition){.https}

------------------------------------------------------------------------

[Hands-On Image Processing with Python](https://www.packtpub.com/big-data-and-business-intelligence/hands-image-processing-python){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-image-processing-python){.https}

------------------------------------------------------------------------

[Natural Language Processing with Python Quick Start Guide](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-python-quick-start-guide){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-python-quick-start-guide){.https}

------------------------------------------------------------------------

[Recurrent Neural Networks with Python Quick Start Guide](https://www.packtpub.com/big-data-and-business-intelligence/recurrent-neural-networks-python-quick-start-guide){.https}
...
Learn how to develop intelligent applications with sequential learning and apply modern methods for language modeling with neural network architectures for deep learning with Python\'s most popular [TensorFlow](./TensorFlow.html){.nonexistent} framework.

Developers struggle to find an easy-to-follow learning resource for implementing Recurrent Neural Network (RNN) models. RNNs are the state-of-the-art model in deep learning for dealing with sequential data. From language translation to generating captions for an image, RNNs are used to continuously improve results. This book will teach you the fundamentals of RNNs, with example applications in Python and the [TensorFlow](./TensorFlow.html){.nonexistent} library. The examples are accompanied by the right combination of theoretical knowledge and real-world implementations of concepts to build a solid foundation of neural network modeling.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/recurrent-neural-networks-python-quick-start-guide){.https}

------------------------------------------------------------------------

[Hands-On GPU Programming with Python and CUDA](https://www.packtpub.com/application-development/hands-gpu-programming-python-and-cuda){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-gpu-programming-python-and-cuda){.https}

------------------------------------------------------------------------

[Hands-On OpenCV 4 with Python](https://india.packtpub.com/in/big-data-and-business-intelligence/hands-opencv-4-python-video){.https}
...
[Publisher\'s page](https://india.packtpub.com/in/big-data-and-business-intelligence/hands-opencv-4-python-video){.https}

------------------------------------------------------------------------

[Mastering Concurrency in Python](https://www.packtpub.com/application-development/mastering-concurrency-python){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/mastering-concurrency-python){.https}

------------------------------------------------------------------------

[Hands-On Reactive Programming with Python](https://www.packtpub.com/application-development/hands-reactive-programming-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-reactive-programming-python-video){.https}

------------------------------------------------------------------------

[Application Development with Python and Flask](https://www.packtpub.com/application-development/application-development-python-and-flask-video){.https}
...
[Hands-On Software Engineering with Python](https://packtpub.com/application-development/hands-software-engineering-python){.https}
...
[Publisher\'s page](https://packtpub.com/application-development/hands-software-engineering-python){.https}

------------------------------------------------------------------------

[Hands-On Data Structures and Algorithms with Python - Second Edition](https://packtpub.com/application-development/hands-data-structures-and-algorithms-python-second-edition){.https}
...
[Publisher\'s page](https://packtpub.com/application-development/hands-data-structures-and-algorithms-python-second-edition){.https}

------------------------------------------------------------------------

[The Complete Machine Learning Course with Python (Video)](https://www.packtpub.com/application-development/complete-machine-learning-course-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/complete-machine-learning-course-python-video){.https}

------------------------------------------------------------------------

[Master Computer Vision OpenCV3 in Python and Machine Learning (Video)](https://www.packtpub.com/application-development/master-computer-vision-opencv3-python-and-machine-learning-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/master-computer-vision-opencv3-python-and-machine-learning-video){.https}

------------------------------------------------------------------------

[Python for Finance: Investment Fundamentals and Data Analytics](https://www.packtpub.com/application-development/python-finance-investment-fundamentals-and-data-analytics-video){.https}
...
The code bundle for this video course is available at [https://github.com/PacktPublishing/Python-for-Finance-Investment-Fundamentals-and-Data-Analytics](https://github.com/PacktPublishing/Python-for-Finance-Investment-Fundamentals-and-Data-Analytics){.https}.

------------------------------------------------------------------------

[Applied Data Science with Python and Jupyter](https://www.packtpub.com/big-data-and-business-intelligence/applied-data-science-python-and-jupyter){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/applied-data-science-python-and-jupyter){.https}

------------------------------------------------------------------------

[Hands-On Reactive Programming with Python](https://india.packtpub.com/in/application-development/hands-reactive-programming-python){.https}
...
[Publisher\'s page](https://india.packtpub.com/in/application-development/hands-reactive-programming-python){.https}

------------------------------------------------------------------------

[Learn Computer Vision with Python and OpenCV \[Video](https://india.packtpub.com/in/application-development/learn-computer-vision-python-and-opencv-video){.https}\]
...
[Publisher\'s page](https://india.packtpub.com/in/application-development/learn-computer-vision-python-and-opencv-video){.https}

------------------------------------------------------------------------

[Learning Vue.js 2.0](https://india.packtpub.com/in/web-development/learning-vuejs-20-video){.https}
...
[Publisher\'s page](https://india.packtpub.com/in/web-development){.https}

------------------------------------------------------------------------

[Hands-On Reactive Programming with Python](https://www.packtpub.com/application-development/hands-reactive-programming-python){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-reactive-programming-python){.https}

------------------------------------------------------------------------

[Mastering Flask Web Development - Second Edition](https://www.packtpub.com/web-development/mastering-flask-web-development-second-edition){.https}
...
You\'ll begin by learning about the installation of Flask and basic concepts such as MVC and accessing a database using an ORM. You will learn how to structure your application so that it can scale to any size with the help of Flask Blueprints. You\'ll then learn how to use Jinja2 templates with a high level of expertise. You will also learn how to develop with SQL or NoSQL databases, and how to develop REST APIs and JWT authentication. Next, you\'ll move on to build role-based access security and authentication using LDAP, OAuth, OpenID, and database. Also learn how to create asynchronous tasks that can scale to any load using Celery and RabbitMQ or Redis. You will also be introduced to a wide range of Flask extensions to leverage technologies such as cache, localization, and debugging. You will learn how to build your own Flask extensions, how to write tests, and how to get test coverage reports. Finally, you will learn how to deploy your application on Heroku and AWS using various technologies, such as Docker, [CloudFormation](./CloudFormation.html){.nonexistent}, and Elastic Beanstalk, and will also learn how to develop Jenkins pipelines to build, test, and deploy applications.

[Publisher\'s page](https://www.packtpub.com/web-development/mastering-flask-web-development-second-edition){.https}

------------------------------------------------------------------------

[Machine Learning for Healthcare Analytics Projects](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-healthcare-analytics-projects){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-healthcare-analytics-projects){.https}

------------------------------------------------------------------------

[Machine Learning with scikit-learn Quick Start Guide](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-scikit-learn-quick-start-guide){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-scikit-learn-quick-start-guide){.https}

------------------------------------------------------------------------

[Python Deep Learning Projects](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning-projects){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning-projects){.https}

------------------------------------------------------------------------

[Mastering Python for Networking and Security](https://www.packtpub.com/networking-and-servers/mastering-python-networking-and-security){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/mastering-python-networking-and-security){.https}

------------------------------------------------------------------------

[Python Automation Cookbook](https://www.packtpub.com/application-development/python-automation-cookbook){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-automation-cookbook){.https}

------------------------------------------------------------------------

[Mastering Predictive Analytics with scikit-learn and TensorFlow](https://www.packtpub.com/big-data-and-business-intelligence/mastering-predictive-analytics-scikit-learn-and-tensorflow){.https}
...
Python is a programming language that provides a wide range of features that can be used in the field of data science. Mastering Predictive Analytics with scikit-learn and [TensorFlow](./TensorFlow.html){.nonexistent} covers various implementations of ensemble methods, how they are used with real-world datasets, and how they improve prediction accuracy in classification and regression problems.

This book starts with ensemble methods and their features. You will see that scikit-learn provides tools for choosing hyperparameters for models. As you make your way through the book, you will cover the nitty-gritty of predictive analytics and explore its features and characteristics. You will also be introduced to artificial neural networks and [TensorFlow](./TensorFlow.html){.nonexistent}, and how it is used to create neural networks. In the final chapter, you will explore factors such as computational power, along with improvement methods and software enhancements for efficient predictive analytics.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/mastering-predictive-analytics-scikit-learn-and-tensorflow){.https}

------------------------------------------------------------------------

[Binary Exploits with Python](https://www.packtpub.com/networking-and-servers/binary-exploits-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/binary-exploits-python-video){.https}

------------------------------------------------------------------------

[Python Reinforcement Learning Projects](https://www.packtpub.com/big-data-and-business-intelligence/python-reinforcement-learning-projects){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-reinforcement-learning-projects){.https}

------------------------------------------------------------------------

[Hands-On Markov Models with Python](https://www.packtpub.com/big-data-and-business-intelligence/hands-markov-models-python){.https}
...
Unleash the power of unsupervised machine learning in Hidden Markov Models using [TensorFlow](./TensorFlow.html){.nonexistent}, pgmpy, and hmmlearn
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-markov-models-python){.https}

------------------------------------------------------------------------

[Mastering Natural Language Processing with Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/mastering-natural-language-processing-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/mastering-natural-language-processing-python-video){.https}

------------------------------------------------------------------------

[Hands-on Supervised Machine Learning with Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/hands-supervised-machine-learning-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-supervised-machine-learning-python-video){.https}

------------------------------------------------------------------------

[Real-World Machine Learning Projects with Scikit-Learn \[Video](https://www.packtpub.com/big-data-and-business-intelligence/real-world-machine-learning-projects-scikit-learn-video){.https}\]
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/real-world-machine-learning-projects-scikit-learn-video){.https}

------------------------------------------------------------------------

[Beginning Selenium WebDriver Testing in Python](https://www.packtpub.com/web-development/beginning-selenium-webdriver-testing-python-video){.https}
...
This course introduces Python users to Selenium [WebDriver](./WebDriver.html){.nonexistent}. It will help users with basic programming knowledge to start code-testing. This course will help users cut down on their time spent on testing code written in Python.
...
[Publisher\'s page](https://www.packtpub.com/web-development/beginning-selenium-webdriver-testing-python-video){.https}

------------------------------------------------------------------------

[Become a Python Data Analyst](https://www.packtpub.com/big-data-and-business-intelligence/become-python-data-analyst){.https}
...
[Publisher\'s page](https://www.amazon.com/Become-Python-Data-Analyst-exploratory/dp/1789531705){.https}

------------------------------------------------------------------------

[Hands-On Bitcoin Programming with Python](https://www.packtpub.com/big-data-and-business-intelligence/hands-bitcoin-programming-python){.https}
...
[Publisher\'s page](https://www.amazon.com/Hands-Bitcoin-Programming-Python-applications/dp/1789537002){.https}

------------------------------------------------------------------------

[Applied Deep Learning with Python](https://www.amazon.com/dp/1789804744){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/applied-deep-learning-python){.https}

------------------------------------------------------------------------

[Modern Python Standard Library Cookbook](https://www.amazon.com/Modern-Python-Standard-Library-Cookbook/dp/1788830822/){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/modern-python-standard-library-cookbook){.https}

------------------------------------------------------------------------

[Clean Code in Python](https://www.packtpub.com/application-development/clean-code-python){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/clean-code-python){.https}

------------------------------------------------------------------------

[PyCharm for Power-Developer (Video)](https://www.packtpub.com/web-development/pycharm-power-developer-video){.https}
...
In this course, you'll learn how to improve your code quality with Lens Mode and Intentions, refactor and debug code, and perform unit testing with the [PyCharm](./PyCharm.html){.nonexistent} test runner. Along the way, we'll work with SQL databases. Further on, you'll learn to integrate Python with web projects that include HTML and [JavaScript](./JavaScript.html){.nonexistent} and build a project with the Flask microframework.

By the end of the course, you'll be well-versed with a terrific tool for Python development---[PyCharm](./PyCharm.html){.nonexistent}---and be able to do everything expected of a Python developer.

[Publisher\'s page](https://www.packtpub.com/web-development/pycharm-power-developer-video){.https}

------------------------------------------------------------------------

[pytest Quick Start Guide](https://www.amazon.com/dp/1789347564){.https}
...
[Publisher\'s page](https://www.packtpub.com/web-development/pytest-quick-start-guide){.https}

------------------------------------------------------------------------

[Mastering Python Networking - Second Edition](https://www.amazon.com/dp/1789135990){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/mastering-python-networking-second-edition){.https}

------------------------------------------------------------------------

[Hands-On Natural Language Processing with Python](https://www.amazon.com/dp/178913949X){.https}
...
Foster your NLP applications with the help of deep learning, NLTK, and [TensorFlow](./TensorFlow.html){.nonexistent}
...
To begin with, you will understand the core concepts of NLP and deep learning, such as Convolutional Neural Networks (CNNs), recurrent neural networks (RNNs), semantic embedding, Word2vec, and more. You will learn how to perform each and every task of NLP using neural networks, in which you will train and deploy neural networks in your NLP applications. You will get accustomed to using RNNs and CNNs in various application areas, such as text classification and sequence labeling, which are essential in the application of sentiment analysis, customer service chatbots, and anomaly detection. You will be equipped with practical knowledge in order to implement deep learning in your linguistic applications using Python\'s popular deep learning library, [TensorFlow](./TensorFlow.html){.nonexistent}.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-natural-language-processing-python){.https}

------------------------------------------------------------------------

[Hands-On Recommendation Systems with Python](https://www.amazon.com/dp/1788993756){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-recommendation-systems-python){.https}

------------------------------------------------------------------------

[Getting Started with Modern Python (Video)](https://www.packtpub.com/application-development/getting-started-modern-python-video-0){.https}
...
[Publisher\'s page](https://www.packtpub.com/web-development/building-rest-apis-python-video){.https}

------------------------------------------------------------------------

[Python Tips, Tricks and Techniques (Video)](https://www.packtpub.com/application-development/python-tips-tricks-and-techniques-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-tips-tricks-and-techniques-video){.https}

------------------------------------------------------------------------

[Tips, Tricks, and Techniques for Python Application Development (Video)](https://www.packtpub.com/application-development/tips-tricks-and-techniques-python-application-development-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/tips-tricks-and-techniques-python-application-development-video){.https}

------------------------------------------------------------------------

[Troubleshooting Python Application Development (Video)](https://www.packtpub.com/application-development/troubleshooting-python-application-development-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/troubleshooting-python-application-development-video){.https}

------------------------------------------------------------------------

[Hands-on Network Programming with Python {Video}](https://www.packtpub.com/networking-and-servers/hands-network-programming-python-video-0){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/hands-network-programming-python-video-0){.https}

------------------------------------------------------------------------

[Hands-on NLP with NLTK and Scikit-learn {Video}](https://www.packtpub.com/big-data-and-business-intelligence/hands-nlp-nltk-and-scikit-learn-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-nlp-nltk-and-scikit-learn-video){.https}

------------------------------------------------------------------------

[Data Science Essentials Advanced Algorithms and Visualizations (Video)](https://www.packtpub.com/big-data-and-business-intelligence/data-science-essentials-advanced-algorithms-and-visualizations-vi){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/data-science-essentials-advanced-algorithms-and-visualizations-vi){.https}

------------------------------------------------------------------------

[Statistical Methods and Applied Mathematics in Data Science (Video)](https://www.packtpub.com/big-data-and-business-intelligence/statistical-methods-and-applied-mathematics-data-science-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/statistical-methods-and-applied-mathematics-data-science-video){.https}

------------------------------------------------------------------------

[Qt5 Python GUI Programming Cookbook](https://www.amazon.com/dp/1788831004){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/qt5-python-gui-programming-cookbook){.https}

------------------------------------------------------------------------

[Building Machine Learning Systems with Python - Third Edition](https://www.amazon.com/dp/1788623223){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/building-machine-learning-systems-python-third-edition){.https}

------------------------------------------------------------------------

[Building Serverless Python Web Services with Zappa](https://www.amazon.com/dp/1788837614){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/building-serverless-python-web-services-zappa){.https}

------------------------------------------------------------------------

[PySpark Cookbook](https://www.amazon.com/dp/1788836529){.https}
...
You'll start by learning the Apache Spark architecture and how to set up a Python environment for Spark. You'll then get familiar with the modules available in [PySpark](./PySpark.html){.nonexistent} and start using them effortlessly. In addition to this, you'll discover how to abstract data with RDDs and [DataFrames](./DataFrames.html){.nonexistent}, and understand the streaming capabilities of [PySpark](./PySpark.html){.nonexistent}. You'll then move on to using ML and MLlib in order to solve any problems related to the machine learning capabilities of [PySpark](./PySpark.html){.nonexistent} and use [GraphFrames](./GraphFrames.html){.nonexistent} to solve graph-processing problems. Finally, you will explore how to deploy your applications to the cloud using the spark-submit command.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/pyspark-cookbook){.https}

------------------------------------------------------------------------

[Hands-On Reinforcement Learning with Python](https://www.amazon.com/dp/1788836529){.https}
...
The book starts with an introduction to Reinforcement Learning followed by OpenAI Gym, and [TensorFlow](./TensorFlow.html){.nonexistent}. You will then explore various RL algorithms and concepts, such as Markov Decision Process, Monte Carlo methods, and dynamic programming, including value and policy iteration. This example-rich guide will introduce you to deep reinforcement learning algorithms, such as Dueling DQN, DRQN, A3C, PPO, and TRPO. You will also learn about imagination-augmented agents, learning from human preference, DQfD, HER, and many more of the recent advancements in reinforcement learning.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-reinforcement-learning-python){.https}

------------------------------------------------------------------------

[Mastering Numerical Computing with NumPy](https://www.amazon.com/dp/1788993357){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/mastering-numerical-computing-numpy){.https}

------------------------------------------------------------------------

[Learn Python Programming - Second Edition](https://www.amazon.com/dp/1788996666){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/learn-python-programming-second-edition){.https}

------------------------------------------------------------------------

[Hands-On Enterprise Automation with Python](https://www.amazon.com/dp/1788998510){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/hands-enterprise-automation-python){.https}

------------------------------------------------------------------------

[Mastering Machine Learning for Penetration Testing](https://www.amazon.com/dp/1788997409){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/mastering-machine-learning-penetration-testing){.https}

------------------------------------------------------------------------

[Deep Learning Projects with PyTorch (Video)](https://www.packtpub.com/application-development/deep-learning-projects-pytorch-video){.https}
...
Step into the world of [PyTorch](./PyTorch.html){.nonexistent} to create deep learning models with the help of real-world examples

[PyTorch](./PyTorch.html){.nonexistent} is a Deep Learning framework that is a boon for researchers and data scientists. It supports Graphic Processing Units and is a platform that provides maximum flexibility and speed. With [PyTorch](./PyTorch.html){.nonexistent}, you can dynamically build neural networks and easily perform advanced Artificial Intelligence tasks.

The course starts with the fundamentals of [PyTorch](./PyTorch.html){.nonexistent} and how to use basic commands. Next, you'll learn about Convolutional Neural Networks (CNN) through an example of image recognition, where you'll look into images from a machine perspective.
...
We'll continue with Boltzmann Machines, where you'll learn to give movie ratings using [AutoEncoders](./AutoEncoders.html){.nonexistent}. In the end, you'll get to develop and train a model to recognize a picture or an object from a given image using Deep Learning, where we'll not only detect the shape, but also the color of the object.

By the end of the course, you'll be able to start using [PyTorch](./PyTorch.html){.nonexistent} to build Deep Learning models by implementing practical projects in the real world. So, grab this course as it will take you through interesting real-world projects to train your first neural nets.

[Publisher\'s page](https://www.packtpub.com/application-development/deep-learning-projects-pytorch-video){.https}

------------------------------------------------------------------------

[Computer Vision Projects with Python 3 (Video)](https://www.packtpub.com/big-data-and-business-intelligence/computer-vision-projects-python-3-video){.https}
...
Next, you'll understand how to set up Anaconda Python 3 for the major OSes (Windows, Mac, and Linux) and augment it with the powerful vision and machine learning tools OpenCV and [TensorFlow](./TensorFlow.html){.nonexistent}, as well as Dlib. You'll be taken through the handwritten digits classifier and then move on to detecting facial features and finally develop a general image classifier.

By the end of this course, you'll know the basic tools of computer vision and be able to put it into practice.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/computer-vision-projects-python-3-video){.https}

------------------------------------------------------------------------

[Beginning Data Science with Python And Jupyter](https://www.amazon.com/Beginning-Science-Python-Jupyter-industry-standard-ebook/dp/B07DNJ9KKL/){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/beginning-data-science-python-and-jupyter){.https}

------------------------------------------------------------------------

[Learning Python Web Penetration Testing](https://www.amazon.com/Learning-Python-Web-Penetration-Testing-ebook/dp/B07F3SRDFY/){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/learning-python-web-penetration-testing){.https}

------------------------------------------------------------------------

[Learning Robotics using Python - Second Edition](https://www.amazon.com/dp/1788623312){.https}
...
[Publisher\'s page](https://www.packtpub.com/hardware-and-creative/learning-robotics-using-python-second-edition){.https}

------------------------------------------------------------------------

[Python Testing Cookbook - Second Edition](https://www.amazon.com/dp/1787122522){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-testing-cookbook-second-edition){.https}

------------------------------------------------------------------------

[Python Machine Learning in 7 Days (Video)](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-7-days-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-7-days-video){.https}

------------------------------------------------------------------------

[Hands-On Unsupervised Learning with Python (Video)](https://www.packtpub.com/application-development/hands-unsupervised-learning-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-unsupervised-learning-python-video){.https}

------------------------------------------------------------------------

[Learn Python in 3 Hours (Video)](https://www.packtpub.com/application-development/learn-python-3-hours-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/learn-python-3-hours-video){.https}

------------------------------------------------------------------------

[Python Deep Learning Solutions (Video)](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning-solutions-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/2018-python-regular-expressions-real-world-projects-video){.https}

------------------------------------------------------------------------

[Python Machine Learning Tips, Tricks, and Techniques (Video)](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-tips-tricks-and-techniques-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-tips-tricks-and-techniques-video){.https}

------------------------------------------------------------------------

[Natural Language Processing with TensorFlow](https://www.amazon.com/dp/1788478312){.https}
...
Write modern natural language processing applications using deep learning algorithms and [TensorFlow](./TensorFlow.html){.nonexistent}.

Thushan Ganegedara starts by giving you a grounding in NLP and [TensorFlow](./TensorFlow.html){.nonexistent} basics. You\'ll then learn how to use Word2vec, including advanced extensions, to create word embeddings that turn sequences of words into vectors accessible to deep learning algorithms. Chapters on classical deep learning algorithms, like convolutional neural networks (CNN) and recurrent neural networks (RNN), demonstrate important NLP tasks as sentence classification and language generation. You will learn how to apply high-performance RNN models, like long short-term memory (LSTM) cells, to NLP tasks. You will also explore neural machine translation and implement a neural machine translator.

After reading this book, you will gain an understanding of NLP and you\'ll have the skills to apply [TensorFlow](./TensorFlow.html){.nonexistent} in deep learning NLP applications, and how to perform specific NLP tasks.

[Publisher\'s page](https://www.packtpub.com/application-development/natural-language-processing-tensorflow){.https}

------------------------------------------------------------------------

[Data Visualization Recipes in Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/data-visualization-recipes-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/data-visualization-recipes-python-video){.https}

------------------------------------------------------------------------

[Hands-On Data Science with Anaconda](https://www.amazon.com/Hands-Data-Science-Anaconda-high-performance-ebook/dp/B079Q47BDK/ref=sr_1_1?s=books&ie=UTF8&qid=1528968698&sr=1-1&keywords=Hands-On+Data+Science+with+Anaconda){.https}
...
The book begins with setting up the environment for Anaconda platform in order to make it accessible for tools and frameworks such as Jupyter, pandas, matplotlib, Python, R, Julia, and more. You'll walk through package manager Conda, through which you can automatically manage all packages including cross-language dependencies, and work across Linux, macOS, and Windows. You'll explore all the essentials of data science and linear algebra to perform data science tasks using packages such as [SciPy](SciPy), contrastive, scikit-learn, Rattle, and Rmixmod.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-data-science-anaconda){.https}

------------------------------------------------------------------------

[Python Robotics Projects](https://www.amazon.com/Python-Robotics-Projects-collaborative-robots/dp/1788832922/ref=sr_1_1?s=books&ie=UTF8&qid=1528967623&sr=1-1&keywords=Python+Robotics+Projects){.https}
...
[Publisher\'s page](https://www.packtpub.com/hardware-and-creative/python-robotics-projects){.https}

------------------------------------------------------------------------

[Secret Recipes of the Python Ninja](https://www.amazon.com/Secret-Recipes-Python-Ninja-programming-ebook/dp/B07BYBMGQT/ref=sr_1_1?s=books&ie=UTF8&qid=1528967096&sr=1-1&keywords=Secret+Recipes+of+the+Python+Ninja){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/secret-recipes-python-ninja){.https}

------------------------------------------------------------------------

[Deep learning for NLP using Python (Video)](https://www.packtpub.com/application-development/deep-learning-nlp-using-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/deep-learning-nlp-using-python-video){.https}

------------------------------------------------------------------------

[Getting Started with Object-Oriented Programming in Python 3 (Video)](https://www.packtpub.com/application-development/getting-started-object-oriented-programming-python-3-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/getting-started-object-oriented-programming-python-3-video){.https}

------------------------------------------------------------------------

[Modeling and Visualization of Data in Pandas (Video)](https://www.packtpub.com/application-development/modelling-visualization-data-pandas-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/modelling-visualization-data-pandas-video){.https}

------------------------------------------------------------------------

[Python By Example (Video)](https://www.packtpub.com/application-development/python-example-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-example-video){.https}

------------------------------------------------------------------------

[Applications of Statistical Learning with Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/applications-statistical-learning-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/applications-statistical-learning-python-video){.https}

------------------------------------------------------------------------

[Machine Learning for OpenCV -- Advanced Methods and Deep Learning (Video)](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-opencv-%E2%80%93-advanced-methods-and-deep-learning-vide){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-opencv-%E2%80%93-advanced-methods-and-deep-learning-vide){.https}

------------------------------------------------------------------------

[Hands-On Test Driven Development with Python (Video)](https://www.packtpub.com/application-development/hands-test-driven-development-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-test-driven-development-python-video){.https}

------------------------------------------------------------------------

[Hands-On MQTT Programming with Python](https://www.amazon.com/dp/178913854X/){.https}
...
You will write Python 3.x code to control a vehicle with MQTT messages delivered through encrypted connections (TLS 1.2), and learn how leverage your knowledge of the MQTT protocol to build a solution based on requirements. Towards the end, you will write Python code to use the [PubNub](./PubNub.html){.nonexistent} cloud-based real-time MQTT provider to monitor a surfing competition.
...
[Publisher\'s page](https://www.packtpub.com/application-development/hands-mqtt-programming-python){.https}

------------------------------------------------------------------------

[Python GUI programming with Tkinter](https://www.amazon.com/dp/1788835883/){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-gui-programming-tkinter){.https}

------------------------------------------------------------------------

[Python Penetration Testing Essentials - Second Edition](https://www.amazon.com/dp/1789138965){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/python-penetration-testing-essentials-second-edition){.https}

------------------------------------------------------------------------

[Text Processing Using NLTK in Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/text-processing-using-nltk-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/text-processing-using-nltk-python-video){.https}

------------------------------------------------------------------------

[Deep Learning with PyTorch (Video)](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-pytorch-video){.https}
...
Build useful and effective deep learning models with the [PyTorch](./PyTorch.html){.nonexistent} Deep Learning framework

In this course, you will learn how to accomplish useful tasks using Convolutional Neural Networks to process spatial data such as images and using Recurrent Neural Networks to process sequential data such as texts. You will explore how you can make use of unlabeled data using Auto Encoders. You will also be training a neural network to learn how to balance a pole all by itself, using Reinforcement Learning. Throughout this journey, you will implement various mechanisms of the [PyTorch](./PyTorch.html){.nonexistent} framework to do these tasks.

By the end of the video course, you will have developed a good understanding of, and feeling for, the algorithms and techniques used. You\'ll have a good knowledge of how [PyTorch](./PyTorch.html){.nonexistent} works and how you can use it in to solve your daily machine learning problems.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-pytorch-video){.https}

------------------------------------------------------------------------

[Text Mining with Machine Learning and Python {Video}](https://www.packtpub.com/application-development/text-mining-machine-learning-and-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/developing-nlp-applications-using-nltk-python-video){.https}

------------------------------------------------------------------------

[Matplotlib for Python Developers - Second Edition](https://www.amazon.com/Matplotlib-Python-Developers-techniques-visualization/dp/178862517X/){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/matplotlib-python-developers-second-edition){.https}

------------------------------------------------------------------------

[Functional Python Programming - Second Edition](https://www.amazon.com/Functional-Python-Programming-evaluation-Generator/dp/1788627067/){.https}
...
You'll learn FP concepts such as lazy evaluation using Python's generator functions and expressions. Moving forward, you'll learn to design and implement decorators to create composite functions. You\'ll also explore data preparation techniques and data exploration in depth, and see how the Python standard library fits the functional programming model. Finally, to top off your journey into the world of functional Python, you'll at look at the [PyMonad](./PyMonad.html){.nonexistent} project and some larger examples to put everything into perspective.

[Publisher\'s page](https://www.packtpub.com/application-development/functional-python-programming-second-edition){.https}

------------------------------------------------------------------------

[Machine Learning Solutions](https://www.amazon.com/Machine-Learning-Solutions-techniques-learning-ebook/dp/B07CVXTHLJ/ref=sr_1_3?s=books&ie=UTF8&qid=1525946555&sr=1-3&keywords=Machine+Learning+Solutions){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-solutions){.https}

------------------------------------------------------------------------

[Mastering Geospatial Analysis with Python](https://www.amazon.com/Mastering-Geospatial-Analysis-Python-Silas/dp/1788293339/ref=sr_1_1?s=books&ie=UTF8&qid=1525945298&sr=1-1&keywords=Mastering+Geospatial+Analysis+with+Python){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/mastering-geospatial-analysis-python){.https}

------------------------------------------------------------------------

[Apache Spark with Python - Big Data with PySpark and Spark (Video)](https://www.packtpub.com/big-data-and-business-intelligence/apache-spark-python-big-data-pyspark-and-spark-video){.https}
...
Learn Apache Spark and Python by 12+ hands-on examples of analyzing big data with [PySpark](./PySpark.html){.nonexistent} and Spark

This course covers all the fundamentals of Apache Spark with Python and teaches you everything you need to know about developing Spark applications using [PySpark](./PySpark.html){.nonexistent}, the Python API for Spark. At the end of this course, you will gain in-depth knowledge about Apache Spark and general big data analysis and manipulations skills to help your company to adopt Apache Spark for building big data processing pipeline and data analytics applications.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/apache-spark-python-big-data-pyspark-and-spark-video){.https}

------------------------------------------------------------------------

[Building Serverless Applications with Python](http://www.amazon.com/dp/1787288676){.http}
...
[Publisher\'s page](https://www.packtpub.com/application-development/building-serverless-applications-python){.https}

------------------------------------------------------------------------

[All-in-One Introduction to Programming (Video)](https://www.packtpub.com/application-development/all-one-introduction-programming-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/all-one-introduction-programming-video){.https}

------------------------------------------------------------------------

[Data Visualization Projects in Python (Video)](https://www.packtpub.com/virtualization-and-cloud/data-visualization-projects-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/virtualization-and-cloud/data-visualization-projects-python-video){.https}

------------------------------------------------------------------------

[Python for Everyday Life (Video)](https://www.packtpub.com/application-development/python-everyday-life-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-everyday-life-video){.https}

------------------------------------------------------------------------

[Machine Learning with scikit-learn and Tensorflow {Video}](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-scikit-learn-and-tensorflow-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-scikit-learn-and-tensorflow-video){.https}

------------------------------------------------------------------------

[Hands - On Reinforcement Learning with Python {Video}](https://www.packtpub.com/big-data-and-business-intelligence/hands-reinforcement-learning-python-video){.https}
...
A practical tour of prediction and control in Reinforcement Learning using OpenAI Gym, Python, and [TensorFlow](./TensorFlow.html){.nonexistent}

Reinforcement learning (RL) is hot! This branch of machine learning powers [AlphaGo](./AlphaGo.html){.nonexistent} and Deepmind\'s Atari AI. It allows programmers to create software agents that learn to take optimal actions to maximize reward, through trying out different strategies in a given environment.

This course will take you through all the core concepts in Reinforcement Learning, transforming a theoretical subject into tangible Python coding exercises with the help of OpenAI Gym. The videos will first guide you through the gym environment, solving the [CartPole](./CartPole.html){.nonexistent}-v0 toy robotics problem, before moving on to coding up and solving a multi-armed bandit problem in Python. As the course ramps up, it shows you how to use dynamic programming and [TensorFlow](./TensorFlow.html){.nonexistent}-based neural networks to solve [GridWorld](./GridWorld.html){.nonexistent}, another OpenAI Gym challenge. Lastly, we take the Blackjack challenge and deploy model free algorithms that leverage Monte Carlo methods and Temporal Difference (TD, more specifically SARSA) techniques.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-reinforcement-learning-python-video){.https}

------------------------------------------------------------------------

[Next Generation Natural Language Processing with Python {Video}](https://www.packtpub.com/big-data-and-business-intelligence/next-generation-natural-language-processing-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/next-generation-natural-language-processing-python-video){.https}

------------------------------------------------------------------------

[Learn Machine Learning in 3 Hours (Video)](https://www.packtpub.com/big-data-and-business-intelligence/learn-machine-learning-3-hours-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/learn-machine-learning-3-hours-video){.https}

------------------------------------------------------------------------

[Advanced Artificial Intelligence Projects with Python](https://www.packtpub.com/big-data-and-business-intelligence/advanced-artificial-intelligence-projects-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/advanced-artificial-intelligence-projects-python-video){.https}

------------------------------------------------------------------------

[Create Your Own Sophisticated Model with Neural Networks (Video)](https://www.packtpub.com/big-data-and-business-intelligence/create-your-own-sophisticated-model-neural-networks-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/create-your-own-sophisticated-model-neural-networks-video){.https}

------------------------------------------------------------------------

[Hands-on Artificial Intelligence with TensorFlow (Video)](https://www.packtpub.com/big-data-and-business-intelligence/hands-artificial-intelligence-tensorflow-video){.https}
...
A practical approach to deep learning and deep reinforcement learning for building real-world applications using [TensorFlow](./TensorFlow.html){.nonexistent}.

This course will show you how to combine the power of Artificial Intelligence and [TensorFlow](./TensorFlow.html){.nonexistent} to develop some exciting applications for the real world. This course will take you through all the relevant AI domains, tools, and algorithms required to build optimal solutions and will show you how to implement them hands-on. You will then be taken through techniques such as reinforcement learning, heuristic searches, neural networks, Computer Vision, OpenAI Gym, and more in different stages of your application. This course will show you how to implement AI practically using [TensorFlow](./TensorFlow.html){.nonexistent} models and how it eases the way you interact with the technology.

You will learn how [TensorFlow](./TensorFlow.html){.nonexistent} can be used to analyze a variety of data sets and will learn to optimize various AI algorithms. By the end of the course, you will have learned to build intelligent apps by leveraging the full potential of Artificial Intelligence with [TensorFlow](./TensorFlow.html){.nonexistent}.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-artificial-intelligence-tensorflow-video){.https}

------------------------------------------------------------------------

[OpenCV 3 Computer Vision with Python Cookbook](https://www.amazon.com/dp/1788474449){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/opencv-3-computer-vision-python-cookbook){.https}

------------------------------------------------------------------------

[Learning Concurrency in Python (Video)](https://www.packtpub.com/application-development/learning-concurrency-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/learning-concurrency-python-video){.https}

------------------------------------------------------------------------

[Hands-On Machine Learning with Python and Scikit-Learn (Video)](https://www.packtpub.com/big-data-and-business-intelligence/hands-machine-learning-python-and-scikit-learn-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-machine-learning-python-and-scikit-learn-video){.https}

------------------------------------------------------------------------

[Practical Computer Vision](https://www.amazon.com/Practical-Computer-Vision-insightful-information/dp/1788297687/ref=sr_1_1_sspa?s=books&ie=UTF8&qid=1520576511&sr=1-1-spons&keywords=Practical+Computer+Vision&psc=1){.https}
...
In this book, you will find several recently proposed methods in various domains of computer vision. You will start by setting up the proper Python environment to work on practical applications. This includes setting up libraries such as OpenCV, [TensorFlow](./TensorFlow.html){.nonexistent}, and Keras using Anaconda. Using these libraries, you\'ll start to understand the concepts of image transformation and filtering. You will find a detailed explanation of feature detectors such as FAST and ORB; you\'ll use them to find similar-looking objects.

With an introduction to convolutional neural nets, you will learn how to build a deep neural net using Keras and how to use it to classify the Fashion-MNIST dataset. With regard to object detection, you will learn the implementation of a simple face detector as well as the workings of complex deep-learning-based object detectors such as Faster R-CNN and SSD using [TensorFlow](./TensorFlow.html){.nonexistent}.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/practical-computer-vision){.https}

------------------------------------------------------------------------

[Machine Learning with Scikit-learn (Video)](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-scikit-learn-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-scikit-learn-video){.https}

------------------------------------------------------------------------

[Data Visualization in Python by Examples (Video)](https://www.packtpub.com/virtualization-and-cloud/data-visualization-python-examples-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/virtualization-and-cloud/data-visualization-python-examples-video){.https}

------------------------------------------------------------------------

[Python Web Scraping Cookbook](https://www.amazon.com/dp/1787285219){.https}
...
Right from extracting data from the websites to writing a sophisticated web crawler, the book\'s independent recipes will be a godsend on the job. This book covers Python libraries, requests, and [BeautifulSoup](./BeautifulSoup.html){.nonexistent}. You will learn about crawling, web spidering, working with AJAX websites, paginated items, and more. You will also learn to tackle problems such as 403 errors, working with proxy, scraping images, LXML, and more.
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-web-scraping-cookbook){.https}

------------------------------------------------------------------------

[Working with Big Data in Python (Video)](https://www.packtpub.com/application-development/working-big-data-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/working-big-data-python-video){.https}

------------------------------------------------------------------------

[Learning PySpark (Video)](https://www.packtpub.com/big-data-and-business-intelligence/learning-pyspark-video){.https}
...
You\'ll learn about different techniques for collecting data, and distinguish between (and understand) techniques for processing data. Next, we provide an in-depth review of RDDs and contrast them with [DataFrames](./DataFrames.html){.nonexistent}. We provide examples of how to read data from files and from HDFS and how to specify schemas using reflection or programmatically (in the case of [DataFrames](./DataFrames.html){.nonexistent}). The concept of lazy execution is described and we outline various transformations and actions specific to RDDs and [DataFrames](./DataFrames.html){.nonexistent}.

Finally, we show you how to use SQL to interact with [DataFrames](./DataFrames.html){.nonexistent}. By the end of this tutorial, you will have learned how to process data using Spark [DataFrames](./DataFrames.html){.nonexistent} and mastered data collection techniques by distributed data processing.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/learning-pyspark-video){.https}

------------------------------------------------------------------------

[Concurrent Programming in Python (Video)](https://www.packtpub.com/application-development/concurrent-programming-python-video-0){.https}

[BignumWorks](./BignumWorks.html){.nonexistent} Software LLP
...
[Publisher\'s page](https://www.packtpub.com/application-development/concurrent-programming-python-video-0){.https}
...
[Deep Learning with PyTorch](https://www.amazon.com/dp/1788624335){.https}
...
Build neural network models in text, vision and advanced analytics using [PyTorch](./PyTorch.html){.nonexistent}

This book will get you up and running with one of the most cutting-edge deep learning libraries---[PyTorch](./PyTorch.html){.nonexistent}. [PyTorch](./PyTorch.html){.nonexistent} is grabbing the attention of deep learning researchers and data science professionals due to its accessibility, efficiency and being more native to Python way of development. You\'ll start off by installing [PyTorch](./PyTorch.html){.nonexistent}, then quickly move on to learn various fundamental blocks that power modern deep learning. You will also learn how to use CNN, RNN, LSTM and other networks to solve real-world problems. This book explains the concepts of various state-of-the-art deep learning architectures, such as [ResNet](./ResNet.html){.nonexistent}, [DenseNet](./DenseNet.html){.nonexistent}, Inception, and [Seq2Seq](./Seq2Seq.html){.nonexistent}, without diving deep into the math behind them.

You will also learn about GPU computing during the course of the book. You will see how to train a model with [PyTorch](./PyTorch.html){.nonexistent} and dive into complex neural networks such as generative networks for producing text and images.By the end of the book, you\'ll be able to implement deep learning applications in [PyTorch](./PyTorch.html){.nonexistent} with ease.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-pytorch){.https}

------------------------------------------------------------------------

[Python Network Programming (Video)](https://www.packtpub.com/networking-and-servers/python-network-programming-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/python-network-programming-video){.https}

------------------------------------------------------------------------

[Python Programming Blueprints](https://www.amazon.com/dp/1786468166){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-programming-blueprints){.https}

------------------------------------------------------------------------

[Building Advanced OpenCV3 Projects with Python (Video)](https://www.packtpub.com/application-development/building-advanced-opencv3-projects-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/building-advanced-opencv3-projects-python-video){.https}

------------------------------------------------------------------------

[Deep Learning Essentials](https://www.amazon.com/dp/1785880365/){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/practical-deep-learning){.https}

------------------------------------------------------------------------

[Training Your Systems with Python Statistical Modeling (Video)](https://www.packtpub.com/big-data-and-business-intelligence/training-your-systems-python-statistical-modeling-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/effective-prediction-machine-learning-second-edition-video){.https}

------------------------------------------------------------------------

[IPython Interactive Computing and Visualization Cookbook - Second Edition](https://www.amazon.com/dp/1785888633){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/ipython-interactive-computing-and-visualization-cookbook-second-e){.https}

------------------------------------------------------------------------

[Ensemble Machine Learning](https://www.packtpub.com/big-data-and-business-intelligence/ensemble-machine-learning){.https}
...
Then you'll learn how to implement them by building ensemble models using [TensorFlow](./TensorFlow.html){.nonexistent} and Python libraries such as scikit-learn and [NumPy](NumPy). As machine learning touches almost every field of the digital world, you'll see how these algorithms can be used in different applications such as computer vision, speech recognition, making recommendations, grouping and document classification, fitting regression on data, and more.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/ensemble-machine-learning){.https}

------------------------------------------------------------------------

[Connect the Dots: Factor Analysis (Video)](https://www.packtpub.com/application-development/connect-dots-factor-analysis-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/connect-dots-factor-analysis-video){.https}

------------------------------------------------------------------------

[Connect the Dots: Linear and Logistic Regression (Video)](https://www.packtpub.com/application-development/connect-dots-linear-and-logistic-regression-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/connect-dots-linear-and-logistic-regression-video){.https}

------------------------------------------------------------------------

[Advanced Statistics for Machine Learning (Video)](https://www.packtpub.com/big-data-and-business-intelligence/advanced-statistics-machine-learning-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/advanced-statistics-machine-learning-video){.https}

------------------------------------------------------------------------

[Natural Language Processing with Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-python-video){.https}

------------------------------------------------------------------------

[Python: Advanced Predictive Analytics](https://www.packtpub.com/big-data-and-business-intelligence/python-advanced-predictive-analytics){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-advanced-predictive-analytics){.https}

------------------------------------------------------------------------

[Practical Time Series Analysis (Video)](https://www.packtpub.com/big-data-and-business-intelligence/practical-time-series-analysis-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/practical-time-series-analysis-video){.https}

------------------------------------------------------------------------

[SciPy Recipes](https://www.packtpub.com/big-data-and-business-intelligence/scipy-recipes){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/scipy-recipes){.https}

------------------------------------------------------------------------

[Advanced Techniques for Exploring Data Sets with Pandas (Video)](https://www.packtpub.com/big-data-and-business-intelligence/advanced-techniques-exploring-data-sets-pandas-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/advanced-techniques-exploring-data-sets-pandas-video){.https}

------------------------------------------------------------------------

[scikit-learn : Machine Learning Simplified](https://www.packtpub.com/big-data-and-business-intelligence/scikit-learn-machine-learning-simplified){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/scikit-learn-machine-learning-simplified){.https}

------------------------------------------------------------------------

[Natural Language Processing with Python Cookbook](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-python-cookbook){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-python-cookbook){.https}

------------------------------------------------------------------------

[Advanced Predictive Techniques with Scikit-Learn and TensorFlow (Video)](https://www.packtpub.com/big-data-and-business-intelligence/advanced-predictive-techniques-scikit-learn-and-tensorflow-video){.https}
...
Artificial Neural Networks are models loosely based on how neural networks work in a living being. These models have a long history in the Artificial Intelligence community with ups and downs in popularity. Nowadays, because of the increase in computational power, improved methods, and software enhancements, they are popular again and are the basis for advanced approaches such as Deep Learning. This course introduces the use of Deep Learning models for Predictive Analytics using the powerful [TensorFlow](./TensorFlow.html){.nonexistent} library.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/advanced-predictive-techniques-scikit-learn-and-tensorflow-video){.https}

------------------------------------------------------------------------

[Cryptography with Python (Video)](https://www.packtpub.com/networking-and-servers/cryptography-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/cryptography-python-video){.https}

------------------------------------------------------------------------

[Scaling Python](https://scaling-python.com){.https}

Julien Danjou

![The Hacker\'s Guide to Scaling Python cover](https://scaling-python.com/img/the-hacker-guide-to-scaling-python.png "The Hacker's Guide to Scaling Python cover"){.external_image width="120"}
...
[Publisher\'s page](https://scaling-python.com){.https}

------------------------------------------------------------------------

[Matplotlib for Python Developers (Video)](https://www.packtpub.com/big-data-and-business-intelligence/matplotlib-python-developers-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/matplotlib-python-developers-video){.https}

------------------------------------------------------------------------

[Python GUI Programming Recipes using PyQt5 (Video)](https://www.packtpub.com/application-development/python-gui-programming-recipes-using-pyqt5-video){.https}
...
In this video, you will successfully install [PyQt5](./PyQt5.html){.nonexistent} and the toolset that contains the QT Designer tool. The QT Designer enables you to develop our GUI in a visual manner, using drag and drop to add and position widgets, and we will use it extensively. We will then learn how to convert QT Designer-generated code into pure Python code.

After having successfully installed [PyQt5](./PyQt5.html){.nonexistent}, the QT Designer, and all other required QT tools, you will start out simple, building a Python GUI using only a few lines of PyQT5 code. Then, you will build a more complex GUI using QT Designer. Along the way, you will explore many QT widgets and learn how to efficiently lay out our GUI design. You will enhance the look-and-feel of the GUI using CSS styling. You will also connect our GUI to a SQL database, which we will create. You decouple the business logic code from the UI code, using best practices. At the end of this video tutorial, viewers will be able to develop complex GUIs using [PyQt5](./PyQt5.html){.nonexistent}.

[Publisher\'s page](https://www.packtpub.com/application-development/python-gui-programming-recipes-using-pyqt5-video){.https}

------------------------------------------------------------------------

[Python Design Patterns (Video)](https://www.packtpub.com/application-development/python-design-patterns-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-design-patterns-video){.https}

------------------------------------------------------------------------

[Mastering Python Data Analysis with Pandas (Video)](https://www.packtpub.com/big-data-and-business-intelligence/mastering-python-data-analysis-pandas-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/mastering-python-data-analysis-pandas-video){.https}

------------------------------------------------------------------------

[Architectural Patterns and Best Practices with Python (Video)](https://www.packtpub.com/application-development/architectural-patterns-and-best-practices-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/architectural-patterns-and-best-practices-python-video){.https}

------------------------------------------------------------------------

[Python 3.x for Computer Vision (Video)](https://www.packtpub.com/application-development/python-3x-computer-vision-video-0){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-3x-computer-vision-video-0){.https}

------------------------------------------------------------------------

[Data Acquisition and Manipulation with Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/data-acquisition-and-manipulation-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-android-hacking-crash-course-trojan-perspective-video){.https}

------------------------------------------------------------------------

[Python For Offensive PenTest: A Complete Practical Course (Video)](https://www.packtpub.com/application-development/python-offensive-pentest-complete-practical-course-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-offensive-pentest-complete-practical-course-video){.https}

------------------------------------------------------------------------

[Python Machine Learning - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-second-edition){.https}

Sebastian Raschka, Vahid Mirjalili

ISBN 13: 9781787125933 Packt Publishing 622 pages (September 2017)

![Python Machine Learning - Second Edition cover](https://www.packtpub.com/sites/default/files/9781787125933.png "Python Machine Learning - Second Edition cover"){.external_image width="130"}
...
Fully extended and modernized, Python Machine Learning Second Edition now includes the popular [TensorFlow](./TensorFlow.html){.nonexistent} deep learning library. The scikit-learn code has also been fully updated to include recent improvements and additions to this versatile machine learning library.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-second-edition){.https}

------------------------------------------------------------------------

[Practical Python Data Science Techniques (Video)](https://www.packtpub.com/application-development/practical-python-data-science-techniques-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/practical-python-data-science-techniques-video){.https}

------------------------------------------------------------------------

[Making Predictions with Data and Python (Video)](https://www.packtpub.com/big-data-and-business-intelligence/making-predictions-data-and-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/making-predictions-data-and-python-video){.https}

------------------------------------------------------------------------

[Python Network Programming Cookbook - Second Edition](https://www.packtpub.com/networking-and-servers/python-network-programming-cookbook-second-edition){.https}
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/python-network-programming-cookbook-second-edition){.https}

------------------------------------------------------------------------

[Functional Programming in Python (Video)](https://www.packtpub.com/application-development/functional-programming-python-video){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/functional-programming-python-video){.https}

------------------------------------------------------------------------

[Mastering Machine Learning with scikit-learn - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/mastering-machine-learning-scikit-learn-second-edition){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/mastering-machine-learning-scikit-learn-second-edition){.https}

------------------------------------------------------------------------

[Python Natural Language Processing](https://www.packtpub.com/big-data-and-business-intelligence/python-natural-language-processing){.https}
...
- Learn NLP using Python libraries such as NLTK, Polyglot, [SpaCy](./SpaCy.html){.nonexistent}, Standford CoreNLP and so on
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-natural-language-processing){.https}

------------------------------------------------------------------------

[Cloud Native Python](https://www.packtpub.com/application-development/cloud-native-python){.https}
...
[Publisher\'s page](https://www.packtpub.com/application-development/cloud-native-python){.https}

------------------------------------------------------------------------

[Python Social Media Analytics](https://www.packtpub.com/big-data-and-business-intelligence/python-social-media-analytics){.https}
...
Right from acquiring data from various social networking sources such as Twitter, Facebook, [YouTube](./YouTube.html){.nonexistent}, Pinterest, and social forums, you will see how to clean data and make it ready for analytical operations using various Python APIs. This book explains how to structure the clean data obtained and store in MongoDB using [PyMongo](./PyMongo.html){.nonexistent}. You will also perform web scraping and visualize data using Scrappy and Beautifulsoup.
...
- Use [PyMongo](./PyMongo.html){.nonexistent} to clean, store, and access data in MongoDB
...
- Analyze video and campaign performance on [YouTube](./YouTube.html){.nonexistent}

- Mine popular trends on [GitHub](./GitHub.html){.nonexistent} and predict the next big technology
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-social-media-analytics){.https}

------------------------------------------------------------------------

[Python Microservices Development](https://www.packtpub.com/web-development/python-microservices-development){.https}
...
[Publisher\'s page](https://www.packtpub.com/web-development/python-microservices-development){.https}

------------------------------------------------------------------------

[Mastering Python Networking](https://www.packtpub.com/networking-and-servers/mastering-python-networking){.https}
...
You will then move on to using Python for [DevOps](./DevOps.html){.nonexistent}, starting with using open source tools to test, secure, and analyze your network. Then, you will focus on network monitoring and visualization. You will learn how to retrieve network information using a polling mechanism, flow-based monitoring, and visualizing the data programmatically. Next, you will learn how to use the Python framework to build your own customized network web services.

In the last module, you will use Python for SDN, where you will use a Python-based controller with [OpenFlow](./OpenFlow.html){.nonexistent} in a hands-on lab to learn its concepts and applications. Compare and contrast [OpenFlow](./OpenFlow.html){.nonexistent}, [OpenStack](./OpenStack.html){.nonexistent}, [OpenDaylight](./OpenDaylight.html){.nonexistent}, and NFV. Finally, you will use everything you've learned in the book to construct a migration plan to go from a legacy to a scalable SDN-based network.
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/mastering-python-networking){.https}

------------------------------------------------------------------------

[Practical Data Science Cookbook - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/practical-data-science-cookbook-second-edition){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/practical-data-science-cookbook-second-edition){.https}

------------------------------------------------------------------------

[Unpacking NumPy and Pandas (Video)](https://www.packtpub.com/big-data-and-business-intelligence/unpacking-numpy-and-pandas-video){.https}
...
- How to handle missing data in a Pandas [DataFrame](./DataFrame.html){.nonexistent}

- How to interface your Python data analysis with R language packages

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/unpacking-numpy-and-pandas-video){.https}

------------------------------------------------------------------------

[Python for Finance - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/python-finance-second-edition){.https}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-finance-second-edition){.https}

------------------------------------------------------------------------

[Python Web Scraping - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/python-web-scraping-second-edition){.https}
...
[Natural Language Processing Fundamentals](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-fundamentals){.https}

Sohom Ghosh, Dwight Gunning

ISBN 13: 9781789954043 Packt 374 Pages (March 2019)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/natural-language-processing-fundamentals){.https}

------------------------------------------------------------------------

[Deep Learning with PyTorch Quick Start Guide](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-pytorch-quick-start-guide){.https}

David Julian

ISBN 13: 9781789534092 Packt 118 pages (December 2018)

Book Overview:

[PyTorch](./PyTorch.html){.nonexistent} is extremely powerful and yet easy to learn. It provides advanced features, such as supporting multiprocessor, distributed, and parallel computation. This book is an excellent entry point for those wanting to explore deep learning with [PyTorch](./PyTorch.html){.nonexistent} to harness its power.

This book will introduce you to the [PyTorch](./PyTorch.html){.nonexistent} deep learning library and teach you how to train deep learning models without any hassle. We will set up the deep learning environment using [PyTorch](./PyTorch.html){.nonexistent}, and then train and deploy different types of deep learning models, such as CNN, RNN, and autoencoders. You will learn how to optimize models by tuning hyperparameters and how to use [PyTorch](./PyTorch.html){.nonexistent} in multiprocessor and distributed environments. We will discuss long short-term memory network (LSTMs) and build a language model to predict text.

By the end of this book, you will be familiar with [PyTorch](./PyTorch.html){.nonexistent}\'s capabilities and be able to utilize the library to train your neural networks with relative ease.

[Amazon Page](http://www.amazon.com/dp/1789534097){.http}

------------------------------------------------------------------------

[Machine Learning Fundamentals](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-fundamentals){.https}

Hyatt Saleh

ISBN 13: 9781789803556 Packt 240 Pages (November 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/machine-learning-fundamentals){.https}

------------------------------------------------------------------------

[Python Fundamentals](https://www.packtpub.com/big-data-and-business-intelligence/python-fundamentals){.https}

Ryan Marvin, Mark Ng'ang'a, Amos Omondi

ISBN 13: 9781789807325 Packt 324 Pages (October 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-fundamentals){.https}

------------------------------------------------------------------------

[Python Data Science Essentials - Third Edition](https://www.packtpub.com/big-data-and-business-intelligence/python-data-science-essentials-third-edition){.https}

Alberto Boschetti, Luca Massaron

ISBN 13: 9781789537864 Packt 472 pages(September 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-data-science-essentials-third-edition){.https}

------------------------------------------------------------------------

[Python Artificial Intelligence Projects for Beginners](https://www.amazon.com/Python-Artificial-Intelligence-Projects-Beginners/dp/1789539463/){.https}

Joshua Eckroth

ISBN 13: 9781789539462 Packt 162 Pages
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-artificial-intelligence-projects-beginners){.https}

------------------------------------------------------------------------

Samuel Bowne

ISBN 13: 9781789534443 Packt 100 Pages
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/hands-cryptography-python){.https}

------------------------------------------------------------------------

[Hands-On Data Analysis with NumPy and Pandas](https://www.amazon.com/Hands-Data-Analysis-NumPy-pandas-ebook/dp/B07F7FLWKM/){.https}

Curtis Miller

ISBN 13: 9781789530797 Packt 168 Pages (June 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-data-analysis-numpy-and-pandas){.https}

------------------------------------------------------------------------

[Deep Reinforcement Learning Hands-On](https://www.amazon.com/dp/1788834240){.https}

Maxim Lapan

ISBN 13: 9781788834247 Packt 546 Pages (June 2018)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/deep-reinforcement-learning-hands){.https}

------------------------------------------------------------------------

[Deep Learning with TensorFlow](https://www.amazon.com/dp/1788831101){.https}

Giancarlo Zaccone, Md. Rezaul Karim, Ahmed Menshawy

ISBN 13: 9781786469786 Packt 320 Pages (April 2018)

Book Overview:

Delve into neural networks, implement deep learning algorithms, and explore layers of data abstraction with the help of this comprehensive [TensorFlow](./TensorFlow.html){.nonexistent} guide.
...
After finishing the book, you will be familiar with machine learning techniques, in particular the use of [TensorFlow](./TensorFlow.html){.nonexistent} for deep learning, and will be ready to apply your knowledge to research or commercial projects.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/deep-learning-tensorflow){.https}

------------------------------------------------------------------------

[Hands-On Transfer Learning with Python](https://www.amazon.com/Hands-Transfer-Learning-Python-TensorFlow/dp/1788831306/){.https}

Dipanjan Sarkar, Raghav Bali, Tamoghna Ghosh

ISBN 13: 9781788831307 Packt 438 Pages (August 2018)
...
The purpose of this book is two-fold; firstly, we focus on detailed coverage of deep learning (DL) and transfer learning, comparing and contrasting the two with easy-to-follow concepts and examples. The second area of focus is real-world examples and research problems using [TensorFlow](./TensorFlow.html){.nonexistent}, Keras, and the Python ecosystem with hands-on examples.

The book starts with the key essential concepts of ML and DL, followed by depiction and coverage of important DL architectures such as convolutional neural networks (CNNs), deep neural networks (DNNs), recurrent neural networks (RNNs), long short-term memory (LSTM), and capsule networks. Our focus then shifts to transfer learning concepts, such as model freezing, fine-tuning, pre-trained models including VGG, inception, [ResNet](./ResNet.html){.nonexistent}, and how these systems perform better than DL models with practical examples. In the concluding chapters, we will focus on a multitude of real-world case studies and problems associated with areas such as computer vision, audio analysis and natural language processing (NLP).

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/hands-transfer-learning-python){.https}

------------------------------------------------------------------------

[Mastering Python Design Patterns - Second Edition](https://www.packtpub.com/application-development/mastering-python-design-patterns-second-edition){.https}

Kamon Ayeva, Sakis Kasampalis

ISBN 13: 9781788837484 Packt 248 Pages (August 2018)
...
[Publisher\'s page](https://www.packtpub.com/application-development/mastering-python-design-patterns-second-edition){.https}

------------------------------------------------------------------------

[Tkinter GUI Application Development Blueprints, Second Edition](https://www.amazon.com/dp/1788837460){.https}

Bhaskar Chaudhary

ISBN 13: 9781788837460 Packt 422 Pages (March 2018)
...
[Publisher\'s page](https://www.packtpub.com/application-development/tkinter-gui-application-development-blueprints-second-edition){.https}

------------------------------------------------------------------------

[Tkinter GUI Application Development Cookbook](https://www.amazon.com/dp/1788622308){.https}

Alejandro Rodas de Paz

ISBN 13: 9781788622301 Packt 242 Pages (March 2018)
...
[Publisher\'s page](https://www.packtpub.com/web-development/tkinter-gui-application-development-cookbook){.https}

------------------------------------------------------------------------

[Python Interviews](https://www.amazon.com/dp/1788399080){.https}

Mike Driscoll

ISBN 13: 9781788399081 Packt 366 Pages (February 2018)
...
[Publisher\'s page](https://www.packtpub.com/web-development/python-interviews){.https}

------------------------------------------------------------------------

[OpenCV 3.x with Python By Example - Second Edition](https://www.amazon.com/dp/1788396901){.https}

Gabriel Garrido, Prateek Joshi

ISBN 13: 9781788396905 Packt 268 Pages (January 2018)
...
[Publisher\'s page](https://www.packtpub.com/application-development/opencv-3x-python-example-second-edition){.https}

------------------------------------------------------------------------

[scikit-learn Cookbook - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/scikit-learn-cookbook-second-edition){.https}

Julian Avila, Trent Hauck

ISBN 13: 9781787286382 Packt 374 Pages (November 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/scikit-learn-cookbook-second-edition){.https}

------------------------------------------------------------------------

[Pandas Cookbook](https://www.packtpub.com/big-data-and-business-intelligence/pandas-cookbook){.https}

Theodore Petrou

ISBN 13: 9781784393878 Packt 538 Pages (October 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/pandas-cookbook){.https}

------------------------------------------------------------------------

[Python Deep Learning Cookbook](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning-cookbook){.https}

Indra den Bakker

ISBN 13: 9781787125193 Packt 330 Pages (October 2017)
...
The Python Deep Learning Cookbook presents technical solutions to the issues presented, along with a detailed explanation of the solutions. Furthermore, a discussion on corresponding pros and cons of implementing the proposed solution using one of the popular frameworks like [TensorFlow](./TensorFlow.html){.nonexistent}, [PyTorch](./PyTorch.html){.nonexistent}, Keras and CNTK is provided. The book includes recipes that are related to the basic concepts of neural networks. All techniques s, as well as classical networks topologies. The main purpose of this book is to provide Python programmers a detailed list of recipes to apply deep learning to common and not-so-common scenarios.

[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning-cookbook){.https}

------------------------------------------------------------------------

[Python Digital Forensics Cookbook](https://www.packtpub.com/networking-and-servers/python-digital-forensics-cookbook){.https}

Preston Miller, Chapin Bryce

ISBN 13: 9781783987467 Packt Publishing 412 Pages (September 2017)

Book Overview:

Over 60 recipes to help you learn digital forensics and leverage Python scripts to amplify your examinations.

By leveraging the Python recipes explored throughout this book, you make the complex simple, quickly extracting relevant information from large datasets. You will explore, develop, and deploy Python code and libraries to provide meaningful results that can be immediately applied to your investigations. Throughout the Python Digital Forensics Cookbook, recipes include topics such as working with forensic evidence containers, parsing mobile and desktop operating system artifacts, extracting embedded metadata from documents and executables, and identifying indicators of compromise. You will also learn to integrate scripts with Application Program Interfaces (APIs) such as [VirusTotal](./VirusTotal.html){.nonexistent} and [PassiveTotal](./PassiveTotal.html){.nonexistent}, and tools such as Axiom, Cellebrite, and [EnCase](./EnCase.html){.nonexistent}.
...
[Publisher\'s page](https://www.packtpub.com/networking-and-servers/python-digital-forensics-cookbook){.https}

------------------------------------------------------------------------

------------------------------------------------------------------------

[Practical Time Series Analysis](https://www.packtpub.com/big-data-and-business-intelligence/practical-time-series-analysis){.https}

Dr. Avishek Pal, Dr. PKS Prakash

ISBN 13: 9781788290227 Packt Publishing 244 Pages (September 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/practical-time-series-analysis){.https}

------------------------------------------------------------------------

[Computer Vision with Python 3](https://www.packtpub.com/application-development/computer-vision-python-3){.https}

Saurabh Kapur

ISBN 13: 9781788299763 Packt Publishing 206 Pages (August 2017)
...
[Publisher\'s page](https://www.packtpub.com/application-development/computer-vision-python-3){.https}

------------------------------------------------------------------------

[Learning Concurrency in Python](https://www.packtpub.com/application-development/learning-concurrency-python){.https}

Elliot Forbes

ISBN 13: 9781787285378 Packt Publishing 313 Pages(August 2017)
...
[Publisher\'s page](https://www.packtpub.com/application-development/learning-concurrency-python){.https}

------------------------------------------------------------------------

[Learning pandas - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/learning-pandas-second-edition){.https}

Michael Heydt

ISBN 13: 9781787123137 Packt Publishing 446 pages (June 2017)
...
- Use pandas Series and [DataFrame](./DataFrame.html){.nonexistent} objects to represent single and multivariate data
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/learning-pandas-second-edition){.https}

------------------------------------------------------------------------

[Python GUI Programming Cookbook - Second Edition](https://www.packtpub.com/application-development/python-gui-programming-cookbook-second-edition){.https}

Burkhard A. Meier

ISBN 13: 9781787129450 Packt Publishing 422 pages (May 2017)
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-gui-programming-cookbook-second-edition){.https}

------------------------------------------------------------------------

[Python Data Structures and Algorithms](https://www.packtpub.com/application-development/python-data-structures-and-algorithms){.https}

Benjamin Baka

ISBN 13: 9781786467355 Packt Publishing 310 pages (May 2017)
...
[Publisher\'s page](https://www.packtpub.com/application-development/python-data-structures-and-algorithms){.https}

------------------------------------------------------------------------

[Python: End-to-end Data Analysis](https://www.packtpub.com/big-data-and-business-intelligence/python-end-end-data-analysis){.https}

Phuong Vothihong, Martin Czygan, Ivan Idris, Magnus Vilhelm Persson & Luiz Felipe Martins

ISBN 13: 9781788394697 Packt Publishing 931 pages (May 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-end-end-data-analysis){.https}

------------------------------------------------------------------------

[Python Machine Learning By Example](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-example){.https}

Yuxi (Hayden) Liu

ISBN 13: 9781783553112 Packt Publishing 254 pages (May 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-machine-learning-example){.https}

------------------------------------------------------------------------

[Python Deep Learning](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning){.https}

Valentino Zocca, Gianmario Spacagna, Daniel Slater, Peter Roelants

ISBN 13: 9781786464453 Packt Publishing 406 pages (April 2017)
...
- Explore deep learning further with Theano, Caffe, Keras, and [TensorFlow](./TensorFlow.html){.nonexistent}
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-deep-learning){.https}

------------------------------------------------------------------------

[Software Architecture with Python](https://www.packtpub.com/application-development/software-architecture-python){.https}

Anand Balachandran Pillai

ISBN 13: 9781786468529 Packt Publishing 556 pages (April 2017)
...
[Publisher\'s page](https://www.packtpub.com/application-development/software-architecture-python){.https}

------------------------------------------------------------------------

[Learning Data Mining with Python - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/learning-data-mining-python-second-edition){.https}

Robert Layton

ISBN 13: 9781787126787 Packt Publishing 358 pages (April 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/learning-data-mining-python-second-edition){.https}

------------------------------------------------------------------------

[Python Data Analysis - Second Edition](https://www.packtpub.com/big-data-and-business-intelligence/python-data-analysis-second-edition){.https}

Armando Fandango

ISBN 13: 9781787127487 Packt Publishing 330 pages (March 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-data-analysis-second-edition){.https}

------------------------------------------------------------------------

[Python: Data Analytics and Visualization](https://www.packtpub.com/big-data-and-business-intelligence/python-data-analytics-and-visualization){.https}

Phuong Vo.T.H, Martin Czygan, Ashish Kumar, Kirthi Raman

ISBN 13: 9781788290098 Packt Publishing 866 pages (March 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-data-analytics-and-visualization){.https}

------------------------------------------------------------------------

[Artificial Intelligence with Python](https://www.packtpub.com/big-data-and-business-intelligence/artificial-intelligence-python){.https}

Prateek Joshi

ISBN 13: 9781786464392 Packt Publishing 446 pages (January 2017)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/artificial-intelligence-python){.https}

------------------------------------------------------------------------

[Building Recommendation Engines](https://www.packtpub.com/big-data-and-business-intelligence/building-recommendation-engines){.https}

Suresh Kumar Gorakala

ISBN 13: 9781785884856 Packt Publishing 372 pages (December 2016)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/building-recommendation-engines){.https}

------------------------------------------------------------------------

[Bayesian Analysis with Python](https://www.packtpub.com/big-data-and-business-intelligence/bayesian-analysis-python){.https}

Osvaldo Martin

ISBN 13: 9781785883804 Packt Publishing 284 pages (November 2016)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/bayesian-analysis-python){.https}

------------------------------------------------------------------------

[Python: Real World Machine Learning](https://www.packtpub.com/big-data-and-business-intelligence/python-real-world-machine-learning){.https}

By Prateek Joshi et al.

ISBN 13: 9781787123212 Packt Publishing 941 pages (November 2016)
...
[Publisher\'s page](https://www.packtpub.com/big-data-and-business-intelligence/python-real-world-machine-learning){.https}
...
By Christian Mayer, September 2018, 191 pages ISBN-13: 978-1719846585

[Coffee Break Python: 50 Workouts to Kickstart Your Rapid Code Understanding in Python](http://viewbook.at/CoffeeBreakPython){.http}
...
How good are your Python skills? **As a bonus, you will track your individual Python coding skill level throughout the book.**

This book is for you, if you are slightly beyond beginner-level in Python:

- Do you already have experience with another programming language---and now it's time to tackle Python?
- Are you a professional engineer and want to brush up your Python skills?
- Are you a student and need to get better at Python for academic courses?

[Get the book!](http://viewbook.at/CoffeeBreakPython){.http}
...
- over 1,000 well-designed, [PowerPoint](./PowerPoint.html){.nonexistent} slides, including every fundamental aspect of each chapter

- included test bank

[Publisher\'s page (for instructors\' request of an evaluation copy)](http://www.wiley.com/WileyCDA/WileyTitle/productCd-EHEP002046.html){.http}

[cdierbach@towson.edu](mailto:cdierbach@towson.edu){.mailto} **(for questions, and example textbook materials)**
...
[http://homepage.mac.com/s_lott/books/oodesign.html](http://homepage.mac.com/s_lott/books/oodesign.html){.http}
...
[1590280539](http://www.amazon.com/exec/obidos/ISBN=1590280539 "ISBN"){.interwiki}, Franklin Beedle & Associates, December 2005

This is a textbook for a CS2 Data Structures Course.

[Home Page](http://knuth.luther.edu/~bmiller/python.html){.http}
