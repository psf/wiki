...
- **2007/07/24** [Training for Python pages](https://wiki.python.org/moin/PythonTraining) continued to be regularly updated. Issued [blog call for trainers](https://python-advocacy.blogspot.com/2007/07/python-trainers-promote-thyself.html) to participate in screencasting that highlight their offerings.

- **2007/07/24** Issued [blog call for members to join](https://python-advocacy.blogspot.com/2007/07/usergroups-forming-arizona-and-carolina.html) fledgling usergroups in Arizona and North/South Carolina.

- **2007/07/17** Made [a place on www.python.org](https://www.python.org/doc/slideshows/) to receive reST/S5-based slide presentations so they can be reused under a free license.
...
- **2007/06/25** Recorded and handed off to [ShowMeDo](../multimedia/ShowMeDo) a pair of screencasts on how to get into making screencasts, to encourage others.
  ...
  - [Giving Your Screencast](http://showmedo.com/videos/video?name=970010&fromSeriesID=97) (10-min) ([reST script](https://www.timecastle.net/casts/screencast-series/giving-your-screencast.txt))

- **2007/06/25** At the request of a member, some small cleanup and organization of [https://www.python.org/doc/faq/windows/](https://www.python.org/doc/faq/windows/), including getting rid of an obsolete, parallel set of FAQ documents.

- **2007/06/22** At of this date, there have been eight postings to the [usergroup organizers shared blog](https://python-groups.blogspot.com).
...
- **2007/06/12** There have been periodic flurries of updates by the community to the [PythonWriters](https://wiki.python.org/moin/PythonWriters) and [PythonTraining](https://wiki.python.org/moin/PythonTraining) wiki pages, which is encouraging. Each page has a good amount of content on it.

- **2007/06/07** Sent out an invitation for usergroup organizers and wannabes to join [the new group-organizers mailing list](https://mail.python.org/mailman/listinfo/group-organizers). There has been a good response, with 21 members as of 2007/06/11.

- **2007/06/07** Sent out an invitation for usergroup organizers to email me information to add them as posters to [the new shared usergroup blog](https://python-groups.blogspot.com/). There are now 10 usergroups added, as of 2007/06/11, as I\'ve recorded in the left-lower menu of links to usergroup websites.

- **2007/06/07** Posted [a meeting summary report](https://python-groups.blogspot.com/2007/06/about-this-past-dfw-pythoneers-4th-sat.html) to the [new shared usergroup blog](https://python-groups.blogspot.com/).

- **2007/06/06** Set up [a prototyping area](https://www.dfwpython.org:8000/) in which to work on changes to www.python.org, in collaboration with the community.
...
- **2007/05/14** Created a [blog to be shared](https://python-groups.blogspot.com/) by the organizers of various usergroups in making announcements and giving meeting reports. Have not yet requested for it to be added to an aggregator nor added to www.python.org.

- **2007/05/14** Issued call to community for updates to [the list of Python trainers](https://wiki.python.org/moin/PythonTraining) and also added an entry to the left menu of www.python.org for \"Training Classes\".

- **2007/05/14** Issued call to community for four code samples for Forrester Survey.

- **2007/05/12** Member of DFW Pythoneers, Brad Allen, is on extended business in Portland Oregon, and he has been working to restart their local Python usergroup. He paid for a year of [https://python.meetup.com/183](https://python.meetup.com/183) and has convened two meetings, the first with 5 people, the second with 8. He has also made contact with the local Plone usergroup and is working to build a Portland leadership before he has to return to Dallas.

- **2007/05/12** 2nd Saturday meeting of the DFW Pythoneers, wherein I presented on D-BUS and showed [how to hook events coming from the Jabber IM client Gajim](https://trac.gajim.org/wiki/GajimDBus). We had a new attendee from the Dallas Personal Robotics Group, which is developing some interest in using Python with robots, as M.I.T. is doing. Fortunately Martin Thomas had brought his [TuxDroid](https://www.tuxisalive.com/), which is controlled with Python and which he had turned into a service on the D-BUS, to be controlled by any application. We didn\'t quite make it to having the [TuxDroid](https://www.tuxisalive.com/) controlled from the Gajim jabber client, both D-BUS participants.
...
- **2007/04/25** Some cleanup and rework of [the Advocacy wiki page](https://wiki.python.org/moin/Advocacy) but more is needed.

- **2007/04/25** The [Omaha Python Usergroup](https://wiki.python.org/moin/OmahaPythonUserGroup) provided [a sample tearaway flyer](https://wiki.python.org/moin/Advocacy/UsergroupSupport), for reuse by other groups.

- **2007/04/25** Convened an online meeting with the [Usergroup Support Committee](https://wiki.python.org/moin/Advocacy/UsergroupSupport/Committee), a small group of community members to provide input and take on some of the tasks of strengthening the usergroups of Python. This committee has a private mailing list \<[usergroup-advocacy@python.org](mailto:usergroup-advocacy@python.org)\>. The IM transcript of this meeting is online [here](https://dfwpython.org/uploads/Advocacy/usergroup-committee-minutes-20070425.txt).

- **2007/04/19** Created a mailing list, \<[group-organizers@python.org](mailto:group-organizers@python.org)\>: \"To share knowledge, of what works and doesn\'t work in running a vibrant Python usergroup. We seek members of existing usergroups to share their expertise and those who wish to start a usergroup near them and want help in getting started.\" This list has not yet been publicly announced, pending a blog to go along with it.
...
- **2006/11/10** Implemented a [suggestion box](https://advocacy.python.org/suggestionbox.html) web form (Zope 3 component) that emails feedback to me at \<[advocate@python.org](mailto:advocate@python.org)\>; mail server on ximinez.python.org not configured to accept/deliver mail yet though.

- **2006/11/08** Implemented a [web viewlet/component](https://advocacy.python.org/docs/dept-careers.3600.en.1), under the Careers tab, that polls monster.com and dice.com once each day and plots the count of Python-specific job openings; retains up to 5 years of data.

- **2006/11/08** Established a [subportal](https://advocacy.python.org/getinvolved), for those who want to help promote Python.

- **2006/10/31** Met over phone with Shane at O\'Reilly to discuss how the various open source communities can work with O\'Reilly; wrote up meeting notes on [my blog](https://python-advocacy.blogspot.com/2006/11/oreilly-seeking-ideas-on-partnering.html).
...
- **2006/10/05** Gave a 60-min presentation at the local DFW Unix Users Group about dynamic languages and Python, as a follow-on to the main presentation given by Dave Thomas about Ruby and Rails. [My slides](https://www.dfwpython.org/static/DFWUUG_AboutPython/AboutPython.html) are available on the club website, in [docutils/restructured-text S5 format](https://www.dfwpython.org/static/DFWUUG_AboutPython/AboutPython.txt). I\'d guess the audience size was roughly 15-20 people. [Blogged](https://python-advocacy.blogspot.com/2006/10/group-discussion-about-dynamic.html).
...
- **2006/09/12** Produce a glossy sheet and a business card for a install fest being held in Australia. Set up a file library to hold them at:
  ...
  - [https://advocacy.dfwpython.org/@@/collaterals/](https://advocacy.dfwpython.org/@@/collaterals/) (soon to be at advocacy.python.org instead)

- **2006/09/11** Subscribed to the pydotorg mailing list to get getting involved in discussions.

- **2006/09/07** Arranged for the creation of the mailing list \<[advocacy@python.org](mailto:advocacy@python.org)\> and the email alias for myself of \<[advocate@python.org](mailto:advocate@python.org)\>.
...
For active discussion on advocating for Python, please join the mailing list at [https://mail.python.org/mailman/listinfo/advocacy](https://mail.python.org/mailman/listinfo/advocacy)
