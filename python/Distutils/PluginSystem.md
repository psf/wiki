...
Read more about how to create plugins with entry points, and what they are, here : [http://lucumr.pocoo.org/2006/7/30/setuptools-plugins](http://lucumr.pocoo.org/2006/7/30/setuptools-plugins){.http}

# Implementation {#Implementation}

- [http://svn.plone.org/svn/collective/collective.releaser/branches/refactor/collective/releaser/commands/extendable.py](http://svn.plone.org/svn/collective/collective.releaser/branches/refactor/collective/releaser/commands/extendable.py){.http}

- [http://svn.plone.org/svn/collective/collective.releaser/branches/refactor/collective/releaser/tests/test_extendable.py](http://svn.plone.org/svn/collective/collective.releaser/branches/refactor/collective/releaser/tests/test_extendable.py){.http}

# Use cases {#Use_cases}

Some simple usecase, need solutions with the above design

## Creating a command to build and install documentation {#Creating_a_command_to_build_and_install_documentation}

(by [DavidCournapeau](./DavidCournapeau.html){.nonexistent})
...
## Installing a C library meant to be used by other extensions {#Installing_a_C_library_meant_to_be_used_by_other_extensions}
...
## Configuring external dependencies locations {#Configuring_external_dependencies_locations}
...
## Building a ctypes extension {#Building_a_ctypes_extension}
...
## Controlling compiler flags {#Controlling_compiler_flags}
...
## Conditionally controlling compiler flags {#Conditionally_controlling_compiler_flags}

(by [FlorisBruynooghe](./FlorisBruynooghe.html){.nonexistent})
