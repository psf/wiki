...
### Python packaging discussion {#Python_packaging_discussion}
...
- [PEP 345 - Metadata for Python Software Packages 1.2](http://www.python.org/dev/peps/pep-0345/){.http}

- [PEP 376 - Changing the .egg-info structure](http://www.python.org/dev/peps/pep-0376/){.http}

- [PEP 382 - Namespace Packages](http://www.python.org/dev/peps/pep-0382/){.http}

- [PEP 386 - Changing the version comparison module in Distutils](http://www.python.org/dev/peps/pep-0386/){.http}

- [PEP 390 - Static metadata for Distutils](http://www.python.org/dev/peps/pep-0390/){.http} Obsoleted by acceptance of PEP 345 which provides field names and format. A concrete syntax proposal is being worked on. See also [StaticMetadata](./StaticMetadata.html){.nonexistent} (not yet up to date with respect to the syntax proposal).
...
### Ideas & Use cases {#Ideas_.26_Use_cases}

## Data file installation paths {#Data_file_installation_paths}
...
## Data file prefix classes/placeholders {#Data_file_prefix_classes.2Fplaceholders}
...
**Discussion**: [Distutils/DiscussionOverview/PrefixClasses](./Distutils(2f)DiscussionOverview(2f)PrefixClasses.html){.nonexistent}

**Status**: Under Consideration

**Affected PEPs**: 376

## Change the default installation scheme {#Change_the_default_installation_scheme}
...
**Discussion**: [Distutils/DiscussionOverview/DefaultInstallScheme](./Distutils(2f)DiscussionOverview(2f)DefaultInstallScheme.html){.nonexistent}

**Status**: Under Consideration

**Affected PEPs**: None

## User defined prefix identifiers {#User_defined_prefix_identifiers}
...
**Discussion**: [Distutils/DiscussionOverview/UserPrefixes](./Distutils(2f)DiscussionOverview(2f)UserPrefixes.html){.nonexistent}

**Status**: Under Consideration

**Affected PEPs**: 376

## User story: Package management {#User_story:_Package_management}
