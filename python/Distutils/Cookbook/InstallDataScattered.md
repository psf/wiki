...
# Solution for Python 2.3 {#Solution_for_Python_2.3}
...
# Solution for Python 2.1 and 2.2 {#Solution_for_Python_2.1_and_2.2}
...
See [this posting](http://groups.google.de/groups?as_umsgid=f70e3538.0404141327.6cea58ca@posting.google.com){.http} for a solution that will work with every Python version.

# Discussion {#Discussion}

If you want to be able to use resources reliably even in the presence of Py2exe or similar packaging schemes (which aren\'t helped by this recipe), you might want to try [ResourcePackage](./ResourcePackage.html){.nonexistent}. [ResourcePackage](./ResourcePackage.html){.nonexistent} automatically embeds resources in Python packages/modules so that they are treated as Python code by the various packaging mechanisms.
