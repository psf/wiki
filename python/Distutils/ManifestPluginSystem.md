...
## How a plugin is called and used ? {#How_a_plugin_is_called_and_used_.3F}
...
## How to choose one or several plugin {#How_to_choose_one_or_several_plugin}
...
## the manifest metadata {#the_manifest_metadata}
