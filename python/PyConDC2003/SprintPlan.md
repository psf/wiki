...
## PyConDC Sprint plan {#PyConDC_Sprint_plan}
...
See also the section \"Sprinting Explained\" at the bottom of this page: [http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/SprintSchedule](http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/SprintSchedule){.http}

### Sprints being planned {#Sprints_being_planned}

- [TwistedSprint](TwistedSprint) - Come hack with the Twisted development team on Twisted or other closely-related projects.

- [I18n/l10n/Zope 3 sprint](http://dev.zope.org/Wikis/DevSite/Projects/ComponentArchitecture/PyConSprint){.http} - The focus of this sprint will be I18n/L10n for Zope and other Python applications. See [JimsPyconSprintMessage](JimsPyconSprintMessage) and [PyconZ3SprintQuestions](PyconZ3SprintQuestions).
