...
- For prototyping, a number of open source tools and commercial components from Rogue Wave Software are available for Python, including [PyIMSL](PyIMSL) Python wrappers to the mathematics and statistics algorithms in the IMSL C Library. This combination of tools provides a rich environment for prototype development.
