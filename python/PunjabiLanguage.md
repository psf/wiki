...
**ਪੰਜਾਬੀ** [1SEP09 Ideally, all the language pages should be like the Polish or Turkish pages - all native language, only the necessary English. ]{.comment style="display:none"}
...
Punjabi in code snippet courtesy of sarwara - Sikh blogger and moderator of [phrasebase.com](http://www.phrasebase.com/forum/members/s/sarwara.php){.http}

:::: {.highlight .python}
::: {.codearea dir="ltr" lang="en"}
``` {#CA-e1a60adec8f9911d0e720805d27e267d26421df9 dir="ltr" lang="en"}
   1 # -*- coding: utf-8 -*-
   2 # python 3.0 or 3.1
   3 
