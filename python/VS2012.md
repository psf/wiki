...
1.  [How to build Python 2.7.5 using Visual Studio 2012 Express on Windows 8 64-bit](#How_to_build_Python_2.7.5_using_Visual_Studio_2012_Express_on_Windows_8_64-bit)
    1.  [References:](#References:)
    2.  [Prepare Environment](#Prepare_Environment)
        1.  [Test Environment](#Test_Environment)
    3.  [Download dependencies](#Download_dependencies)
    4.  [Patch External Dependencies](#Patch_External_Dependencies)
        1.  [Tcl](#Tcl)
        2.  [Tk](#Tk)
    5.  [Compile External Dependencies](#Compile_External_Dependencies)
    6.  [Manually Build Openssl 1.0.1e](#Manually_Build_Openssl_1.0.1e)
    7.  [Convert Visual Studio 2008 Solution](#Convert_Visual_Studio_2008_Solution)
        1.  [Patch Project Files](#Patch_Project_Files)
    8.  [Build Python](#Build_Python)
    9.  [Testing Python](#Testing_Python)
    10. [Install Python](#Install_Python)
2.  [How to build Numpy & Matplotlib in Debug Mode](#How_to_build_Numpy_.26_Matplotlib_in_Debug_Mode)
    1.  [Setup Environment](#Setup_Environment)
    2.  [Build and Install Numpy](#Build_and_Install_Numpy)
    3.  [Verify Numpy Installed](#Verify_Numpy_Installed)
    4.  [Build & Install FreeType](#Build_.26_Install_FreeType)
    5.  [Build & Install zlib](#Build_.26_Install_zlib)
    6.  [Build & Install libpng](#Build_.26_Install_libpng)
    7.  [Installing Matplotlib](#Installing_Matplotlib)
:::

# How to build Python 2.7.5 using Visual Studio 2012 Express on Windows 8 64-bit {#How_to_build_Python_2.7.5_using_Visual_Studio_2012_Express_on_Windows_8_64-bit}
...
**Shameless Plug**: I\'m the author of the C++ & Python module [Nsound](http://nsound.sourceforge.net){.http}
...
## Patch External Dependencies {#Patch_External_Dependencies}
...
## Compile External Dependencies {#Compile_External_Dependencies}
...
## Manually Build Openssl 1.0.1e {#Manually_Build_Openssl_1.0.1e}
...
- cd openssl-1.0.1e/include/openssl
  ...
  If you don\'t have Cygwin installed, just unzip this file into `openssl-1.0.1e\include\openssl`{.backtick} [openssl-headers-1.0.1e.zip](attachments/VS2012/openssl-headers-1.0.1e.zip){.attachment}
...
## Convert Visual Studio 2008 Solution {#Convert_Visual_Studio_2008_Solution}
...
### Patch Project Files {#Patch_Project_Files}

See this diff file: [PCbuild_patches.txt](attachments/VS2012/PCbuild_patches.txt){.attachment}

I\'ve also just zipped up the project files so you can just unzip them into `PCbuild`{.backtick}: [python-2.7.5-amd64-pcbuild.zip](attachments/VS2012/python-2.7.5-amd64-pcbuild.zip){.attachment}
...
1\. Save this script to your build directory: [manual_install.py](attachments/VS2012/manual_install.py){.attachment}
...
# How to build Numpy & Matplotlib in Debug Mode {#How_to_build_Numpy_.26_Matplotlib_in_Debug_Mode}

Numpy is easy to get installed, however, Matplotlib has several dependancies, [FreeType](./FreeType.html){.nonexistent}, libpng and zlib.
...
## Build and Install Numpy {#Build_and_Install_Numpy}
...
## Verify Numpy Installed {#Verify_Numpy_Installed}
...
## Build & Install FreeType {#Build_.26_Install_FreeType}
...
## Build & Install zlib {#Build_.26_Install_zlib}
...
## Build & Install libpng {#Build_.26_Install_libpng}
...
## Installing Matplotlib {#Installing_Matplotlib}
...
2\. To compile against TK, [FreeType](./FreeType.html){.nonexistent}, libpng, and zlib, we need update the INCLUDE shell variable so the matplotlib setup can find the headers, from the `python_build`{.backtick} directory do:
...
- cd c:\
  ...
  [plot.png](attachments/VS2012/plot.png){.attachment}
