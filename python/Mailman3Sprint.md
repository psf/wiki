...
### Description of Mailman3Sprint {#Description_of_Mailman3Sprint}
...
For [PyCon2005](./PyCon2005.html){.nonexistent} I\'m interested in sprinting for a bit, but not sure about the dates yet. Monday and or Tuesday maybe. \-- *Maki Kato*
...
I\'ll be around Saturday and Sunday; would be interested in helping out with the archiving (perhaps just figuring out what to do to start from scratch). \-- *[AndrewKuchling](AndrewKuchling)*

I\'ll be around from Sunday on and am interested \-- *R. David Murray* (david at bitdance.com)
:::
