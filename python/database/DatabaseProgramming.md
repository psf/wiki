...
- [DatabaseInterfaces](DatabaseInterfaces) \-- List of available Python databases interfaces. This also helps you choose the right database for your application.
...
- [Talk video and slides: Using the Python Database API](http://www.egenix.com/library/presentations/EuroPython2008-Using-the-Python-Database-API/)

- [Slides: Datenbankprogrammierung mit dem Python Database API](http://www.zope.de/tagung/Dresden_2010/Python-Datenbankprogrammierung_mal.pdf) (in German)
...
- [PEP 248: Python Database API Specification v1.0](http://www.python.org/dev/peps/pep-0248/).
...
- [DatabaseBooks](DatabaseBooks) \-- lists a few recommended titles for learning about databases. These books aren\'t Python-specific.

- [Programming:Databases](http://dmoz.org/Computers/Programming/Databases/) category on dmoz.org
