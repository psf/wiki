...
- [http://people.freenet.de/AiTI-IT/](http://people.freenet.de/AiTI-IT/){.http}

My first own Python scripts are dated 2003.

News:

\# 2005-10-12 : uploaded the HowTo_AccessRawSectorsOfPhysicalDrives_onWindows.py to [http://people.freenet.de/AiTI-IT/Python/HowTo_AccessRawSectorsOfPhysicalDrives_onWindows.py](http://people.freenet.de/AiTI-IT/Python/HowTo_AccessRawSectorsOfPhysicalDrives_onWindows.py){.http} and HowTo_AccessRawSectorsOfPhysicalDrives_onLinux.py to [http://people.freenet.de/AiTI-IT/Python/HowTo_AccessRawSectorsOfPhysicalDrives_onLinux.py](http://people.freenet.de/AiTI-IT/Python/HowTo_AccessRawSectorsOfPhysicalDrives_onLinux.py){.http} . For more details on this subject check out the thread \" Wanted: Python module allowing direct access to raw sectors of harddrives (MFT, boot sector, etc.) in MS Windows \", initiated on 2005-10-10 in comp.lang.python.

\# 2005-04-09 : posted to comp.lang.python a Python script (pyMBM.py) querying the shared memory area exposed by the freeware MBM 5 utility (available from [http://mbm.livewiredev.com/](http://mbm.livewiredev.com/){.http}) for tracking motherboard sensory information as temperatures, fan speeds and voltages.

\# 2005-02-07 : uploaded my own version of Console.py to [http://people.freenet.de/AiTI-IT/Python/Console.py](http://people.freenet.de/AiTI-IT/Python/Console.py){.http} Console.py is part of the readline module and is used by e.g. IPython. In my version the (extended) Console() class supports any ANSI escape sequences of the form ESC\[#m and ESC\[#,#m , making it possible to set any by console supported text and background colors.
