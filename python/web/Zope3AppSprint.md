...
- A photo library/gallery ([photo/photoslides](http://svn.zope.org/photo/) already exists)
...
- A Zope3 implementation of the [Java Pet Store](http://java.sun.com/blueprints/code/jps131/docs/index.html) demo

- Build something using [MichelPelletier](./MichelPelletier.html)\'s Zemantic catalog
