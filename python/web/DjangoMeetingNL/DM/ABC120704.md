# Django Meeting NL / DM / ABC 120704
...
If you have any questions, just contact one of the organisors, Remco Wendt: [remco@maykinmedia.nl](mailto:remco@maykinmedia.nl) or Wim Feijen: wim at go2people dot nl.

### Presentations 

- `10 min -`{.backtick} \"[DjangoCon](./DjangoCon.html) Europe 2012 summary of the summary\" - *Remco Wendt ([Maykin Media](http://www.maykinmedia.nl))*

- `30 min -`{.backtick} \"Building Single-page web-applications with Django, Twisted and [TxWebsocket](./TxWebsocket.html)\" - *Jeroen van Veen ([Goldmund, Wyldebeast & Wunderliebe](http://gw20e.com))*

- `5 min -`{.backtick} \"Document automation (Office) using Django\" - *Henk Vos ([http://www.rapasso.eu](http://www.rapasso.eu))*
...
- Guido Kollerie ([Blog](http://blog.kollerie.com/))

- Kuno Woudt ([frob.nl](https://frob.nl)), Remie Woudt
