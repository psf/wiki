...
# Python Software Foundation License FAQ {#Python_Software_Foundation_License_FAQ}
...
1.  [Python Software Foundation License FAQ](#Python_Software_Foundation_License_FAQ)
    1.  [Using the Python Software Foundation License](#Using_the_Python_Software_Foundation_License)
        1.  [Can I bundle Python with my non-open-source application?](#Can_I_bundle_Python_with_my_non-open-source_application.3F)
        2.  [If I bundle Python with my application, what do I need to include in my software and/or printed documentation?](#If_I_bundle_Python_with_my_application.2C_what_do_I_need_to_include_in_my_software_and.2For_printed_documentation.3F)
        3.  [What about using third party Python modules that aren\'t part of the Python distribution?](#What_about_using_third_party_Python_modules_that_aren.27t_part_of_the_Python_distribution.3F)
        4.  [Is Python subject to export laws?](#Is_Python_subject_to_export_laws.3F)
        5.  [Which open source license should I use?](#Which_open_source_license_should_I_use.3F)
        6.  [How do I use the PSF License?](#How_do_I_use_the_PSF_License.3F)
    2.  [Contributing Code to Python](#Contributing_Code_to_Python)
        1.  [What if I want to contribute my code to the PSF?](#What_if_I_want_to_contribute_my_code_to_the_PSF.3F)
        2.  [Why can\'t I contribute code under the PSF License?](#Why_can.27t_I_contribute_code_under_the_PSF_License.3F)
        3.  [Who signs the contributor agreement?](#Who_signs_the_contributor_agreement.3F)
        4.  [What do I put on the \"title\" line of the contributor agreement?](#What_do_I_put_on_the_.22title.22_line_of_the_contributor_agreement.3F)
        5.  [How do I define the Contribution mentioned in the contributor agreement](#How_do_I_define_the_Contribution_mentioned_in_the_contributor_agreement)
:::

## Using the Python Software Foundation License {#Using_the_Python_Software_Foundation_License}

### Can I bundle Python with my non-open-source application? {#Can_I_bundle_Python_with_my_non-open-source_application.3F}

Yes. Unlike some open source licenses, the PSF License allows Python to be included in non-open applications, either in unmodified or modified form. See also this [more detailed overview](http://python.org/psf/license){.http}.

### If I bundle Python with my application, what do I need to include in my software and/or printed documentation? {#If_I_bundle_Python_with_my_application.2C_what_do_I_need_to_include_in_my_software_and.2For_printed_documentation.3F}

You must retain all copyright notices found in the code you are redistributing and include a copy of the PSF License and all of the other licenses in the Python \"license stack\" with the software distribution. The \"license stack\" is a result of the history of Python\'s development as [described here](https://opensource.org/steward/python-software-foundation/){.https} (this page also lists all licenses in the stack).
...
### What about using third party Python modules that aren\'t part of the Python distribution? {#What_about_using_third_party_Python_modules_that_aren.27t_part_of_the_Python_distribution.3F}
...
### Is Python subject to export laws? {#Is_Python_subject_to_export_laws.3F}

- **Please note that this section is most probably no longer up to date:** The US export rules have changed a lot, since the text was written. For up to date information, please consult the [Bureau of Industry and Security (BIS)](http://www.bis.doc.gov/){.http} website.
...
[http://www.bis.doc.gov/Encryption/PubAvailEncSourceCodeNofify.html](http://www.bis.doc.gov/Encryption/PubAvailEncSourceCodeNofify.html){.http}
...
### How do I use the PSF License? {#How_do_I_use_the_PSF_License.3F}
...
## Contributing Code to Python {#Contributing_Code_to_Python}

### What if I want to contribute my code to the PSF? {#What_if_I_want_to_contribute_my_code_to_the_PSF.3F}
...
- License your code under an acceptable open source license. These currently include only the [Academic Free License 2.1](http://www.samurajdata.se/opensource/mirror/licenses/afl-2.1.php){.http} ([local copy](./PythonSoftwareFoundationLicenseFaq(2f)AFL(2d)2(2e)1.html)) and the [Apache License 2.0](http://www.opensource.org/licenses/apache2.0.php){.http} ([local copy](./PythonSoftwareFoundationLicenseFaq(2f)Apache(2d)License(2d)2(2e)0.html)), although this list may be expanded in the future. (No, the PSF License is not acceptable; see below)

- Fill out and submit a [contributor agreement](http://www.python.org/psf/contrib/contrib-form/){.http}.

For details, see [Contributing to the PSF](http://www.python.org/psf/contrib/){.http}.

### Why can\'t I contribute code under the PSF License? {#Why_can.27t_I_contribute_code_under_the_PSF_License.3F}
...
### Who signs the contributor agreement? {#Who_signs_the_contributor_agreement.3F}
...
### What do I put on the \"title\" line of the contributor agreement? {#What_do_I_put_on_the_.22title.22_line_of_the_contributor_agreement.3F}
...
### How do I define the Contribution mentioned in the contributor agreement {#How_do_I_define_the_Contribution_mentioned_in_the_contributor_agreement}
