...
PyOhio may record presentations for later release over the web. Presenters will need to sign a release of recording rights to PyOhio; see [http://wiki.python.org/moin/PyOhio/RecordingRelease](http://wiki.python.org/moin/PyOhio/RecordingRelease){.http .reference .external}

All proposals should be emailed to [cfp@pyohio.org](mailto:cfp@pyohio.org){.mailto .reference .external} for review. Please submit proposals by May 10, 2010. Accepted speakers will be notified by May 24.

You can read more about the conference at [http://pyohio.org](http://pyohio.org){.http .reference .external}. If you have questions about proposals, please email [cfp@pyohio.org](mailto:cfp@pyohio.org){.mailto .reference .external}. You can also contact the PyOhio organizers at [pyohio-organizers@python.org](mailto:pyohio-organizers@python.org){.mailto .reference .external}.

[Download CFP template](attachments/PyOhio(2f)CallForProposals/cfp_template.rst){.attachment .reference .external}
:::
