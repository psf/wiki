...
*Download prospectus in PDF format here:* [sponsor_prospectus_2011.pdf](attachments/PyOhio(2f)Prospectus/sponsor_prospectus_2011.pdf){.attachment}

# PyOhio 2011 Sponsor Prospectus {#PyOhio_2011_Sponsor_Prospectus}
...
## Why sponsor PyOhio? {#Why_sponsor_PyOhio.3F}
...
## Who runs PyOhio? {#Who_runs_PyOhio.3F}
...
## What will your PyOhio sponsorship dollars go towards {#What_will_your_PyOhio_sponsorship_dollars_go_towards}
...
**[T-Shirt Sponsor (\$3000) (limited to 1 sponsor)]{.u}**

- Your logo ***alone*** will appear on conference t-shirts

- All benefits of Presenting Sponsorship

**[Presenting Sponsor (\$2000) (limited to 3 sponsors)]{.u}**

- ***Your logo*** on session videos, to be available indefinitely on the [Python Miro Community](./python(2e)mirocommunity(2e)org.html){.nonexistent}. (Python conference session videos total over 50,000 downloads per month)
...
*[pyohio-organizers@python.org](mailto:pyohio-organizers@python.org){.mailto}*
:::
