...
:   [http://sqlite.org/](http://sqlite.org/){.http}
...
:   [http://code.google.com/p/pysqlite/](http://code.google.com/p/pysqlite/){.http}

SourceForge

:   [http://sourceforge.net/projects/pysqlite](http://sourceforge.net/projects/pysqlite){.http}
...
:   [http://code.google.com/p/apsw/](http://code.google.com/p/apsw/){.http}
...
APSW is a Python wrapper for the [SQLite](http://sqlite.org/){.http} embedded relational database engine. In contrast to other wrappers such as [pysqlite](http://code.google.com/p/pysqlite/){.http} it focuses on being a minimal layer over SQLite attempting just to translate the complete SQLite API into Python. The [documentation](http://apidoc.apsw.googlecode.com/hg/pysqlite.html){.http} has a section on the differences between APSW and pysqlite.
...
- [PyAddbook](./PyAddbook.html){.nonexistent} (Address Book)

## Usage Notes {#Usage_Notes}

The following solution was difficult to discover with the available documentation ([http://pysqlite.org/](http://pysqlite.org/){.http} was unavailable). If this page can be found by others searching for answers, it may save many hours of frustration.

### Id of Most Recent Row {#Id_of_Most_Recent_Row}
