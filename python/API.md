...
Loosely defined, API describes everything an application programmer needs to know about piece of code to know how to use it. The idea is that the programmer knows all [Signature](./Signature.html){.nonexistent}s of classes and methods; their parameters, parameter types (or behaviour) as well as return values.
