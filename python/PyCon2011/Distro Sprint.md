...
## Status of python3 third-party modules 1 {#Status_of_python3_third-party_modules_1}
...
### Have to engage upstreams {#Have_to_engage_upstreams}

How do we market to upstream that we (distro maintainers) want to help create patches for python3?

#### gtk/gnome {#gtk.2Fgnome}

- port to pygi as the method of going to python3

- api changes are [largely simple](https://code.launchpad.net/~pitti/computer-janitor/pygi/+merge/46779){.https}. Changes of case in the method names, etc. Few widgets are not so simple.
...
## Multiple versions 1 {#Multiple_versions_1}
...
### A current solution {#A_current_solution}
...
### A new ENVVAR specifying config files {#A_new_ENVVAR_specifying_config_files}
...
#### Why not just use PYTHONPATH? {#Why_not_just_use_PYTHONPATH.3F}
...
### Use a symlink farm {#Use_a_symlink_farm}
...
## Duplicate named modules {#Duplicate_named_modules}
...
- Get RSS feed for file uploads for [http://pypi.python.org/pypi/](http://pypi.python.org/pypi/){.http}
...
## Licensing issue {#Licensing_issue}
...
### Bento & distutils2 discussion {#Bento_.26_distutils2_discussion}
...
### Byte/unicode issues on python3 {#Byte.2Funicode_issues_on_python3}

#### Surrogate escape {#Surrogate_escape}
...
#### Import of non_ascii module names {#Import_of_non_ascii_module_names}
