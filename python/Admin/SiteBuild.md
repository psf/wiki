...
## Post-commit hook {#Post-commit_hook}
...
This directory is accessible through the web at [http://www.python.org/status/](http://www.python.org/status/){.http}.
...
## Automatic build {#Automatic_build}
