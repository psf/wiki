...
# Compiling Python with Visual Studio 2010 {#Compiling_Python_with_Visual_Studio_2010}

::: caution
This is a draft related to [http://bugs.python.org/issue13210](./issue(20)13210.html){.nonexistent}.
:::
...
\* [issue 13210](http://bugs.python.org/issue13210){.http}: parent issue

\* [issue 10469](http://bugs.python.org/issue10469){.http}: test_asyncore blocks forever

\* [issue 4431](http://bugs.python.org/issue4431){.http}: manifest handling

\* [issue7833](http://bugs.python.org/issue7833){.http}: patch to avoid the use of manifests

\* [issue6807](http://bugs.python.org/issue6807){.http}: problem with msi for installer creation

\* [issue2286](http://bugs.python.org/issue2286){.http}: crash on test_marshal

\* [patch wininst](http://hg.python.org/cpython/rev/78e40316e023){.http}
...
## Compile additional libraries {#Compile_additional_libraries}
...
\* Modify Python-2.7.2\\PCbuild\\\_ssl.vcxproj and Python-2.7.2\\PCbuild\\\_hashlib.vcxproj - remove each [PreBuildEvent](./PreBuildEvent.html){.nonexistent} section (could not get build_ssl.py to work, prefered manual compilation)
...
Note: currently the tests will lock on test_asyncore: may be related to [http://bugs.python.org/issue10469](./issue(20)10469.html){.nonexistent}.

## Create installer {#Create_installer}

\* get [http://sourceforge.net/projects/pywin32/files/pywin32/Build216/pywin32-216.zip/download](http://sourceforge.net/projects/pywin32/files/pywin32/Build216/pywin32-216.zip/download){.http} \* unzip pywin32-216.zip
