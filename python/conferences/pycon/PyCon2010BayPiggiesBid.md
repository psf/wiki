...
*The requirements for future [PyCon](PyCon) bids will be different than years past in that we won\'t be asking local groups to actually begin negotiations with venues.*

Right. We can identify candidates, but we won\'t be negotiating the contract.

*Instead, we\'re looking for a somewhat less formal proposal telling us why [PyCon](PyCon) should be held in your local area:*
...
- Multicore Expo
  ...
  \+ *How\'s the weather? Remember, the target is for [PyCon](PyCon) to be held between mid-February and mid-April.*
...
- \+ *How many volunteers can you expect to provide for [PyCon](PyCon)?*
...
- \+ *Are there any key players who bring experience or skills that you feel are particularly valuable to [PyCon](PyCon)?*
...
- \+ *Local companies doing exciting things with Python?*
  ...
  o *Would they be interested in sponsoring [PyCon](PyCon)?*
