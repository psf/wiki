...
- LD Landis \<[ldlandis@gmail.com](mailto:ldlandis@gmail.com)\>

- Nick Bastin \<[nick.bastin@gmail.com](mailto:nick.bastin@gmail.com)\>

- Mitch Chapman \<[mitchchapman@earthlink.net](mailto:mitchchapman@earthlink.net)\>
...
The Manager of Audio-Visual Services for the Cafritz Conference Center is Anthony J. Arrington \<[anthonyj@gwu.edu](mailto:anthonyj@gwu.edu)\>.
...
Each box is a Kuro Box (www.kurobox.com) running Linux, with a 60 GB or larger harddisk. Plugged into it is an [iMic USB audio I/O device](http://www.griffintechnology.com/products/imic/index.php) from Griffin Technology. For microphones I chose the [SP-BMC-3 omnidirectional](http://www.soundprofessionals.com/cgi-bin/gold/item/SP-BMC-3). I have two such boxes; not enough to cover three tracks and the open talk area.
...
- Equipment:
  ...
  - [ThinkPad](./ThinkPad.html) w/firewire PCMCIA, CDRW
- Arrival/Departure:
...
- [DigiDesign](./DigiDesign.html) Mbox USB audio interface (2x XLR input)
...
- Equipment:
  ...
  - \(2\) [iMic USB audio I/O device](http://www.griffintechnology.com/products/imic/index.php) from Griffin Technology.

  - \(1\) [PowerWave USB audio I/O](http://www.griffintechnology.com/products/powerwave/)

  - \(1\) [mic battery module](http://www.soundprofessionals.com/cgi-bin/gold/item/SP-SPSB-1) for phantom power

  - \(1\) [SP-BMC-3](http://www.soundprofessionals.com/cgi-bin/gold/item/SP-BMC-3) omnidirectional stereo microphone

  - \(1\) [SP-BMC-2](http://www.soundprofessionals.com/cgi-bin/gold/item/SP-BMC-2) omnidirectional stereo microphone
- Arrival/Departure Dates:
