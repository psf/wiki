...
See also: [the 2008 list](./PyCon2008IdeasFor2009.html), the [Board Game suggestion page](http://us.pycon.org/2009/openspace/boardgames/), and the [PyCon 2009 Debrief transcript](http://wiki.python.org/moin-pycon/PyCon_2009_Debrief_2009-03-29) (private PyCon wiki; join [pycon-organizers](http://mail.python.org/mailman/listinfo/pycon-organizers) and ask for the password).

::: 
- [A/V Recording](#a-v-recording)
...
- [Registration Software](#registration-software)
...
- [Job Board](#job-board)
- [Swag (T-shirts, bags, etc.)](#swag-t-shirts-bags-etc)
- [Traveling](#traveling)
- [PyCon Office](#pycon-office)
- [On-Site Feedback](#on-site-feedback)
- [VM Summit notes](#vm-summit-notes)
- [Python Summit notes](#python-summit-notes)
:::
...
- Buy several audio recorders for podcasting open space sessions. (Perhaps the under-\$200 [Zoom H2 Handy Recorder](http://www.kk.org/cooltools/archives/003104.php) or similar.)
...
[CategoryPyCon2009](CategoryPyCon2009) [CategoryPyCon2010](CategoryPyCon2010) [CategoryPyConPlanning](CategoryPyConPlanning) [CategoryPyCon](CategoryPyCon)
:::
