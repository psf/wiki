...
- Sponsorship - There are a number of companies (some international and some local) in India which use Python. An incomplete list is available [here](http://wiki.python.org/moin/BangPypers/PythonCompaniesInIndia). We plan to create a persuasive sponsorship kit and visit these organisations for funding.
...
- **Seeking Sponsors**. For e.g, from Google, HP, [ThoughtWorks](./ThoughtWorks.html)
