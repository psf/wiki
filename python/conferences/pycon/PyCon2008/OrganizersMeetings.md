...
**Page for PyCon 2009 meetings:** [PyCon2009/Organizers_Meetings](./PyCon2009(2f)Organizers_Meetings.html)

Meetings will be held every other week on Tuesday.

Meetings are held via IRC. We use the \'#pycon\' channel on irc.freenode.net. [Connection details (instructions) here](./PyCon(2f)Organizers_Meetings_Connection_Details.html).

There is a [\"PyCon 2008 Planning\" Google calendar](https://www.google.com/calendar/embed?src=og3ea7a3ov1tb3e18qppkd4ev8%40group.calendar.google.com&mode=MONTH). If you want write access, ask David Goodger or Chris McAvoy (or just ask on [the pycon-organizers list](http://mail.python.org/mailman/listinfo/pycon-organizers)).

[Private PyCon Organizers\' wiki](http://wiki.python.org/moin-pycon/FrontPage) (join pycon-organizers and ask for the user/password info).
...
- newcomers to the planning group - how does this work? how can we help? (mel)
- pycon 2009 site - ETA to live?
:::
...
(If Skip can\'t be there, summarize please to [skip@pobox.com](mailto:skip@pobox.com)).
:::
...
> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-11-20)
...
- Daily Schedule (see [the sample schedules](http://wiki.python.org/moin-pycon/Scheduling#daily-schedule))
- PyCon-Tech update (registration, proposals, etc.)
- PyCon 2009 & 2010 ([draft call for bids](http://wiki.python.org/moin-pycon/2010BidInfo))
...
> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-11-06)
...
> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-10-23)

- Review action items (see past minutes or 2007-10-11 \"action items\" message).
- Call for bids for PyCon 2010 (2009?). See [http://pyfound.blogspot.com/2006/04/so-you-want-to-host-pycon-2008.html](http://pyfound.blogspot.com/2006/04/so-you-want-to-host-pycon-2008.html)
:::

::: 
#### October 9

> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-10-09)
...
> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-09-25)

- Program guide (guest: Marco Tabini)

- [Call for Conference Talk Proposals](http://wiki.python.org/moin-pycon/Call_for_Conference_Talk_Proposals) & [Call for Tutorial Proposals](http://wiki.python.org/moin-pycon/Call_for_Tutorial_Proposals) (with [example](http://wiki.python.org/moin-pycon/example_tutorial_proposal))
...
- Budget: I\'m going to go ahead and get PSF approval of the budget at \<[http://spreadsheets.google.com/pub?key=pyx4TeJX2JDoKnFsixLn9bw](http://spreadsheets.google.com/pub?key=pyx4TeJX2JDoKnFsixLn9bw)\>. Please give it a look and let me know if you notice anything missing or wrong.
:::

::: 
#### September 11

> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-09-11)

- Populating the web site
- Catering
- Budget: [http://spreadsheets.google.com/ccc?key=pyx4TeJX2JDoKnFsixLn9bw](http://spreadsheets.google.com/ccc?key=pyx4TeJX2JDoKnFsixLn9bw)
:::

::: 
#### August 28

> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-08-28)

- Network
- Keynote speakers ([notes in private wiki](http://wiki.python.org/moin-pycon/Keynote_Speakers))
- Scheduling ([notes in private wiki](http://wiki.python.org/moin-pycon/Scheduling))
- Website redesign
:::
...
> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-08-14)
...
> [Meeting minutes](http://wiki.python.org/moin-pycon/2007-07-31)
