...
This talk is based on one I gave for the the [Triangle Python/Zope User Group](http://dev.zope.org/Members/tbryan/TriZPUG/FrontPage) in November 2002. I extended the content for the [PyCon](PyCon). The original talk covered the following topics:
