...
- See [EuroPy2006LightningTalks](EuroPy2006LightningTalks) for the approximate schedule.
...
IRC **is not permitted at CERN (and the port is blocked in the firewall).**

Please use the [EuroPython](EuroPython) Jabber room, [EuroPython](EuroPython)\@conference.jabber.org instead.
