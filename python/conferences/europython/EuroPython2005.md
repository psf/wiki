...
If you plan to arrange a sprint, please send a mail to [europython@python.org](mailto:europython@python.org) with a description of the sprint as well. We are going to need volunteers to help with some logistical issues. Read more at this URL: [http://www.europython.org/sections/sprints_and_wiki/dates_for_sprinting](http://www.europython.org/sections/sprints_and_wiki/dates_for_sprinting)
...
- [MuseumVisit](./MuseumVisit.html)

- [LisebergVisit](./LisebergVisit.html)

- [BeerDrinking](./BeerDrinking.html)

- [DiningOut](./DiningOut.html)

- [MusicEvent](./MusicEvent.html)

- [EastIndia](./EastIndia.html) Ship

- [BotanicalGardens](./BotanicalGardens.html)

- [SlottsSkogen](./SlottsSkogen.html)
...
- [Kamaelia](http://www.bbc.co.uk/rd/pubs/whp/whp113.shtml) - Paper describing Kamaelia (content should give you a good idea of the content of the talk).

- [Money](http://www.taniquetil.com.ar/facundo/bdvfiles/money-1.2.sxi) - Slides of Money talk, from [Facundo Batista](http://www.taniquetil.com.ar/plog/)
...
[http://www.gulasidorna.se/query?stq=0&streetname=Utlandagatan+24+G%F6teborg&what=map&asearch=1](http://www.gulasidorna.se/query?stq=0&streetname=Utlandagatan+24+G%F6teborg&what=map&asearch=1)
