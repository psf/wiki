...
- ***Your logo*** on session videos, to be available indefinitely on the [Python Miro Community](./python(2e)mirocommunity(2e)org.html). (Python conference session videos total over 50,000 downloads per month)
