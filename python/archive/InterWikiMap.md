...
```
    ...
    PEP http://www.python.org/dev/peps/pep-
    pydotorg http://code.google.com/p/pydotorg/issues/detail?id=
    ...
    AwarenessWiki http://aware.wiki.taoriver.net/moin.cgi/
    ...
    # Updated 2002-05-10 from http://www.usemod.com/cgi-bin/mb.pl?InterMapTxt
