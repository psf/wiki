...
- [PyroShell](./PyroShell.html) (a combination of Pyro and [PyShell](./PyShell.html) allows user to have an interactive autocomplete interpreter on a remote machine)

- [CherryShell](./CherryShell.html) (a Python shell in a Web browser; currently version 0.1 but still useful for remote operations; designed to replace [PyroShell](./PyroShell.html), feature code completion and code tips; works right now only with Firefox)
