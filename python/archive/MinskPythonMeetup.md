...
- [https://www.facebook.com/MinskPythonMeetup](https://www.facebook.com/MinskPythonMeetup)

There is also short version set up by people from local meetups community:

- [http://python.meetup.by](http://python.meetup.by)
...
- \[x\] 14.02 [WiFi](./WiFi.html)

- \[x\] 14.01 [http://python.meetup.py](http://python.meetup.py)
...
- Portable [WiFi](./WiFi.html) hot-spot with desktop video streaming capabilities
