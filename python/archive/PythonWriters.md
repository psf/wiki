...
- [Will McGugan](http://www.willmcgugan.com) - Currently writing a book about game development with Python for [APress](http://www.apress.com). Would like to write on a variety of Python topics, including graphics, networking and application development (wxPython).

- [Steve Holden](http://holdenweb.com) - Author of *Python Web Programming* and a contributing editor to [Python Magazine](http://pymag.phparch.com). His [For Some Value of Magic \...](http://holdenweb.blogspot.com/) blog is mostly Python-related, and he writes about the environments used by Python developers in the [On Your Desktop](http://onyourdesktop.blogspot.com/) blog. Steve also publishes occasional interviews with Python personalities.
...
- [Calvin Spealman](http://ironfroggy-code.blogspot.com/) - Python and agile development blogger currently involved in a top secret writing project and available for writing.

- [Elisio Leonardo](http://infomoz.net/) - Mozambican programmer and web developer.Has written some articles about Python in portuguese, and also one complete online course about [Intorduction to Python Programming](http://infomoz.net/modules/news/article.php?storyid=114)also in portuguese. Available for writing or translate article from English to portuguese.

- [Andrew Kuchling](http://www.greendragonflyllc.com) - author of the \"What\'s New in Python 2.x\" documents (the most recent is [for Python 2.7](http://docs.python.org/whatsnew/2.7.html)) and the occasional article. Available for writing.

- [Tarek Ziadé](http://programmation-python.org) - author of \"Programmation Python\" (01/2006) in french, and \"Python, petit guide à l\'usage du développeur agile\" (available 08/16/2007). Involved in a third book in french on a Python web framework, but can write on small projects besides. FRENCH but can do english.

- [Vasudev Ram](https://vasudevram.github.io) - Fellow of the [Python Software Foundation](http://python.org/psf), author of some articles - on using [xtopdf](https://vasudevram.github.io/products.html#xtopdf) to generate PDF from other formats (for Packt Publishing, no link); [Linux command-line utility development in C](https://jugad2.blogspot.in/2014/09/my-ibm-developerworks-article.html) for IBM developerWorks; [A vi editor quickstart tutorial](http://vasudevram.github.io/writings/vi_quickstart.txt) and [Using Knoppix to recover data from a crashed Linux system](http://vasudevram.github.io/writings/knopresc.txt) - the last two, both written for Linux For You magazine, now [Open Source For You](http://opensourceforu.com). An independent software consultant, trainer and open source developer (see my [Products](http://vasudevram.github.io/products.html) page) with several years of experience in multiple technologies including Python, C, UNIX, Java, Ruby, many relational databases, many open source technologies, PDF generation. Have both software development and UNIX/Linux system administration experience. Interested in writing articles on Python. Strong interest in exploring new technologies and writing useful/interesting articles and software projects based upon them.
...
- [Gordon Webster](http://www.digitalbiologypartners.com/dbpleadership.html) is a co-founder at [Digital Biology Partners](http://www.digitalbiologypartners.com), a company that specializes in life science applications of Python. Gordon writes about Python regularly online at [The Digital Biologist](http://digitalbiologist.com).
