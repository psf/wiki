...
::: {}
  ---------------------------------------------------------------------------------------------------------------------------------------------
  ![Google Groups](http://groups.google.com/intl/en/images/logos/groups_logo_sm.gif "Google Groups")
...
\* Places are strictly limited to 40 on a first come first served basis. To reserve your place please register here : [http://lfpug.eventwax.com/london-finance-python-users-group-lfpug](http://lfpug.eventwax.com/london-finance-python-users-group-lfpug) \* Venue: Bank of America, 5 Canada Square, London E14 5AQ
...
- 17 Oct 2012
  - Program:
    ...
    - \"Financial data analysis in Python with pandas\", Wes [McKinney](./McKinney.html)
...
- Topics :
  - PyQL : a new set of wrappers around [QuantLib](./QuantLib.html)
...
- Location: Wilkins Haldane Room, at UCL on Gower Street - [http://www.ucl.ac.uk/locations/ucl-maps/ucl-maps/map2_low_res](http://www.ucl.ac.uk/locations/ucl-maps/ucl-maps/map2_low_res)
...
- Topics :
  ...
  - [CodeTools](./CodeTools.html) project : a series of modules for analysis and control of code execution, Didrik Pinte, Enthought
...
- Topics :
  ...
  - *A Web Application Stack for a Hedge Fund*, Chris Withers, Simplistix/GLC - \[[http://groups.google.com/group/glcuk](http://groups.google.com/group/glcuk)\]
...
- Topics :
  - *Real time web and implementations with repoze.bfg and eventlet*, by Ben Ford
    ...
    - Here are some links on what I was talking about in no particular order:
      - [http://github.com/boothead/multivisor](http://github.com/boothead/multivisor) (slightly out of date but I\'ll be updating it soon) [http://vis.stanford.edu/protovis/](http://vis.stanford.edu/protovis/) [http://eventlet.net/](http://eventlet.net/) [http://en.wikipedia.org/wiki/WebSockets](http://en.wikipedia.org/wiki/WebSockets) [http://www.zeromq.org/](http://www.zeromq.org/) and [http://github.com/ellisonbg/pyzmq](http://github.com/ellisonbg/pyzmq) [http://www.amqp.org/](http://www.amqp.org/) and [http://www.rabbitmq.com/](http://www.rabbitmq.com/)
...
- March, 11 2010
  ...
  - *Cloud computing with Python and Excel ([Blog post](http://dpinte.wordpress.com/2010/03/12/cloud-computing-with-python-and-excel-picloud-integration/)) by Didrik Pinte [Enthought](./htp(3a2f2f)www(2e)enthought(2e)com.html)*
...
- *Feb 3, 2010 at 7pm*
  ...
  - *Speeding up Python code using Cython ([Blog post](http://dpinte.wordpress.com/2010/02/12/improving-python-speed-using-cython-binomial-option-valuation-example/)) - Didrik Pinte, [Enthought](./htp(3a2f2f)www(2e)enthought(2e)com.html)*
...
- *Dec 14th, 2009 :*
  ...
  - *Chaco : a 2D interactive plotting application toolkit - Didrik Pinte, [Enthought](./htp(3a2f2f)www(2e)enthought(2e)com.html)*
