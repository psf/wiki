...
The difference between PythonWebKit and [PyWebkitGtk](../gui/PyWebkitGtk) and [PyWebkitQt4](./PyWebkitQt4.html) is that PythonWebKit adds the entire range of W3C DOM bindings functions - including HTML5 features - whereas [PyWebkitGtk](../gui/PyWebkitGtk) and [PyWebkitQt4](./PyWebkitQt4.html) provide very little, inadequate, incomplete and more CPU-intensive DOM bindings.
