...
- I don\'t think we can mine the [ActiveStateCookbook](./ActiveStateCookbook.html) to seed the wiki.

- I will put all of my code snippets here.

Advantages of wiki over the [ActiveStateCookbook](./ActiveStateCookbook.html):

- wiki [affords](http://www.emacswiki.org/cw/WhatIsAffordance) linking between pages
...
- Many people want to put snippets on the [ActiveStateCookbook](./ActiveStateCookbook.html).
