...
- [The next generation Python Software Foundation (FOSDEM 2014, PDF)](attachments/MembershipModelTalks/FOSDEM-2014-Next-Generation-PSF.pdf "The next generation Python Software Foundation (FOSDEM 2014, PDF)")
...
- [The next generation Python Software Foundation (PyCon AU 2014, LibreOffice slides)](attachments/MembershipModelTalks/PyConAU-2014-Next-Generation-PSF.odp "The next generation Python Software Foundation (PyCon AU 2014, LibreOffice slides)")
