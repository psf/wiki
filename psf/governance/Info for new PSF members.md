...
- The [psf-members-announce mailing list](http://mail.python.org/mailman/listinfo/psf-members-announce), which is a low-traffic list used only for PSF internal announcements.
...
- Join the psf-board mailing list: [http://mail.python.org/mailman/listinfo/psf-board](http://mail.python.org/mailman/listinfo/psf-board)

- Subscribe to the \"PSF Board\" Google Calendar.

- Note the following wiki pages:

  Agenda for Board meetings: [http://wiki.python.org/psf/BoardAgenda](http://wiki.python.org/psf/BoardAgenda)

  List of action items: [http://wiki.python.org/psf/Action_Items](http://wiki.python.org/psf/Action_Items)

- Note the schedule of meetings:

  Our regular meetings are held on IRC on the #psf-board channel every two weeks

- There is an overview of the Duties & Responsibilities Of PSF Directors here: [http://wiki.python.org/moin/PythonSoftwareFoundation/DutiesAndResponsibilitiesOfDirectors](http://wiki.python.org/moin/PythonSoftwareFoundation/DutiesAndResponsibilitiesOfDirectors)

A wiki admin should add the Director\'s/Officer\'s wiki account to the \"BoardGroup\" page: [http://wiki.python.org/psf/BoardGroup](http://wiki.python.org/psf/BoardGroup)
:::
