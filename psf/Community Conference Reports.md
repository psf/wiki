...
1.  [Current Travel Policy](#Current_Travel_Policy)
2.  [Slides & Notes from previous PSF talks](#Slides_.26_Notes_from_previous_PSF_talks)
3.  [Resources for Directors](#Resources_for_Directors)
4.  [2019](#A2019)
    1.  [PyColorado](#PyColorado)
    2.  [PyCon Africa](#PyCon_Africa)
        1.  [Report from Ewa Jodlowska](#Report_from_Ewa_Jodlowska)
    3.  [Python Pizza Berlin](#Python_Pizza_Berlin)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder)
    4.  [PyCon Belarus](#PyCon_Belarus)
5.  [2018](#A2018)
    1.  [PythonDay México](#PythonDay_M.2BAOk-xico)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-1)
    2.  [DjangoCon US](#DjangoCon_US)
    3.  [PyCon CZ](#PyCon_CZ)
    4.  [Europython 2018](#Europython_2018)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-2)
    5.  [OSCON](#OSCON)
        1.  [Report from Betsy Waliszewski](#Report_from_Betsy_Waliszewski)
    6.  [PyLondinium](#PyLondinium)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-3)
    7.  [PyCon Colombia 2018](#PyCon_Colombia_2018)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-4)
    8.  [PyCascades](#PyCascades)
6.  [2017](#A2017)
    1.  [Python Brasil](#Python_Brasil)
    2.  [PyCon ES](#PyCon_ES)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-5)
    3.  [PyCon Nigeria 2017](#PyCon_Nigeria_2017)
    4.  [EuroPython 2017](#EuroPython_2017)
    5.  [Sustain OSS](#Sustain_OSS)
        1.  [Betsy Waliszewski](#Betsy_Waliszewski)
    6.  [PyCon CZ](#PyCon_CZ-1)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-6)
7.  [2016](#A2016)
    1.  [PyCon Jamaica](#PyCon_Jamaica)
    2.  [Python Brasil\[12\]](#Python_Brasil.5B12.5D)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-7)
    3.  [PyBay 2016](#PyBay_2016)
        1.  [Report from Betsy Waliszewski](#Report_from_Betsy_Waliszewski-1)
        2.  [Report from Carol Willing](#Report_from_Carol_Willing)
    4.  [PyCon APAC 2016](#PyCon_APAC_2016)
        1.  [Report from Ewa Jodlowska](#Report_from_Ewa_Jodlowska-1)
    5.  [Europython 2016](#Europython_2016)
        1.  [Report from Naomi Ceder](#Report_from_Naomi_Ceder-8)
:::

## Current Travel Policy {#Current_Travel_Policy}
...
## Slides & Notes from previous PSF talks {#Slides_.26_Notes_from_previous_PSF_talks}

When writing a conference report, please try to answer the following questions:

- Did conference attendees know about the PSF, its work, and mission?
- How can the PSF help/do more in that particular region?
- Highlight a few conversations you had with community members
- What was your overall impression of the conference? Was it well organized? How were the talks? Was attendance local/regional/national?
- Do you think we should send a PSF keynote speaker again next year (if asked)?

Below are reports from the PSF representatives that attended a Python Conference.

- By Ewa Jodlowska, [PyColorado](./PyColorado.html){.nonexistent} [https://www.dropbox.com/s/8yynucaexkd3a3s/pycolorado-2019.key?dl=0](https://www.dropbox.com/s/8yynucaexkd3a3s/pycolorado-2019.key?dl=0){.https}

- By Ewa Jodlowska, [ChiPy](./ChiPy.html){.nonexistent} meetup [https://www.dropbox.com/s/sr3yoavo83mb35s/chipy_june_2019.key?dl=0](https://www.dropbox.com/s/sr3yoavo83mb35s/chipy_june_2019.key?dl=0){.https}

- By Ewa Jodlowska, [PyCon](./PyCon.html){.nonexistent} 2019: [https://www.dropbox.com/sh/7v0bjdbcsp8vu30/AAA5JfMkEI1CM4harMXmdiKga?dl=0](https://www.dropbox.com/sh/7v0bjdbcsp8vu30/AAA5JfMkEI1CM4harMXmdiKga?dl=0){.https}

- By Ewa Jodlowska, [PyCon](./PyCon.html){.nonexistent} Belarus 2019 [https://www.dropbox.com/s/mgacacpjq7ff02o/pycon_belarus_2019_edited.key?dl=0](https://www.dropbox.com/s/mgacacpjq7ff02o/pycon_belarus_2019_edited.key?dl=0){.https}

- By Betsy Waliszewski: [PyCascades](./PyCascades.html){.nonexistent} 2018 - (speaker notes) [https://docs.google.com/document/d/11IIOQiEtPs4pSaJ-YezHdCyAvyxTwh1nB30Y-yBEP5Q/edit;](https://docs.google.com/document/d/11IIOQiEtPs4pSaJ-YezHdCyAvyxTwh1nB30Y-yBEP5Q/edit;){.https} (slide presentation) [https://drive.google.com/drive/folders/0B7Jit1pzkJbgSmJpV19LZUVtbFE](https://drive.google.com/drive/folders/0B7Jit1pzkJbgSmJpV19LZUVtbFE){.https}

- By Naomi Ceder & Lynn Root: [EuroPython](./EuroPython.html){.nonexistent} 2015 - [https://goo.gl/tevB0D](https://goo.gl/tevB0D){.https}

- By Naomi Ceder & Lorena Mesa: [EuroPython](./EuroPython.html){.nonexistent} 2016 members meeting - [https://goo.gl/4F3Wwy](https://goo.gl/4F3Wwy){.https}

- By Naomi Ceder & Eric Holscher: [EuroPython](./EuroPython.html){.nonexistent} 2018 members meeting - [https://goo.gl/jH3XLA](https://goo.gl/jH3XLA){.https}

- By Naomi Ceder: [PyCon](./PyCon.html){.nonexistent} Ireland 2015 - [https://goo.gl/OUBjVN](https://goo.gl/OUBjVN){.https}

- By Ewa Jodlowska: [PyGotham](./PyGotham.html){.nonexistent} 2016 about international outreach via grants - Transcripts: [https://docs.google.com/document/d/1XwqQZFlsHmu6MGleKPzizjMQXVXdA8oVAgYOsTaYv2w/edit?usp=sharing](https://docs.google.com/document/d/1XwqQZFlsHmu6MGleKPzizjMQXVXdA8oVAgYOsTaYv2w/edit?usp=sharing){.https}. Slides: [http://prezi.com/pksptnc5g2-n/?utm_campaign=share&utm_medium=copy](http://prezi.com/pksptnc5g2-n/?utm_campaign=share&utm_medium=copy){.http}

- By Ewa Jodlowska: [ClePy](./ClePy.html){.nonexistent} Meetup 2017 about PSF and how we can grow fiscal sponsorship program: [https://docs.google.com/presentation/d/1eAM0pf4-5XRblXA00OVjrYsmruqqF2NC2oTHKmOnClo/edit?usp=sharing](https://docs.google.com/presentation/d/1eAM0pf4-5XRblXA00OVjrYsmruqqF2NC2oTHKmOnClo/edit?usp=sharing){.https}

- By Naomi Ceder: [PyConEs](./PyConEs.html){.nonexistent} 2017 (Cáceres, Spain) - [https://goo.gl/yDaZ8j](https://goo.gl/yDaZ8j){.https} (slides in Spanish)

- By Naomi Ceder: [PyConEs](./PyConEs.html){.nonexistent} 2017 (Cáceres, Spain) members meeting - [https://goo.gl/KkHQ2o](https://goo.gl/KkHQ2o){.https}

- By Paola Katherine: [Python Brasil](./Python(20)Brasil.html){.nonexistent} 2017 (Belo Horizonte, Brazil) - [https://speakerdeck.com/pkpacheco/o-que-voce-quer](https://speakerdeck.com/pkpacheco/o-que-voce-quer){.https} ( slides in Portuguese)

- By Ewa Jodlowska: [EuroPython](./EuroPython.html){.nonexistent} 2017 - [https://www.dropbox.com/s/s04im5egf1u2vyz/EuroPython2017_MembersMeeting.key?dl=0](https://www.dropbox.com/s/s04im5egf1u2vyz/EuroPython2017_MembersMeeting.key?dl=0){.https}

  - handout that Ewa gave out to those interested with helping the PSF: [https://www.dropbox.com/s/v6glyw391v2rtys/handout%20for%20europython.pdf?dl=0](https://www.dropbox.com/s/v6glyw391v2rtys/handout%20for%20europython.pdf?dl=0){.https}

- By Ewa Jodlowska: [ClePy](./ClePy.html){.nonexistent} Meetup October 2017: nitty gritty about [PyCon](./PyCon.html){.nonexistent} [https://www.dropbox.com/s/5fwqwufewch6de0/CLEPy_two.key?dl=0](https://www.dropbox.com/s/5fwqwufewch6de0/CLEPy_two.key?dl=0){.https}

## Resources for Directors {#Resources_for_Directors}

- PSF Flyer to be printed 2 on an 8-1/2 x 11 sheet: [https://www.dropbox.com/work?preview=PSF+Flyer+-+Print+2-up.pdf](https://www.dropbox.com/work?preview=PSF+Flyer+-+Print+2-up.pdf){.https} (a better version is coming)

- Contact [betsy@python.org](mailto:betsy@python.org){.mailto} if you want stickers for your event. I will order them from Sticker Mule and have them shipped directly to you or to your event.

## 2019 {#A2019}

### PyColorado {#PyColorado}

[PyColorado](./PyColorado.html){.nonexistent} was held September 6-8, 2019. On September 6th there was an opening reception. I met several of the organizers and in more detail discussed the code of conduct efforts the group has taken.

On September 7th the day started with Scott delivering the opening statement. The opening not only described what the conference would include, it informed attendees about what it took to get [PyColorado](./PyColorado.html){.nonexistent} going and what things worked and what things didn't. He also emphasized that the parts that didn't work out 100% they would work on those aspects more for next year. After that I delivered my keynote. Overall I received positive feedback. Lots of people approached me afterwards stating that they had no idea what the PSF did or what initiatives it worked on so they enjoyed learning about it more. I also received a lot of positive feedback about sharing personal story. One female attendee said I should share it more as it is impactful to learn about especially about a prominent figure in our community. An attendee that works for Heroku approached me saying that she really enjoyed hearing how I got started with the Python community. She said it is an impactful story that needs to be shared so people know that even a prominent person in our community had such a starting point. Saturday talks included coding with empathy, boring object orientation, pandas optimizations, SQL and pandas best practices, Locust,

On September 8th On Sunday the conference started with coffee, tea and continental breakfast. Uche was the first speaker that day and did a really fun spin on the Zen of Python. Through out the day there were talks about asyncio, Dash, CUDA. The one talk that stood out to me was a talk about trends origin the usage of Python. The speaker ended talking about positives and negatives of our community. The negative she pointed out related to Guido stepping down. My take away from hearing that is the steering council needs to be promoted more so people don't think that nothing was improved after Guido stepped down as BDFL. I left around 3pm for my 5pm flight, which unfortunately ended up being delayed until 9pm.

General comments The talks were good. They had 1/3 female speakers but hope to improve that next year. The organization of this event was exceptional. Of course there are ways they can improve but for a first time conference it was great. The organizers took the best of all conferences and combined it into one. I enjoyed hearing the different ways attendees used Python. There were teachers, data scientific and software engineers present at the conference. They worked in all sorts of fields (folks that I spoke with were in energy, security certification, video production).

### PyCon Africa {#PyCon_Africa}

Accra, Ghana, August 6-10, 2019

PSF Representative: Ewa Jodlowska

#### Report from Ewa Jodlowska {#Report_from_Ewa_Jodlowska}

Unfortunately I had a lot of delayed flight issues with this trip. I arrived at the hotel 10pm at night the night before the last day of the conference (my keynote was the first talk of the last day).

The last day of the conference, August 9th, I delivered by keynote. After that I spoke with dozens of community members and attended several talks.

August 10th, Saturday, was a sprint day with some workshops. I first had an interview with Vuyisile Ndlovu about the PSF and what it does. His published blog is here: [https://vuyisile.com/interview-with-ewa-jodlowska-psf-executive-director/](https://vuyisile.com/interview-with-ewa-jodlowska-psf-executive-director/){.https}. Afterwards I had a productive meeting with Chukwudi. After my morning meetings I attending Daniele Procida\'s workshop called \"Organising your own Python community conference\". During the workshop I helped folks understand some of the requirements from the PSF pov such as code of conduct and preplanned budget.

### Python Pizza Berlin {#Python_Pizza_Berlin}

Berlin, February 23, 2019

PSF Representative: Naomi Ceder

#### Report from Naomi Ceder {#Report_from_Naomi_Ceder}

I attended this new conference and gave a keynote. I was also then on a panel at a related [PyLadies](./PyLadies.html){.nonexistent} event the next day. This was a very small, focussed one track conference that was quite well organized. They have good attendance (around 250) and are planning to repeat.

### PyCon Belarus {#PyCon_Belarus}

Minsk, Belarus February 15-18, 2019

PSF Representative: Ewa Jodlowska

I attended the conference on behalf of the PSF. I delivered a keynote (link above) and in addition to that met several community members. I spent some time with Tania Allard discussing the progress of the Mentored Sprints at [PyCon](./PyCon.html){.nonexistent} 2019. In addition to community members, I met the Director of Operations for the Kotlin Foundation and we discussed hurdles and similarities. Overall, it was a great conference that spent a lot of effort taking care of their speakers. I took away some of those ideas and implemented them into [PyCon](./PyCon.html){.nonexistent} 2019 (such as hand written thank you cards to speakers and also having a speaker Slack channel for questions). My keynote revolved around the importance of a diverse and welcoming community especially in terms of sustainability.

## 2018 {#A2018}

### PythonDay México {#PythonDay_M.2BAOk-xico}

Guadalajara, Jalisco, MX Nov 30-Dec 1, 2018

#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-1}

PSF Representative: Naomi Ceder

I attended and gave a keynote and also represented the PSF. This was a well organized conference with good local support, but attendance was a bit disappointing to the organizers - less than 100.

### DjangoCon US {#DjangoCon_US}

San Diego, CA October 14-19

PSF Representative present: Ernest W. Durbin III

I attended [DjangoCon](./DjangoCon.html){.nonexistent} 2018 on behalf of the Python Software Foundation and as [PyCon](./PyCon.html){.nonexistent} Chair!

Overall the event was well attended, well run, and had an excellent mix of content provided that served to help in directing the community towards positive interpersonal and ethical standards while also providing solid technical talks.

Attendance was great and in talking to many attendees I was delighted to meet an excellent mix of newcomers, Django/Python users, and leaders in the Django community.

Attendees seemed familiar at some basic level with the PSF, but many were surprised to hear about what whe do beyond the legal guardianship of Python. Had some good conversations but ultimately it seems that for most Django users who aren\'t also more active in the broader Python community, PSF is not necessarily on their radar. This isn\'t a surprise given the focus of the conference and the manner in which many might learn and/or use Django without realizing they\'re also learning/using Python :).

### PyCon CZ {#PyCon_CZ}

Location: Prague, CZ

PSF Representative present: Van Lindberg

Sorry for the delayed report, but I wanted to report on the visit to [PyCon](./PyCon.html){.nonexistent} CZ 2018. It was an excellent conference and the organizers there deserve both congratulations and any further support we can give. Bára Drbohlavová, chair of the conference, deserves special thanks.

Two things impressed me particularly: 1) the friendliness and diversity of the attendees and speakers, and 2) the overall efficiency of the conference.

1\) The conference had a lot more than just the normal talks: There were music jam areas, food areas, hacking areas, pair programming areas, and game areas. For a relatively small conference, there was a lot of attention paid to finding ways people could positively interact.

There was also a substantial effort relative to inclusiveness. My favorite story came from Vojtěch Polášek, who reported on [PyCon](./PyCon.html){.nonexistent} CZ 2017, although it was representative of 2018 as well: \"This year, I didn\'t manage to find anyone to assist me throughout the conference so I decided to go alone. But time showed that I wouldn\'t be alone at all. There was literally almost not a single minute when I would feel abandoned at this place. There was always someone around to help me or to talk to me.\"

The conference was consciously diverse, with a substantial number of women both attending and speaking. I don\'t know the exact ratio and I don\'t think it was at half, but it was clear that both in word and in action that they had spent time working on attracting a broad audience. This was noted not just by me, but by a number of attendees - see the links below. 2) Perhaps this is just the organizer in me, but I saw a lot of evidence that there was a clear budget that was being followed, and maximized.The conference was held in Smichov, which is one of the districts of Prague. It was off the beaten path, but still relatively accessible. It was well-sized for the number of attendees.

I gave a talk on community building, with an emphasis on why stronger communities tend to become more diverse over time, and the importance of accepting others, with an emphasis on how following the Code of Conduct can help us become a stronger and better community. I also spent time talking about the role of the PSF, which seemed to be appreciated by the organizers.
...
#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-2}
...
#### Report from Betsy Waliszewski {#Report_from_Betsy_Waliszewski}

The PSF was given a complimentary booth as part of their support for open source non-profits. Estimated attendance was 3200+. There were 55 Sponsor /Exhibitors + 26 Open Source Booths = 81. For comparison, [PyCon](./PyCon.html){.nonexistent} had 71 exhibitors + 16 Open Source Booths = 87.
...
I was able to connect with several potential PSF sponsors (that I had been emailing) to set up calls: Capital One, Twitter, Digital Ocean, and Redis. I also spoke with 7 sponsors about sponsoring [PyCon](./PyCon.html){.nonexistent} 2019. I will be following up in the coming weeks.
...
#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-3}

[PyLondinium](./PyLondinium.html){.nonexistent} is a new conference, the brainchild of Mario Corchero, held in Bloomberg\'s new offices in the City. Mario\'s idea was to leverage Bloomberg\'s sponsorship to 1) have a very low cost conference (regular tickets were £35) and 2) give all of the ticket proceeds to the PSF. Thanks to the support of Bloomberg and other sponsors, they achieved this, with final attendance around 250 (the initial target was 200), and after expenses a net contribution to the PSF of over \$12,000.

**Diversity**: On Friday, June 8, [PyLondinium](./PyLondinium.html){.nonexistent} hosted a [PyLadies](./PyLadies.html){.nonexistent} tutorial using the Django Girls curriculum (about 30-35 attendees) and a Trans\*Code hackday (about 20 attendees). Attendees to both of those events were offered free tickets to the rest of the conference. As founder of Trans\*Code I attended most of that session, but also gave a brief welcome talk to the [PyLadies](./PyLadies.html){.nonexistent} group. On the main conference days 6 of 23 speakers and one keynote (me) out 4 were women, and I\'d estimate that probably 25-30% of attendees were women.
...
**Blog post**: In discussing with Ewa, we decided that I will do a blog post on the event and their contribution to the PSF - post is at [http://pyfound.blogspot.com/2018/07/ophidia-in-urbe-pylondinium-arrives.html](http://pyfound.blogspot.com/2018/07/ophidia-in-urbe-pylondinium-arrives.html){.http}.

### PyCon Colombia 2018 {#PyCon_Colombia_2018}
...
- My talk was about community, help, donation, motivation. Slides → [https://speakerdeck.com/pkpacheco/o-que-voce-quer](https://speakerdeck.com/pkpacheco/o-que-voce-quer){.https}
...
- During Python Brazil, I had another event called Anitas. Where we have three women telling his story, always based on a chapter of the Lean In [Sheryl](https://www.google.com.ar/search?q=Sheryl+Sandberg&stick=H4sIAAAAAAAAAOPgE-LSz9U3KKrKKzMwUuIEsU0zsqrKtWSyk630k_Lzs_XLizJLSlLz4svzi7KtEktLMvKLAJBICBg3AAAA&sa=X&ved=0ahUKEwiZ2JnznO7WAhVEEZAKHRy_AUEQmxMIqQEoATAP){.https} Sandberg.I was invited and the theme was impostor syndrome. I told a little about my story and the PSF. The ultimate goal is that other people see a little behind the scenes another woman\'s life, which is not always easy, that all the achievements were not easy.

- Some statistics about the event: [https://docs.google.com/presentation/d/1cfMHOaxsc7Z8GrLJRrQoWpaPT8G9kc8JcT1KIrfMkiM/edit#slide=id.p](https://docs.google.com/presentation/d/1cfMHOaxsc7Z8GrLJRrQoWpaPT8G9kc8JcT1KIrfMkiM/edit#slide=id.p){.https}

- I talked to many people and others keynotes that were not Brazilians, and were impressed by the size of the community.

- In addition to one year ago I had created a repository to list all communities in latin america in order to create a [PyCon](./PyCon.html){.nonexistent} Latam. And this idea started walking this year along with Manuel Kauffmann and others of the Brazilian community. I would very much like that created a board as well as the Euro Python works, the Latam Python.
...
One final note - I believe that many have changed their thinking regarding PSF, I saw that many think in one day if you plan to go to a [PyCon](./PyCon.html){.nonexistent} US, but is somewhat impractical because it is quite expensive. I saw a national movement for a [PyCon](./PyCon.html){.nonexistent} Latam, there was much acceptance. I saw that future may have a Pyladies Conf in Brazil.
...
#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-5}
...
The main conference was in a beautiful 15th century convent that had been converted into a meeting space. It was well organized and had about 450 attendees. In particular they had come to [PyCon](./PyCon.html){.nonexistent} US this year and they deliberately followed the notion of having a green room, session chairs, and session runners, and the organizers and the speakers I talked to thought that was a big improvement in keeping the conference flowing. Overall I was quite impressed with the vibrance and activity of the Spanish Python community.
...
- My keynote on the Python community (video at [https://youtu.be/xQj_s8oj4Bw?t=34m58s](https://youtu.be/xQj_s8oj4Bw?t=34m58s){.https}). It was a discussion of community that I\'ve done before, but my slides were in Spanish. It was well received, and many people there told me that they hadn\'t been very aware of the PSF and they appreciated the information.
...
I was quite impressed by the size and level of organization at [PyConEs](./PyConEs.html){.nonexistent}. They had good sponsorship support (many of the organizers work in Bloomberg London, so Bloomberg was a key sponsor) and they had put a lot of thought, time and effort into making the event a success.
...
### PyCon Nigeria 2017 {#PyCon_Nigeria_2017}
...
This was the very first [PyCon](./PyCon.html){.nonexistent} held in Nigeria. Its interesting to note that the organizers of the event were inspired to start their own [PyCon](./PyCon.html){.nonexistent} after attending [PyCon](./PyCon.html){.nonexistent} Namibia (I felt that this was a testament to the benefits of collaboration amongst various African countries as a way to see long term growth.) The event was very well organized with over 100 people in attendance and a good amount of sponsorship most notably from a range of local companies.
...
### EuroPython 2017 {#EuroPython_2017}
...
- Spoke to Richard from [PyCon](./PyCon.html){.nonexistent} SK about government support - embassy grants. Richard is the one that discovered the US Embassy Grants for conference support and shared it Wirth [PyCon](./PyCon.html){.nonexistent} Czech. We discussed that every country with an Embassy can apply for the grant. How do we make that known to our organizers? Perhaps the [PyCon](./PyCon.html){.nonexistent} Slack. Mario from PyConES mentioned that they also get EU financial support for their [PyCon](./PyCon.html){.nonexistent}. Is it within our 501(c)(3) allowances to mention this to our local organizers?

- I also spoke to Richard from [PyCon](./PyCon.html){.nonexistent} SK about their education summit. The summit created a lot of motivation and movement. They have even started a conference for educators that want to implement Python into schools. I told Richard that he should ask if any of them want to join the Python Education Slack channel that we just started to continue the conversations from [PyCon](./PyCon.html){.nonexistent} US. He is going to email them and ask.
...
#### Betsy Waliszewski {#Betsy_Waliszewski}

On Monday, June 19, I attended and participated in the Sustain OSS event: [https://sustainoss.org/](https://sustainoss.org/){.https}. It was described as a one-day conversation for Open Source Software sustainers and maintainers. It sold out with 100 participants from all over the world.

Organizers included Pia Mancini (opencollective.com), Chad Whitacre (gratipay.com), Justin Dorfman (Sticker Mule), Andrew Nesbitt (libraries.io), and Richard Littauer ([GitHub](./GitHub.html){.nonexistent} Developer Program Manager).

Alan Gunn (Gunner) helped plan and facilitate (paid) the event: [https://aspirationtech.org/about/people/gunner](https://aspirationtech.org/about/people/gunner){.https}. He is Executive Director of Aspiration and focusses on "open approaches to capacity building and knowledge sharing in social change efforts."
...
#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-6}
...
### PyCon Jamaica {#PyCon_Jamaica}

Location: Kingston, Jamaica

Web: [PyCon Jamaica](https://www.pythonjam.org.jm/conference-2016/schedule){.https}
...
### Python Brasil\[12\] {#Python_Brasil.5B12.5D}
...
#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-7}
...
October 13-14 were tutorials, including a [PyLadies](./PyLadies.html){.nonexistent} tutorial for some 30 women of whom only 2 had ever done any coding, and Django Girls with 50 women. I arrived late in the afternoon of Oct 13, and attended the social events that evening and the [DjangoGirls](./DjangoGirls.html){.nonexistent} and social events the next day.
...
The afternoon PSF meeting was attended by 50-70 people. I outlined the main functions of the PSF very briefly and explained the membership model and the grants process. One of the attendees set up his laptop as a sign-up station and I think we had 30 (or possibly more) people sign up as basic PSF members, and I encouraged at least 15 to self-certify as voting members. At this meeting I distributed the bulk of stickers I had, both the Python3 and PSF stickers as well as the little PSF Member stickers I got from MAL at [EuroPython](./EuroPython.html){.nonexistent}. Stickers were definitely an effective incentive.

Oct 18 was the sprint day - I had to leave the evening of the 17th, but from social media shares it looked like they had a good turn out, sprinting on the [PyLadies](./PyLadies.html){.nonexistent} web site, [BeeWare](./BeeWare.html){.nonexistent}, and other projects.
...
#### Report from Betsy Waliszewski {#Report_from_Betsy_Waliszewski-1}

- There were just under 400 attendees and it looked like nearly everyone had checked in by the mid-day on Saturday.

- Friday, there were 2 pre-conference offsite tutorials (Wesley Chun and Raymond Hettinger) that were sold out. After that, everyone came back to the conference venue at the Mission Bay Conference Center for a reception, keynote by Jessica [McKellar](./McKellar.html){.nonexistent}, lightening talks, and networking.
...
#### Report from Carol Willing {#Report_from_Carol_Willing}
...
### PyCon APAC 2016 {#PyCon_APAC_2016}
...
Top tweets from the event: [https://www.dropbox.com/s/kyol5e4xv8xqygr/%23PyConAPAC%20-%20Twitter%20Search.pdf?dl=0](https://www.dropbox.com/s/kyol5e4xv8xqygr/#PyConAPAC%20-%20Twitter%20Search.pdf?dl=0){.https}

Ewa\'s slides shown at the PSF booth: [http://prezi.com/8kgq9e9o_1fk/?utm_campaign=share&utm_medium=copy&rc=ex0share](http://prezi.com/8kgq9e9o_1fk/?utm_campaign=share&utm_medium=copy&rc=ex0share){.http}

#### Report from Ewa Jodlowska {#Report_from_Ewa_Jodlowska-1}

**August 13, 2016**

- Attended Wes's talk (opening Keynote). During his talk, he mentioned how Scientific Python gets supported by [NumFocus](./NumFocus.html){.nonexistent} and the Apache Foundation but did not mention the PSF. Why is that? Perhaps we need to better publicize our working groups.
...
- Met with Dmitri from [JetBrains](./JetBrains.html){.nonexistent}. [JetBrains](./JetBrains.html){.nonexistent} is very interested in partnering with the PSF similar to how they have with the DSF. Discussed fundraiser ([https://www.djangoproject.com/weblog/2016/jun/30/pycharm-and-django-fundraiser/](https://www.djangoproject.com/weblog/2016/jun/30/pycharm-and-django-fundraiser/){.https}), discussed [http://www.jetbrains.com/pycharm/python-developers-survey-2016/](http://www.jetbrains.com/pycharm/python-developers-survey-2016/){.http}. Discussed getting corporate stats to help drive better sponsorship. Discussed how companies and the PSF are interested in a common thread of sustainability. We discussed how Data Analysis/Scientific in Python is on the rise.

- Spoke to Maciej about moving [PyPy](./PyPy.html){.nonexistent} over to the PSF from the FSC. I think once we figure this out for [BeeWare](./BeeWare.html){.nonexistent}, we can offer this the same model to [PyPy](./PyPy.html){.nonexistent}. I think that kind of support is huge for the community and I would like to see the PSF assist with it. I would like to help with the accounting if needed in order to make it happen for our community projects.
...
- Armin's talk Python having stageful modules & how Flask helps with state management. Flask is commonly used by developers in Korea so Armin\'s talk and presence at the conference was very well received. He was asked for pictures and autographs several times during his time at the PSF booth ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}

- Maciej's talk was great - funding open source. Open Source is saving companies billions. We need to make corps see this so we can use some of those saved funds to help support and maintain OS. His talk would be great for our Sponsorship WG to see unfortunately it was not recorded ![:(](/wiki/europython/img/sad.png ":("){height="16" width="16"}

- It would be better interaction onsite to have access to \@thepsf twitter account.

- Met [PyLadies](./PyLadies.html){.nonexistent} local organizers

- Attending [PyCon](./PyCon.html){.nonexistent} APAC organizers meeting. During this meetings, they discussed creating a guideline document that can help other countries put on an APAC. They discussed how to increase national diversity so all APAC countries are represented in the audience. They also discussed financial aid. Off line, they will discuss how to deal with APAC accounting. Since the conference moves to different countries, money tends to get moved around when possible, but they would like to better the organization. They are considering an approach similar to how [EuroPython](./EuroPython.html){.nonexistent} is done or to become a PSF working group and have the money be managed by us.

- Attended [PyCon](./PyCon.html){.nonexistent} APAC dinner that the conference put on for volunteers, speakers, and sponsors. Met with two students who were conference volunteers. They have recently learned about Python and developing in general but are very driven and energetic about the prospects. I spoke to them about attending [PyCon](./PyCon.html){.nonexistent} US when they have a chance and also informed them of our financial aid program. I also met with another [PyCon](./PyCon.html){.nonexistent} US sponsor, Roy from [CrossCompute](./CrossCompute.html){.nonexistent}. We discussed international [PyCons](./PyCons.html){.nonexistent} and his experiences attending them.

**August 15, 2016**

- Sprints and tutorials happening at a local company.

- The conference had more attendees show up for this day than they had expected. Organizations had to book additional space last minute. Good problem to have in my opinion. After lunch I chatted with Manabu Terada, the [PyCon](./PyCon.html){.nonexistent} JP organizer. We talked about doing a similar setup of the PSF booth in [PyCon](./PyCon.html){.nonexistent} JP 2017 as we did in [PyCon](./PyCon.html){.nonexistent} APAC 2016.

### Europython 2016 {#Europython_2016}
...
#### Report from Naomi Ceder {#Report_from_Naomi_Ceder-8}

- gave keynote on Python Community and PSF (video at [https://www.youtube.com/watch?v=cCCiA-IlVco](https://www.youtube.com/watch?v=cCCiA-IlVco){.https}).

- ran PSF member meeting (with Lorena\'s help) (video at [https://www.youtube.com/watch?v=kuMf6lnEumo](https://www.youtube.com/watch?v=kuMf6lnEumo){.https}).
