...
[Meine persönliche Seite jetzt anlegen!](./FehlendePers(c3b6)nlicheSeite.html?action=edit&template=HomepageVorlage){.action}

Der Name Ihrer persönlichen Seite entspricht Ihrem Anmeldenamen (Login) im Wiki, lautet in der Regel also \"VornameNachname\".

Wenn Sie jetzt Ihre persönliche Seite nicht einrichten wollen, folgen Sie einfach einem anderen Link, z.B. zum [WegWeiser](./WegWeiser.html){.nonexistent}.
:::
