# ScientificWG/Charter_v3

::: {#content dir="ltr" lang="en"}
# Scientific Python Working Group Charter {#Scientific_Python_Working_Group_Charter}
...
## Rules & Decision Making Procedures {#Rules_.26_Decision_Making_Procedures}
...
### Funding guidelines {#Funding_guidelines}
...
- The PSF will only sponsor **conferences** that have a Code of Conduct/Anti Harassment guide for their conference. The Ada Initiative has a basic template available at [http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy](http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy){.http}.
...
### Grant request size guidelines {#Grant_request_size_guidelines}
...
### Grantee reporting responsibility {#Grantee_reporting_responsibility}
...
The bulk of communication among the working group shall be over the mailing list [scientific@python.org](mailto:scientific@python.org){.mailto}. As needed, we may use other communication means such as video conferencing, phone calls, or in-person meetings.

## Administration & Membership {#Administration_.26_Membership}

Please refer to [ScientificWG](ScientificWG)

## Support Requirements {#Support_Requirements}

Mailman list: [scientific@python.org](mailto:scientific@python.org){.mailto}
:::
