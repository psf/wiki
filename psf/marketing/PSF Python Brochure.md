...
The project has been running since Dec 2010, making slow, but steady progress. It\'s one of those projects that take time and lots of effort to get to the finishing line.
...
The PSF has signed a contract with Evenios Publishing to produce the brochure under a predefined budget plan. After successful production, Evenios will also take care of distributing the brochures to interested parties with the PSF managing the selection process.
...
- Payment platform for ads, reference entries, subscriptions and educational sponsorships

- Creating preview booklets and flyers for the brochure

- Getting approvals from all content suppliers

- Creating a PDF preview of the complete brochure which can be sent out to sponsors

- Selling the various ads and sponsorship options to help refinance the production and distribution costs

- Printing of the brochure

We\'re now in the last phase:

- Distribution of the brochures to conferences, user groups, universities, schools, etc.

Most of the 10,000 printed brochures have been distributed already. We only have a few boxes left.

Due to too many community orders and an overall increase in costs (for e.g. running a shopping system and due to the many delays we had to deal with), we will not have money left to refund the initial upfront investment back to the PSF.
