...
# Infrastructure Working Group Charter {#Infrastructure_Working_Group_Charter}
...
- in-kind sponsorships for relevant service donations
...
In the event the chair steps down, the PSF IT Manager will take the temporary role of the chair. The PSF IT Manager shall discuss the chair role within the workgroup. If no one is able to take the chair role, the PSF IT Manager shall post a call to the active contributors: ([https://github.com/python/psf-salt/graphs/contributors](https://github.com/python/psf-salt/graphs/contributors){.https}).

## Participation {#Participation}

Membership in the Infra-WG is open to all members of the PSF, however several special classes of member are recognized: Chair, Advisory, Staff, and Tenant Members as described below. Any PSF member may apply for membership in the Infra-WG by first emailing [mailto:infrastructure@python.org](mailto:infrastructure@python.org){.mailto} and introducing yourself, and asking to join. After approval, you can join the [Infra-WG mailing list](http://mail.python.org/mailman/listinfo/infrastructure){.http}. The PSF IT Manager is a permanent member of this workgroup.

All participants agree to abide by the Python Community Code of Conduct: [https://www.python.org/psf/codeofconduct/](https://www.python.org/psf/codeofconduct/){.https}
...
## SSL Certificate Management {#SSL_Certificate_Management}
...
## Server and Application Hosting {#Server_and_Application_Hosting}
