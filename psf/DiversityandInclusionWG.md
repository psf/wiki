...
# Diversity and Inclusion Working Group {#Diversity_and_Inclusion_Working_Group}

::: table-of-contents
Contents

1.  [Diversity and Inclusion Working Group](#Diversity_and_Inclusion_Working_Group)
    1.  [Purpose](#Purpose)
    2.  [Active Time](#Active_Time)
    3.  [Core Values](#Core_Values)
    4.  [Membership](#Membership)
        1.  [Rules & Guidelines](#Rules_.26_Guidelines)
        2.  [Decision Making Procedures](#Decision_Making_Procedures)
        3.  [Communication Plan](#Communication_Plan)
        4.  [Budget](#Budget)
        5.  [List of Members/Who we are](#List_of_Members.2FWho_we_are)
        6.  [Administration and Contact](#Administration_and_Contact)
:::
...
- Folks that would like to join the Diversity and Inclusion Work Group should send an email to the WG ([diversity-inclusion-wg@python.org](mailto:diversity-inclusion-wg@python.org){.mailto}) introducing themselves. The WG will vote on new member requests verbally at meetings.
...
### List of Members/Who we are {#List_of_Members.2FWho_we_are}
...
- Georgi Ker (Chair) [georgi@python.org](mailto:georgi@python.org){.mailto}

- Marie Nordin (PSF Staff) [marie@python.org](mailto:marie@python.org){.mailto}

- [Diversity and Inclusion Work Group Charter](https://wiki.python.org/psf/DiversityandInclusionWG/Charter){.https}

- [diversity-inclusion-wg@python.org](mailto:diversity-inclusion-wg@python.org){.mailto}
::::
