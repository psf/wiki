...
- \* We won\'t make these non-Python tests from pytest\'s perspective (pytest has functionality for this: [https://docs.pytest.org/en/latest/example/nonpython.html](https://docs.pytest.org/en/latest/example/nonpython.html){.https})
