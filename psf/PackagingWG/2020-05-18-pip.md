...
- Nicole requested logging information - Pradyun is going to share all of the ways that pip outputs information to the user via a gist- [https://gist.github.com/pradyunsg/d76a2c4dfe3147b4ebc3aed9b1ce785e](https://gist.github.com/pradyunsg/d76a2c4dfe3147b4ebc3aed9b1ce785e){.https}
...
- Nicole asked Pradyun why poetry was unable to resolve a dependency conflict that pip can resolve (see [https://gist.github.com/nlhkabu/dd09051652a277eaec1d6f599d0e05f1](https://gist.github.com/nlhkabu/dd09051652a277eaec1d6f599d0e05f1){.https}). This is probably due to poetry using pubgrub and throwing information away too early.

  - In this case, pip is doing a better job ![:D](/wiki/europython/img/biggrin.png ":D"){height="16" width="16"}

  - Nicole asked for an example of where poetry \*can\* resolve dependency conflicts - there is an example in the poetry readme: [https://github.com/python-poetry/poetry#dependency-resolution](https://github.com/python-poetry/poetry#dependency-resolution){.https}
...
Bernard is having trouble finding failing package combinations for pipenv. Pradyun has an issue tracker for this: [https://github.com/pradyunsg/zazo/issues](https://github.com/pradyunsg/zazo/issues){.https} \\o/
...
Why not using pubgrub: [https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/PubGrub.20question/near/197679316](https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/PubGrub.20question/near/197679316){.https}
