...
- Is implementing pubgrub/or similar algo in scope for the project? (changing the core resolver algorithm; from our meeting [https://hackmd.io/el6WZNrTR-mK34szStCtrQ?both](https://hackmd.io/el6WZNrTR-mK34szStCtrQ?both){.https} on Tuesday/Today)

  - Bernard: maybe Pradyun could explain?

  - P: in the discussions we had about error messaging: the direction we are heading is, essentially, rediscovering everything that was in [PubGrub](./PubGrub.html){.nonexistent} \.... was in the tech choices we could make. We deferred on that by choosing the resolvlib API. Coming up in the error messages discussion. We\'re figuring out whether we should implement [PubGrub](./PubGrub.html){.nonexistent}. Pradyun says it is ok to not implement it right now, to meet deadline, but we should revisit it later.
  ...
  - TODO: Sumana to start conversation in Zulip \-- done in GitHub [https://github.com/pypa/pip/issues/8203](https://github.com/pypa/pip/issues/8203){.https} and will do in Zulip [https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/PubGrub.20question](https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/PubGrub.20question){.https} (
