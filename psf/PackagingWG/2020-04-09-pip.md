...
## Dev mini syncup chat {#Dev_mini_syncup_chat}
...
- pip output messages - how closely do we have to match current? (UX inputs would be great)
  ...
  - Past Pradyun wanted to redo the entire output, partly because of this problem. ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"} [https://github.com/pypa/pip/issues/4649](https://github.com/pypa/pip/issues/4649){.https}
    ...
    - Bernard: why is the new resolver reporting different than old?
      ...
      - Useful faq: [https://www.youtube.com/watch?v=B6-45rswo0o](https://www.youtube.com/watch?v=B6-45rswo0o){.https} (how to beatbox like a pro)
