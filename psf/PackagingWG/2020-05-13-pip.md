...
pip uses logging from the standard library - levels can be viewed here: [https://docs.python.org/3/library/logging.html#logging-levels](https://docs.python.org/3/library/logging.html#logging-levels){.https}
...
- See [https://github.com/pypa/pip/issues/4649](https://github.com/pypa/pip/issues/4649){.https}
