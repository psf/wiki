...
- Agenda
  ...
  - pip install a, a depends on c 2.0, already installed b and c where b depends on c 1.0
    ...
    - Do we have use cases for relaxing the graph?
      ...
      - \- this case [https://lwn.net/Articles/816044/](https://lwn.net/Articles/816044/){.https}
  ...
  - Beta release automation
    - Doable (looks like)!
  - Moar weekly calls
    - w/ UX folks for figuring out UI/UX stuff with them. ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
