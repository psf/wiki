...
- (from last week)
  ...
  - upgrade strategy (need to emit a warning/error for this)
    - TP: I want to replace it with a new flag \--strategy ( [https://github.com/pypa/pip/issues/8085](https://github.com/pypa/pip/issues/8085){.https} )
  ...
  - wheel cache ( [https://github.com/pypa/pip/pull/8066](https://github.com/pypa/pip/pull/8066){.https} )
...
- Windows CI boxes: do they allow symlinks?
  ...
  - [https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/Resolver.20and.20Testing/near/193347324](https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/Resolver.20and.20Testing/near/193347324){.https}
...
- Talked about [https://pypistats.org/packages/pip](https://pypistats.org/packages/pip){.https}, and how sharing it with the UX folks helped
...
\- PEP 610 + new resolver ( [https://github.com/pypa/pip/pull/8005](https://github.com/pypa/pip/pull/8005){.https} )
...
- pip search: [https://github.com/pypa/pip/issues/5216](https://github.com/pypa/pip/issues/5216){.https}
:::
