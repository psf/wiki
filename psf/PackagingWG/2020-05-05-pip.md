...
## Resolver Dev Syncup (5 May 2020) {#Resolver_Dev_Syncup_.285_May_2020.29}
...
- Some tests are very procedural, probably not likely to be translatable to YAML
  - [https://hackmd.io/niav7TZET4SxHR8G0l56PA](https://hackmd.io/niav7TZET4SxHR8G0l56PA){.https} \-- an example

\[then\... everyone gets into co-working mode\]

## pip UX and resolver team meeting note pad {#pip_UX_and_resolver_team_meeting_note_pad}
...
- Pradyun: would like to make decisions about UX-related pip issues [https://github.com/pypa/pip/milestone/10](https://github.com/pypa/pip/milestone/10){.https}, but today might not be the right time since the decisionmakers aren\'t in the call. Sumana asked to make that list
...
- [https://github.com/pypa/pip/blob/master/tests/functional/test_new_resolver.py](https://github.com/pypa/pip/blob/master/tests/functional/test_new_resolver.py){.https}

- [https://github.com/pypa/pip/blob/master/tests/yaml/install/conflicting_triangle.yml#L1](https://github.com/pypa/pip/blob/master/tests/yaml/install/conflicting_triangle.yml#L1){.https}
...
### Install (run) time {#Install_.28run.29_time}
...
- conflicting cases - [https://pradyun.github.io/scrap/four.html](https://pradyun.github.io/scrap/four.html){.https}
...
### Possible design deliverables {#Possible_design_deliverables}

#### Error message content {#Error_message_content}
...
Documentation on recommendations on pinning dependencies (e.g. you\'re less likely to see this issue if you have less pinned package versions) There are blogposts, can they be rolled into \"if you don\'t know what to do, start with these options and these are the reasons why\" trustable, good documentation. [https://caremad.io/posts/2013/07/setup-vs-requirement](https://caremad.io/posts/2013/07/setup-vs-requirement){.https} and [https://packaging.python.org/tutorials/managing-dependencies/](https://packaging.python.org/tutorials/managing-dependencies/){.https}
...
- [https://github.com/pradyunsg/zazo/issues/20](https://github.com/pradyunsg/zazo/issues/20){.https}

- [https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/Error.20messages/near/196694599](https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/Error.20messages/near/196694599){.https}
...
- Collect data for sucessful resolutions
  ...
  - this is done in debian\'s popularity contest ([https://popcon.debian.org/](https://popcon.debian.org/){.https}), homebrew ([https://formulae.brew.sh/analytics/](https://formulae.brew.sh/analytics/){.https}). TZP reminds us that the way homebrew did it was controversial ([https://news.ycombinator.com/item?id=11566720](https://news.ycombinator.com/item?id=11566720){.https})

  - [https://popcon.debian.org/FAQ](https://popcon.debian.org/FAQ){.https}

    - [https://popcon.debian.org/README](https://popcon.debian.org/README){.https}

#### participant recruitment {#participant_recruitment}
...
### Expert approach {#Expert_approach}
...
### Possible design deliverables {#Possible_design_deliverables-1}

#### Error message content {#Error_message_content-1}
...
### General research questions {#General_research_questions}
...
### Dependency resolution and PubGrub {#Dependency_resolution_and_PubGrub}

[https://pradyun.github.io/scrap/four.html](https://pradyun.github.io/scrap/four.html){.https}
...
- TODO: find out i there a comman/package to run to work out number of deps in a project/how complex?
  - [https://stackoverflow.com/questions/42237072/list-dependencies-in-python](https://stackoverflow.com/questions/42237072/list-dependencies-in-python){.https} seems to a solution
