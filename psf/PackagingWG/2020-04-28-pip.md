...
- pip 20.1 release
- test failures
  - [https://trello.com/b/tydA30lP/new-resolver-for-pip-fix-the-failing-tests](https://trello.com/b/tydA30lP/new-resolver-for-pip-fix-the-failing-tests){.https} (maybe do not include in public notes?)
...
- Visualization work
  ...
  - [https://github.com/sarugaku/resolvelib/issues/46#issuecomment-620106093](https://github.com/sarugaku/resolvelib/issues/46#issuecomment-620106093){.https}
...
- pip command to open project URL ( pypi.org/project/\<name\>/\<version\> ) to let the user have easy access to metadata.
  ...
  - TP: Think about this again, the setup.py I want to read is almost never the frontmost code on [GitHub](./GitHub.html){.nonexistent} (that's master, I want a specific version). A more viable solution would be for Warehouse to implement a "view content in sdist" page, and we link to that.
