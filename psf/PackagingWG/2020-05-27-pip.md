...
## Dev syncup, May 27th {#Dev_syncup.2C_May_27th}
...
- `PreviousBuildDirError`{.backtick}
  ...
  - [https://github.com/pypa/pip/pull/8282](https://github.com/pypa/pip/pull/8282){.https} Merged (lol)

  - [https://github.com/pypa/pip/pull/8283](https://github.com/pypa/pip/pull/8283){.https}
...
## Teamwide meeting, May 27th {#Teamwide_meeting.2C_May_27th}
...
- TODO: UX folks to start Zulip thread or [GitHub](./GitHub.html){.nonexistent} issue if you want, so we can paste in code examples
...
- UX output & followup on \[redacted: Notion document by Simply Secure\]
  ...
  - getting more reports re: resolutiontoodeep & resolution impossible:
    ...
    - B, N, & G had a discussion about this: even without data, we do have best practices re: providing info to user. We\'ve started a draft of some error messages for `ResolutionImpossible`{.backtick} (not yet `ResolutionTooDeep`{.backtick}). There\'s a Notion page
      ...
      - Nicole: aspirational. ![:-)](/wiki/europython/img/smile.png ":-)"){height="16" width="16"}
...
- next deliverable \-- a \"please test this\" push in June? \[how far are we?\]
  ...
  - Paul: it\'s been hard to get traction on the proposal in a \"we can code this\" way\.... what if suggestions of message improvements turned into [GitHub](./GitHub.html){.nonexistent} tickets:

    - when you do A,B, C, we want the output to look like THIS

  - Sumana: agrees

  - Bernard: in [https://www.notion.so/WIP-Example-error-messages-7b4ede077ad54c10a8f4182795fb949d](https://www.notion.so/WIP-Example-error-messages-7b4ede077ad54c10a8f4182795fb949d){.https} \-- we\'ve broken the error messages into 2 resolution exceptions. 1 is Res Impossible, the other is Res Too Deep
