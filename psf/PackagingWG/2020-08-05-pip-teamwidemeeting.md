...
- performance [https://github.com/pypa/pip/issues/8664](https://github.com/pypa/pip/issues/8664){.https}
  ...
  - [https://github.com/pypa/pip/issues/2195](https://github.com/pypa/pip/issues/2195){.https} \-- another \"slower\" situation.
...
- output on backtracking that leads to `ResolutionTooDeep`{.backtick}: [https://github.com/pypa/pip/issues/8683](https://github.com/pypa/pip/issues/8683){.https}
  ...
  - Diff between this and `ResolutionTooDeep`{.backtick}? This IS RTD. What happened earlier was we deferred it in some senses\.... but we do have an error message on the RTD [GitHub](./GitHub.html){.nonexistent} ticket.

    - [https://github.com/pypa/pip/issues/8380](https://github.com/pypa/pip/issues/8380){.https}
  ...
  - Sumana: we also need to define under what circumstances pip should error out, and a preliminary threshold for pip to start saying \"weird things are happening, and the user should start getting some notice and info about that\"
    ...
    - Ticket opened to work out the UX: [https://github.com/pypa/pip/issues/8714](https://github.com/pypa/pip/issues/8714){.https}

- using automated testing to find likely bugs/problems in upstreams
  - grabbing a bunch of requirements.txt files and setup.py files, constraints files, etc. from [GitHub](./GitHub.html){.nonexistent} \[and libraries.io\] and running those in test environments \[idea in [https://twitter.com/zzzeek/status/1289602964420612098](https://twitter.com/zzzeek/status/1289602964420612098){.https} and elsewhere\]

    - asking Tidelift whether we can grab some from them?

  - using [OpenStack](./OpenStack.html){.nonexistent} applications [https://github.com/sqlalchemy/mako/issues/322#issuecomment-667551424](https://github.com/sqlalchemy/mako/issues/322#issuecomment-667551424){.https}

  - helping users submit test cases \-- perhaps with pipdeptree?? per [https://twitter.com/westurner/status/1289612483800338434](https://twitter.com/westurner/status/1289612483800338434){.https}
...
- resolver beta testing survey \-- how many responses? & goal-setting
  ...
  - [https://tools.simplysecure.org/survey/index.php?r=survey/index&sid=989272&lang=en](https://tools.simplysecure.org/survey/index.php?r=survey/index&sid=989272&lang=en){.https}
  ...
  - there is also a Google form \.... in `ResolutionImpossible`{.backtick} message, [https://forms.gle/cWKMoDs8sUVE29hz9](https://forms.gle/cWKMoDs8sUVE29hz9){.https} survey #cWKMoDs8sUVE29hz9 \.... not what we are talking about
    ...
    - List of surveys: [https://www.notion.so/simplysecure/b46a0992ba8548cf988200cb2a02636b?v=beba10f184b647aa87c207e832f645b4](https://www.notion.so/simplysecure/b46a0992ba8548cf988200cb2a02636b?v=beba10f184b647aa87c207e832f645b4){.https} (work in progress)
...
- research on pip force install [https://github.com/pypa/pip/issues/8452](https://github.com/pypa/pip/issues/8452){.https}
