...
# pip test infrastructure planning {#pip_test_infrastructure_planning}
...
1.  [pip test infrastructure planning](#pip_test_infrastructure_planning)
    1.  [Agenda](#Agenda)
    2.  [Pipelines](#Pipelines)
    3.  [Pain points](#Pain_points)
        1.  [Wait time](#Wait_time)
        2.  [Inconsistent test environment](#Inconsistent_test_environment)
        3.  [Automation snags and permissions](#Automation_snags_and_permissions)
    4.  [Goals](#Goals)
...
Documented already: [https://pip.pypa.io/en/latest/development/ci/](https://pip.pypa.io/en/latest/development/ci/){.https}

Pipelines:

- the docs at pip.pypa.io and implied in NEWS provide context & info

Pradyun: We use Azure, GitHub, and Travis as our 3 CI providers \-- see matrix at [https://pip.pypa.io/en/latest/development/ci/](https://pip.pypa.io/en/latest/development/ci/){.https}

## Pain points {#Pain_points}

### Wait time {#Wait_time}

Pain point \# 1: reduce time between a pull request submission and [GitHub](./GitHub.html){.nonexistent} reporting the success:
...
### Inconsistent test environment {#Inconsistent_test_environment}
...
### Automation snags and permissions {#Automation_snags_and_permissions}
...
- [https://github.com/orgs/pypa/people/BrownTruck](https://github.com/orgs/pypa/people/BrownTruck){.https}

- [https://github.com/orgs/pypa/people/pypa-bot](https://github.com/orgs/pypa/people/pypa-bot){.https}
...
- 2-step release process \-- [https://github.com/pypa/warehouse/issues/726](https://github.com/pypa/warehouse/issues/726){.https}

- yanking \-- [https://github.com/pypa/warehouse/pull/5838](https://github.com/pypa/warehouse/pull/5838){.https} (open PR)

- Automated test of installability - Warehouse issue #194 [https://github.com/pypa/warehouse/issues/194](https://github.com/pypa/warehouse/issues/194){.https}

- (later, for resolver, Warehouse metadata API would help \-- [https://github.com/pypa/warehouse/issues/474](https://github.com/pypa/warehouse/issues/474){.https} I believe )
...
Pradyun\'s idea: Speeding up the test suite [https://github.com/pypa/pip/issues/4497](https://github.com/pypa/pip/issues/4497){.https}
...
- TODO: Sumana to note these meeting notes in [https://github.com/pypa/warehouse/issues/5837](https://github.com/pypa/warehouse/issues/5837){.https} re yanking prioritization
::::
