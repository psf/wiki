...
- Agenda
  ...
  - work done?
    ...
    - [https://github.com/pypa/pip/issues/4575](https://github.com/pypa/pip/issues/4575){.https}
  - pipeline of work:
    - debuggabilty
    ...
    - Look at the test suite, and see what\'s failing what\'s not
      - [https://github.com/pypa/pip/pull/7884](https://github.com/pypa/pip/pull/7884){.https}
...
- How is everyone
  - Let's keep not being a part of the "numbers" being published ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
- Invoices
...
- It\'s release month!
  - Pradyun: let\'s discuss: what do we want in the release?
    - What will actually get in?
      ...
      - Messaging about functionality \....
        - Do we want to tell people about it? at all?
          ...
          - Issue on prerelease automation [https://github.com/pypa/pip/issues/7952](https://github.com/pypa/pip/issues/7952){.https}
      - release notes
        ...
        - Draft a substantial release note about what is in it, what is not, how to test drive it
          - Example: [https://wiki.python.org/psf/WarehousePackageMaintainerTesting](https://wiki.python.org/psf/WarehousePackageMaintainerTesting){.https} and earlier versions like [https://wiki.python.org/psf/WarehousePackageMaintainerTesting?action=recall&rev=27](https://wiki.python.org/psf/WarehousePackageMaintainerTesting?action=recall&rev=27){.https}

          - also check out [https://pad.sfconservancy.org/p/help-test-pipenv-2020-03-26](https://pad.sfconservancy.org/p/help-test-pipenv-2020-03-26){.https}
    ...
    - What should the timeline of the release be? We usually like to have it in the first half of the month
      - Is there a release issue already on GitHub? [https://github.com/pypa/pip/issues/7951](https://github.com/pypa/pip/issues/7951){.https}
...
- Teaming up with Sumana on organizing the project board
  - [https://github.com/pypa/pip/projects/5#card-34798081](https://github.com/pypa/pip/projects/5#card-34798081){.https}
...
- Ilan and testing stuff
  ...
  - Ilan: reading the tests of the new resolver \..... today \.... running the YAML resolver tests with the new resolver \-- didn\'t quite work yet. So \... want to fix \..... see why it\'s not working.
    - TP: Oh he has already done what I wanted! ![:-)](/wiki/europython/img/smile.png ":-)"){height="16" width="16"}
