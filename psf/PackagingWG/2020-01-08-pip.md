...
- Potentially: devising a way to declare external dependencies that can be effectively consumed by the \"conda skeleton\" command, per [https://github.com/pypa/interoperability-peps/pull/30](https://github.com/pypa/interoperability-peps/pull/30){.https}
...
- [https://github.com/pradyunsg/zazo/tree/master/tests](https://github.com/pradyunsg/zazo/tree/master/tests){.https}

Other potential sources:

- [https://github.com/CocoaPods/Resolver-Integration-Specs/](https://github.com/CocoaPods/Resolver-Integration-Specs/){.https}

- [https://github.com/pradyunsg/zazo/tree/master/tests/yaml](https://github.com/pradyunsg/zazo/tree/master/tests/yaml){.https}

- [https://github.com/apple/swift-package-manager/tree/master/Tests/PackageGraphTests](https://github.com/apple/swift-package-manager/tree/master/Tests/PackageGraphTests){.https}

- [https://github.com/rust-lang/cargo/blob/master/crates/resolver-tests/tests/resolve.rs](https://github.com/rust-lang/cargo/blob/master/crates/resolver-tests/tests/resolve.rs){.https}
...
## Overall timeline {#Overall_timeline}

What is realistic to get done between now and the end of May?

\[discussion of a contractual timeline\]

### MOSS-funded developer {#MOSS-funded_developer}

[https://github.com/python/request-for/blob/master/2020-pip/RFP.md#role-1-senior-developer](https://github.com/python/request-for/blob/master/2020-pip/RFP.md#role-1-senior-developer){.https}
...
### CZI-funded (Pradyun\'s) work {#CZI-funded_.28Pradyun.27s.29_work}
