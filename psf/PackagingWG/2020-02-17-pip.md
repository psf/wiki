...
- No information about \"requested\" extras
  ...
  - [https://github.com/pypa/packaging-problems/issues/215](https://github.com/pypa/packaging-problems/issues/215){.https}

  - Let\'s defer this; it\'d be nice to fix this but it\'ll be very tricky to do so on the time-boxed nature.

  REQUESTED ([https://www.python.org/dev/peps/pep-0376/#requested](https://www.python.org/dev/peps/pep-0376/#requested){.https})
