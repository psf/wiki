...
- `ignore_dependencies`{.backtick} implementation [https://github.com/pypa/pip/pull/7888](https://github.com/pypa/pip/pull/7888){.https}

  - It works! ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
...
- Extras implementation [https://github.com/pypa/pip/pull/7897](https://github.com/pypa/pip/pull/7897){.https}
...
- Requires-Python prototype needs at least one interface tweak [https://github.com/pypa/pip/pull/7889](https://github.com/pypa/pip/pull/7889){.https}
...
- Use installed dist: `ignore_installed`{.backtick} and `force_reinstall`{.backtick} [https://github.com/pypa/pip/projects/5#card-35032881](https://github.com/pypa/pip/projects/5#card-35032881){.https}
...
- Broader resolution debugging ideas!
  ...
  - This is where reporter comes into play.
    ...
    - TP: Where did you put the \"print\" \-- that\'s probably a good place to report. ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
...
- Engaging people/users in intereviews
  - Sumana: \"engagement funnel\" \-- how many people click \"I\'ll be there\" vs how many actually show up. I\'ve publicized to improve this. PSF blog, PyPA twitter, LWN [https://lwn.net/Articles/815902/](https://lwn.net/Articles/815902/){.https} all have publicized about this.
...
- Suggestions on weekly collaborative working with the team
  - would get a lot out of collaboratively looking at issues that come into the [GitHub](./GitHub.html){.nonexistent} queue \... have time to talk with people who are better at interpreting - technical issue? feedback needs changing? etc.

  - suggestion: 7:30-9am ET on Wednesdays\... optional. Drop-in time.
    - [https://www.worldtimebuddy.com/?pl=1&lid=2643743,1275339,5,1668341&h=1275339&date=4/1/2020%7C3](https://www.worldtimebuddy.com/?pl=1&lid=2643743,1275339,5,1668341&h=1275339&date=4/1/2020%7C3){.https}
...
[http://www.ei8fdb.org/thoughts/2020/03/pip-ux-studies-response-data/](http://www.ei8fdb.org/thoughts/2020/03/pip-ux-studies-response-data/){.http}

- Pradyun: looks great!

- (bernard) thanks ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
