...
## Dev mini syncup {#Dev_mini_syncup}
...
- Paul: Ran the whole test suite on the new resolver \-- 135 tests failed. ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
...
- Project model
  ...
  - [https://github.com/pypa/pip/pulls?q=is%3Apr+download+is%3Aclosed](https://github.com/pypa/pip/pulls?q=is%3Apr+download+is%3Aclosed){.https}

  - [https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/Refactoring.20work.20behind.20the.20resolver.20prototyping](https://python.zulipchat.com/#narrow/stream/218659-pip-development/topic/Refactoring.20work.20behind.20the.20resolver.20prototyping){.https}

    - Paul: would like to be focused on Provider
    - Pradyun: I can look into this

[https://dev.azure.com/pypa/pip/\_build/results?buildId=20323&view=ms.vss-test-web.build-test-results-tab](https://dev.azure.com/pypa/pip/_build/results?buildId=20323&view=ms.vss-test-web.build-test-results-tab){.https}

[https://github.com/pypa/pip/runs/396903834?check_suite_focus=true](https://github.com/pypa/pip/runs/396903834?check_suite_focus=true){.https}

This is the test failures at the moment [https://gist.github.com/pfmoore/5fc59e04905c6f944b4e99a3d8ef7705](https://gist.github.com/pfmoore/5fc59e04905c6f944b4e99a3d8ef7705){.https}

## Team syncup, 19 March 2020 {#Team_syncup.2C_19_March_2020}
...
### PyCon and COVID-19 {#PyCon_and_COVID-19}
...
- Ernest:
  ...
  - Most up-to-date info is in most recent PyCon blog post [https://pycon.blogspot.com/2020/03/march-12-update-on-covid-19.html](https://pycon.blogspot.com/2020/03/march-12-update-on-covid-19.html){.https}
...
### Drop-in hours/conversation hours for the group (online) {#Drop-in_hours.2Fconversation_hours_for_the_group_.28online.29}
...
- Sumana: \[too fast for note taker\] a few purposes, centering on relationship and content
  ...
  - Content: I think we have 2 directions
    ...
    - them to us: unknown unknowns + what they want, what they do, what they like etc ([https://en.wikipedia.org/wiki/There_are_known_knowns](https://en.wikipedia.org/wiki/There_are_known_knowns){.https})
