# PackagingWG/2020-03-05-pip

::: {#content dir="ltr" lang="en"}
## Resolver mini-syncup {#Resolver_mini-syncup}

Mini-syncup, 5 Mar 2020

Paul, Pradyun, TP

- TP: Initial effort posted. What's that PreviousBuildError about ![:(](/wiki/europython/img/sad.png ":("){height="16" width="16"}
...
- Someone from Twitter filed an issue within the last day saying: hey! we have implemented pip resolver that turns requirements into ? \.... [https://github.com/pypa/pip/issues/7819](https://github.com/pypa/pip/issues/7819){.https}
...
- Blockers?
  ...
  - Tzu-Ping:
    - Things are moving along \.... reading some other implementations from Twitter: [https://github.com/pypa/pip/issues/7819](https://github.com/pypa/pip/issues/7819){.https} \...

    - resolver prototype\... now & next week ( [https://github.com/pypa/pip/pull/7799](https://github.com/pypa/pip/pull/7799){.https} )

  - Paul:
    - this past week, been fragmented, other stuff in the way\.... pre-meeting chat, now knows what is next \... refactoring prototype implementation, look at [https://github.com/pypa/pip/issues/7819](https://github.com/pypa/pip/issues/7819){.https} , get some tests of new implementation in place
...
- pip logo issue [https://github.com/pypa/pip/pull/7754#issuecomment-588194568](https://github.com/pypa/pip/pull/7754#issuecomment-588194568){.https}
  ...
  - (last discussion) It\'s probably OK to delay \-- is that still True?
    ...
    - Today: reiterating that. (And yes a logo is \_useful\_.) Logo design brief would be useful.
...
- Do we have any news on impact of corona virus on Python conferences? [https://pycon.blogspot.com/2020/03/march-2-update-on-covid-19.html](https://pycon.blogspot.com/2020/03/march-2-update-on-covid-19.html){.https} currently says all AOK.
...
- Communication
  - with stakeholders: [https://gist.github.com/brainwane/f5a3dd07099d56bd2cb1ec60e1650598](https://gist.github.com/brainwane/f5a3dd07099d56bd2cb1ec60e1650598){.https}
  ...
  - Can we do this work in a collab doc instead of GitHub gist?
    ...
    - [https://hackmd.io/@pradyunsg/BJq9aKREI](https://hackmd.io/@pradyunsg/BJq9aKREI){.https}
