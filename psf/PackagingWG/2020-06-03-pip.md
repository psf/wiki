...
- \- [https://github.com/pypa/pip/issues/8307](https://github.com/pypa/pip/issues/8307){.https}
...
\- pip\'s new resolver\'s output: [https://github.com/pypa/pip/issues/8220](https://github.com/pypa/pip/issues/8220){.https}
...
- \- [https://github.com/pypa/pip/issues/7846](https://github.com/pypa/pip/issues/7846){.https}
...
- \- Paul worked on upgrade-strategy: [https://github.com/pypa/pip/pull/8117](https://github.com/pypa/pip/pull/8117){.https}

- \- [https://github.com/pypa/pip/issues/4745](https://github.com/pypa/pip/issues/4745){.https}

- \- No clear \"this is the input, this is the output\" description.

\- Already Installed packages

- \- [https://github.com/pypa/pip/issues/7744](https://github.com/pypa/pip/issues/7744){.https}

- We sort of reached agreement that we just do what we have at the moment.
  - \- Pradyun wasn\'t 100% convinced by the arguments (and TBH, Paul understands they were a bit weak ![:-))](/wiki/europython/img/smile3.png ":-))"){height="16" width="16"}
...
- [https://github.com/pypa/pip/issues/8294](https://github.com/pypa/pip/issues/8294){.https}
...
- What flag will users use to call the new resolver? [https://github.com/pypa/pip/issues/8371](https://github.com/pypa/pip/issues/8371){.https}
...
- UX work/workflow/priorities
  ...
  - But ResolutionImpossible people will see frequently
    ...
    - TP: it would be suboptimal for them to report it to \*pip\*, but we\'d like it reported to [https://github.com/pypa/packaging-problems/issues/](https://github.com/pypa/packaging-problems/issues/){.https}

    - TODO: add \"please report this to [https://github.com/pypa/packaging-problems/issues/](https://github.com/pypa/packaging-problems/issues/){.https} \"
    ...
    - Bernard: we have Iteration 2 \-- in the ticket 8377 \... next step would be to test with users a bit. Will do that Thursday and Friday [https://github.com/pypa/pip/issues/8377](https://github.com/pypa/pip/issues/8377){.https}
    ...
    - Bernard: this is Iteration 2, our current thinking. Then we test this with users, then, assuming the bindings are not drastically different, it will follow that general structure \..... 
      - Paul: it\'s an actionable coding task. The quoted message [https://github.com/pypa/pip/issues/8377](https://github.com/pypa/pip/issues/8377){.https} he can do, and then he can update with a followup with that. 
