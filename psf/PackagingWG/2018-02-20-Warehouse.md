...
# Warehouse Sync-up Meeting {#Warehouse_Sync-up_Meeting}
...
## Current work/announcements/blocked: {#Current_work.2Fannouncements.2Fblocked:}
...
- Also pushing forward [PEP](https://www.python.org/dev/peps/pep-0566/){.https}[566](https://www.python.org/dev/peps/pep-0566/){.https}, which will eventually enable Markdown support in Warehouse
...
- met with Ernest and helped create codebase description in docs: [https://warehouse.readthedocs.io/application/](https://warehouse.readthedocs.io/application/){.https}

- Created promotional campaign in the PSF CRM

- Created a planning document for promoting the latest milestone to maintainers: [https://docs.google.com/document/d/1j1c-Waa2l0ikbfHblto5py9_KWiOgqgo02x2SLTKmKs/edit](https://docs.google.com/document/d/1j1c-Waa2l0ikbfHblto5py9_KWiOgqgo02x2SLTKmKs/edit){.https}

Sumana:

- \- bug triage

- \- Twine RtD fix PR [https://github.com/pypa/twine/pull/297](https://github.com/pypa/twine/pull/297){.https}
...
\* [https://github.com/pypa/warehouse/issues/2285](https://github.com/pypa/warehouse/issues/2285){.https} Rename \"/legacy\" url to something else
...
\* Possible spamming of package namespace #2859 [https://github.com/pypa/warehouse/issues/2859](https://github.com/pypa/warehouse/issues/2859){.https}
...
\* [https://github.com/pypa/warehouse/issues/2533](https://github.com/pypa/warehouse/issues/2533){.https} \"499 Client Error: Client Disconnected for url: [https://upload.pypi.org/legacy/](https://upload.pypi.org/legacy/){.https}\"
...
\* [https://github.com/pypa/warehouse/issues/916](https://github.com/pypa/warehouse/issues/916){.https} option to turn off indexing in robots.txt across instance (e.g., Test PyPI)
...
- Resolution: [Sumana will update as cool-but-not-urgent]{.strike} Ernest has created [a PR](https://github.com/pypa/warehouse/pull/2995){.https}

\* [https://github.com/pypa/warehouse/issues/1000](https://github.com/pypa/warehouse/issues/1000){.https} Email all owners when a new owner/maintainer is added
...
\* [https://github.com/pypa/warehouse/issues/998](https://github.com/pypa/warehouse/issues/998){.https} Send confirmation when email address changes
...
\* [https://github.com/pypa/warehouse/issues/997](https://github.com/pypa/warehouse/issues/997){.https} Email all owners when a new version of a package is uploaded
...
\* [https://github.com/pypa/warehouse/issues/469](https://github.com/pypa/warehouse/issues/469){.https} Disallow runs of special characters in project names
...
\* [https://pyfound.blogspot.com/2017/01/time-to-upgrade-your-python-tls-v12.html](https://pyfound.blogspot.com/2017/01/time-to-upgrade-your-python-tls-v12.html){.https}
...
\* [https://github.com/pypa/warehouse/issues/582](https://github.com/pypa/warehouse/issues/582){.https} ability to delete legacy docs
...
## Ask Donald to: {#Ask_Donald_to:}

- [https://github.com/pypa/warehouse/issues/2216](https://github.com/pypa/warehouse/issues/2216){.https} \<- not just do this, but also help us make sure we can do it in the same way w/o him

  - Ties back into the dang db dump tooling. This requires some automated scrubbing to get right.

- [https://github.com/pypa/warehouse/issues/2287](https://github.com/pypa/warehouse/issues/2287){.https} \<- Dustin can do this if Nicole or Ernest can give access to the repo (or banner can go away at launch)

  - Ernest can grant Nicole and Dustin access to that repo

## Milestone progress {#Milestone_progress}

[We\'ve hit Milestone 1 and are on to Milestone 2!](https://github.com/pypa/warehouse/projects/1){.https}
...
- add a nice to have issue for a \"report spam\" button
  - +1, once [https://github.com/pypa/warehouse/pull/2991](https://github.com/pypa/warehouse/pull/2991){.https} is merged
