...
## Resolver dev team chat {#Resolver_dev_team_chat}
...
- Remaining test failures [https://hackmd.io/TkGB1hPQTcu9y_4JwAtGyA?view](https://hackmd.io/TkGB1hPQTcu9y_4JwAtGyA?view){.https}

- Constraints review + failures?

Discussion of [https://github.com/pypa/pip/issues/14](https://github.com/pypa/pip/issues/14){.https}
...
- UI cruft
  ...
  - Georgia: +100.
    ...
    - +1 from Bernard - creating a [GitHub](./GitHub.html){.nonexistent} issue - \"make foo does what it says it does\"
...
- Current resolver failures - Ilan\'s work
  - [https://hackmd.io/TkGB1hPQTcu9y_4JwAtGyA?view](https://hackmd.io/TkGB1hPQTcu9y_4JwAtGyA?view){.https}
...
- \"Release beta of resolver in May?\" [https://github.com/pypa/pip/issues/8206](https://github.com/pypa/pip/issues/8206){.https}
