# PackagingWG/2020-10-20-pip-team-meeting
...
- Are these blockers? If so, who\'s working on them/what should we do next?
  - [https://github.com/pypa/pip/issues/8686](https://github.com/pypa/pip/issues/8686){.https} Dependency resolution and improper handling of extras
  ...
  - [https://github.com/pypa/pip/issues/8713](https://github.com/pypa/pip/issues/8713){.https} Pip downloads lots of different versions of the same package
    ...
    - Should be covered by [https://github.com/pypa/pip/pull/9017](https://github.com/pypa/pip/pull/9017){.https}
  ...
  - [https://github.com/pypa/pip/issues/8115](https://github.com/pypa/pip/issues/8115){.https} Clarify and define install/upgrade behaviour for the new resolver
    ...
    - TODO: Sumana to move to post-release work
      ...
      - Migration Guide, Documentation of current behavior \-- add to [https://pip.pypa.io/en/latest/user_guide/#changes-to-the-pip-dependency-resolver-in-20-2-2020](https://pip.pypa.io/en/latest/user_guide/#changes-to-the-pip-dependency-resolver-in-20-2-2020){.https}
  ...
  - [https://github.com/pypa/pip/issues/8975](https://github.com/pypa/pip/issues/8975){.https} How to improve information provided to users when pip backtracks

    - Should be covered by [https://github.com/pypa/pip/pull/9017](https://github.com/pypa/pip/pull/9017){.https}

  - [https://github.com/pypa/pip/issues/8711](https://github.com/pypa/pip/issues/8711){.https} local development and pip\'s 2020 resolver

    - This is resolved.
    - TODO: Pradyun: mark issue as resolved.

  - [https://github.com/pypa/pip/issues/9011](https://github.com/pypa/pip/issues/9011){.https} Pip 20.2.4 goes into infinite resolution of dependencies
  ...
  - And: re: updating docs to say new resolver is default:
    - [https://github.com/pypa/pip/issues/8937](https://github.com/pypa/pip/issues/8937){.https}
