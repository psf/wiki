...
- Yay, beta is out!
  - Feels like we checked the checkbox! ![:-)](/wiki/europython/img/smile.png ":-)"){height="16" width="16"}
...
- issue followup on things that we would like to finish before stable 20.3 release (from [https://github.com/pypa/pip/projects/5](https://github.com/pypa/pip/projects/5){.https} , [https://github.com/pypa/pip/projects/6](https://github.com/pypa/pip/projects/6){.https} , and [https://github.com/pypa/pip/milestone/38](https://github.com/pypa/pip/milestone/38){.https} )
  ...
  - [https://github.com/pypa/pip/issues/8380](https://github.com/pypa/pip/issues/8380){.https} `ResolutionTooDeep`{.backtick} error message

    - Have we resolved this with some other PR that maybe didn\'t get attached?

    - We basically removed the `ResolutionTooDeep`{.backtick} error in [https://github.com/pypa/pip/pull/8275](https://github.com/pypa/pip/pull/8275){.https}, because we figured \"how many package names have we looked at\" is a bad metric. ![:)](/wiki/europython/img/smile.png ":)"){height="16" width="16"}
  ...
  - [https://github.com/pypa/pip/issues/9011](https://github.com/pypa/pip/issues/9011){.https} Pip 20.2.4 goes into infinite resolution of dependencies #9011
  ...
  - printing warnings about pip potentially introducing conflicts involving existing dependencies: [https://github.com/pypa/pip/issues/7744#issuecomment-717773481](https://github.com/pypa/pip/issues/7744#issuecomment-717773481){.https}
  ...
  - Including backtracking in the user guide [https://github.com/pypa/pip/pull/9040](https://github.com/pypa/pip/pull/9040){.https}

    - incorporate Sumana\'s commit and merge?
    - TODO: Pradyun to \^

  - [https://github.com/pypa/pip/issues/8495](https://github.com/pypa/pip/issues/8495){.https} New resolver error message is confusing if a package has inconsistent dependencies #8495
  ...
  - [https://github.com/pypa/pip/issues/9083](https://github.com/pypa/pip/issues/9083){.https} numpy, PEP 440, comparison, version normalization

    - How hard is this to fix?
      - Has an approved PR, can be merged as is (waiting on writing a test tho): [https://github.com/pypa/pip/pull/9085](https://github.com/pypa/pip/pull/9085){.https}
