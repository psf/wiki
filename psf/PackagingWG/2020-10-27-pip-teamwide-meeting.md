...
- Release: schedule change
  - [https://github.com/pypa/pip/issues/8936](https://github.com/pypa/pip/issues/8936){.https}

  - consensus from group
- Individual status/blockers
  - Pradyun: yesterday was productive! ![:D](/wiki/europython/img/biggrin.png ":D"){height="16" width="16"} merged CI fixes which should unblock everything else. PR for flipping new resolver switch needs update re Python 2 change. Everything else: reviewing and merging PRs. Only looking at 20.3 milestone. All of this can be done in the next day assuming others are quick to respond. Reviewed many issues over the past day - nothing reproducible. So bugs likely already fixed!
  ...
  - Ernest: ![:-)](/wiki/europython/img/smile.png ":-)"){height="16" width="16"}
...
- Outstanding issues blocking release
  - Handle conflicts from installed packages when updating other packages
    - #7744 [https://github.com/pypa/pip/issues/7744](https://github.com/pypa/pip/issues/7744){.https}
  ...
  - Log an informational message when backtracking takes multiple rounds on a specific package
    - #9017 [https://github.com/pypa/pip/pull/9017](https://github.com/pypa/pip/pull/9017){.https}
  ...
  - Include backtracking in user guide
    - #9040 [https://github.com/pypa/pip/pull/9040](https://github.com/pypa/pip/pull/9040){.https}

    - Bernard reviewing and finishing

  - [https://github.com/pypa/pip/milestone/38](https://github.com/pypa/pip/milestone/38){.https} ? \[others?\]

    - `ResolutionImpossible`{.backtick} error message - [https://github.com/pypa/pip/issues/8495#issuecomment-714771364](https://github.com/pypa/pip/issues/8495#issuecomment-714771364){.https}
